...
void bind_NCollection_Array1(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_Array1<TheItemType>::iterator (NCollection_Array1<TheItemType>::*)() const ) &NCollection_Array1<TheItemType>::begin, "Returns an iterator pointing to the first element in the array.");
	cls.def("end", (NCollection_Array1<TheItemType>::iterator (NCollection_Array1<TheItemType>::*)() const ) &NCollection_Array1<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls.def("cbegin", (NCollection_Array1<TheItemType>::const_iterator (NCollection_Array1<TheItemType>::*)() const ) &NCollection_Array1<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls.def("cend", (NCollection_Array1<TheItemType>::const_iterator (NCollection_Array1<TheItemType>::*)() const ) &NCollection_Array1<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the array.");
...
void bind_NCollection_CellFilter(py::object &mod, std::string const &name) {
	...
	cls.def("Add", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Target &, const NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Add, "Adds a target object for further search at a point (into only one cell)", py::arg("theTarget"), py::arg("thePnt"));
	cls.def("Add", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Target &, const NCollection_CellFilter<Inspector>::Point &, const NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Add, "Adds a target object for further search in the range of cells defined by two points (the first point must have all co-ordinates equal or less than the same co-ordinate of the second point)", py::arg("theTarget"), py::arg("thePntMin"), py::arg("thePntMax"));
	cls.def("Remove", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Target &, const NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Remove, "Find a target object at a point and remove it from the structures. For usage of this method 'operator ==' should be defined for Target.", py::arg("theTarget"), py::arg("thePnt"));
	cls.def("Remove", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Target &, const NCollection_CellFilter<Inspector>::Point &, const NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Remove, "Find a target object in the range of cells defined by two points and remove it from the structures (the first point must have all co-ordinates equal or less than the same co-ordinate of the second point). For usage of this method 'operator ==' should be defined for Target.", py::arg("theTarget"), py::arg("thePntMin"), py::arg("thePntMax"));
	cls.def("Inspect", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Point &, Inspector &)) &NCollection_CellFilter<Inspector>::Inspect, "Inspect all targets in the cell corresponding to the given point", py::arg("thePnt"), py::arg("theInspector"));
	cls.def("Inspect", (void (NCollection_CellFilter<Inspector>::*)(const NCollection_CellFilter<Inspector>::Point &, const NCollection_CellFilter<Inspector>::Point &, Inspector &)) &NCollection_CellFilter<Inspector>::Inspect, "Inspect all targets in the cells range limited by two given points (the first point must have all co-ordinates equal or less than the same co-ordinate of the second point)", py::arg("thePntMin"), py::arg("thePntMax"), py::arg("theInspector"));
...
void bind_NCollection_DataMap(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::iterator (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_DataMap<TheKeyType, TheItemType, Hasher>::begin, "Returns an iterator pointing to the first element in the map.");
	cls.def("end", (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::iterator (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_DataMap<TheKeyType, TheItemType, Hasher>::end, "Returns an iterator referring to the past-the-end element in the map.");
	cls.def("cbegin", (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::const_iterator (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_DataMap<TheKeyType, TheItemType, Hasher>::cbegin, "Returns a const iterator pointing to the first element in the map.");
	cls.def("cend", (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::const_iterator (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_DataMap<TheKeyType, TheItemType, Hasher>::cend, "Returns a const iterator referring to the past-the-end element in the map.");
	...
	// FIXME cls.def("Find", (const TheItemType & (NCollection_DataMap<TheKeyType, TheItemType, Hasher>::*)(const TheKeyType &) const ) &NCollection_DataMap<TheKeyType, TheItemType, Hasher>::Find, "Find returns the Item for Key. Raises if Key was not bound", py::arg("theKey"));
...
void bind_NCollection_EBTree(py::object &mod, std::string const &name) {
	...
	cls.def("FindNode", (const NCollection_EBTree<TheObjType, TheBndType>::TreeNode & (NCollection_EBTree<TheObjType, TheBndType>::*)(const TheObjType &) const ) &NCollection_EBTree<TheObjType, TheBndType>::FindNode, "Returns The leaf node containing the object.", py::arg("theObj"));
...
void bind_NCollection_IndexedDataMap(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::iterator (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::begin, "Returns an iterator pointing to the first element in the map.");
	cls.def("end", (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::iterator (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::end, "Returns an iterator referring to the past-the-end element in the map.");
	cls.def("cbegin", (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::const_iterator (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::cbegin, "Returns a const iterator pointing to the first element in the map.");
	cls.def("cend", (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::const_iterator (NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::*)() const ) &NCollection_IndexedDataMap<TheKeyType, TheItemType, Hasher>::cend, "Returns a const iterator referring to the past-the-end element in the map.");
...
void bind_NCollection_IndexedMap(py::object &mod, std::string const &name) {
	...
	cls.def("cbegin", (NCollection_IndexedMap<TheKeyType, Hasher>::const_iterator (NCollection_IndexedMap<TheKeyType, Hasher>::*)() const ) &NCollection_IndexedMap<TheKeyType, Hasher>::cbegin, "Returns a const iterator pointing to the first element in the map.");
	cls.def("cend", (NCollection_IndexedMap<TheKeyType, Hasher>::const_iterator (NCollection_IndexedMap<TheKeyType, Hasher>::*)() const ) &NCollection_IndexedMap<TheKeyType, Hasher>::cend, "Returns a const iterator referring to the past-the-end element in the map.");
...
void bind_NCollection_List(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_List<TheItemType>::iterator (NCollection_List<TheItemType>::*)() const ) &NCollection_List<TheItemType>::begin, "Returns an iterator pointing to the first element in the list.");
	cls.def("end", (NCollection_List<TheItemType>::iterator (NCollection_List<TheItemType>::*)() const ) &NCollection_List<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the list.");
	cls.def("cbegin", (NCollection_List<TheItemType>::const_iterator (NCollection_List<TheItemType>::*)() const ) &NCollection_List<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the list.");
	cls.def("cend", (NCollection_List<TheItemType>::const_iterator (NCollection_List<TheItemType>::*)() const ) &NCollection_List<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the list.");
	...
	cls.def("Append", (void (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Append, "Append one item at the end and output iterator pointing at the appended item", py::arg("theItem"), py::arg("theIter"));
	...
	cls.def("Remove", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Remove, "Remove item pointed by iterator theIter; theIter is then set to the next item", py::arg("theIter"));
	cls.def("InsertBefore", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theItem"), py::arg("theIter"));
	cls.def("InsertBefore", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theOther"), py::arg("theIter"));
	cls.def("InsertAfter", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theItem"), py::arg("theIter"));
	cls.def("InsertAfter", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theOther"), py::arg("theIter"));
...
void bind_NCollection_Map(py::object &mod, std::string const &name) {
	...
	cls.def("cbegin", (NCollection_Map<TheKeyType, Hasher>::const_iterator (NCollection_Map<TheKeyType, Hasher>::*)() const ) &NCollection_Map<TheKeyType, Hasher>::cbegin, "Returns a const iterator pointing to the first element in the map.");
	cls.def("cend", (NCollection_Map<TheKeyType, Hasher>::const_iterator (NCollection_Map<TheKeyType, Hasher>::*)() const ) &NCollection_Map<TheKeyType, Hasher>::cend, "Returns a const iterator referring to the past-the-end element in the map.");
...
void bind_NCollection_Sequence(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_Sequence<TheItemType>::iterator (NCollection_Sequence<TheItemType>::*)() const ) &NCollection_Sequence<TheItemType>::begin, "Returns an iterator pointing to the first element in the sequence.");
	cls.def("end", (NCollection_Sequence<TheItemType>::iterator (NCollection_Sequence<TheItemType>::*)() const ) &NCollection_Sequence<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the sequence.");
	cls.def("cbegin", (NCollection_Sequence<TheItemType>::const_iterator (NCollection_Sequence<TheItemType>::*)() const ) &NCollection_Sequence<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
	cls.def("cend", (NCollection_Sequence<TheItemType>::const_iterator (NCollection_Sequence<TheItemType>::*)() const ) &NCollection_Sequence<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
	...
	cls.def("Remove", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &)) &NCollection_Sequence<TheItemType>::Remove, "Remove one item", py::arg("thePosition"));
	...
	cls.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
...
void bind_NCollection_StdAllocator(py::object &mod, std::string const &name) {
	...
	cls.def("address", (NCollection_StdAllocator<T>::pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::reference) const ) &NCollection_StdAllocator<T>::address, "Returns an object address. Returns &x.", py::arg("x"));
	cls.def("address", (NCollection_StdAllocator<T>::const_pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::const_reference) const ) &NCollection_StdAllocator<T>::address, "Returns an object address. Returns &x.", py::arg("x"));
	cls.def("allocate", [](NCollection_StdAllocator<T> &self, NCollection_StdAllocator<T>::size_type a0) -> NCollection_StdAllocator<T>::pointer { return self.allocate(a0); }, py::arg("n"));
	cls.def("allocate", (NCollection_StdAllocator<T>::pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::size_type, const void *)) &NCollection_StdAllocator<T>::allocate, "Allocates memory for n objects. Uses underlying allocator to allocate memory.", py::arg("n"), py::arg(""));
	cls.def("deallocate", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer, NCollection_StdAllocator<T>::size_type)) &NCollection_StdAllocator<T>::deallocate, "Frees previously allocated memory. Uses underlying allocator to deallocate memory.", py::arg("p"), py::arg(""));
	cls.def("max_size", (NCollection_StdAllocator<T>::size_type (NCollection_StdAllocator<T>::*)() const ) &NCollection_StdAllocator<T>::max_size, "Returns the largest value for which method allocate might succeed.");
	cls.def("construct", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer, NCollection_StdAllocator<T>::const_reference)) &NCollection_StdAllocator<T>::construct, "Constructs an object. Uses placement new operator and copy constructor to construct an object.", py::arg("p"), py::arg("val"));
	cls.def("destroy", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer)) &NCollection_StdAllocator<T>::destroy, "Destroys the object. Uses object destructor.", py::arg("p"));
...
void bind_NCollection_UBTree(py::object &mod, std::string const &name) {
	...
	cls.def("Select", (Standard_Integer (NCollection_UBTree<TheObjType, TheBndType>::*)(NCollection_UBTree<TheObjType, TheBndType>::Selector &) const ) &NCollection_UBTree<TheObjType, TheBndType>::Select, "Searches in the tree all objects conforming to the given selector. return Number of objects accepted", py::arg("theSelector"));
	...
	cls.def("Root", (const NCollection_UBTree<TheObjType, TheBndType>::TreeNode & (NCollection_UBTree<TheObjType, TheBndType>::*)() const ) &NCollection_UBTree<TheObjType, TheBndType>::Root, "Returns the root node of the tree");
...
void bind_NCollection_UBTreeFiller(py::object &mod, std::string const &name) {
	...
	cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &>(), py::arg("theTree"));
	cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &, const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theTree"), py::arg("theAlloc"));
	cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &, const opencascade::handle<NCollection_BaseAllocator> &, const Standard_Boolean>(), py::arg("theTree"), py::arg("theAlloc"), py::arg("isFullRandom"));
...
void bind_NCollection_Vector(py::object &mod, std::string const &name) {
	...
	cls.def("begin", (NCollection_Vector<TheItemType>::iterator (NCollection_Vector<TheItemType>::*)() const ) &NCollection_Vector<TheItemType>::begin, "Returns an iterator pointing to the first element in the vector.");
	cls.def("end", (NCollection_Vector<TheItemType>::iterator (NCollection_Vector<TheItemType>::*)() const ) &NCollection_Vector<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the vector.");
	cls.def("cbegin", (NCollection_Vector<TheItemType>::const_iterator (NCollection_Vector<TheItemType>::*)() const ) &NCollection_Vector<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the vector.");
	cls.def("cend", (NCollection_Vector<TheItemType>::const_iterator (NCollection_Vector<TheItemType>::*)() const ) &NCollection_Vector<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the vector.");
