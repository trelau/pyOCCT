...
cls.def("Append", (void (TheHSequenceType::*)(const TheSequenceType::value_type &)) &TheHSequenceType::Append, "None", py::arg("theItem"));
...
// cls.def("Append", (void (TheHSequenceType::*)(const TheSequenceType::value_type &)) &TheHSequenceType::Append, "Append one item", py::arg("theItem"));
...
cls.def("Prepend", (void (TheHSequenceType::*)(const TheSequenceType::value_type &)) &TheHSequenceType::Prepend, "Prepend one item", py::arg("theItem"));
...
cls.def("InsertBefore", (void (TheHSequenceType::*)(const Standard_Integer, const TheSequenceType::value_type &)) &TheHSequenceType::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
...
cls.def("InsertAfter", (void (TheHSequenceType::*)(typename TheHSequenceType::Iterator &, const TheSequenceType::value_type &)) &TheHSequenceType::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
...
cls.def("InsertAfter", (void (TheHSequenceType::*)(const Standard_Integer, const TheSequenceType::value_type &)) &TheHSequenceType::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
...
cls.def("First", (const TheSequenceType::value_type & (TheHSequenceType::*)() const) &TheHSequenceType::First, "First item access");
cls.def("ChangeFirst", (TheSequenceType::value_type & (TheHSequenceType::*)()) &TheHSequenceType::ChangeFirst, "First item access");
cls.def("Last", (const TheSequenceType::value_type & (TheHSequenceType::*)() const) &TheHSequenceType::Last, "Last item access");
cls.def("ChangeLast", (TheSequenceType::value_type & (TheHSequenceType::*)()) &TheHSequenceType::ChangeLast, "Last item access");
cls.def("Value", (const TheSequenceType::value_type & (TheHSequenceType::*)(const Standard_Integer) const) &TheHSequenceType::Value, "Constant item access by theIndex", py::arg("theIndex"));
cls.def("__call__", (const TheSequenceType::value_type & (TheHSequenceType::*)(const Standard_Integer) const) &TheHSequenceType::operator(), py::is_operator(), "Constant operator()", py::arg("theIndex"));
cls.def("ChangeValue", (TheSequenceType::value_type & (TheHSequenceType::*)(const Standard_Integer)) &TheHSequenceType::ChangeValue, "Variable item access by theIndex", py::arg("theIndex"));
cls.def("__call__", (TheSequenceType::value_type & (TheHSequenceType::*)(const Standard_Integer)) &TheHSequenceType::operator(), py::is_operator(), "Variable operator()", py::arg("theIndex"));
cls.def("SetValue", (void (TheHSequenceType::*)(const Standard_Integer, const TheSequenceType::value_type &)) &TheHSequenceType::SetValue, "Set item value by theIndex", py::arg("theIndex"), py::arg("theItem"));
