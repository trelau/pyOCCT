...
PYBIND11_MODULE(TNaming, mod) {
	...
	*/
	...
	cls_TNaming_Tool.def_static("Label_", (TDF_Label (*)(const TDF_Label &, const TopoDS_Shape &, Standard_Integer &)) &TNaming_Tool::Label, "Returns the label of the first apparition of <aShape>. Transdef is a value of the transaction of the first apparition of <aShape>.", py::arg("access"), py::arg("aShape"), py::arg("TransDef"));
