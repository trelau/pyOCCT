...
PYBIND11_MODULE(XCAFView, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\XCAFView_ProjectionType.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\XCAFView_Object.hxx
	py::class_<XCAFView_Object, opencascade::handle<XCAFView_Object>, Standard_Transient> cls_XCAFView_Object(mod, "XCAFView_Object", "object to store view");
