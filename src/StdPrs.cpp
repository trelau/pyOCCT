...
PYBIND11_MODULE(StdPrs, mod) {
	...
	cls_StdPrs_Isolines.def_static("UVIsoParameters_", (void (*)(const TopoDS_Face &, const Standard_Integer, const Standard_Integer, const Standard_Real, TColStd_SequenceOfReal &, TColStd_SequenceOfReal &)) &StdPrs_Isolines::UVIsoParameters, "Evaluate sequence of parameters for drawing uv isolines for a given face.", py::arg("theFace"), py::arg("theNbIsoU"), py::arg("theNbIsoV"), py::arg("theUVLimit"), py::arg("theUIsoParams"), py::arg("theVIsoParams"));
