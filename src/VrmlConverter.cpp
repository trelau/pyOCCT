...
PYBIND11_MODULE(VrmlConverter, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_TypeOfCamera.hxx
	py::enum_<VrmlConverter_TypeOfCamera>(mod, "VrmlConverter_TypeOfCamera", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_TypeOfLight.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_Drawer.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_Projector.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_Curve.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_DeflectionCurve.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_LineAspect.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_IsoAspect.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_ShadingAspect.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_PointAspect.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_HLRShape.hxx
	py::class_<VrmlConverter_HLRShape, std::unique_ptr<VrmlConverter_HLRShape, Deleter<VrmlConverter_HLRShape>>> cls_VrmlConverter_HLRShape(mod, "VrmlConverter_HLRShape", "HLRShape - computes the presentation of objects with removal of their hidden lines for a specific projector, converts them into VRML objects and writes (adds) them into anOStream. All requested properties of the representation are specify in aDrawer of Drawer class. This kind of the presentation is converted into IndexedLineSet and if they are defined in Projector into : PerspectiveCamera, OrthographicCamera, DirectionLight, PointLight, SpotLight from Vrml package.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_WFDeflectionRestrictedFace.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\VrmlConverter_WFRestrictedFace.hxx
