...
PYBIND11_MODULE(BRepAdaptor, mod) {
	...
	cls_BRepAdaptor_CompCurve.def("Edge", (void (BRepAdaptor_CompCurve::*)(const Standard_Real, TopoDS_Edge &, Standard_Real &) const ) &BRepAdaptor_CompCurve::Edge, "returns an edge and one parameter on them corresponding to the parameter U.", py::arg("U"), py::arg("E"), py::arg("UonE"));
