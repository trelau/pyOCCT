...
PYBIND11_MODULE(WNT, mod) {
	...
	cls_WNT_Window.def("Position", (void (WNT_Window::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &WNT_Window::Position, "Returns The Window POSITION in PIXEL", py::arg("X1"), py::arg("Y1"), py::arg("X2"), py::arg("Y2"));
	cls_WNT_Window.def("Size", (void (WNT_Window::*)(Standard_Integer &, Standard_Integer &) const ) &WNT_Window::Size, "Returns The Window SIZE in PIXEL", py::arg("Width"), py::arg("Height"));
