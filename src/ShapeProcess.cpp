...
PYBIND11_MODULE(ShapeProcess, mod) {
	...
	cls_ShapeProcess_Context.def("GetReal", (Standard_Boolean (ShapeProcess_Context::*)(const Standard_CString, Standard_Real &) const ) &ShapeProcess_Context::GetReal, "None", py::arg("param"), py::arg("val"));
	cls_ShapeProcess_Context.def("GetInteger", (Standard_Boolean (ShapeProcess_Context::*)(const Standard_CString, Standard_Integer &) const ) &ShapeProcess_Context::GetInteger, "None", py::arg("param"), py::arg("val"));
	cls_ShapeProcess_Context.def("GetBoolean", (Standard_Boolean (ShapeProcess_Context::*)(const Standard_CString, Standard_Boolean &) const ) &ShapeProcess_Context::GetBoolean, "None", py::arg("param"), py::arg("val"));
