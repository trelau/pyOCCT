...
PYBIND11_MODULE(Image, mod) {
	...
	*/
	...
	cls_Image_Diff.def("SaveDiffImage", (Standard_Boolean (Image_Diff::*)(Image_PixMap &) const ) &Image_Diff::SaveDiffImage, "Saves a difference between two images as white pixels on black background.", py::arg("theDiffImage"));
	cls_Image_Diff.def("SaveDiffImage", (Standard_Boolean (Image_Diff::*)(const TCollection_AsciiString &) const ) &Image_Diff::SaveDiffImage, "Saves a difference between two images as white pixels on black background.", py::arg("theDiffPath"));
