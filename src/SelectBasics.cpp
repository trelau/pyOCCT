...
PYBIND11_MODULE(SelectBasics, mod) {
	...
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const NCollection_Vec3<Standard_Real> &, const NCollection_Vec3<Standard_Real> &, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by box theBox", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theDepth"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", [](SelectBasics_SelectingVolumeManager &self, const NCollection_Vec3<Standard_Real> & a0, const NCollection_Vec3<Standard_Real> & a1) -> Standard_Boolean { return self.Overlaps(a0, a1); }, py::arg("theBoxMin"), py::arg("theBoxMax"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const NCollection_Vec3<Standard_Real> &, const NCollection_Vec3<Standard_Real> &, Standard_Boolean *)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by axis-aligned bounding box with minimum corner at point theMinPt and maximum at point theMaxPt", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theInside"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const gp_Pnt &, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by point thePnt", py::arg("thePnt"), py::arg("theDepth"));
	...
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const opencascade::handle<TColgp_HArray1OfPnt> &, Standard_Integer, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by planar convex polygon, which points are stored in theArrayOfPts, taking into account sensitivity type theSensType", py::arg("theArrayOfPts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const TColgp_Array1OfPnt &, Standard_Integer, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by planar convex polygon, which points are stored in theArrayOfPts, taking into account sensitivity type theSensType", py::arg("theArrayOfPts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by line segment with start point at thePt1 and end point at thePt2", py::arg("thePt1"), py::arg("thePt2"), py::arg("theDepth"));
	cls_SelectBasics_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectBasics_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Standard_Integer, Standard_Real &)) &SelectBasics_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by triangle with vertices thePt1, thePt2 and thePt3, taking into account sensitivity type theSensType", py::arg("thePt1"), py::arg("thePt2"), py::arg("thePt3"), py::arg("theSensType"), py::arg("theDepth"));
	...
	cls_SelectBasics_SensitiveEntity.def("BoundingBox", (Select3D_BndBox3d (SelectBasics_SensitiveEntity::*)()) &SelectBasics_SensitiveEntity::BoundingBox, "Returns bounding box of sensitive entity");
