...
PYBIND11_MODULE(IGESDefs, mod) {
	...
	py::class_<IGESDefs_TabularData, opencascade::handle<IGESDefs_TabularData>, IGESData_IGESEntity> cls_IGESDefs_TabularData(mod, "IGESDefs_TabularData", "Defines IGES Tabular Data, Type <406> Form <11>, in package IGESDefs This Class is used to provide a Structure to accommodate point form data.");
	...
	cls_IGESDefs_UnitsData.def("ScaleFactor", (Standard_Real (IGESDefs_UnitsData::*)(const Standard_Integer) const ) &IGESDefs_UnitsData::ScaleFactor, "returns the multiplicative scale factor to be applied to the UnitNum'th unit being defined raises exception if UnitNum <= 0 or UnitNum > NbUnits()", py::arg("UnitNum"));
