...
PYBIND11_MODULE(Graphic3d, mod) {
	...
	cls_Graphic3d_AspectFillArea3d.def("PolygonOffsets", (void (Graphic3d_AspectFillArea3d::*)(Standard_Integer &, Standard_ShortReal &, Standard_ShortReal &) const ) &Graphic3d_AspectFillArea3d::PolygonOffsets, "Returns current polygon offsets settings.", py::arg("theMode"), py::arg("theFactor"), py::arg("theUnits"));
	...
	cls_Graphic3d_AspectFillArea3d.def("Values", (void (Graphic3d_AspectFillArea3d::*)(Aspect_InteriorStyle &, Quantity_Color &, Quantity_Color &, Aspect_TypeOfLine &, Standard_Real &) const ) &Graphic3d_AspectFillArea3d::Values, "Returns the current values.", py::arg("theStyle"), py::arg("theIntColor"), py::arg("theEdgeColor"), py::arg("theType"), py::arg("theWidth"));
	cls_Graphic3d_AspectFillArea3d.def("Values", (void (Graphic3d_AspectFillArea3d::*)(Aspect_InteriorStyle &, Quantity_Color &, Quantity_Color &, Quantity_Color &, Aspect_TypeOfLine &, Standard_Real &) const ) &Graphic3d_AspectFillArea3d::Values, "Returns the current values.", py::arg("theStyle"), py::arg("theIntColor"), py::arg("theBackIntColor"), py::arg("theEdgeColor"), py::arg("theType"), py::arg("theWidth"));
	...
	cls_Graphic3d_Camera.def("ZFitAll", (bool (Graphic3d_Camera::*)(const Standard_Real, const Bnd_Box &, const Bnd_Box &, Standard_Real &, Standard_Real &) const ) &Graphic3d_Camera::ZFitAll, "Estimate Z-min and Z-max planes of projection volume to match the displayed objects. The methods ensures that view volume will be close by depth range to the displayed objects. Fitting assumes that for orthogonal projection the view volume contains the displayed objects completely. For zoomed perspective view, the view volume is adjusted such that it contains the objects or their parts, located in front of the camera.", py::arg("theScaleFactor"), py::arg("theMinMax"), py::arg("theGraphicBB"), py::arg("theZNear"), py::arg("theZFar"));
	...
	cls_Graphic3d_AspectLine3d.def("Values", (void (Graphic3d_AspectLine3d::*)(Quantity_Color &, Aspect_TypeOfLine &, Standard_Real &) const ) &Graphic3d_AspectLine3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theType"), py::arg("theWidth"));
	...
	// FIXME cls_Graphic3d_AspectText3d.def("Values", (void (Graphic3d_AspectText3d::*)(Quantity_Color &, Standard_CString &, Standard_Real &, Standard_Real &) const ) &Graphic3d_AspectText3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theFont"), py::arg("theExpansionFactor"), py::arg("theSpace"));
	// FIXME cls_Graphic3d_AspectText3d.def("Values", (void (Graphic3d_AspectText3d::*)(Quantity_Color &, Standard_CString &, Standard_Real &, Standard_Real &, Aspect_TypeOfStyleText &, Aspect_TypeOfDisplayText &, Quantity_Color &) const ) &Graphic3d_AspectText3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theFont"), py::arg("theExpansionFactor"), py::arg("theSpace"), py::arg("theStyle"), py::arg("theDisplayType"), py::arg("theColorSubTitle"));
	// FIXME cls_Graphic3d_AspectText3d.def("Values", (void (Graphic3d_AspectText3d::*)(Quantity_Color &, Standard_CString &, Standard_Real &, Standard_Real &, Aspect_TypeOfStyleText &, Aspect_TypeOfDisplayText &, Quantity_Color &, Standard_Boolean &, Standard_Real &) const ) &Graphic3d_AspectText3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theFont"), py::arg("theExpansionFactor"), py::arg("theSpace"), py::arg("theStyle"), py::arg("theDisplayType"), py::arg("theColorSubTitle"), py::arg("theTextZoomable"), py::arg("theTextAngle"));
	// FIXME cls_Graphic3d_AspectText3d.def("Values", (void (Graphic3d_AspectText3d::*)(Quantity_Color &, Standard_CString &, Standard_Real &, Standard_Real &, Aspect_TypeOfStyleText &, Aspect_TypeOfDisplayText &, Quantity_Color &, Standard_Boolean &, Standard_Real &, Font_FontAspect &) const ) &Graphic3d_AspectText3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theFont"), py::arg("theExpansionFactor"), py::arg("theSpace"), py::arg("theStyle"), py::arg("theDisplayType"), py::arg("theColorSubTitle"), py::arg("theTextZoomable"), py::arg("theTextAngle"), py::arg("theTextFontAspect"));
	...
	cls_Graphic3d_MarkerImage.def("GetTextureSize", (void (Graphic3d_MarkerImage::*)(Standard_Integer &, Standard_Integer &) const ) &Graphic3d_MarkerImage::GetTextureSize, "Returns texture size", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_Graphic3d_AspectMarker3d.def("GetTextureSize", (void (Graphic3d_AspectMarker3d::*)(Standard_Integer &, Standard_Integer &) const ) &Graphic3d_AspectMarker3d::GetTextureSize, "Returns marker's texture size.", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_Graphic3d_AspectMarker3d.def("Values", (void (Graphic3d_AspectMarker3d::*)(Quantity_Color &, Aspect_TypeOfMarker &, Standard_Real &) const ) &Graphic3d_AspectMarker3d::Values, "Returns the current values of the group.", py::arg("theColor"), py::arg("theType"), py::arg("theScale"));
	...
	cls_Graphic3d_Vertex.def("Coord", (void (Graphic3d_Vertex::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_Vertex::Coord, "Returns the coordinates.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	...
	cls_Graphic3d_Structure.def_static("Transforms_", (void (*)(const gp_Trsf &, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &)) &Graphic3d_Structure::Transforms, "Transforms theX, theY, theZ with the transformation theTrsf.", py::arg("theTrsf"), py::arg("theX"), py::arg("theY"), py::arg("theZ"), py::arg("theNewX"), py::arg("theNewY"), py::arg("theNewZ"));
	...
	cls_Graphic3d_ArrayOfPrimitives.def("Vertice", (void (Graphic3d_ArrayOfPrimitives::*)(const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_ArrayOfPrimitives::Vertice, "Returns the vertice coordinates at rank theRank from the vertex table if defined.", py::arg("theRank"), py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	...
	cls_Graphic3d_ArrayOfPrimitives.def("VertexColor", (void (Graphic3d_ArrayOfPrimitives::*)(const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_ArrayOfPrimitives::VertexColor, "Returns the vertex color values at rank theRank from the vertex table if defined.", py::arg("theRank"), py::arg("theR"), py::arg("theG"), py::arg("theB"));
	cls_Graphic3d_ArrayOfPrimitives.def("VertexColor", (void (Graphic3d_ArrayOfPrimitives::*)(const Standard_Integer, Standard_Integer &) const ) &Graphic3d_ArrayOfPrimitives::VertexColor, "Returns the vertex color values at rank theRank from the vertex table if defined.", py::arg("theRank"), py::arg("theColor"));
	...
	cls_Graphic3d_ArrayOfPrimitives.def("VertexNormal", (void (Graphic3d_ArrayOfPrimitives::*)(const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_ArrayOfPrimitives::VertexNormal, "Returns the vertex normal coordinates at rank theRank from the vertex table if defined.", py::arg("theRank"), py::arg("theNX"), py::arg("theNY"), py::arg("theNZ"));
	...
	cls_Graphic3d_ArrayOfPrimitives.def("BoundColor", (void (Graphic3d_ArrayOfPrimitives::*)(const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_ArrayOfPrimitives::BoundColor, "Returns the bound color values at rank theRank from the bound table if defined.", py::arg("theRank"), py::arg("theR"), py::arg("theG"), py::arg("theB"));
	...
	cls_Graphic3d_Group.def("MinMaxValues", (void (Graphic3d_Group::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_Group::MinMaxValues, "Returns the coordinates of the boundary box of the group.", py::arg("theXMin"), py::arg("theYMin"), py::arg("theZMin"), py::arg("theXMax"), py::arg("theYMax"), py::arg("theZMax"));
	...
	*/
	...
	cls_Graphic3d_CView.def("FBOGetDimensions", (void (Graphic3d_CView::*)(const opencascade::handle<Standard_Transient> &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &Graphic3d_CView::FBOGetDimensions, "Read offscreen FBO configuration.", py::arg("theFbo"), py::arg("theWidth"), py::arg("theHeight"), py::arg("theWidthMax"), py::arg("theHeightMax"));
	...
	cls_Graphic3d_Vector.def("Coord", (void (Graphic3d_Vector::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &Graphic3d_Vector::Coord, "Returns the coordinates of the vector <me>.", py::arg("AX"), py::arg("AY"), py::arg("AZ"));
