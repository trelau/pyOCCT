...
PYBIND11_MODULE(Geom2dConvert, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\Geom2dConvert_CompCurveToBSplineCurve.hxx
	py::class_<Geom2dConvert_CompCurveToBSplineCurve, std::unique_ptr<Geom2dConvert_CompCurveToBSplineCurve, Deleter<Geom2dConvert_CompCurveToBSplineCurve>>> cls_Geom2dConvert_CompCurveToBSplineCurve(mod, "Geom2dConvert_CompCurveToBSplineCurve", "This algorithm converts and concat several curve in an BSplineCurve");
	...
	cls_Geom2dConvert_CompCurveToBSplineCurve.def("Add", [](Geom2dConvert_CompCurveToBSplineCurve &self, const opencascade::handle<Geom2d_BoundedCurve> & a0, const Standard_Real a1) -> Standard_Boolean { return self.Add(a0, a1); }, py::arg("NewCurve"), py::arg("Tolerance"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\Geom2dConvert_BSplineCurveKnotSplitting.hxx
	...
	// FIXME cls_Geom2dConvert_ApproxCurve.def("Dump", (void (Geom2dConvert_ApproxCurve::*)(Standard_OStream &) const ) &Geom2dConvert_ApproxCurve::Dump, "Print on the stream o information about the object", py::arg("o"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\Geom2dConvert.hxx
	py::class_<Geom2dConvert, std::unique_ptr<Geom2dConvert, Deleter<Geom2dConvert>>> cls_Geom2dConvert(mod, "Geom2dConvert", "This package provides an implementation of algorithmes to do the conversion between equivalent geometric entities from package Geom2d. It gives the possibility : . to obtain the B-spline representation of bounded curves. . to split a B-spline curve into several B-spline curves with some constraints of continuity, . to convert a B-spline curve into several Bezier curves or surfaces. All the geometric entities used in this package are bounded. References : . Generating the Bezier Points of B-spline curves and surfaces (Wolfgang Bohm) CAGD volume 13 number 6 november 1981 . On NURBS: A Survey (Leslie Piegl) IEEE Computer Graphics and Application January 1991 . Curve and surface construction using rational B-splines (Leslie Piegl and Wayne Tiller) CAD Volume 19 number 9 november 1987 . A survey of curve and surface methods in CAGD (Wolfgang BOHM) CAGD 1 1984");
	cls_Geom2dConvert.def(py::init<>());
	cls_Geom2dConvert.def_static("SplitBSplineCurve_", [](const opencascade::handle<Geom2d_BSplineCurve> & a0, const Standard_Integer a1, const Standard_Integer a2) -> opencascade::handle<Geom2d_BSplineCurve> { return Geom2dConvert::SplitBSplineCurve(a0, a1, a2); }, py::arg("C"), py::arg("FromK1"), py::arg("ToK2"));
	...
	cls_Geom2dConvert.def_static("SplitBSplineCurve_", [](const opencascade::handle<Geom2d_BSplineCurve> & a0, const Standard_Real a1, const Standard_Real a2, const Standard_Real a3) -> opencascade::handle<Geom2d_BSplineCurve> { return Geom2dConvert::SplitBSplineCurve(a0, a1, a2, a3); }, py::arg("C"), py::arg("FromU1"), py::arg("ToU2"), py::arg("ParametricTolerance"));
	...
	cls_Geom2dConvert.def_static("CurveToBSplineCurve_", [](const opencascade::handle<Geom2d_Curve> & a0) -> opencascade::handle<Geom2d_BSplineCurve> { return Geom2dConvert::CurveToBSplineCurve(a0); }, py::arg("C"));
	...
	// FIXME cls_Geom2dConvert.def_static("ConcatG1_", (void (*)(TColGeom2d_Array1OfBSplineCurve &, const TColStd_Array1OfReal &, opencascade::handle<TColGeom2d_HArray1OfBSplineCurve> &, const Standard_Boolean, const Standard_Real)) &Geom2dConvert::ConcatG1, "This Method concatenates G1 the ArrayOfCurves as far as it is possible. ArrayOfCurves[0..N-1] ArrayOfToler contains the biggest tolerance of the two points shared by two consecutives curves. Its dimension: [0..N-2] ClosedTolerance indicates if the ArrayOfCurves is closed. In this case ClosedTolerance contains the biggest tolerance of the two points which are at the closure. Otherwise its value is 0.0", py::arg("ArrayOfCurves"), py::arg("ArrayOfToler"), py::arg("ArrayOfConcatenated"), py::arg("ClosedFlag"), py::arg("ClosedTolerance"));
	// FIXME cls_Geom2dConvert.def_static("ConcatC1_", (void (*)(TColGeom2d_Array1OfBSplineCurve &, const TColStd_Array1OfReal &, opencascade::handle<TColStd_HArray1OfInteger> &, opencascade::handle<TColGeom2d_HArray1OfBSplineCurve> &, const Standard_Boolean, const Standard_Real)) &Geom2dConvert::ConcatC1, "This Method concatenates C1 the ArrayOfCurves as far as it is possible. ArrayOfCurves[0..N-1] ArrayOfToler contains the biggest tolerance of the two points shared by two consecutives curves. Its dimension: [0..N-2] ClosedTolerance indicates if the ArrayOfCurves is closed. In this case ClosedTolerance contains the biggest tolerance of the two points which are at the closure. Otherwise its value is 0.0", py::arg("ArrayOfCurves"), py::arg("ArrayOfToler"), py::arg("ArrayOfIndices"), py::arg("ArrayOfConcatenated"), py::arg("ClosedFlag"), py::arg("ClosedTolerance"));
	// FIXME cls_Geom2dConvert.def_static("ConcatC1_", (void (*)(TColGeom2d_Array1OfBSplineCurve &, const TColStd_Array1OfReal &, opencascade::handle<TColStd_HArray1OfInteger> &, opencascade::handle<TColGeom2d_HArray1OfBSplineCurve> &, const Standard_Boolean, const Standard_Real, const Standard_Real)) &Geom2dConvert::ConcatC1, "This Method concatenates C1 the ArrayOfCurves as far as it is possible. ArrayOfCurves[0..N-1] ArrayOfToler contains the biggest tolerance of the two points shared by two consecutives curves. Its dimension: [0..N-2] ClosedTolerance indicates if the ArrayOfCurves is closed. In this case ClosedTolerance contains the biggest tolerance of the two points which are at the closure. Otherwise its value is 0.0", py::arg("ArrayOfCurves"), py::arg("ArrayOfToler"), py::arg("ArrayOfIndices"), py::arg("ArrayOfConcatenated"), py::arg("ClosedFlag"), py::arg("ClosedTolerance"), py::arg("AngularTolerance"));
