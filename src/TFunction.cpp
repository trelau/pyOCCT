...
PYBIND11_MODULE(TFunction, mod) {
	...
	// FIXME cls_TFunction_DriverTable.def("bits_left", (Standard_OStream & (TFunction_DriverTable::*)(Standard_OStream &) const ) &TFunction_DriverTable::operator<<, py::is_operator(), "None", py::arg("anOS"));
