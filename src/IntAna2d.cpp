...
PYBIND11_MODULE(IntAna2d, mod) {
	...
	cls_IntAna2d_AnaIntersection.def("IsDone", (Standard_Boolean (IntAna2d_AnaIntersection::*)() const ) &IntAna2d_AnaIntersection::IsDone, "Returns TRUE if the computation was successful.");
