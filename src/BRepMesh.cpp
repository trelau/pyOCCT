...
PYBIND11_MODULE(BRepMesh, mod) {
	...
	cls_BRepMesh_FaceAttribute.def("AddNode", (void (BRepMesh_FaceAttribute::*)(const Standard_Integer, const gp_XY &, const BRepMesh_DegreeOfFreedom, Standard_Integer &, Standard_Integer &)) &BRepMesh_FaceAttribute::AddNode, "Adds node with the given parameters to mesh.", py::arg("theIndex"), py::arg("theUV"), py::arg("theMovability"), py::arg("theNodeIndex"), py::arg("theNodeOnEdgeIndex"));
	...
	cls_BRepMesh_VertexTool.def("GetTolerance", (void (BRepMesh_VertexTool::*)(Standard_Real &, Standard_Real &)) &BRepMesh_VertexTool::GetTolerance, "Gets the tolerance to be used for identification of coincident vertices.", py::arg("theToleranceX"), py::arg("theToleranceY"));
	...
	cls_BRepMesh_CircleTool.def_static("MakeCircle_", (Standard_Boolean (*)(const gp_XY &, const gp_XY &, const gp_XY &, gp_XY &, Standard_Real &)) &BRepMesh_CircleTool::MakeCircle, "Computes circle on three points.", py::arg("thePoint1"), py::arg("thePoint2"), py::arg("thePoint3"), py::arg("theLocation"), py::arg("theRadius"));
	...
	cls_BRepMesh_GeomTool.def("Value", (Standard_Boolean (BRepMesh_GeomTool::*)(const Standard_Integer, const Standard_Real, Standard_Real &, gp_Pnt &, gp_Pnt2d &) const ) &BRepMesh_GeomTool::Value, "Gets parameters of discretization point with the given index.", py::arg("theIndex"), py::arg("theIsoParam"), py::arg("theParam"), py::arg("thePoint"), py::arg("theUV"));
	cls_BRepMesh_GeomTool.def("Value", (Standard_Boolean (BRepMesh_GeomTool::*)(const Standard_Integer, Standard_Real &, gp_Pnt &) const ) &BRepMesh_GeomTool::Value, "Gets parameters of discretization point with the given index.", py::arg("theIndex"), py::arg("theParam"), py::arg("thePoint"));
	...
	cls_BRepMesh_Delaun.def("Contains", (Standard_Boolean (BRepMesh_Delaun::*)(const Standard_Integer, const BRepMesh_Vertex &, const Standard_Real, Standard_Integer &) const ) &BRepMesh_Delaun::Contains, "Test is the given triangle contains the given vertex.", py::arg("theTriangleId"), py::arg("theVertex"), py::arg("theSqTolerance"), py::arg("theEdgeOn"));
	...
	cls_BRepMesh_IEdgeTool.def("Value", (Standard_Boolean (BRepMesh_IEdgeTool::*)(const Standard_Integer, Standard_Real &, gp_Pnt &, gp_Pnt2d &)) &BRepMesh_IEdgeTool::Value, "Returns parameters of solution with the given index.", py::arg("theIndex"), py::arg("theParameter"), py::arg("thePoint"), py::arg("theUV"));
	...
	cls_BRepMesh_EdgeTessellationExtractor.def("Value", (Standard_Boolean (BRepMesh_EdgeTessellationExtractor::*)(const Standard_Integer, Standard_Real &, gp_Pnt &, gp_Pnt2d &)) &BRepMesh_EdgeTessellationExtractor::Value, "Returns parameters of solution with the given index.", py::arg("theIndex"), py::arg("theParameter"), py::arg("thePoint"), py::arg("theUV"));
	...
	cls_BRepMesh_EdgeTessellator.def("Value", (Standard_Boolean (BRepMesh_EdgeTessellator::*)(const Standard_Integer, Standard_Real &, gp_Pnt &, gp_Pnt2d &)) &BRepMesh_EdgeTessellator::Value, "Returns parameters of solution with the given index.", py::arg("theIndex"), py::arg("theParameter"), py::arg("thePoint"), py::arg("theUV"));
	...
	cls_BRepMesh_ShapeTool.def_static("BoxMaxDimension_", (void (*)(const Bnd_Box &, Standard_Real &)) &BRepMesh_ShapeTool::BoxMaxDimension, "Gets the maximum dimension of the given bounding box. If the given bounding box is void leaves the resulting value unchanged.", py::arg("theBox"), py::arg("theMaxDimension"));
	cls_BRepMesh_ShapeTool.def_static("RelativeEdgeDeflection_", (Standard_Real (*)(const TopoDS_Edge &, const Standard_Real, const Standard_Real, Standard_Real &)) &BRepMesh_ShapeTool::RelativeEdgeDeflection, "Returns relative deflection for edge with respect to shape size.", py::arg("theEdge"), py::arg("theDeflection"), py::arg("theMaxShapeSize"), py::arg("theAdjustmentCoefficient"));
