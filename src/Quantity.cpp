...
PYBIND11_MODULE(Quantity, mod) {
	...
	// FIXME cls_Quantity_Color.def("Blue", (Standard_Real (Quantity_Color::*)() const ) &Quantity_Color::Blue, "Returns the Blue component (quantity of blue) of the color within range [0.0; 1.0].");
	// FIXME cls_Quantity_Color.def("Green", (Standard_Real (Quantity_Color::*)() const ) &Quantity_Color::Green, "Returns the Green component (quantity of green) of the color within range [0.0; 1.0].");
	// FIXME cls_Quantity_Color.def("Hue", (Standard_Real (Quantity_Color::*)() const ) &Quantity_Color::Hue, "Returns the Hue component (hue angle) of the color in degrees within range [0.0; 360.0], 0.0 being Red. -1.0 is a special value reserved for grayscale color (S should be 0.0)");
	...
	// FIXME cls_Quantity_Color.def("Light", (Standard_Real (Quantity_Color::*)() const ) &Quantity_Color::Light, "Returns the Light component (value of the lightness) of the color within range [0.0; 1.0].");
	...
	cls_Quantity_Color.def_static("HlsRgb_", (void (*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &)) &Quantity_Color::HlsRgb, "Converts HLS components into RGB ones.", py::arg("H"), py::arg("L"), py::arg("S"), py::arg("R"), py::arg("G"), py::arg("B"));
	cls_Quantity_Color.def_static("RgbHls_", (void (*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &)) &Quantity_Color::RgbHls, "Converts RGB components into HLS ones.", py::arg("R"), py::arg("G"), py::arg("B"), py::arg("H"), py::arg("L"), py::arg("S"));
	cls_Quantity_Color.def_static("Color2argb_", (void (*)(const Quantity_Color &, Standard_Integer &)) &Quantity_Color::Color2argb, "Convert the Color value to ARGB integer value. theARGB has Alpha equal to zero, so the output is formatted as 0x00RRGGBB", py::arg("theColor"), py::arg("theARGB"));
	...
	cls_Quantity_Period.def("Values", (void (Quantity_Period::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &Quantity_Period::Values, "Decomposes this period into a number of days,hours, minutes,seconds,milliseconds and microseconds Example of return values: 2 days, 15 hours, 0 minute , 0 second 0 millisecond and 0 microsecond", py::arg("dd"), py::arg("hh"), py::arg("mn"), py::arg("ss"), py::arg("mis"), py::arg("mics"));
	cls_Quantity_Period.def("Values", (void (Quantity_Period::*)(Standard_Integer &, Standard_Integer &) const ) &Quantity_Period::Values, "Returns the number of seconds in Ss and the number of remainding microseconds in Mics of this period. Example of return values: 3600 seconds and 0 microseconds", py::arg("ss"), py::arg("mics"));
