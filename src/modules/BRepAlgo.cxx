...
py::class_<BRepAlgo_Image> cls_BRepAlgo_Image(mod, "BRepAlgo_Image", "Stores link between a shape <S> and a shape <NewS> obtained from <S>. <NewS> is an image of <S>.");
...
// CLASS: BREPALGO_CUT
py::class_<BRepAlgo_Cut, BRepAlgo_BooleanOperation> cls_BRepAlgo_Cut(mod, "BRepAlgo_Cut", "Describes functions for performing a topological cut operation (Boolean subtraction). A Cut object provides the framework for: - defining the construction of a cut shape, - implementing the construction algorithm, and - consulting the result.");

// Constructors
cls_BRepAlgo_Cut.def(py::init<const TopoDS_Shape &, const TopoDS_Shape &>(), py::arg("S1"), py::arg("S2"));

// Methods
// cls_BRepAlgo_Cut.def_static("operator new_", (void * (*)(size_t)) &BRepAlgo_Cut::operator new, "None", py::arg("theSize"));
// cls_BRepAlgo_Cut.def_static("operator delete_", (void (*)(void *)) &BRepAlgo_Cut::operator delete, "None", py::arg("theAddress"));
// cls_BRepAlgo_Cut.def_static("operator new[]_", (void * (*)(size_t)) &BRepAlgo_Cut::operator new[], "None", py::arg("theSize"));
...
// CLASS: BREPALGO_LOOP
py::class_<BRepAlgo_Loop> cls_BRepAlgo_Loop(mod, "BRepAlgo_Loop", "Builds the loops from a set of edges on a face.");
