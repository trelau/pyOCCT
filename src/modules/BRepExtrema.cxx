...
// TYPEDEF: BREPEXTREMA_SEQOFSOLUTION
bind_NCollection_Sequence<BRepExtrema_SolutionElem>(mod, "BRepExtrema_SeqOfSolution", py::module_local(false));
...
py::class_<BRepExtrema_DistShapeShape> cls_BRepExtrema_DistShapeShape(mod, "BRepExtrema_DistShapeShape", "This class provides tools to compute minimum distance between two Shapes (Compound,CompSolid, Solid, Shell, Face, Wire, Edge, Vertex).");
...
py::class_<BRepExtrema_ExtFF> cls_BRepExtrema_ExtFF(mod, "BRepExtrema_ExtFF", "None");
...
py::class_<BRepExtrema_ExtPC> cls_BRepExtrema_ExtPC(mod, "BRepExtrema_ExtPC", "None");
...
py::class_<BRepExtrema_ExtPF> cls_BRepExtrema_ExtPF(mod, "BRepExtrema_ExtPF", "None");
...
// TYPEDEF: BREPEXTREMA_MAPOFINTEGERPACKEDMAPOFINTEGER
if (py::hasattr(mod, "BRepExtrema_MapOfIntegerPackedMapOfInteger")) {
	mod.attr("BRepExtrema_MapOfIntegerPackedMapOfInteger") = mod.attr("BRepExtrema_MapOfIntegerPackedMapOfInteger");
}
