...
cls_BRepGProp_Face.def("Load", (bool (BRepGProp_Face::*)(const TopoDS_Edge &)) &BRepGProp_Face::Load, "Loading the boundary arc. Returns FALSE if edge has no P-Curve.", py::arg("E"));
...
py::class_<BRepGProp_MeshCinert, GProp_GProps> cls_BRepGProp_MeshCinert(mod, "BRepGProp_MeshCinert", "Computes the global properties of of polylines represented by set of points. This class is used for computation of global properties of edge, which has no exact geometry (3d or 2d curve), but has any of allowed polygons.");

// Constructors
cls_BRepGProp_MeshCinert.def(py::init<>());

// Methods
// cls_BRepGProp_MeshCinert.def_static("operator new_", (void * (*)(size_t)) &BRepGProp_MeshCinert::operator new, "None", py::arg("theSize"));
// cls_BRepGProp_MeshCinert.def_static("operator delete_", (void (*)(void *)) &BRepGProp_MeshCinert::operator delete, "None", py::arg("theAddress"));
// cls_BRepGProp_MeshCinert.def_static("operator new[]_", (void * (*)(size_t)) &BRepGProp_MeshCinert::operator new[], "None", py::arg("theSize"));
// cls_BRepGProp_MeshCinert.def_static("operator delete[]_", (void (*)(void *)) &BRepGProp_MeshCinert::operator delete[], "None", py::arg("theAddress"));
// cls_BRepGProp_MeshCinert.def_static("operator new_", (void * (*)(size_t, void *)) &BRepGProp_MeshCinert::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_BRepGProp_MeshCinert.def_static("operator delete_", (void (*)(void *, void *)) &BRepGProp_MeshCinert::operator delete, "None", py::arg(""), py::arg(""));
cls_BRepGProp_MeshCinert.def("SetLocation", (void (BRepGProp_MeshCinert::*)(const gp_Pnt &)) &BRepGProp_MeshCinert::SetLocation, "None", py::arg("CLocation"));
cls_BRepGProp_MeshCinert.def("Perform", (void (BRepGProp_MeshCinert::*)(const TColgp_Array1OfPnt &)) &BRepGProp_MeshCinert::Perform, "Computes the global properties of of polylines represented by set of points.", py::arg("theNodes"));
cls_BRepGProp_MeshCinert.def_static("PreparePolygon_", (void (*)(const TopoDS_Edge &, opencascade::handle<TColgp_HArray1OfPnt> &)) &BRepGProp_MeshCinert::PreparePolygon, "Prepare set of 3d points on base of any available edge polygons: 3D polygon, polygon on triangulation, 2d polygon on surface If edge has no polygons, array thePolyg is left unchanged", py::arg("theE"), py::arg("thePolyg"));

// CLASS: BREPGPROP_MESHPROPS
py::class_<BRepGProp_MeshProps, GProp_GProps> cls_BRepGProp_MeshProps(mod, "BRepGProp_MeshProps", "Computes the global properties of a surface mesh. The mesh can be interpreted as just a surface or as a piece of volume limited by this surface.");

// Constructors
cls_BRepGProp_MeshProps.def(py::init<const BRepGProp_MeshProps::BRepGProp_MeshObjType>(), py::arg("theType"));

// Methods
// cls_BRepGProp_MeshProps.def_static("operator new_", (void * (*)(size_t)) &BRepGProp_MeshProps::operator new, "None", py::arg("theSize"));
// cls_BRepGProp_MeshProps.def_static("operator delete_", (void (*)(void *)) &BRepGProp_MeshProps::operator delete, "None", py::arg("theAddress"));
// cls_BRepGProp_MeshProps.def_static("operator new[]_", (void * (*)(size_t)) &BRepGProp_MeshProps::operator new[], "None", py::arg("theSize"));
// cls_BRepGProp_MeshProps.def_static("operator delete[]_", (void (*)(void *)) &BRepGProp_MeshProps::operator delete[], "None", py::arg("theAddress"));
// cls_BRepGProp_MeshProps.def_static("operator new_", (void * (*)(size_t, void *)) &BRepGProp_MeshProps::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_BRepGProp_MeshProps.def_static("operator delete_", (void (*)(void *, void *)) &BRepGProp_MeshProps::operator delete, "None", py::arg(""), py::arg(""));
cls_BRepGProp_MeshProps.def("SetLocation", (void (BRepGProp_MeshProps::*)(const gp_Pnt &)) &BRepGProp_MeshProps::SetLocation, "Sets the point relative which the calculation is to be done", py::arg("theLocation"));
cls_BRepGProp_MeshProps.def("Perform", (void (BRepGProp_MeshProps::*)(const opencascade::handle<Poly_Triangulation> &, const TopLoc_Location &, const TopAbs_Orientation)) &BRepGProp_MeshProps::Perform, "Computes the global properties of a surface mesh of 3D space. Calculation of surface properties is performed by numerical integration over triangle surfaces using Gauss cubature formulas. Depending on the mesh object type used in constructor this method can calculate the surface or volume properties of the mesh.", py::arg("theMesh"), py::arg("theLoc"), py::arg("theOri"));
cls_BRepGProp_MeshProps.def("Perform", (void (BRepGProp_MeshProps::*)(const TColgp_Array1OfPnt &, const Poly_Array1OfTriangle &, const TopAbs_Orientation)) &BRepGProp_MeshProps::Perform, "None", py::arg("theNodes"), py::arg("theTriangles"), py::arg("theOri"));
// cls_BRepGProp_MeshProps.def_static("CalculateProps_", (void (*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, const Standard_Boolean, Standard_Real [10], const Standard_Integer, const Standard_Real *)) &BRepGProp_MeshProps::CalculateProps, "Computes the global properties of triangle {p1, p2, p3} relatively point Apex If isVolume = true, volume properties are calculated otherwise - surface ones", py::arg("p1"), py::arg("p2"), py::arg("p3"), py::arg("Apex"), py::arg("isVolume"), py::arg("GProps"), py::arg("NbGaussPoints"), py::arg("GaussPnts"));
cls_BRepGProp_MeshProps.def("GetMeshObjType", (BRepGProp_MeshProps::BRepGProp_MeshObjType (BRepGProp_MeshProps::*)() const) &BRepGProp_MeshProps::GetMeshObjType, "Get type of mesh object");

// Enums
py::enum_<BRepGProp_MeshProps::BRepGProp_MeshObjType>(cls_BRepGProp_MeshProps, "BRepGProp_MeshProps_BRepGProp_MeshObjType", "Describes types of geometric objects. - Vinert is 3D closed region of space delimited with Point and surface mesh; - Sinert is surface mesh in 3D space.")
	.value("Vinert", BRepGProp_MeshProps::BRepGProp_MeshObjType::Vinert)
	.value("Sinert", BRepGProp_MeshProps::BRepGProp_MeshObjType::Sinert)
	.export_values();
