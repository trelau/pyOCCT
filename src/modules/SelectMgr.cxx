...
bind_NCollection_IndexedDataMap<opencascade::handle<SelectBasics_EntityOwner>, SelectMgr_SortCriterion, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "SelectMgr_IndexedDataMapOfOwnerCriterion", py::module_local(false));
...
// TYPEDEF: SELECTMGR_SEQUENCEOFSELECTOR
bind_NCollection_Sequence<opencascade::handle<SelectMgr_ViewerSelector> >(mod, "SelectMgr_SequenceOfSelector", py::module_local(false));

// TYPEDEF: SELECTMGR_DATAMAPOFOBJECTSELECTORS
bind_NCollection_DataMap<opencascade::handle<SelectMgr_SelectableObject>, NCollection_Sequence<opencascade::handle<SelectMgr_ViewerSelector> >, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "SelectMgr_DataMapOfObjectSelectors", py::module_local(false));

// TYPEDEF: SELECTMGR_DATAMAPITERATOROFDATAMAPOFOBJECTSELECTORS
