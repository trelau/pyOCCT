...
void bind_BRepBlend_ConstRadInv(py::module &mod){

py::class_<BlendFunc_ConstRadInv, std::unique_ptr<BlendFunc_ConstRadInv, Deleter<BlendFunc_ConstRadInv>>, Blend_FuncInv> cls_BRepBlend_ConstRadInv(mod, "BRepBlend_ConstRadInv", "None", py::module_local());
