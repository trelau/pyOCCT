...
void bind_BRepBlend_ConstRad(py::module &mod){

py::class_<BlendFunc_ConstRad, std::unique_ptr<BlendFunc_ConstRad, Deleter<BlendFunc_ConstRad>>, Blend_Function> cls_BRepBlend_ConstRad(mod, "BRepBlend_ConstRad", "None", py::module_local());
