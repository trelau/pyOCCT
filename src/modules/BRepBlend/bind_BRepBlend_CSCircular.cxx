...
py::class_<BlendFunc_CSCircular, std::unique_ptr<BlendFunc_CSCircular, Deleter<BlendFunc_CSCircular>>, Blend_CSFunction> cls_BRepBlend_CSCircular(mod, "BRepBlend_CSCircular", "None", py::module_local());
