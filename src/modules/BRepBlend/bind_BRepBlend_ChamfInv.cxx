...
py::class_<BlendFunc_ChamfInv, std::unique_ptr<BlendFunc_ChamfInv, Deleter<BlendFunc_ChamfInv>>, Blend_FuncInv> cls_BRepBlend_ChamfInv(mod, "BRepBlend_ChamfInv", "None", py::module_local());
