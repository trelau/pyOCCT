...
py::class_<BlendFunc_CSConstRad, std::unique_ptr<BlendFunc_CSConstRad, Deleter<BlendFunc_CSConstRad>>, Blend_CSFunction> cls_BRepBlend_CSConstRad(mod, "BRepBlend_CSConstRad", "None", py::module_local());
