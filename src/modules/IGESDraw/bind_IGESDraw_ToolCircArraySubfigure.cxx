...
py::class_<IGESDraw_ToolCircArraySubfigure, std::unique_ptr<IGESDraw_ToolCircArraySubfigure, Deleter<IGESDraw_ToolCircArraySubfigure>>> cls_IGESDraw_ToolCircArraySubfigure(mod, "IGESDraw_ToolCircArraySubfigure", "Tool to work on a CircArraySubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
