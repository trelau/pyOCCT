...
py::class_<IGESDraw, std::unique_ptr<IGESDraw, Deleter<IGESDraw>>> cls_IGESDraw(mod, "IGESDraw", "This package contains the group of classes necessary for Structure Entities implied in Drawings and Structured Graphics (Sets for drawing, Drawings and Views).");
