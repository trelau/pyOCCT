...
py::class_<IGESDraw_ToolNetworkSubfigureDef, std::unique_ptr<IGESDraw_ToolNetworkSubfigureDef, Deleter<IGESDraw_ToolNetworkSubfigureDef>>> cls_IGESDraw_ToolNetworkSubfigureDef(mod, "IGESDraw_ToolNetworkSubfigureDef", "Tool to work on a NetworkSubfigureDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
