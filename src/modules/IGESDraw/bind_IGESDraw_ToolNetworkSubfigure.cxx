...
py::class_<IGESDraw_ToolNetworkSubfigure, std::unique_ptr<IGESDraw_ToolNetworkSubfigure, Deleter<IGESDraw_ToolNetworkSubfigure>>> cls_IGESDraw_ToolNetworkSubfigure(mod, "IGESDraw_ToolNetworkSubfigure", "Tool to work on a NetworkSubfigure. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
