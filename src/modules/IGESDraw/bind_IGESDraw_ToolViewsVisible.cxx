...
py::class_<IGESDraw_ToolViewsVisible, std::unique_ptr<IGESDraw_ToolViewsVisible, Deleter<IGESDraw_ToolViewsVisible>>> cls_IGESDraw_ToolViewsVisible(mod, "IGESDraw_ToolViewsVisible", "Tool to work on a ViewsVisible. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
