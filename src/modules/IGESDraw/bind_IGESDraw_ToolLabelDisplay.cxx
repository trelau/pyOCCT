...
py::class_<IGESDraw_ToolLabelDisplay, std::unique_ptr<IGESDraw_ToolLabelDisplay, Deleter<IGESDraw_ToolLabelDisplay>>> cls_IGESDraw_ToolLabelDisplay(mod, "IGESDraw_ToolLabelDisplay", "Tool to work on a LabelDisplay. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
