...
py::class_<IGESDraw_ToolSegmentedViewsVisible, std::unique_ptr<IGESDraw_ToolSegmentedViewsVisible, Deleter<IGESDraw_ToolSegmentedViewsVisible>>> cls_IGESDraw_ToolSegmentedViewsVisible(mod, "IGESDraw_ToolSegmentedViewsVisible", "Tool to work on a SegmentedViewsVisible. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
