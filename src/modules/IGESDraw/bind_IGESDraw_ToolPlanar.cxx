...
py::class_<IGESDraw_ToolPlanar, std::unique_ptr<IGESDraw_ToolPlanar, Deleter<IGESDraw_ToolPlanar>>> cls_IGESDraw_ToolPlanar(mod, "IGESDraw_ToolPlanar", "Tool to work on a Planar. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
