...
py::class_<IGESDraw_ToolDrawing, std::unique_ptr<IGESDraw_ToolDrawing, Deleter<IGESDraw_ToolDrawing>>> cls_IGESDraw_ToolDrawing(mod, "IGESDraw_ToolDrawing", "Tool to work on a Drawing. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
