...
py::class_<IGESDraw_ToolDrawingWithRotation, std::unique_ptr<IGESDraw_ToolDrawingWithRotation, Deleter<IGESDraw_ToolDrawingWithRotation>>> cls_IGESDraw_ToolDrawingWithRotation(mod, "IGESDraw_ToolDrawingWithRotation", "Tool to work on a DrawingWithRotation. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
