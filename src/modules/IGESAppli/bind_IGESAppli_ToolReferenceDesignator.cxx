...
py::class_<IGESAppli_ToolReferenceDesignator, std::unique_ptr<IGESAppli_ToolReferenceDesignator>> cls_IGESAppli_ToolReferenceDesignator(mod, "IGESAppli_ToolReferenceDesignator", "Tool to work on a ReferenceDesignator. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
