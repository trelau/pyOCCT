...
void bind_RWStepGeom_RWPcurve(py::module &mod){

py::class_<RWStepGeom_RWPcurve, std::unique_ptr<RWStepGeom_RWPcurve>> cls_RWStepGeom_RWPcurve(mod, "RWStepGeom_RWPcurve", "Read & Write Module for Pcurve");
