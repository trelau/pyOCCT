...
py::class_<RWStepGeom_RWConicalSurface, std::unique_ptr<RWStepGeom_RWConicalSurface>> cls_RWStepGeom_RWConicalSurface(mod, "RWStepGeom_RWConicalSurface", "Read & Write Module for ConicalSurface");
