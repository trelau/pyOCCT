...
py::class_<RWStepGeom_RWSurfaceReplica, std::unique_ptr<RWStepGeom_RWSurfaceReplica>> cls_RWStepGeom_RWSurfaceReplica(mod, "RWStepGeom_RWSurfaceReplica", "Read & Write Module for SurfaceReplica");
