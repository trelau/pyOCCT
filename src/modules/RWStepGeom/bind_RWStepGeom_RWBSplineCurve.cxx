...
py::class_<RWStepGeom_RWBSplineCurve, std::unique_ptr<RWStepGeom_RWBSplineCurve>> cls_RWStepGeom_RWBSplineCurve(mod, "RWStepGeom_RWBSplineCurve", "Read & Write Module for BSplineCurve");
