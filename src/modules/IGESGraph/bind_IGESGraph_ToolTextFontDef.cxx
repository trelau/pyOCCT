...
py::class_<IGESGraph_ToolTextFontDef, std::unique_ptr<IGESGraph_ToolTextFontDef>> cls_IGESGraph_ToolTextFontDef(mod, "IGESGraph_ToolTextFontDef", "Tool to work on a TextFontDef. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
