...
// TYPEDEF: VRMLDATA_LISTOFNODE
bind_NCollection_List<opencascade::handle<VrmlData_Node> >(mod, "VrmlData_ListOfNode", py::module_local(false));
...
py::class_<VrmlData_ShapeConvert> cls_VrmlData_ShapeConvert(mod, "VrmlData_ShapeConvert", "Algorithm converting one shape or a set of shapes to VrmlData_Scene.");
