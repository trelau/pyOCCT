...
py::class_<BOPDS_InterfVF, std::unique_ptr<BOPDS_InterfVF>, BOPDS_Interf> cls_BOPDS_InterfVF(mod, "BOPDS_InterfVF", "The class BOPDS_InterfVF is is to store the information about the interference of the type vertex/face");
