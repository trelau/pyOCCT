...
py::class_<BRepOffsetAPI_MakeDraft, std::unique_ptr<BRepOffsetAPI_MakeDraft, Deleter<BRepOffsetAPI_MakeDraft>>, BRepBuilderAPI_MakeShape> cls_BRepOffsetAPI_MakeDraft(mod, "BRepOffsetAPI_MakeDraft", "Build a draft surface along a wire");
