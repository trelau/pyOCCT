...
// TYPEDEF: TOBJ_DELETINGMODE

// TYPEDEF: TOBJ_SEQUENCEOFOBJECT
...
// TYPEDEF: TOBJ_SEQUENCEOFITERATOR
bind_NCollection_Sequence<opencascade::handle<TObj_ObjectIterator> >(mod, "TObj_SequenceOfIterator", py::module_local(false));
...
bind_NCollection_SparseArray<int>(mod, "TObj_TIntSparseArray_VecOfData", py::module_local(false));

// TYPEDEF: TOBJ_TINTSPARSEARRAY_MAPOFDATA
if (py::hasattr(mod, "TObj_TIntSparseArray_VecOfData")) {
	mod.attr("TObj_TIntSparseArray_MapOfData") = mod.attr("TObj_TIntSparseArray_VecOfData");
}
