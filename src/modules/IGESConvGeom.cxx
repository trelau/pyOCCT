...
py::class_<IGESConvGeom_GeomBuilder> cls_IGESConvGeom_GeomBuilder(mod, "IGESConvGeom_GeomBuilder", "This class provides some useful basic tools to build IGESGeom curves, especially : define a curve in a plane in 3D space (ex. Circular or Conic arc, or Copious Data defined in 2D) make a CopiousData from a list of points/vectors");
