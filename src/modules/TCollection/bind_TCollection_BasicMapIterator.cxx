...
py::class_<TCollection_BasicMapIterator> cls_TCollection_BasicMapIterator(mod, "TCollection_BasicMapIterator", "This class provides basic services for the iterators on Maps. The iterators are inherited from this one.");
