...
py::class_<TCollection_BaseSequence> cls_TCollection_BaseSequence(mod, "TCollection_BaseSequence", "Definition of a base class for all instanciations of sequence.");
