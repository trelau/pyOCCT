...
py::class_<BRepMesh_VertexTool> cls_BRepMesh_VertexTool(mod, "BRepMesh_VertexTool", "Describes data structure intended to keep mesh nodes defined in UV space and implements functionality providing their uniqueness regarding thir position.");
...
py::class_<BRepMesh_ShapeTool> cls_BRepMesh_ShapeTool(mod, "BRepMesh_ShapeTool", "None");
...
py::class_<BRepMesh_SelectorOfDataStructureOfDelaun> cls_BRepMesh_SelectorOfDataStructureOfDelaun(mod, "BRepMesh_SelectorOfDataStructureOfDelaun", "Describes a selector and an iterator on a selector of components of a mesh.");
...
py::class_<BRepMesh_WireChecker> cls_BRepMesh_WireChecker(mod, "BRepMesh_WireChecker", "Auxilary class intended to check correctness of discretized face. In particular, checks boundaries of discretized face for self intersections and gaps.");
