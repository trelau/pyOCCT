...
// TYPEDEF: STORAGE_ARRAYOFCALLBACK
bind_NCollection_Array1<opencascade::handle<Storage_CallBack> >(mod, "Storage_ArrayOfCallBack", py::module_local(false));

// TYPEDEF: STORAGE_ARRAYOFSCHEMA
bind_NCollection_Array1<opencascade::handle<Storage_Schema> >(mod, "Storage_ArrayOfSchema", py::module_local(false));
...
/*
py::class_<Storage_BucketOfPersistent> cls_Storage_BucketOfPersistent(mod, "Storage_BucketOfPersistent", "None");
...
// TYPEDEF: STORAGE_MAPOFCALLBACK
bind_NCollection_DataMap<TCollection_AsciiString, opencascade::handle<Storage_TypedCallBack>, TCollection_AsciiString>(mod, "Storage_MapOfCallBack", py::module_local(false));

// TYPEDEF: STORAGE_DATAMAPITERATOROFMAPOFCALLBACK

// TYPEDEF: STORAGE_MAPOFPERS
bind_NCollection_DataMap<TCollection_AsciiString, opencascade::handle<Storage_Root>, TCollection_AsciiString>(mod, "Storage_MapOfPers", py::module_local(false));

// TYPEDEF: STORAGE_DATAMAPITERATOROFMAPOFPERS
