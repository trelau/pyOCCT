...
py::class_<BRepPrim_OneAxis> cls_BRepPrim_OneAxis(mod, "BRepPrim_OneAxis", "Algorithm to build primitives with one axis of revolution.");
...
py::class_<BRepPrim_Revolution, BRepPrim_OneAxis> cls_BRepPrim_Revolution(mod, "BRepPrim_Revolution", "Implement the OneAxis algoritm for a revolution surface.");
...
py::class_<BRepPrim_Torus, BRepPrim_Revolution> cls_BRepPrim_Torus(mod, "BRepPrim_Torus", "Implements the torus primitive");
