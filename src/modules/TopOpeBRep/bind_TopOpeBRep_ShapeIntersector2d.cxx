...
py::class_<TopOpeBRep_ShapeIntersector2d, std::unique_ptr<TopOpeBRep_ShapeIntersector2d>> cls_TopOpeBRep_ShapeIntersector2d(mod, "TopOpeBRep_ShapeIntersector2d", "Intersect two shapes.");
