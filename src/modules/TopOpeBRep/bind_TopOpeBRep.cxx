...
py::class_<TopOpeBRep, std::unique_ptr<TopOpeBRep>> cls_TopOpeBRep(mod, "TopOpeBRep", "This package provides the topological operations on the BRep data structure.");
