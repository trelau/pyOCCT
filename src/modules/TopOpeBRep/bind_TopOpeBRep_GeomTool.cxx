...
py::class_<TopOpeBRep_GeomTool, std::unique_ptr<TopOpeBRep_GeomTool>> cls_TopOpeBRep_GeomTool(mod, "TopOpeBRep_GeomTool", "Provide services needed by the DSFiller");
