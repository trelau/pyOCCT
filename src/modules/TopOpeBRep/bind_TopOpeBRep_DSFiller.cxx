...
py::class_<TopOpeBRep_DSFiller, std::unique_ptr<TopOpeBRep_DSFiller>> cls_TopOpeBRep_DSFiller(mod, "TopOpeBRep_DSFiller", "Provides class methods to fill a datastructure with results of intersections.");
