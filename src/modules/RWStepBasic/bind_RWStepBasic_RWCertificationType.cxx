...
py::class_<RWStepBasic_RWCertificationType, std::unique_ptr<RWStepBasic_RWCertificationType>> cls_RWStepBasic_RWCertificationType(mod, "RWStepBasic_RWCertificationType", "Read & Write tool for CertificationType");
