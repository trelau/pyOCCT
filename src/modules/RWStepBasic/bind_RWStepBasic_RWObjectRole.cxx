...
py::class_<RWStepBasic_RWObjectRole, std::unique_ptr<RWStepBasic_RWObjectRole>> cls_RWStepBasic_RWObjectRole(mod, "RWStepBasic_RWObjectRole", "Read & Write tool for ObjectRole");
