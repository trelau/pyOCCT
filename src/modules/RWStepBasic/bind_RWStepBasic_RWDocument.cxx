...
void bind_RWStepBasic_RWDocument(py::module &mod){

py::class_<RWStepBasic_RWDocument, std::unique_ptr<RWStepBasic_RWDocument>> cls_RWStepBasic_RWDocument(mod, "RWStepBasic_RWDocument", "Read & Write tool for Document");
