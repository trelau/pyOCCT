...
void bind_RWStepBasic_RWSiUnitAndAreaUnit(py::module &mod){

py::class_<RWStepBasic_RWSiUnitAndAreaUnit, std::unique_ptr<RWStepBasic_RWSiUnitAndAreaUnit>> cls_RWStepBasic_RWSiUnitAndAreaUnit(mod, "RWStepBasic_RWSiUnitAndAreaUnit", "Read & Write Module for SiUnitAndAreaUnit");
