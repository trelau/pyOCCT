...
void bind_RWStepBasic_RWGroupRelationship(py::module &mod){

py::class_<RWStepBasic_RWGroupRelationship, std::unique_ptr<RWStepBasic_RWGroupRelationship>> cls_RWStepBasic_RWGroupRelationship(mod, "RWStepBasic_RWGroupRelationship", "Read & Write tool for GroupRelationship");
