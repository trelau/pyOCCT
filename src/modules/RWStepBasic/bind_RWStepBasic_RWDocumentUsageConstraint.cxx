...
void bind_RWStepBasic_RWDocumentUsageConstraint(py::module &mod){

py::class_<RWStepBasic_RWDocumentUsageConstraint, std::unique_ptr<RWStepBasic_RWDocumentUsageConstraint>> cls_RWStepBasic_RWDocumentUsageConstraint(mod, "RWStepBasic_RWDocumentUsageConstraint", "Read & Write Module for DocumentUsageConstraint");
