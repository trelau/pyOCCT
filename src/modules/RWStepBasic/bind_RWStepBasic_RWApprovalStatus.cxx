...
void bind_RWStepBasic_RWApprovalStatus(py::module &mod){

py::class_<RWStepBasic_RWApprovalStatus, std::unique_ptr<RWStepBasic_RWApprovalStatus>> cls_RWStepBasic_RWApprovalStatus(mod, "RWStepBasic_RWApprovalStatus", "Read & Write Module for ApprovalStatus");
