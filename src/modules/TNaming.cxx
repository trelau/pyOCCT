...
// TYPEDEF: TNAMING_LISTOFNAMEDSHAPE
bind_NCollection_List<opencascade::handle<TNaming_NamedShape> >(mod, "TNaming_ListOfNamedShape", py::module_local(false));

// TYPEDEF: TNAMING_LISTITERATOROFLISTOFNAMEDSHAPE
bind_NCollection_TListIterator<opencascade::handle<TNaming_NamedShape> >(mod, "TNaming_ListIteratorOfListOfNamedShape", py::module_local(false));
...
// TYPEDEF: TNAMING_PTRREFSHAPE

// TYPEDEF: TNAMING_DATAMAPOFSHAPEPTRREFSHAPE
/*
bind_NCollection_DataMap<TopoDS_Shape, TNaming_RefShape *, TopTools_ShapeMapHasher>(mod, "TNaming_DataMapOfShapePtrRefShape", py::module_local(false));
*/

// TYPEDEF: TNAMING_DATAMAPITERATOROFDATAMAPOFSHAPEPTRREFSHAPE

// CLASS: TNAMING_SHAPESSET
py::class_<TNaming_ShapesSet> cls_TNaming_ShapesSet(mod, "TNaming_ShapesSet", "None");
...
// TYPEDEF: TNAMING_DATAMAPOFSHAPESHAPESSET
bind_NCollection_DataMap<TopoDS_Shape, TNaming_ShapesSet, TopTools_ShapeMapHasher>(mod, "TNaming_DataMapOfShapeShapesSet", py::module_local(false));

// TYPEDEF: TNAMING_DATAMAPITERATOROFDATAMAPOFSHAPESHAPESSET
...
py::class_<TNaming_Identifier> cls_TNaming_Identifier(mod, "TNaming_Identifier", "None");
...
// TYPEDEF: TNAMING_LISTOFINDEXEDDATAMAPOFSHAPELISTOFSHAPE
bind_NCollection_List<NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher> >(mod, "TNaming_ListOfIndexedDataMapOfShapeListOfShape", py::module_local(false));

// TYPEDEF: TNAMING_LISTITERATOROFLISTOFINDEXEDDATAMAPOFSHAPELISTOFSHAPE
...
// TYPEDEF: TNAMING_LISTOFMAPOFSHAPE
bind_NCollection_List<NCollection_Map<TopoDS_Shape, TopTools_ShapeMapHasher> >(mod, "TNaming_ListOfMapOfShape", py::module_local(false));

// TYPEDEF: TNAMING_LISTITERATOROFLISTOFMAPOFSHAPE
bind_NCollection_TListIterator<NCollection_Map<TopoDS_Shape, TopTools_ShapeMapHasher> >(mod, "TNaming_ListIteratorOfListOfMapOfShape", py::module_local(false));

// TYPEDEF: TNAMING_NAMEDSHAPEHASHER
...
py::class_<TNaming_Localizer> cls_TNaming_Localizer(mod, "TNaming_Localizer", "None");
...
py::class_<TNaming_OldShapeIterator> cls_TNaming_OldShapeIterator(mod, "TNaming_OldShapeIterator", "Iterates on all the ascendants of a shape");
...
// CLASS: TNAMING_SCOPE
py::class_<TNaming_Scope> cls_TNaming_Scope(mod, "TNaming_Scope", "this class manage a scope of labels ===================================");
