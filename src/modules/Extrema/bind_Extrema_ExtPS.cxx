...
py::class_<Extrema_ExtPS, std::unique_ptr<Extrema_ExtPS>> cls_Extrema_ExtPS(mod, "Extrema_ExtPS", "It calculates all the extremum distances between a point and a surface. These distances can be minimum or maximum.");
