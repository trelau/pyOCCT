...
py::class_<Extrema_ExtElC2d, std::unique_ptr<Extrema_ExtElC2d>> cls_Extrema_ExtElC2d(mod, "Extrema_ExtElC2d", "It calculates all the distance between two elementary curves. These distances can be maximum or minimum.");
