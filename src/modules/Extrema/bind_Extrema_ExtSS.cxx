...
py::class_<Extrema_ExtSS, std::unique_ptr<Extrema_ExtSS>> cls_Extrema_ExtSS(mod, "Extrema_ExtSS", "It calculates all the extremum distances between two surfaces. These distances can be minimum or maximum.");
