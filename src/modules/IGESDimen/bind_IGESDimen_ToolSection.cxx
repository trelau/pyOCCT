...
py::class_<IGESDimen_ToolSection, std::unique_ptr<IGESDimen_ToolSection, Deleter<IGESDimen_ToolSection>>> cls_IGESDimen_ToolSection(mod, "IGESDimen_ToolSection", "Tool to work on a Section. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
