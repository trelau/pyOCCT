...
py::class_<IGESDimen_ToolPointDimension, std::unique_ptr<IGESDimen_ToolPointDimension, Deleter<IGESDimen_ToolPointDimension>>> cls_IGESDimen_ToolPointDimension(mod, "IGESDimen_ToolPointDimension", "Tool to work on a PointDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
