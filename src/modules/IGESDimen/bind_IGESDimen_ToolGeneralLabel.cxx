...
py::class_<IGESDimen_ToolGeneralLabel, std::unique_ptr<IGESDimen_ToolGeneralLabel, Deleter<IGESDimen_ToolGeneralLabel>>> cls_IGESDimen_ToolGeneralLabel(mod, "IGESDimen_ToolGeneralLabel", "Tool to work on a GeneralLabel. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
