...
py::class_<IGESDimen_ToolLinearDimension, std::unique_ptr<IGESDimen_ToolLinearDimension, Deleter<IGESDimen_ToolLinearDimension>>> cls_IGESDimen_ToolLinearDimension(mod, "IGESDimen_ToolLinearDimension", "Tool to work on a LinearDimension. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
