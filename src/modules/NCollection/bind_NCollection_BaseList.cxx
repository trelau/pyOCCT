...
// Nested classes
py::class_<NCollection_BaseList::Iterator, std::unique_ptr<NCollection_BaseList::Iterator, Deleter<NCollection_BaseList::Iterator>>> cls_Iterator(cls_NCollection_BaseList, "Iterator", "Memory allocation");
