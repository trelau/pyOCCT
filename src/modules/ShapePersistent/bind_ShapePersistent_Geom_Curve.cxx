...
/*
py::class_<ShapePersistent_Geom_Curve, std::unique_ptr<ShapePersistent_Geom_Curve, Deleter<ShapePersistent_Geom_Curve>>> cls_ShapePersistent_Geom_Curve(mod, "ShapePersistent_Geom_Curve", "None");
