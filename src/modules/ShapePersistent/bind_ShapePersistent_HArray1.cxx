...
py::class_<ShapePersistent_HArray1, std::unique_ptr<ShapePersistent_HArray1, Deleter<ShapePersistent_HArray1>>> cls_ShapePersistent_HArray1(mod, "ShapePersistent_HArray1", "None");
