...
/*
py::class_<ShapePersistent_Geom, std::unique_ptr<ShapePersistent_Geom, Deleter<ShapePersistent_Geom>>, StdObjMgt_SharedObject> cls_ShapePersistent_Geom(mod, "ShapePersistent_Geom", "None");
