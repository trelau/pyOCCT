...
/*
py::class_<ShapePersistent_BRep, std::unique_ptr<ShapePersistent_BRep, Deleter<ShapePersistent_BRep>>> cls_ShapePersistent_BRep(mod, "ShapePersistent_BRep", "None");
