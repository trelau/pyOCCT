...
/*
py::class_<ShapePersistent_Geom_Surface, std::unique_ptr<ShapePersistent_Geom_Surface, Deleter<ShapePersistent_Geom_Surface>>> cls_ShapePersistent_Geom_Surface(mod, "ShapePersistent_Geom_Surface", "None");
