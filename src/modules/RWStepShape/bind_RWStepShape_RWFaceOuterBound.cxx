...
py::class_<RWStepShape_RWFaceOuterBound, std::unique_ptr<RWStepShape_RWFaceOuterBound>> cls_RWStepShape_RWFaceOuterBound(mod, "RWStepShape_RWFaceOuterBound", "Read & Write Module for FaceOuterBound");
