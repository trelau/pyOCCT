...
py::class_<RWStepShape_RWFaceSurface, std::unique_ptr<RWStepShape_RWFaceSurface>> cls_RWStepShape_RWFaceSurface(mod, "RWStepShape_RWFaceSurface", "Read & Write Module for FaceSurface");
