...
py::class_<RWStepElement_RWSurfaceSection, std::unique_ptr<RWStepElement_RWSurfaceSection>> cls_RWStepElement_RWSurfaceSection(mod, "RWStepElement_RWSurfaceSection", "Read & Write tool for SurfaceSection");
