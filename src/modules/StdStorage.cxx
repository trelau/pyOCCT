...
/*
py::class_<StdStorage_Bucket> cls_StdStorage_Bucket(mod, "StdStorage_Bucket", "None");
...
/*
py::class_<StdStorage_BucketOfPersistent> cls_StdStorage_BucketOfPersistent(mod, "StdStorage_BucketOfPersistent", "None");
...
/*
py::class_<StdStorage_BucketIterator> cls_StdStorage_BucketIterator(mod, "StdStorage_BucketIterator", "None");
...
// TYPEDEF: STDSTORAGE_SEQUENCEOFROOTS
...
// TYPEDEF: STDSTORAGE_DATAMAPITERATOROFMAPOFROOTS

// TYPEDEF: STDSTORAGE_MAPOFTYPES
bind_NCollection_IndexedDataMap<TCollection_AsciiString, int, TCollection_AsciiString>(mod, "StdStorage_MapOfTypes", py::module_local(false));
...
// FIXME: cls_StdStorage_TypeData.def("Instantiator", (StdObjMgt_Persistent::Instantiator (StdStorage_TypeData::*)(const Standard_Integer) const) &StdStorage_TypeData::Instantiator, py::return_value_policy::reference, "Returns a persistent object instantiator of <aTypeName>", py::arg("aTypeNum"));
