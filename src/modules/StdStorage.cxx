...
cls_StdStorage_TypeData.def("Instantiator", (StdObjMgt_Persistent::Instantiator (StdStorage_TypeData::*)(const Standard_Integer) const) &StdStorage_TypeData::Instantiator, py::return_value_policy::reference, "Returns a persistent object instantiator of <aTypeName>", py::arg("aTypeNum"));
