...
void bind_BlendFunc_EvolRad(py::module &mod){

py::class_<BlendFunc_EvolRad, std::unique_ptr<BlendFunc_EvolRad>, Blend_Function> cls_BlendFunc_EvolRad(mod, "BlendFunc_EvolRad", "None");
