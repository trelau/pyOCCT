...
void bind_BlendFunc_RuledInv(py::module &mod){

py::class_<BlendFunc_RuledInv, std::unique_ptr<BlendFunc_RuledInv>, Blend_FuncInv> cls_BlendFunc_RuledInv(mod, "BlendFunc_RuledInv", "None");
