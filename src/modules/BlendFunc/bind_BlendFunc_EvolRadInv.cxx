...
void bind_BlendFunc_EvolRadInv(py::module &mod){

py::class_<BlendFunc_EvolRadInv, std::unique_ptr<BlendFunc_EvolRadInv>, Blend_FuncInv> cls_BlendFunc_EvolRadInv(mod, "BlendFunc_EvolRadInv", "None");
