...
void bind_BlendFunc_ChamfInv(py::module &mod){

py::class_<BlendFunc_ChamfInv, std::unique_ptr<BlendFunc_ChamfInv>, Blend_FuncInv> cls_BlendFunc_ChamfInv(mod, "BlendFunc_ChamfInv", "None");
