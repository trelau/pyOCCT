...
py::class_<Interface_LineBuffer, std::unique_ptr<Interface_LineBuffer, Deleter<Interface_LineBuffer>>> cls_Interface_LineBuffer(mod, "Interface_LineBuffer", "Simple Management of a Line Buffer, to be used by Interface File Writers. While a String is suitable to do that, this class ensures an optimised Memory Management, because this is a hard point of File Writing.");
