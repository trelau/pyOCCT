...
py::class_<HLRAppli_ReflectLines> cls_HLRAppli_ReflectLines(mod, "HLRAppli_ReflectLines", "This class builds reflect lines on a shape according to the axes of view defined by user. Reflect lines are represented by edges in 3d.");
