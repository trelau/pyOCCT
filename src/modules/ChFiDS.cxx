...
// TYPEDEF: CHFIDS_SEQUENCEOFSURFDATA
...
// TYPEDEF: CHFIDS_LISTOFSTRIPE
bind_NCollection_List<opencascade::handle<ChFiDS_Stripe> >(mod, "ChFiDS_ListOfStripe", py::module_local(false));

// TYPEDEF: CHFIDS_LISTITERATOROFLISTOFSTRIPE
bind_NCollection_TListIterator<opencascade::handle<ChFiDS_Stripe> >(mod, "ChFiDS_ListIteratorOfListOfStripe", py::module_local(false));

// TYPEDEF: CHFIDS_INDEXEDDATAMAPOFVERTEXLISTOFSTRIPE
bind_NCollection_IndexedDataMap<TopoDS_Vertex, NCollection_List<opencascade::handle<ChFiDS_Stripe> >, TopTools_ShapeMapHasher>(mod, "ChFiDS_IndexedDataMapOfVertexListOfStripe", py::module_local(false));
...
// CLASS: CHFIDS_REGUL
py::class_<ChFiDS_Regul> cls_ChFiDS_Regul(mod, "ChFiDS_Regul", "Storage of a curve and its 2 faces or surfaces of support.");
...
// TYPEDEF: CHFIDS_REGULARITIES
bind_NCollection_List<ChFiDS_Regul>(mod, "ChFiDS_Regularities", py::module_local(false));

// TYPEDEF: CHFIDS_LISTITERATOROFREGULARITIES
bind_NCollection_TListIterator<ChFiDS_Regul>(mod, "ChFiDS_ListIteratorOfRegularities", py::module_local(false));

// CLASS: CHFIDS_ELSPINE
py::class_<ChFiDS_ElSpine, Adaptor3d_Curve> cls_ChFiDS_ElSpine(mod, "ChFiDS_ElSpine", "Elementary Spine for cheminements and approximations.");
...
// TYPEDEF: CHFIDS_LISTOFHELSPINE
bind_NCollection_List<opencascade::handle<ChFiDS_HElSpine> >(mod, "ChFiDS_ListOfHElSpine", py::module_local(false));

// TYPEDEF: CHFIDS_LISTITERATOROFLISTOFHELSPINE
bind_NCollection_TListIterator<opencascade::handle<ChFiDS_HElSpine> >(mod, "ChFiDS_ListIteratorOfListOfHElSpine", py::module_local(false));
...
// TYPEDEF: CHFIDS_SEQUENCEOFSPINE
bind_NCollection_Sequence<opencascade::handle<ChFiDS_Spine> >(mod, "ChFiDS_SequenceOfSpine", py::module_local(false));

// TYPEDEF: CHFIDS_STRIPEARRAY1
bind_NCollection_Array1<opencascade::handle<ChFiDS_Stripe> >(mod, "ChFiDS_StripeArray1", py::module_local(false));
