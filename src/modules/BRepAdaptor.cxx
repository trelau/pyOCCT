...
py::class_<BRepAdaptor_Surface, Adaptor3d_Surface> cls_BRepAdaptor_Surface(mod, "BRepAdaptor_Surface", "The Surface from BRepAdaptor allows to use a Face of the BRep topology look like a 3D surface.");
...
// TYPEDEF: BREPADAPTOR_ARRAY1OFCURVE
