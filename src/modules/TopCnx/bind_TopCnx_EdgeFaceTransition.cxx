...
py::class_<TopCnx_EdgeFaceTransition> cls_TopCnx_EdgeFaceTransition(mod, "TopCnx_EdgeFaceTransition", "TheEdgeFaceTransition is an algorithm to compute the cumulated transition for interferences on an edge.");
