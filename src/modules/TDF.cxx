...
// TYPEDEF: TDF_LABELNODEPTR

// TYPEDEF: TDF_ATTRIBUTEINDEXEDMAP
bind_NCollection_IndexedMap<opencascade::handle<TDF_Attribute>, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "TDF_AttributeIndexedMap", py::module_local(false));
...
// TYPEDEF: TDF_HALLOCATOR
/*
bind_opencascade::handle<NCollection_BaseAllocator>(mod, "TDF_HAllocator", py::module_local(false));
*/
...
// TYPEDEF: TDF_LABELLIST
bind_NCollection_List<TDF_Label>(mod, "TDF_LabelList", py::module_local(false));

// TYPEDEF: TDF_LISTITERATOROFLABELLIST
bind_NCollection_TListIterator<TDF_Label>(mod, "TDF_ListIteratorOfLabelList", py::module_local(false));

// TYPEDEF: TDF_LABELSEQUENCE
bind_NCollection_Sequence<TDF_Label>(mod, "TDF_LabelSequence", py::module_local(false));

// TYPEDEF: TDF_ATTRIBUTELIST
bind_NCollection_List<opencascade::handle<TDF_Attribute> >(mod, "TDF_AttributeList", py::module_local(false));

// TYPEDEF: TDF_LISTITERATOROFATTRIBUTELIST
bind_NCollection_TListIterator<opencascade::handle<TDF_Attribute> >(mod, "TDF_ListIteratorOfAttributeList", py::module_local(false));
...
bind_NCollection_Map<TDF_Label, TDF_LabelMapHasher>(mod, "TDF_LabelMap", py::module_local(false));

// TYPEDEF: TDF_MAPITERATOROFLABELMAP

// TYPEDEF: TDF_IDLIST
bind_NCollection_List<Standard_GUID>(mod, "TDF_IDList", py::module_local(false));

// TYPEDEF: TDF_LISTITERATOROFIDLIST
bind_NCollection_TListIterator<Standard_GUID>(mod, "TDF_ListIteratorOfIDList", py::module_local(false));
...
// TYPEDEF: TDF_ATTRIBUTEARRAY1
bind_NCollection_Array1<opencascade::handle<TDF_Attribute> >(mod, "TDF_AttributeArray1", py::module_local(false));

// TYPEDEF: TDF_ATTRIBUTEDATAMAP
bind_NCollection_DataMap<opencascade::handle<TDF_Attribute>, opencascade::handle<TDF_Attribute>, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "TDF_AttributeDataMap", py::module_local(false));

// TYPEDEF: TDF_DATAMAPITERATOROFATTRIBUTEDATAMAP

// TYPEDEF: TDF_ATTRIBUTEDELTALIST
bind_NCollection_List<opencascade::handle<TDF_AttributeDelta> >(mod, "TDF_AttributeDeltaList", py::module_local(false));

// TYPEDEF: TDF_LISTITERATOROFATTRIBUTEDELTALIST
...
py::class_<TDF_AttributeIterator> cls_TDF_AttributeIterator(mod, "TDF_AttributeIterator", "None");
...
// TYPEDEF: TDF_MAPITERATOROFATTRIBUTEMAP

// TYPEDEF: TDF_ATTRIBUTESEQUENCE
bind_NCollection_Sequence<opencascade::handle<TDF_Attribute> >(mod, "TDF_AttributeSequence", py::module_local(false));

// CLASS: TDF_CHILDITERATOR
py::class_<TDF_ChildIterator> cls_TDF_ChildIterator(mod, "TDF_ChildIterator", "Iterates on the children of a label, at the first level only. It is possible to ask the iterator to explore all the sub label levels of the given one, with the option 'allLevels'.");
...
py::class_<TDF_ChildIDIterator> cls_TDF_ChildIDIterator(mod, "TDF_ChildIDIterator", "Iterates on the children of a label, to find attributes having ID as Attribute ID.");
...
// TYPEDEF: TDF_IDMAP
bind_NCollection_Map<Standard_GUID, Standard_GUID>(mod, "TDF_IDMap", py::module_local(false));

// TYPEDEF: TDF_MAPITERATOROFIDMAP
...
// TYPEDEF: TDF_LABELDATAMAP
bind_NCollection_DataMap<TDF_Label, TDF_Label, TDF_LabelMapHasher>(mod, "TDF_LabelDataMap", py::module_local(false));

// TYPEDEF: TDF_DATAMAPITERATOROFLABELDATAMAP
...
// TYPEDEF: TDF_LABELINTEGERMAP
bind_NCollection_DataMap<TDF_Label, int, TDF_LabelMapHasher>(mod, "TDF_LabelIntegerMap", py::module_local(false));

// TYPEDEF: TDF_DATAMAPITERATOROFLABELINTEGERMAP
...
// TYPEDEF: TDF_DELTALIST
bind_NCollection_List<opencascade::handle<TDF_Delta> >(mod, "TDF_DeltaList", py::module_local(false));

// TYPEDEF: TDF_LISTITERATOROFDELTALIST
bind_NCollection_TListIterator<opencascade::handle<TDF_Delta> >(mod, "TDF_ListIteratorOfDeltaList", py::module_local(false));
...
// TYPEDEF: TDF_GUIDPROGIDMAP
bind_NCollection_DoubleMap<Standard_GUID, TCollection_ExtendedString, Standard_GUID, TCollection_ExtendedString>(mod, "TDF_GUIDProgIDMap", py::module_local(false));

// TYPEDEF: TDF_DOUBLEMAPITERATOROFGUIDPROGIDMAP

// TYPEDEF: TDF_LABELDOUBLEMAP
bind_NCollection_DoubleMap<TDF_Label, TDF_Label, TDF_LabelMapHasher, TDF_LabelMapHasher>(mod, "TDF_LabelDoubleMap", py::module_local(false));
