...
// TYPEDEF: INTPOLYH_ARRAYOFEDGES
bind_IntPolyh_Array<IntPolyh_Edge>(mod, "IntPolyh_ArrayOfEdges", py::module_local(false));
...
// TYPEDEF: INTPOLYH_ARRAYOFPOINTNORMAL
bind_IntPolyh_Array<IntPolyh_PointNormal>(mod, "IntPolyh_ArrayOfPointNormal", py::module_local(false));
...
// TYPEDEF: INTPOLYH_ARRAYOFPOINTS
bind_IntPolyh_Array<IntPolyh_Point>(mod, "IntPolyh_ArrayOfPoints", py::module_local(false));
...
// TYPEDEF: INTPOLYH_SEQOFSTARTPOINTS
bind_NCollection_Sequence<IntPolyh_StartPoint>(mod, "IntPolyh_SeqOfStartPoints", py::module_local(false));
...
// TYPEDEF: INTPOLYH_ARRAYOFSECTIONLINES
bind_IntPolyh_Array<IntPolyh_SectionLine>(mod, "IntPolyh_ArrayOfSectionLines", py::module_local(false));

// TYPEDEF: INTPOLYH_ARRAYOFTANGENTZONES
bind_IntPolyh_Array<IntPolyh_StartPoint>(mod, "IntPolyh_ArrayOfTangentZones", py::module_local(false));

// TYPEDEF: INTPOLYH_ARRAYOFTRIANGLES
...
bind_NCollection_List<IntPolyh_Couple>(mod, "IntPolyh_ListOfCouples", py::module_local(false));

// TYPEDEF: INTPOLYH_LISTITERATOROFLISTOFCOUPLES
bind_NCollection_TListIterator<IntPolyh_Couple>(mod, "IntPolyh_ListIteratorOfListOfCouples", py::module_local(false));

// TYPEDEF: INTPOLYH_PMAILLAGEAFFINAGE
...
py::class_<IntPolyh_MaillageAffinage> cls_IntPolyh_MaillageAffinage(mod, "IntPolyh_MaillageAffinage", "Low-level algorithm to compute intersection of the surfaces by computing the intersection of their triangulations.");
