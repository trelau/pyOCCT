...
// TYPEDEF: BREPOFFSET_LISTOFINTERVAL
bind_NCollection_List<BRepOffset_Interval>(mod, "BRepOffset_ListOfInterval", py::module_local(false));

// TYPEDEF: BREPOFFSET_LISTITERATOROFLISTOFINTERVAL
bind_NCollection_TListIterator<BRepOffset_Interval>(mod, "BRepOffset_ListIteratorOfListOfInterval", py::module_local(false));

// TYPEDEF: BREPOFFSET_DATAMAPOFSHAPELISTOFINTERVAL
bind_NCollection_DataMap<TopoDS_Shape, NCollection_List<BRepOffset_Interval>, TopTools_ShapeMapHasher>(mod, "BRepOffset_DataMapOfShapeListOfInterval", py::module_local(false));

// TYPEDEF: BREPOFFSET_DATAMAPITERATOROFDATAMAPOFSHAPELISTOFINTERVAL
...
// TYPEDEF: BREPOFFSET_DATAMAPOFSHAPEOFFSET
bind_NCollection_DataMap<TopoDS_Shape, BRepOffset_Offset, TopTools_ShapeMapHasher>(mod, "BRepOffset_DataMapOfShapeOffset", py::module_local(false));

// TYPEDEF: BREPOFFSET_DATAMAPITERATOROFDATAMAPOFSHAPEOFFSET
...
py::class_<BRepOffset_MakeOffset> cls_BRepOffset_MakeOffset(mod, "BRepOffset_MakeOffset", "None");
...
py::class_<BRepOffset_MakeSimpleOffset> cls_BRepOffset_MakeSimpleOffset(mod, "BRepOffset_MakeSimpleOffset", "Limitations: According to the algorithm nature result depends on the smoothness of input data. Smooth (G1-continuity) input shape will lead to the good result.");
...
// TYPEDEF: BREPOFFSET_DATAMAPOFSHAPEMAPOFSHAPE
bind_NCollection_DataMap<TopoDS_Shape, NCollection_Map<TopoDS_Shape, TopTools_ShapeMapHasher>, TopTools_ShapeMapHasher>(mod, "BRepOffset_DataMapOfShapeMapOfShape", py::module_local(false));

// TYPEDEF: BREPOFFSET_DATAMAPITERATOROFDATAMAPOFSHAPEMAPOFSHAPE
...
cls_BRepOffset_Tool.def_static("EnLargeFace_", [](const TopoDS_Face & a0, TopoDS_Face & a1, const Standard_Boolean a2, const Standard_Boolean a3, const Standard_Boolean a4, const Standard_Boolean a5, const Standard_Boolean a6, const Standard_Integer a7) -> Standard_Boolean { return BRepOffset_Tool::EnLargeFace(a0, a1, a2, a3, a4, a5, a6, a7); });
cls_BRepOffset_Tool.def_static("EnLargeFace_", [](const TopoDS_Face & a0, TopoDS_Face & a1, const Standard_Boolean a2, const Standard_Boolean a3, const Standard_Boolean a4, const Standard_Boolean a5, const Standard_Boolean a6, const Standard_Integer a7, const Standard_Real a8) -> Standard_Boolean { return BRepOffset_Tool::EnLargeFace(a0, a1, a2, a3, a4, a5, a6, a7, a8); });
cls_BRepOffset_Tool.def_static("EnLargeFace_", [](const TopoDS_Face & a0, TopoDS_Face & a1, const Standard_Boolean a2, const Standard_Boolean a3, const Standard_Boolean a4, const Standard_Boolean a5, const Standard_Boolean a6, const Standard_Integer a7, const Standard_Real a8, const Standard_Real a9) -> Standard_Boolean { return BRepOffset_Tool::EnLargeFace(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9); });
cls_BRepOffset_Tool.def_static("EnLargeFace_", [](const TopoDS_Face & a0, TopoDS_Face & a1, const Standard_Boolean a2, const Standard_Boolean a3, const Standard_Boolean a4, const Standard_Boolean a5, const Standard_Boolean a6, const Standard_Integer a7, const Standard_Real a8, const Standard_Real a9, const Standard_Real a10) -> Standard_Boolean { return BRepOffset_Tool::EnLargeFace(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10); });
cls_BRepOffset_Tool.def_static("EnLargeFace_", (Standard_Boolean (*)(const TopoDS_Face &, TopoDS_Face &, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Boolean, const Standard_Integer, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real)) &BRepOffset_Tool::EnLargeFace, "Returns True if The Surface of <NF> has changed. if <ChangeGeom> is TRUE , the surface can be changed . if <UpdatePCurve> is TRUE, update the pcurves of the edges of <F> on the new surface if the surface has been changed. <enlargeU>, <enlargeVfirst>, <enlargeVlast> allow or forbid enlargement in U and V directions correspondingly. <theExtensionMode> is a mode of extension of the surface of the face: if <theExtensionMode> equals 1, potentially infinite surfaces are extended by maximum value, and limited surfaces are extended by 25%. if <theExtensionMode> equals 2, potentially infinite surfaces are extended by 10*(correspondent size of face), and limited surfaces are extended by 100%. <theLenBeforeUfirst>, <theLenAfterUlast>, <theLenBeforeVfirst>, <theLenAfterVlast> set the values of enlargement on correspondent directions. If some of them equals -1, the default value of enlargement is used.", py::arg("F"), py::arg("NF"), py::arg("ChangeGeom"), py::arg("UpDatePCurve"), py::arg("enlargeU"), py::arg("enlargeVfirst"), py::arg("enlargeVlast"), py::arg("theExtensionMode"), py::arg("theLenBeforeUfirst"), py::arg("theLenAfterUlast"), py::arg("theLenBeforeVfirst"), py::arg("theLenAfterVlast"));
