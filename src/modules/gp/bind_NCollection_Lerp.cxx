...
py::class_<NCollection_Lerp<gp_Trsf>, std::unique_ptr<NCollection_Lerp<gp_Trsf>, Deleter<NCollection_Lerp<gp_Trsf>>>> cls_NCollection_Lerp(mod, "gp_TrsfNLerp", "Linear interpolation tool for transformation defined by gp_Trsf.");
