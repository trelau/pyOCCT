...
py::class_<BinTools_LocationSet> cls_BinTools_LocationSet(mod, "BinTools_LocationSet", "The class LocationSet stores a set of location in a relocatable state.");
...
py::class_<BinTools_Curve2dSet> cls_BinTools_Curve2dSet(mod, "BinTools_Curve2dSet", "Stores a set of Curves from Geom2d in binary format");
...
py::class_<BinTools_ShapeSet> cls_BinTools_ShapeSet(mod, "BinTools_ShapeSet", "Writes topology in OStream in binary format");
...
// TYPEDEF: BINTOOLS_LOCATIONSETPTR
