...
py::class_<APIHeaderSection_MakeHeader> cls_APIHeaderSection_MakeHeader(mod, "APIHeaderSection_MakeHeader", "This class allows to consult and prepare/edit data stored in a Step Model Header");
