...
py::class_<BOPAlgo_ToolsProvider, std::unique_ptr<BOPAlgo_ToolsProvider, Deleter<BOPAlgo_ToolsProvider>>, BOPAlgo_Builder> cls_BOPAlgo_ToolsProvider(mod, "BOPAlgo_ToolsProvider", "Auxiliary class providing API to operate tool arguments.");
