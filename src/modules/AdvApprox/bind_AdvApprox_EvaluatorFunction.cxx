...
py::class_<AdvApprox_EvaluatorFunction, std::unique_ptr<AdvApprox_EvaluatorFunction, Deleter<AdvApprox_EvaluatorFunction>>> cls_AdvApprox_EvaluatorFunction(mod, "AdvApprox_EvaluatorFunction", "Interface for a class implementing a function to be approximated by AdvApprox_ApproxAFunction");
