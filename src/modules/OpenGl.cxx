...
py::class_<OpenGl_AspectFace, OpenGl_Element> cls_OpenGl_AspectFace(mod, "OpenGl_AspectFace", "The element holding Graphic3d_AspectFillArea3d.");
...
// TYPEDEF: OPENGL_MAPOFZLAYERSETTINGS
bind_NCollection_DataMap<int, Graphic3d_ZLayerSettings, NCollection_DefaultHasher<int> >(mod, "OpenGl_MapOfZLayerSettings", py::module_local(false));
...
// TYPEDEF: OPENGL_INDEXEDMAPOFSTRUCTURE
bind_NCollection_IndexedMap<const OpenGl_Structure *, NCollection_DefaultHasher<const OpenGl_Structure *> >(mod, "OpenGl_IndexedMapOfStructure", py::module_local(false));
...
// CLASS: OPENGL_GLOBALLAYERSETTINGS
py::class_<OpenGl_GlobalLayerSettings> cls_OpenGl_GlobalLayerSettings(mod, "OpenGl_GlobalLayerSettings", "None");
...
// TYPEDEF: OPENGL_INDEXEDMAPOFSTRUCTURE
if (py::hasattr(mod, "OpenGl_IndexedMapOfStructure")) {
	mod.attr("OpenGl_IndexedMapOfStructure") = mod.attr("OpenGl_IndexedMapOfStructure");
}

// TYPEDEF: OPENGL_ARRAYOFINDEXEDMAPOFSTRUCTURE
