...
py::class_<RWStepVisual_RWStyledItem, std::unique_ptr<RWStepVisual_RWStyledItem>> cls_RWStepVisual_RWStyledItem(mod, "RWStepVisual_RWStyledItem", "Read & Write Module for StyledItem");
