...
py::class_<RWStepVisual_RWTessellatedCurveSet, std::unique_ptr<RWStepVisual_RWTessellatedCurveSet>> cls_RWStepVisual_RWTessellatedCurveSet(mod, "RWStepVisual_RWTessellatedCurveSet", "Read & Write Module for AnnotationOccurrence");
