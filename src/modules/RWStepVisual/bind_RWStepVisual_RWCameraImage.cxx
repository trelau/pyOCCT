...
py::class_<RWStepVisual_RWCameraImage, std::unique_ptr<RWStepVisual_RWCameraImage>> cls_RWStepVisual_RWCameraImage(mod, "RWStepVisual_RWCameraImage", "Read & Write Module for CameraImage");
