...
py::class_<AppCont_Function, std::unique_ptr<AppCont_Function, Deleter<AppCont_Function>>> cls_AppCont_Function(mod, "AppCont_Function", "Class describing a continous 3d and/or function f(u). This class must be provided by the user to use the approximation algorithm FittingCurve.");
