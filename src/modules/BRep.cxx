...
// TYPEDEF: BREP_LISTOFPOINTREPRESENTATION
bind_NCollection_List<opencascade::handle<BRep_PointRepresentation> >(mod, "BRep_ListOfPointRepresentation", py::module_local(false));

// TYPEDEF: BREP_LISTITERATOROFLISTOFPOINTREPRESENTATION
bind_NCollection_TListIterator<opencascade::handle<BRep_PointRepresentation> >(mod, "BRep_ListIteratorOfListOfPointRepresentation", py::module_local(false));
...
// TYPEDEF: BREP_LISTOFCURVEREPRESENTATION
bind_NCollection_List<opencascade::handle<BRep_CurveRepresentation> >(mod, "BRep_ListOfCurveRepresentation", py::module_local(false));

// TYPEDEF: BREP_LISTITERATOROFLISTOFCURVEREPRESENTATION
bind_NCollection_TListIterator<opencascade::handle<BRep_CurveRepresentation> >(mod, "BRep_ListIteratorOfListOfCurveRepresentation", py::module_local(false));
