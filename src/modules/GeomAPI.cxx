...
cls_GeomAPI_PointsToBSplineSurface.def("Interpolate", [](GeomAPI_PointsToBSplineSurface &self, const TColgp_Array2OfPnt & a0) -> void { return self.Interpolate(a0); });
cls_GeomAPI_PointsToBSplineSurface.def("Interpolate", (void (GeomAPI_PointsToBSplineSurface::*)(const TColgp_Array2OfPnt &, const Standard_Boolean)) &GeomAPI_PointsToBSplineSurface::Interpolate, "Interpolates a BSpline Surface passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be 3. 2- his continuity will be C2.", py::arg("Points"), py::arg("thePeriodic"));
cls_GeomAPI_PointsToBSplineSurface.def("Interpolate", [](GeomAPI_PointsToBSplineSurface &self, const TColgp_Array2OfPnt & a0, const Approx_ParametrizationType a1) -> void { return self.Interpolate(a0, a1); });
cls_GeomAPI_PointsToBSplineSurface.def("Interpolate", (void (GeomAPI_PointsToBSplineSurface::*)(const TColgp_Array2OfPnt &, const Approx_ParametrizationType, const Standard_Boolean)) &GeomAPI_PointsToBSplineSurface::Interpolate, "Interpolates a BSpline Surface passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be 3. 2- his continuity will be C2.", py::arg("Points"), py::arg("ParType"), py::arg("thePeriodic"));
...
cls_GeomAPI_PointsToBSplineSurface.def("Init", [](GeomAPI_PointsToBSplineSurface &self, const TColgp_Array2OfPnt & a0, const Approx_ParametrizationType a1, const Standard_Integer a2, const Standard_Integer a3, const GeomAbs_Shape a4, const Standard_Real a5) -> void { return self.Init(a0, a1, a2, a3, a4, a5); });
cls_GeomAPI_PointsToBSplineSurface.def("Init", (void (GeomAPI_PointsToBSplineSurface::*)(const TColgp_Array2OfPnt &, const Approx_ParametrizationType, const Standard_Integer, const Standard_Integer, const GeomAbs_Shape, const Standard_Real, const Standard_Boolean)) &GeomAPI_PointsToBSplineSurface::Init, "Approximates a BSpline Surface passing through an array of Point. The resulting BSpline will have the following properties: 1- his degree will be in the range [Degmin,Degmax] 2- his continuity will be at least <Continuity> 3- the distance from the point <Points> to the BSpline will be lower to Tol3D.", py::arg("Points"), py::arg("ParType"), py::arg("DegMin"), py::arg("DegMax"), py::arg("Continuity"), py::arg("Tol3D"), py::arg("thePeriodic"));
