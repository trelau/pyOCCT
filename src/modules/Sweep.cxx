...
py::class_<Sweep_NumShapeTool> cls_Sweep_NumShapeTool(mod, "Sweep_NumShapeTool", "This class provides the indexation and type analysis services required by the NumShape Directing Shapes of Swept Primitives.");
...
py::class_<Sweep_NumShapeIterator> cls_Sweep_NumShapeIterator(mod, "Sweep_NumShapeIterator", "This class provides iteration services required by the Swept Primitives for a Directing NumShape Line.");
