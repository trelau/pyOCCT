...
// TYPEDEF: IGESSOLID_ARRAY1OFLOOP
...
// TYPEDEF: IGESSOLID_ARRAY1OFFACE
...
// TYPEDEF: IGESSOLID_ARRAY1OFSHELL
...
// TYPEDEF: IGESSOLID_ARRAY1OFVERTEXLIST
bind_NCollection_Array1<opencascade::handle<IGESSolid_VertexList> >(mod, "IGESSolid_Array1OfVertexList", py::module_local(false));
...
py::class_<IGESSolid_ToolBlock> cls_IGESSolid_ToolBlock(mod, "IGESSolid_ToolBlock", "Tool to work on a Block. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
...
py::class_<IGESSolid_ToolBooleanTree> cls_IGESSolid_ToolBooleanTree(mod, "IGESSolid_ToolBooleanTree", "Tool to work on a BooleanTree. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");

// Constructors
cls_IGESSolid_ToolBooleanTree.def(py::init<>());

// Methods
// cls_IGESSolid_ToolBooleanTree.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolBooleanTree::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolBooleanTree.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolBooleanTree::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolBooleanTree.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolBooleanTree::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolBooleanTree.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolBooleanTree::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolBooleanTree.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolBooleanTree::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolBooleanTree.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolBooleanTree::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolConicalSurface> cls_IGESSolid_ToolConicalSurface(mod, "IGESSolid_ToolConicalSurface", "Tool to work on a ConicalSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
...
py::class_<IGESSolid_ToolCylinder> cls_IGESSolid_ToolCylinder(mod, "IGESSolid_ToolCylinder", "Tool to work on a Cylinder. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
...
py::class_<IGESSolid_ToolEdgeList> cls_IGESSolid_ToolEdgeList(mod, "IGESSolid_ToolEdgeList", "Tool to work on a EdgeList. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
...
// Methods
// cls_IGESSolid_ToolManifoldSolid.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolManifoldSolid::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolManifoldSolid.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolManifoldSolid::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolManifoldSolid.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolManifoldSolid::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolManifoldSolid.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolManifoldSolid::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolManifoldSolid.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolManifoldSolid::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolManifoldSolid.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolManifoldSolid::operator delete, "None", py::arg(""), py::arg(""));
...
// Methods
// cls_IGESSolid_ToolPlaneSurface.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolPlaneSurface::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolPlaneSurface.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolPlaneSurface::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolPlaneSurface.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolPlaneSurface::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolPlaneSurface.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolPlaneSurface::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolPlaneSurface.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolPlaneSurface::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolPlaneSurface.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolPlaneSurface::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolSelectedComponent> cls_IGESSolid_ToolSelectedComponent(mod, "IGESSolid_ToolSelectedComponent", "Tool to work on a SelectedComponent. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");

// Constructors
cls_IGESSolid_ToolSelectedComponent.def(py::init<>());

// Methods
// cls_IGESSolid_ToolSelectedComponent.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolSelectedComponent::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolSelectedComponent.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolSelectedComponent::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSelectedComponent.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolSelectedComponent::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolSelectedComponent.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolSelectedComponent::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSelectedComponent.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolSelectedComponent::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolSelectedComponent.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolSelectedComponent::operator delete, "None", py::arg(""), py::arg(""));
...
// Methods
// cls_IGESSolid_ToolShell.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolShell::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolShell.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolShell::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolShell.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolShell::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolShell.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolShell::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolShell.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolShell::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolShell.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolShell::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolSolidInstance> cls_IGESSolid_ToolSolidInstance(mod, "IGESSolid_ToolSolidInstance", "Tool to work on a SolidInstance. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");

// Constructors
cls_IGESSolid_ToolSolidInstance.def(py::init<>());

// Methods
// cls_IGESSolid_ToolSolidInstance.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolSolidInstance::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolSolidInstance.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolSolidInstance::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSolidInstance.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolSolidInstance::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolSolidInstance.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolSolidInstance::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSolidInstance.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolSolidInstance::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolSolidInstance.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolSolidInstance::operator delete, "None", py::arg(""), py::arg(""));
...
// Methods
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolSolidOfRevolution::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolSolidOfRevolution::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolSolidOfRevolution::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolSolidOfRevolution::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolSolidOfRevolution::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolSolidOfRevolution.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolSolidOfRevolution::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolSphere> cls_IGESSolid_ToolSphere(mod, "IGESSolid_ToolSphere", "Tool to work on a Sphere. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
...
// Methods
// cls_IGESSolid_ToolSphericalSurface.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolSphericalSurface::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolSphericalSurface.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolSphericalSurface::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSphericalSurface.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolSphericalSurface::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolSphericalSurface.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolSphericalSurface::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolSphericalSurface.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolSphericalSurface::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolSphericalSurface.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolSphericalSurface::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolTorus> cls_IGESSolid_ToolTorus(mod, "IGESSolid_ToolTorus", "Tool to work on a Torus. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");

// Constructors
cls_IGESSolid_ToolTorus.def(py::init<>());

// Methods
// cls_IGESSolid_ToolTorus.def_static("operator new_", (void * (*)(size_t)) &IGESSolid_ToolTorus::operator new, "None", py::arg("theSize"));
// cls_IGESSolid_ToolTorus.def_static("operator delete_", (void (*)(void *)) &IGESSolid_ToolTorus::operator delete, "None", py::arg("theAddress"));
// cls_IGESSolid_ToolTorus.def_static("operator new[]_", (void * (*)(size_t)) &IGESSolid_ToolTorus::operator new[], "None", py::arg("theSize"));
// cls_IGESSolid_ToolTorus.def_static("operator delete[]_", (void (*)(void *)) &IGESSolid_ToolTorus::operator delete[], "None", py::arg("theAddress"));
// cls_IGESSolid_ToolTorus.def_static("operator new_", (void * (*)(size_t, void *)) &IGESSolid_ToolTorus::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_IGESSolid_ToolTorus.def_static("operator delete_", (void (*)(void *, void *)) &IGESSolid_ToolTorus::operator delete, "None", py::arg(""), py::arg(""));
...
py::class_<IGESSolid_ToolVertexList> cls_IGESSolid_ToolVertexList(mod, "IGESSolid_ToolVertexList", "Tool to work on a VertexList. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
