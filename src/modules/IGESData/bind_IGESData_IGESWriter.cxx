...
py::class_<IGESData_IGESWriter, std::unique_ptr<IGESData_IGESWriter, Deleter<IGESData_IGESWriter>>> cls_IGESData_IGESWriter(mod, "IGESData_IGESWriter", "manages atomic file writing, under control of IGESModel : prepare text to be sent then sends it takes into account distinction between successive Sections");
