...
py::class_<IGESData_IGESType, std::unique_ptr<IGESData_IGESType, Deleter<IGESData_IGESType>>> cls_IGESData_IGESType(mod, "IGESData_IGESType", "taken from directory part of an entity (from file or model), gives 'type' and 'form' data, used to recognize entity's type");
