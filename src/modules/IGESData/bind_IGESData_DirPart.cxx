...
py::class_<IGESData_DirPart, std::unique_ptr<IGESData_DirPart, Deleter<IGESData_DirPart>>> cls_IGESData_DirPart(mod, "IGESData_DirPart", "litteral/numeric description of an entity's directory section, taken from file");
