...
py::class_<gce_Root, std::unique_ptr<gce_Root>> cls_gce_Root(mod, "gce_Root", "This class implements the common services for all classes of gce which report error.");
