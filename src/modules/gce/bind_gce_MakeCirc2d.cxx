...
py::class_<gce_MakeCirc2d, std::unique_ptr<gce_MakeCirc2d>, gce_Root> cls_gce_MakeCirc2d(mod, "gce_MakeCirc2d", "This class implements the following algorithms used to create Circ2d from gp.");
