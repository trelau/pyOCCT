...
py::class_<BRepSweep_Builder, std::unique_ptr<BRepSweep_Builder, Deleter<BRepSweep_Builder>>> cls_BRepSweep_Builder(mod, "BRepSweep_Builder", "implements the abstract Builder with the BRep Builder");
