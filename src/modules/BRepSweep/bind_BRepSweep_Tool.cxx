...
py::class_<BRepSweep_Tool, std::unique_ptr<BRepSweep_Tool, Deleter<BRepSweep_Tool>>> cls_BRepSweep_Tool(mod, "BRepSweep_Tool", "Provides the indexation and type analysis services required by the TopoDS generating Shape of BRepSweep.");
