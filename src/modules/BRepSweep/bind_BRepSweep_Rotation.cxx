...
py::class_<BRepSweep_Rotation, std::unique_ptr<BRepSweep_Rotation, Deleter<BRepSweep_Rotation>>, BRepSweep_Trsf> cls_BRepSweep_Rotation(mod, "BRepSweep_Rotation", "Provides an algorithm to build object by Rotation sweep.");
