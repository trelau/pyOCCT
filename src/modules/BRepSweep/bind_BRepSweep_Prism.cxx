...
py::class_<BRepSweep_Prism, std::unique_ptr<BRepSweep_Prism, Deleter<BRepSweep_Prism>>> cls_BRepSweep_Prism(mod, "BRepSweep_Prism", "Provides natural constructors to build BRepSweep translated swept Primitives.");
