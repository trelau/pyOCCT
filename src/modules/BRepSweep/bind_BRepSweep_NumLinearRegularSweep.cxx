...
py::class_<BRepSweep_NumLinearRegularSweep, std::unique_ptr<BRepSweep_NumLinearRegularSweep, Deleter<BRepSweep_NumLinearRegularSweep>>> cls_BRepSweep_NumLinearRegularSweep(mod, "BRepSweep_NumLinearRegularSweep", "This a generic class is used to build Sweept primitives with a generating 'shape' and a directing 'line'.");
