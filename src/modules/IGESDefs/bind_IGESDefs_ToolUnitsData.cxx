...
void bind_IGESDefs_ToolUnitsData(py::module &mod){

py::class_<IGESDefs_ToolUnitsData, std::unique_ptr<IGESDefs_ToolUnitsData>> cls_IGESDefs_ToolUnitsData(mod, "IGESDefs_ToolUnitsData", "Tool to work on a UnitsData. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
