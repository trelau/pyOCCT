...
void bind_IGESSolid_ToolSolidInstance(py::module &mod){

py::class_<IGESSolid_ToolSolidInstance, std::unique_ptr<IGESSolid_ToolSolidInstance>> cls_IGESSolid_ToolSolidInstance(mod, "IGESSolid_ToolSolidInstance", "Tool to work on a SolidInstance. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
