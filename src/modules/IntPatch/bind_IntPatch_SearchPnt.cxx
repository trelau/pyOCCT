...
py::class_<Intf_InterferencePolygon2d, std::unique_ptr<Intf_InterferencePolygon2d, Deleter<Intf_InterferencePolygon2d>>, Intf_Interference> cls_IntPatch_SearchPnt(mod, "IntPatch_SearchPnt", "Computes the interference between two polygons or the self intersection of a polygon in two dimensions.", py::module_local());
