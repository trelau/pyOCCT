...
py::class_<GccAna_Lin2dTanObl, std::unique_ptr<GccAna_Lin2dTanObl, Deleter<GccAna_Lin2dTanObl>>> cls_GccAna_Lin2dTanObl(mod, "GccAna_Lin2dTanObl", "This class implements the algorithms used to create 2d line tangent to a circle or a point and making an angle with a line. The angle is in radians. The origin of the solution is the tangency point with the first argument. Its direction is making an angle Angle with the second argument.");
