...
py::class_<ShapeAnalysis_WireVertex, std::unique_ptr<ShapeAnalysis_WireVertex, Deleter<ShapeAnalysis_WireVertex>>> cls_ShapeAnalysis_WireVertex(mod, "ShapeAnalysis_WireVertex", "Analyzes and records status of vertices in a Wire");
