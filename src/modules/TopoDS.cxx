...
// FUNCTION: HASHCODE
mod.def("HashCode", (Standard_Integer (*) (const TopoDS_Shape &, const Standard_Integer)) &HashCode, "Computes a hash code for the given shape, in the range [1, theUpperBound]", py::arg("theShape"), py::arg("theUpperBound"));
...
cls_TopoDS_TShape.def("Free", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Free, "Sets the free flag.", py::arg("theIsFree"));
cls_TopoDS_TShape.def("Locked", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Locked, "Returns the locked flag.");
cls_TopoDS_TShape.def("Locked", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Locked, "Sets the locked flag.", py::arg("theIsLocked"));
cls_TopoDS_TShape.def("Modified", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Modified, "Returns the modification flag.");
cls_TopoDS_TShape.def("Modified", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Modified, "Sets the modification flag.", py::arg("theIsModified"));
cls_TopoDS_TShape.def("Checked", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Checked, "Returns the checked flag.");
cls_TopoDS_TShape.def("Checked", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Checked, "Sets the checked flag.", py::arg("theIsChecked"));
...
cls_TopoDS_TShape.def("Orientable", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Orientable, "Sets the orientability flag.", py::arg("theIsOrientable"));
cls_TopoDS_TShape.def("Closed", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Closed, "Returns the closedness flag.");
cls_TopoDS_TShape.def("Closed", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Closed, "Sets the closedness flag.", py::arg("theIsClosed"));
cls_TopoDS_TShape.def("Infinite", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Infinite, "Returns the infinity flag.");
cls_TopoDS_TShape.def("Infinite", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Infinite, "Sets the infinity flag.", py::arg("theIsInfinite"));
cls_TopoDS_TShape.def("Convex", (Standard_Boolean (TopoDS_TShape::*)() const) &TopoDS_TShape::Convex, "Returns the convexness flag.");
cls_TopoDS_TShape.def("Convex", (void (TopoDS_TShape::*)(Standard_Boolean)) &TopoDS_TShape::Convex, "Sets the convexness flag.", py::arg("theIsConvex"));
...
cls_TopoDS_TShape.def("NbChildren", (Standard_Integer (TopoDS_TShape::*)() const) &TopoDS_TShape::NbChildren, "Returns the number of direct sub-shapes (children).");
cls_TopoDS_TShape.def("DumpJson", [](TopoDS_TShape &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_TopoDS_TShape.def("DumpJson", (void (TopoDS_TShape::*)(Standard_OStream &, const Standard_Integer) const) &TopoDS_TShape::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
cls_TopoDS_Shape.def("Location", (void (TopoDS_Shape::*)(const TopLoc_Location &)) &TopoDS_Shape::Location, "Sets the shape local coordinate system.", py::arg("theLoc"));
cls_TopoDS_Shape.def("Located", (TopoDS_Shape (TopoDS_Shape::*)(const TopLoc_Location &) const) &TopoDS_Shape::Located, "Returns a shape similar to <me> with the local coordinate system set to <Loc>.", py::arg("theLoc"));
...
cls_TopoDS_Shape.def("Orientation", (void (TopoDS_Shape::*)(TopAbs_Orientation)) &TopoDS_Shape::Orientation, "Sets the shape orientation.", py::arg("theOrient"));
cls_TopoDS_Shape.def("Oriented", (TopoDS_Shape (TopoDS_Shape::*)(TopAbs_Orientation) const) &TopoDS_Shape::Oriented, "Returns a shape similar to <me> with the orientation set to <Or>.", py::arg("theOrient"));
cls_TopoDS_Shape.def("TShape", (const opencascade::handle<TopoDS_TShape> & (TopoDS_Shape::*)() const) &TopoDS_Shape::TShape, "Returns a handle to the actual shape implementation.");
...
cls_TopoDS_Shape.def("Free", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Free, "Sets the free flag.", py::arg("theIsFree"));
cls_TopoDS_Shape.def("Locked", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Locked, "Returns the locked flag.");
cls_TopoDS_Shape.def("Locked", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Locked, "Sets the locked flag.", py::arg("theIsLocked"));
cls_TopoDS_Shape.def("Modified", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Modified, "Returns the modification flag.");
cls_TopoDS_Shape.def("Modified", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Modified, "Sets the modification flag.", py::arg("theIsModified"));
cls_TopoDS_Shape.def("Checked", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Checked, "Returns the checked flag.");
cls_TopoDS_Shape.def("Checked", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Checked, "Sets the checked flag.", py::arg("theIsChecked"));
...
cls_TopoDS_Shape.def("Orientable", (void (TopoDS_Shape::*)(const Standard_Boolean)) &TopoDS_Shape::Orientable, "Sets the orientability flag.", py::arg("theIsOrientable"));
cls_TopoDS_Shape.def("Closed", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Closed, "Returns the closedness flag.");
cls_TopoDS_Shape.def("Closed", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Closed, "Sets the closedness flag.", py::arg("theIsClosed"));
cls_TopoDS_Shape.def("Infinite", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Infinite, "Returns the infinity flag.");
cls_TopoDS_Shape.def("Infinite", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Infinite, "Sets the infinity flag.", py::arg("theIsInfinite"));
cls_TopoDS_Shape.def("Convex", (Standard_Boolean (TopoDS_Shape::*)() const) &TopoDS_Shape::Convex, "Returns the convexness flag.");
cls_TopoDS_Shape.def("Convex", (void (TopoDS_Shape::*)(Standard_Boolean)) &TopoDS_Shape::Convex, "Sets the convexness flag.", py::arg("theIsConvex"));
cls_TopoDS_Shape.def("Move", (void (TopoDS_Shape::*)(const TopLoc_Location &)) &TopoDS_Shape::Move, "Multiplies the Shape location by thePosition.", py::arg("thePosition"));
cls_TopoDS_Shape.def("Moved", (TopoDS_Shape (TopoDS_Shape::*)(const TopLoc_Location &) const) &TopoDS_Shape::Moved, "Returns a shape similar to <me> with a location multiplied by thePosition.", py::arg("thePosition"));
...
cls_TopoDS_Shape.def("Compose", (void (TopoDS_Shape::*)(TopAbs_Orientation)) &TopoDS_Shape::Compose, "Updates the Shape Orientation by composition with theOrient, using the Compose method from the TopAbs package.", py::arg("theOrient"));
cls_TopoDS_Shape.def("Composed", (TopoDS_Shape (TopoDS_Shape::*)(TopAbs_Orientation) const) &TopoDS_Shape::Composed, "Returns a shape similar to <me> with the orientation composed with theOrient, using the Compose method from the TopAbs package.", py::arg("theOrient"));
cls_TopoDS_Shape.def("NbChildren", (Standard_Integer (TopoDS_Shape::*)() const) &TopoDS_Shape::NbChildren, "Returns the number of direct sub-shapes (children).");
cls_TopoDS_Shape.def("IsPartner", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::IsPartner, "Returns True if two shapes are partners, i.e. if they share the same TShape. Locations and Orientations may differ.", py::arg("theOther"));
cls_TopoDS_Shape.def("IsSame", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::IsSame, "Returns True if two shapes are same, i.e. if they share the same TShape with the same Locations. Orientations may differ.", py::arg("theOther"));
cls_TopoDS_Shape.def("IsEqual", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::IsEqual, "Returns True if two shapes are equal, i.e. if they share the same TShape with the same Locations and Orientations.", py::arg("theOther"));
cls_TopoDS_Shape.def("__eq__", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::operator==, py::is_operator(), "None", py::arg("theOther"));
cls_TopoDS_Shape.def("IsNotEqual", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::IsNotEqual, "Negation of the IsEqual method.", py::arg("theOther"));
cls_TopoDS_Shape.def("__ne__", (Standard_Boolean (TopoDS_Shape::*)(const TopoDS_Shape &) const) &TopoDS_Shape::operator!=, py::is_operator(), "None", py::arg("theOther"));
cls_TopoDS_Shape.def("HashCode", (Standard_Integer (TopoDS_Shape::*)(Standard_Integer) const) &TopoDS_Shape::HashCode, "Returns a hashed value denoting <me>. This value is in the range [1, theUpperBound]. It is computed from the TShape and the Location. The Orientation is not used.", py::arg("theUpperBound"));
...
cls_TopoDS_Shape.def("TShape", (void (TopoDS_Shape::*)(const opencascade::handle<TopoDS_TShape> &)) &TopoDS_Shape::TShape, "None", py::arg("theTShape"));
...
cls_TopoDS_AlertWithShape.def("SetShape", (void (TopoDS_AlertWithShape::*)(const TopoDS_Shape &)) &TopoDS_AlertWithShape::SetShape, "Sets the shape", py::arg("theShape"));
