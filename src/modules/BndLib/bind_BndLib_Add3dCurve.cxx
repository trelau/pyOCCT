...
py::class_<BndLib_Add3dCurve, std::unique_ptr<BndLib_Add3dCurve, Deleter<BndLib_Add3dCurve>>> cls_BndLib_Add3dCurve(mod, "BndLib_Add3dCurve", "Computes the bounding box for a curve in 3d. Functions to add a 3D curve to a bounding box. The 3D curve is defined from a Geom curve.");
