...
py::class_<BRepMesh_OrientedEdge, std::unique_ptr<BRepMesh_OrientedEdge>> cls_BRepMesh_OrientedEdge(mod, "BRepMesh_OrientedEdge", "Light weighted structure representing simple link.");
