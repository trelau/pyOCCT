...
py::class_<BRepFilletAPI_LocalOperation, std::unique_ptr<BRepFilletAPI_LocalOperation, Deleter<BRepFilletAPI_LocalOperation>>, BRepBuilderAPI_MakeShape> cls_BRepFilletAPI_LocalOperation(mod, "BRepFilletAPI_LocalOperation", "Construction of fillets on the edges of a Shell.");
