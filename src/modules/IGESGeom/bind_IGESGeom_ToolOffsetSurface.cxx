...
void bind_IGESGeom_ToolOffsetSurface(py::module &mod){

py::class_<IGESGeom_ToolOffsetSurface, std::unique_ptr<IGESGeom_ToolOffsetSurface>> cls_IGESGeom_ToolOffsetSurface(mod, "IGESGeom_ToolOffsetSurface", "Tool to work on a OffsetSurface. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
