...
py::class_<IGESGeom_ToolSurfaceOfRevolution, std::unique_ptr<IGESGeom_ToolSurfaceOfRevolution>> cls_IGESGeom_ToolSurfaceOfRevolution(mod, "IGESGeom_ToolSurfaceOfRevolution", "Tool to work on a SurfaceOfRevolution. Called by various Modules (ReadWriteModule, GeneralModule, SpecificModule)");
