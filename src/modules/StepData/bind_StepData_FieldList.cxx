...
py::class_<StepData_FieldList, std::unique_ptr<StepData_FieldList, Deleter<StepData_FieldList>>> cls_StepData_FieldList(mod, "StepData_FieldList", "Describes a list of fields, in a general way This basic class is for a null size list Subclasses are for 1, N (fixed) or Dynamic sizes");
