...
py::class_<NCollection_Vector<Poly_CoherentTriangle>::Iterator, std::unique_ptr<NCollection_Vector<Poly_CoherentTriangle>::Iterator, Deleter<NCollection_Vector<Poly_CoherentTriangle>::Iterator>>> cls_Poly_BaseIteratorOfCoherentTriangle(mod, "Poly_BaseIteratorOfCoherentTriangle", "Nested class Iterator");
