...
// TYPEDEF: SHAPEFIX_SEQUENCEOFWIRESEGMENT
bind_NCollection_Sequence<ShapeFix_WireSegment>(mod, "ShapeFix_SequenceOfWireSegment", py::module_local(false));
...
// FIXME: Unresolved symbol cls_ShapeFix_Edge.def("Context", (opencascade::handle<ShapeBuild_ReShape> (ShapeFix_Edge::*)() const) &ShapeFix_Edge::Context, "Returns context");
...
py::class_<ShapeFix_EdgeConnect> cls_ShapeFix_EdgeConnect(mod, "ShapeFix_EdgeConnect", "Rebuilds edges to connect with new vertices, was moved from ShapeBuild. Makes vertices to be shared to connect edges, updates positions and tolerances for shared vertices. Accepts edges bounded by two vertices each.");
...
py::class_<ShapeFix_SplitTool> cls_ShapeFix_SplitTool(mod, "ShapeFix_SplitTool", "Tool for splitting and cutting edges; includes methods used in OverlappingTool and IntersectionTool");
