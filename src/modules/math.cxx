...
// CLASS: MATH_FUNCTION
py::class_<math_Function> cls_math_Function(mod, "math_Function", "This abstract class describes the virtual functions associated with a Function of a single variable.");
...
py::class_<math_DoubleTab> cls_math_DoubleTab(mod, "math_DoubleTab", "None");
...
py::class_<math_MultipleVarFunction> cls_math_MultipleVarFunction(mod, "math_MultipleVarFunction", "Describes the virtual functions associated with a multiple variable function.");
...
py::class_<math_FunctionSet> cls_math_FunctionSet(mod, "math_FunctionSet", "This abstract class describes the virtual functions associated to a set on N Functions of M independant variables.");
...
py::class_<math_MultipleVarFunctionWithHessian, math_MultipleVarFunctionWithGradient> cls_math_MultipleVarFunctionWithHessian(mod, "math_MultipleVarFunctionWithHessian", "None");
...
py::class_<math_FunctionSample> cls_math_FunctionSample(mod, "math_FunctionSample", "This class gives a default sample (constant difference of parameter) for a function defined between two bound A,B.");
...
py::class_<math_DirectPolynomialRoots> cls_math_DirectPolynomialRoots(mod, "math_DirectPolynomialRoots", "This class implements the calculation of all the real roots of a real polynomial of degree <= 4 using a direct method. Once found, the roots are polished using the Newton method.");
...
py::class_<math_ValueAndWeight> cls_math_ValueAndWeight(mod, "math_ValueAndWeight", "Simple container storing two reals: value and weight");
...
// TYPEDEF: MATH_ARRAY1OFVALUEANDWEIGHT
bind_NCollection_Array1<math_ValueAndWeight>(mod, "math_Array1OfValueAndWeight", py::module_local(false));
...
py::class_<math_BracketMinimum> cls_math_BracketMinimum(mod, "math_BracketMinimum", "Given two distinct initial points, BracketMinimum implements the computation of three points (a, b, c) which bracket the minimum of the function and verify A less than B, B less than C and F(B) less than F(A), F(B) less than F(C).");
...
py::class_<math_BrentMinimum> cls_math_BrentMinimum(mod, "math_BrentMinimum", "This class implements the Brent's method to find the minimum of a function of a single variable. No knowledge of the derivative is required.");
...
py::class_<math_BullardGenerator> cls_math_BullardGenerator(mod, "math_BullardGenerator", "Fast random number generator (the algorithm proposed by Ian C. Bullard).");
...
py::class_<math_ComputeGaussPointsAndWeights> cls_math_ComputeGaussPointsAndWeights(mod, "math_ComputeGaussPointsAndWeights", "None");
...
py::class_<math_ComputeKronrodPointsAndWeights> cls_math_ComputeKronrodPointsAndWeights(mod, "math_ComputeKronrodPointsAndWeights", "None");
...
py::class_<math_FunctionRoot> cls_math_FunctionRoot(mod, "math_FunctionRoot", "This class implements the computation of a root of a function of a single variable which is near an initial guess using a minimization algorithm.Knowledge of the derivative is required. The algorithm used is the same as in");
...
py::class_<math_FunctionRoots> cls_math_FunctionRoots(mod, "math_FunctionRoots", "This class implements an algorithm which finds all the real roots of a function with derivative within a given range. Knowledge of the derivative is required.");
...
py::class_<math_GaussSingleIntegration> cls_math_GaussSingleIntegration(mod, "math_GaussSingleIntegration", "This class implements the integration of a function of a single variable between the parameter bounds Lower and Upper. Warning: Order must be inferior or equal to 61.");
...
py::class_<math_NewtonFunctionRoot> cls_math_NewtonFunctionRoot(mod, "math_NewtonFunctionRoot", "This class implements the calculation of a root of a function of a single variable starting from an initial near guess using the Newton algorithm. Knowledge of the derivative is required.");
...
// CLASS: MATH_POWELL
py::class_<math_Powell> cls_math_Powell(mod, "math_Powell", "This class implements the Powell method to find the minimum of function of multiple variables (the gradient does not have to be known).");
...
// CLASS: MATH_PSO
py::class_<math_PSO> cls_math_PSO(mod, "math_PSO", "In this class implemented variation of Particle Swarm Optimization (PSO) method. A. Ismael F. Vaz, L. N. Vicente 'A particle swarm pattern search method for bound constrained global optimization'");
...
// CLASS: PSO_PARTICLE
py::class_<PSO_Particle> cls_PSO_Particle(mod, "PSO_Particle", "Describes particle pool for using in PSO algorithm. Indexes: 0 <= aDimidx <= myDimensionCount - 1");
...
py::class_<math_PSOParticlesPool> cls_math_PSOParticlesPool(mod, "math_PSOParticlesPool", "None");
