...
py::class_<HatchGen_PointOnElement, HatchGen_IntersectionPoint> cls_HatchGen_PointOnElement(mod, "HatchGen_PointOnElement", "None");
...
// TYPEDEF: HATCHGEN_POINTSONELEMENT
bind_NCollection_Sequence<HatchGen_PointOnElement>(mod, "HatchGen_PointsOnElement", py::module_local(false));

// CLASS: HATCHGEN_POINTONHATCHING
py::class_<HatchGen_PointOnHatching, HatchGen_IntersectionPoint> cls_HatchGen_PointOnHatching(mod, "HatchGen_PointOnHatching", "None");
...
// TYPEDEF: HATCHGEN_POINTSONHATCHING
bind_NCollection_Sequence<HatchGen_PointOnHatching>(mod, "HatchGen_PointsOnHatching", py::module_local(false));
...
// TYPEDEF: HATCHGEN_DOMAINS
bind_NCollection_Sequence<HatchGen_Domain>(mod, "HatchGen_Domains", py::module_local(false));
