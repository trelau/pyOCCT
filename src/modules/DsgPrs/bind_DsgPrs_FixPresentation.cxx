...
py::class_<DsgPrs_FixPresentation, std::unique_ptr<DsgPrs_FixPresentation, Deleter<DsgPrs_FixPresentation>>> cls_DsgPrs_FixPresentation(mod, "DsgPrs_FixPresentation", "class which draws the presentation of Fixed objects");
