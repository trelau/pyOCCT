...
py::class_<DsgPrs_ParalPresentation, std::unique_ptr<DsgPrs_ParalPresentation, Deleter<DsgPrs_ParalPresentation>>> cls_DsgPrs_ParalPresentation(mod, "DsgPrs_ParalPresentation", "A framework to define display of relations of parallelism between shapes.");
