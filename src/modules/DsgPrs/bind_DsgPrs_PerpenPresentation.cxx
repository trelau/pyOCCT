...
py::class_<DsgPrs_PerpenPresentation, std::unique_ptr<DsgPrs_PerpenPresentation, Deleter<DsgPrs_PerpenPresentation>>> cls_DsgPrs_PerpenPresentation(mod, "DsgPrs_PerpenPresentation", "A framework to define display of perpendicular constraints between shapes.");
