...
py::class_<DsgPrs_SymbPresentation, std::unique_ptr<DsgPrs_SymbPresentation, Deleter<DsgPrs_SymbPresentation>>> cls_DsgPrs_SymbPresentation(mod, "DsgPrs_SymbPresentation", "A framework to define display of symbols.");
