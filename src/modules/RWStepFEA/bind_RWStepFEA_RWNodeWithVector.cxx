...
py::class_<RWStepFEA_RWNodeWithVector, std::unique_ptr<RWStepFEA_RWNodeWithVector>> cls_RWStepFEA_RWNodeWithVector(mod, "RWStepFEA_RWNodeWithVector", "Read & Write tool for NodeWithVector");
