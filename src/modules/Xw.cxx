...
// Methods
cls_Xw_Window.def_static("VirtualKeyFromNative_", (Aspect_VKey (*)(unsigned long)) &Xw_Window::VirtualKeyFromNative, "Convert X11 virtual key (KeySym) into Aspect_VKey.", py::arg("theKey"));
