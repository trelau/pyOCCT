...
// TYPEDEF: MAT_SEQUENCEOFARC
bind_NCollection_Sequence<opencascade::handle<MAT_Arc> >(mod, "MAT_SequenceOfArc", py::module_local(false));
...
// TYPEDEF: MAT_SEQUENCEOFBASICELT
bind_NCollection_Sequence<opencascade::handle<MAT_BasicElt> >(mod, "MAT_SequenceOfBasicElt", py::module_local(false));
