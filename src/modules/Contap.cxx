...
py::class_<Contap_ContAna> cls_Contap_ContAna(mod, "Contap_ContAna", "This class provides the computation of the contours for quadric surfaces.");
...
// CLASS: CONTAP_POINT
py::class_<Contap_Point> cls_Contap_Point(mod, "Contap_Point", "Definition of a vertex on the contour line. Most of the time, such a point is an intersection between the contour and a restriction of the surface. When it is not tyhe method IsOnArc return False. Such a point is contains geometrical informations (see the Value method) and logical informations.");
...
// TYPEDEF: CONTAP_THESEQUENCEOFPOINT
...
// TYPEDEF: CONTAP_THESEQUENCEOFLINE
bind_NCollection_Sequence<Contap_Line>(mod, "Contap_TheSequenceOfLine", py::module_local(false));
...
// TYPEDEF: CONTAP_SEQUENCEOFSEGMENTOFTHESEARCH
bind_NCollection_Sequence<Contap_TheSegmentOfTheSearch>(mod, "Contap_SequenceOfSegmentOfTheSearch", py::module_local(false));

// TYPEDEF: CONTAP_SEQUENCEOFPATHPOINTOFTHESEARCH
bind_NCollection_Sequence<Contap_ThePathPointOfTheSearch>(mod, "Contap_SequenceOfPathPointOfTheSearch", py::module_local(false));

// CLASS: CONTAP_THESEARCH
py::class_<Contap_TheSearch> cls_Contap_TheSearch(mod, "Contap_TheSearch", "None");
...
py::class_<Contap_TheSearchInside> cls_Contap_TheSearchInside(mod, "Contap_TheSearchInside", "None");
...
// cls_Contap_HCurve2dTool.def_static("operator delete_", (void (*)(void *)) &Contap_HCurve2dTool::operator delete, "None", py::arg("theAddress"));
// cls_Contap_HCurve2dTool.def_static("operator new[]_", (void * (*)(size_t)) &Contap_HCurve2dTool::operator new[], "None", py::arg("theSize"));
// cls_Contap_HCurve2dTool.def_static("operator delete[]_", (void (*)(void *)) &Contap_HCurve2dTool::operator delete[], "None", py::arg("theAddress"));
// cls_Contap_HCurve2dTool.def_static("operator new_", (void * (*)(size_t, void *)) &Contap_HCurve2dTool::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_Contap_HCurve2dTool.def_static("operator delete_", (void (*)(void *, void *)) &Contap_HCurve2dTool::operator delete, "None", py::arg(""), py::arg(""));
...
cls_Contap_TheIWLineOfTheIWalking.def("PassingPoint", [](Contap_TheIWLineOfTheIWalking &self, const Standard_Integer Index, Standard_Integer & IndexLine, Standard_Integer & IndexPnts){ self.PassingPoint(Index, IndexLine, IndexPnts); return std::tuple<Standard_Integer &, Standard_Integer &>(IndexLine, IndexPnts); }, "returns the index of the point belonging to the line which is associated to the passing point belonging to Pnts1 an exception is raised if Index > NbPassingPoint()", py::arg("Index"), py::arg("IndexLine"), py::arg("IndexPnts"));
cls_Contap_TheIWLineOfTheIWalking.def("TangentVector", [](Contap_TheIWLineOfTheIWalking &self, Standard_Integer & Index){ const gp_Vec & rv = self.TangentVector(Index); return std::tuple<const gp_Vec &, Standard_Integer &>(rv, Index); }, "None", py::arg("Index"));
...
// TYPEDEF: CONTAP_SEQUENCEOFIWLINEOFTHEIWALKING
bind_NCollection_Sequence<opencascade::handle<Contap_TheIWLineOfTheIWalking> >(mod, "Contap_SequenceOfIWLineOfTheIWalking", py::module_local(false));
