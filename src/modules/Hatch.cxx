...
// TYPEDEF: HATCH_SEQUENCEOFPARAMETER
bind_NCollection_Sequence<Hatch_Parameter>(mod, "Hatch_SequenceOfParameter", py::module_local(false));
...
// TYPEDEF: HATCH_SEQUENCEOFLINE
bind_NCollection_Sequence<Hatch_Line>(mod, "Hatch_SequenceOfLine", py::module_local(false));
