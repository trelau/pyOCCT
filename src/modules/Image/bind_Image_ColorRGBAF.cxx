...
py::class_<Image_ColorRGBAF, std::unique_ptr<Image_ColorRGBAF>> cls_Image_ColorRGBAF(mod, "Image_ColorRGBAF", "POD structure for packed RGBA color value (4 floats)");
