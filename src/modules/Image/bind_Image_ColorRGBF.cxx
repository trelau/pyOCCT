...
py::class_<Image_ColorRGBF, std::unique_ptr<Image_ColorRGBF>> cls_Image_ColorRGBF(mod, "Image_ColorRGBF", "POD structure for packed float RGB color value (3 floats)");
