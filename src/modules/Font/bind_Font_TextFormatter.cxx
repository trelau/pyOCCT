...
py::class_<Font_TextFormatter, std::unique_ptr<Font_TextFormatter>> cls_Font_TextFormatter(mod, "Font_TextFormatter", "This class intended to prepare formatted text.");
