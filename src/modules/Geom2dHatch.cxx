...
py::class_<Geom2dHatch_Intersector, Geom2dInt_GInter> cls_Geom2dHatch_Intersector(mod, "Geom2dHatch_Intersector", "None");
...
py::class_<Geom2dHatch_FClass2dOfClassifier> cls_Geom2dHatch_FClass2dOfClassifier(mod, "Geom2dHatch_FClass2dOfClassifier", "None");
...
py::class_<Geom2dHatch_Classifier> cls_Geom2dHatch_Classifier(mod, "Geom2dHatch_Classifier", "None");
...
py::class_<Geom2dHatch_Element> cls_Geom2dHatch_Element(mod, "Geom2dHatch_Element", "None");
...
py::class_<NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator, NCollection_BaseMap::Iterator> cls_NCollection_DataMap_Geom2dHatch_DataMapIteratorOfMapOfElements(mod, "Geom2dHatch_DataMapIteratorOfMapOfElements", "None");
...
cls_NCollection_DataMap_Geom2dHatch_DataMapIteratorOfMapOfElements.def("Next", (void (NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::*)()) &NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::Next, "Make a step along the collection");
cls_NCollection_DataMap_Geom2dHatch_DataMapIteratorOfMapOfElements.def("Value", (const Geom2dHatch_Element & (NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::*)() const) &NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::Value, "Value inquiry");
cls_NCollection_DataMap_Geom2dHatch_DataMapIteratorOfMapOfElements.def("ChangeValue", (Geom2dHatch_Element & (NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::*)() const) &NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::ChangeValue, "Value change access");
cls_NCollection_DataMap_Geom2dHatch_DataMapIteratorOfMapOfElements.def("Key", (const int & (NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::*)() const) &NCollection_DataMap<int, Geom2dHatch_Element, NCollection_DefaultHasher<int> >::Iterator::Key, "Key");

// CLASS: GEOM2DHATCH_ELEMENTS
py::class_<Geom2dHatch_Elements> cls_Geom2dHatch_Elements(mod, "Geom2dHatch_Elements", "None");
