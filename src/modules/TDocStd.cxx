...
cls_TDocStd_Application.def("MessageDriver", (opencascade::handle<Message_Messenger> (TDocStd_Application::*)()) &TDocStd_Application::MessageDriver, "Redefines message driver, by default outputs to std::cout.");
...
// TYPEDEF: TDOCSTD_SEQUENCEOFDOCUMENT
bind_NCollection_Sequence<opencascade::handle<TDocStd_Document> >(mod, "TDocStd_SequenceOfDocument", py::module_local(false));
...
// TYPEDEF: TDOCSTD_LABELIDMAPDATAMAP
bind_NCollection_DataMap<TDF_Label, NCollection_Map<Standard_GUID, Standard_GUID>, TDF_LabelMapHasher>(mod, "TDocStd_LabelIDMapDataMap", py::module_local(false));

// TYPEDEF: TDOCSTD_DATAMAPITERATOROFLABELIDMAPDATAMAP
...
// TYPEDEF: TDOCSTD_SEQUENCEOFAPPLICATIONDELTA
bind_NCollection_Sequence<opencascade::handle<TDocStd_ApplicationDelta> >(mod, "TDocStd_SequenceOfApplicationDelta", py::module_local(false));
