...
void bind_RWStepDimTol_RWDatum(py::module &mod){

py::class_<RWStepDimTol_RWDatum, std::unique_ptr<RWStepDimTol_RWDatum>> cls_RWStepDimTol_RWDatum(mod, "RWStepDimTol_RWDatum", "Read & Write tool for Datum");
