...
py::class_<RWStepDimTol_RWDatumTarget, std::unique_ptr<RWStepDimTol_RWDatumTarget>> cls_RWStepDimTol_RWDatumTarget(mod, "RWStepDimTol_RWDatumTarget", "Read & Write tool for DatumTarget");
