...
PYBIND11_MODULE(StepSelect, mod) {
	...
	// FIXME cls_StepSelect_FloatFormat.def("Label", (TCollection_AsciiString (StepSelect_FloatFormat::*)() const ) &StepSelect_FloatFormat::Label, "Returns specific Label : for instance, 'Float Format [ZeroSuppress] %E [, in range R1-R2 %f]'");
