...
PYBIND11_MODULE(GeomAdaptor, mod) {
	...
	cls_GeomAdaptor_Surface.def("Load", [](GeomAdaptor_Surface &self, const opencascade::handle<Geom_Surface> & a0, const Standard_Real a1, const Standard_Real a2, const Standard_Real a3, const Standard_Real a4) -> void { return self.Load(a0, a1, a2, a3, a4); }, py::arg("S"), py::arg("UFirst"), py::arg("ULast"), py::arg("VFirst"), py::arg("VLast"));
	cls_GeomAdaptor_Surface.def("Load", [](GeomAdaptor_Surface &self, const opencascade::handle<Geom_Surface> & a0, const Standard_Real a1, const Standard_Real a2, const Standard_Real a3, const Standard_Real a4, const Standard_Real a5) -> void { return self.Load(a0, a1, a2, a3, a4, a5); }, py::arg("S"), py::arg("UFirst"), py::arg("ULast"), py::arg("VFirst"), py::arg("VLast"), py::arg("TolU"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_Curve.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_GHCurve.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_GHSurface.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_HSurface.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_HSurfaceOfLinearExtrusion.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_HSurfaceOfRevolution.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_HCurve.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor.hxx
	...
	cls_GeomAdaptor.def_static("MakeCurve_", (opencascade::handle<Geom_Curve> (*)(const Adaptor3d_Curve &)) &GeomAdaptor::MakeCurve, "Inherited from GHCurve. Provides a curve handled by reference. Build a Geom_Curve using the information from the Curve from Adaptor3d", py::arg("C"));
	cls_GeomAdaptor.def_static("MakeSurface_", [](const Adaptor3d_Surface & a0) -> opencascade::handle<Geom_Surface> { return GeomAdaptor::MakeSurface(a0); }, py::arg("theS"));
	cls_GeomAdaptor.def_static("MakeSurface_", (opencascade::handle<Geom_Surface> (*)(const Adaptor3d_Surface &, const Standard_Boolean)) &GeomAdaptor::MakeSurface, "Build a Geom_Surface using the information from the Surface from Adaptor3d", py::arg("theS"), py::arg("theTrimFlag"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomAdaptor_SurfaceOfLinearExtrusion.hxx
	py::class_<GeomAdaptor_SurfaceOfLinearExtrusion, std::unique_ptr<GeomAdaptor_SurfaceOfLinearExtrusion, Deleter<GeomAdaptor_SurfaceOfLinearExtrusion>>, GeomAdaptor_Surface> cls_GeomAdaptor_SurfaceOfLinearExtrusion(mod, "GeomAdaptor_SurfaceOfLinearExtrusion", "Generalised cylinder. This surface is obtained by sweeping a curve in a given direction. The parametrization range for the parameter U is defined with referenced the curve. The parametrization range for the parameter V is ]-infinite,+infinite[ The position of the curve gives the origin for the parameter V. The continuity of the surface is CN in the V direction.");
