...
PYBIND11_MODULE(FSD, mod) {
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_Character)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_ExtCharacter)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_Integer)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_Boolean)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_Real)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator<<", (Storage_BaseDriver & (FSD_BinaryFile::*)(const Standard_ShortReal)) &FSD_BinaryFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_Character &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_ExtCharacter &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_Integer &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_Boolean &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	cls_FSD_BinaryFile.def("GetReal", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_Real &)) &FSD_BinaryFile::GetReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_Real &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_BinaryFile.def("operator>>", (Storage_BaseDriver & (FSD_BinaryFile::*)(Standard_ShortReal &)) &FSD_BinaryFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_Character)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_ExtCharacter)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_Integer)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_Boolean)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	cls_FSD_CmpFile.def("PutReal", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_Real)) &FSD_CmpFile::PutReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_Real)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator<<", (Storage_BaseDriver & (FSD_CmpFile::*)(const Standard_ShortReal)) &FSD_CmpFile::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Character &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_ExtCharacter &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	cls_FSD_CmpFile.def("GetInteger", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Integer &)) &FSD_CmpFile::GetInteger, "None", py::arg("aValue"));
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Integer &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	cls_FSD_CmpFile.def("GetBoolean", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Boolean &)) &FSD_CmpFile::GetBoolean, "None", py::arg("aValue"));
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Boolean &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	cls_FSD_CmpFile.def("GetReal", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Real &)) &FSD_CmpFile::GetReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_Real &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_CmpFile.def("operator>>", (Storage_BaseDriver & (FSD_CmpFile::*)(Standard_ShortReal &)) &FSD_CmpFile::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_Character)) &FSD_File::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_ExtCharacter)) &FSD_File::operator<<, "None", py::arg("aValue"));
	cls_FSD_File.def("PutInteger", (Storage_BaseDriver & (FSD_File::*)(const Standard_Integer)) &FSD_File::PutInteger, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_Integer)) &FSD_File::operator<<, "None", py::arg("aValue"));
	cls_FSD_File.def("PutBoolean", (Storage_BaseDriver & (FSD_File::*)(const Standard_Boolean)) &FSD_File::PutBoolean, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_Boolean)) &FSD_File::operator<<, "None", py::arg("aValue"));
	cls_FSD_File.def("PutReal", (Storage_BaseDriver & (FSD_File::*)(const Standard_Real)) &FSD_File::PutReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_Real)) &FSD_File::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_File.def("operator<<", (Storage_BaseDriver & (FSD_File::*)(const Standard_ShortReal)) &FSD_File::operator<<, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_Character &)) &FSD_File::operator>>, "None", py::arg("aValue"));
	...
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_ExtCharacter &)) &FSD_File::operator>>, "None", py::arg("aValue"));
	cls_FSD_File.def("GetInteger", (Storage_BaseDriver & (FSD_File::*)(Standard_Integer &)) &FSD_File::GetInteger, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_Integer &)) &FSD_File::operator>>, "None", py::arg("aValue"));
	cls_FSD_File.def("GetBoolean", (Storage_BaseDriver & (FSD_File::*)(Standard_Boolean &)) &FSD_File::GetBoolean, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_Boolean &)) &FSD_File::operator>>, "None", py::arg("aValue"));
	cls_FSD_File.def("GetReal", (Storage_BaseDriver & (FSD_File::*)(Standard_Real &)) &FSD_File::GetReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_Real &)) &FSD_File::operator>>, "None", py::arg("aValue"));
	cls_FSD_File.def("GetShortReal", (Storage_BaseDriver & (FSD_File::*)(Standard_ShortReal &)) &FSD_File::GetShortReal, "None", py::arg("aValue"));
	// FIXME cls_FSD_File.def("operator>>", (Storage_BaseDriver & (FSD_File::*)(Standard_ShortReal &)) &FSD_File::operator>>, "None", py::arg("aValue"));
