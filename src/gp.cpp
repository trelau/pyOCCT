...
PYBIND11_MODULE(gp, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_TrsfForm.hxx
	py::enum_<gp_TrsfForm>(mod, "gp_TrsfForm", "Identifies the type of a geometric transformation.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_EulerSequence.hxx
	...
	// FUNCTIONS
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Vec2d.lxx
	mod.def("__mul__", (gp_Vec2d (*)(const Standard_Real, const gp_Vec2d &)) &operator*, py::is_operator(), "None", py::arg("Scalar"), py::arg("V"));


	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Pnt2d.hxx
	...
	cls_gp_Pnt2d.def("Coord", (void (gp_Pnt2d::*)(Standard_Real &, Standard_Real &) const ) &gp_Pnt2d::Coord, "For this point returns its two coordinates as a number pair.", py::arg("Xp"), py::arg("Yp"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Vec2d.hxx
	...
	cls_gp_Vec2d.def("Coord", (void (gp_Vec2d::*)(Standard_Real &, Standard_Real &) const ) &gp_Vec2d::Coord, "For this vector, returns its two coordinates Xv and Yv", py::arg("Xv"), py::arg("Yv"));
	...
	cls_gp_Vec2d.def("__iadd__", (void (gp_Vec2d::*)(const gp_Vec2d &)) &gp_Vec2d::operator+=, "None", py::arg("Other"));
	...
	// FIXME cls_gp_Vec2d.def("CrossSquareMagnitude", (Standard_Real (gp_Vec2d::*)(const gp_Vec2d &) const ) &gp_Vec2d::CrossSquareMagnitude, "Computes the square magnitude of the cross product between <me> and Right. Returns || <me> ^ Right ||**2", py::arg("Right"));
	cls_gp_Vec2d.def("Divide", (void (gp_Vec2d::*)(const Standard_Real)) &gp_Vec2d::Divide, "None", py::arg("Scalar"));
	cls_gp_Vec2d.def("__itruediv__", (void (gp_Vec2d::*)(const Standard_Real)) &gp_Vec2d::operator/=, "None", py::arg("Scalar"));
	...
	cls_gp_Vec2d.def("__imul__", (void (gp_Vec2d::*)(const Standard_Real)) &gp_Vec2d::operator*=, "None", py::arg("Scalar"));
	...
	cls_gp_Vec2d.def("__isub__", (void (gp_Vec2d::*)(const gp_Vec2d &)) &gp_Vec2d::operator-=, "None", py::arg("Right"));
	...
	cls_gp_Lin2d.def("Coefficients", (void (gp_Lin2d::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Lin2d::Coefficients, "Returns the normalized coefficients of the line : A * X + B * Y + C = 0.", py::arg("A"), py::arg("B"), py::arg("C"));
	...
	// FIXME cls_gp_Circ2d.def("Coefficients", (void (gp_Circ2d::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Circ2d::Coefficients, "Returns the normalized coefficients from the implicit equation of the circle : A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.0", py::arg("A"), py::arg("B"), py::arg("C"), py::arg("D"), py::arg("E"), py::arg("F"));
	...
	// FIXME cls_gp_Elips2d.def("Coefficients", (void (gp_Elips2d::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Elips2d::Coefficients, "Returns the coefficients of the implicit equation of the ellipse. A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.", py::arg("A"), py::arg("B"), py::arg("C"), py::arg("D"), py::arg("E"), py::arg("F"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Hypr2d.hxx
	...
	// FIXME cls_gp_Hypr2d.def("Coefficients", (void (gp_Hypr2d::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Hypr2d::Coefficients, "Computes the coefficients of the implicit equation of the hyperbola : A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.", py::arg("A"), py::arg("B"), py::arg("C"), py::arg("D"), py::arg("E"), py::arg("F"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Parab2d.hxx
	...
	// FIXME cls_gp_Parab2d.def("Coefficients", (void (gp_Parab2d::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Parab2d::Coefficients, "Computes the coefficients of the implicit equation of the parabola (in WCS - World Coordinate System). A * (X**2) + B * (Y**2) + 2*C*(X*Y) + 2*D*X + 2*E*Y + F = 0.", py::arg("A"), py::arg("B"), py::arg("C"), py::arg("D"), py::arg("E"), py::arg("F"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Mat2d.hxx
	...
	cls_gp_Mat2d.def("__iadd__", (void (gp_Mat2d::*)(const gp_Mat2d &)) &gp_Mat2d::operator+=, "None", py::arg("Other"));
	...
	cls_gp_Mat2d.def("__itruediv__", (void (gp_Mat2d::*)(const Standard_Real)) &gp_Mat2d::operator/=, "None", py::arg("Scalar"));
	...
	cls_gp_Mat2d.def("__imul__", (void (gp_Mat2d::*)(const Standard_Real)) &gp_Mat2d::operator*=, "None", py::arg("Scalar"));
	...
	cls_gp_Mat2d.def("__isub__", (void (gp_Mat2d::*)(const gp_Mat2d &)) &gp_Mat2d::operator-=, "None", py::arg("Other"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_XY.hxx
	...
	cls_gp_XY.def("Coord", (void (gp_XY::*)(Standard_Real &, Standard_Real &) const ) &gp_XY::Coord, "For this number pair, returns its coordinates X and Y.", py::arg("X"), py::arg("Y"));
	...
	cls_gp_XY.def("__iadd__", (void (gp_XY::*)(const gp_XY &)) &gp_XY::operator+=, "None", py::arg("Other"));
	...
	// FIXME cls_gp_XY.def("CrossSquareMagnitude", (Standard_Real (gp_XY::*)(const gp_XY &) const ) &gp_XY::CrossSquareMagnitude, "computes the square magnitude of the cross product between <me> and Right. Returns || <me> ^ Right ||**2", py::arg("Right"));
	cls_gp_XY.def("Divide", (void (gp_XY::*)(const Standard_Real)) &gp_XY::Divide, "divides <me> by a real.", py::arg("Scalar"));
	cls_gp_XY.def("__itruediv__", (void (gp_XY::*)(const Standard_Real)) &gp_XY::operator/=, "None", py::arg("Scalar"));
	...
	cls_gp_XY.def("__imul__", (void (gp_XY::*)(const Standard_Real)) &gp_XY::operator*=, "None", py::arg("Scalar"));
	cls_gp_XY.def("Multiply", (void (gp_XY::*)(const gp_XY &)) &gp_XY::Multiply, "<me>.X() = <me>.X() * Other.X(); <me>.Y() = <me>.Y() * Other.Y();", py::arg("Other"));
	cls_gp_XY.def("__imul__", (void (gp_XY::*)(const gp_XY &)) &gp_XY::operator*=, "None", py::arg("Other"));
	cls_gp_XY.def("Multiply", (void (gp_XY::*)(const gp_Mat2d &)) &gp_XY::Multiply, "<me> = Matrix * <me>", py::arg("Matrix"));
	cls_gp_XY.def("__imul__", (void (gp_XY::*)(const gp_Mat2d &)) &gp_XY::operator*=, "None", py::arg("Matrix"));
	...
	cls_gp_XY.def("__isub__", (void (gp_XY::*)(const gp_XY &)) &gp_XY::operator-=, "None", py::arg("Right"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Pnt.hxx
	...
	cls_gp_Pnt.def("Coord", (void (gp_Pnt::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Pnt::Coord, "For this point gives its three coordinates Xp, Yp and Zp.", py::arg("Xp"), py::arg("Yp"), py::arg("Zp"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Dir.hxx
	...
	cls_gp_Dir.def("Coord", (void (gp_Dir::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Dir::Coord, "Returns for the unit vector its three coordinates Xv, Yv, and Zv.", py::arg("Xv"), py::arg("Yv"), py::arg("Zv"));
	...
	// FIXME cls_gp_Dir.def("Angle", (Standard_Real (gp_Dir::*)(const gp_Dir &) const ) &gp_Dir::Angle, "Computes the angular value in radians between <me> and <Other>. This value is always positive in 3D space. Returns the angle in the range [0, PI]", py::arg("Other"));
	...
	cls_gp_Dir2d.def("Coord", (void (gp_Dir2d::*)(Standard_Real &, Standard_Real &) const ) &gp_Dir2d::Coord, "For this unit vector returns its two coordinates Xv and Yv. Raises OutOfRange if Index != {1, 2}.", py::arg("Xv"), py::arg("Yv"));
	...
	// FIXME cls_gp_Dir2d.def("Angle", (Standard_Real (gp_Dir2d::*)(const gp_Dir2d &) const ) &gp_Dir2d::Angle, "Computes the angular value in radians between <me> and <Other>. Returns the angle in the range [-PI, PI].", py::arg("Other"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Ax2d.hxx
	py::class_<gp_Ax2d, std::unique_ptr<gp_Ax2d, Deleter<gp_Ax2d>>> cls_gp_Ax2d(mod, "gp_Ax2d", "Describes an axis in the plane (2D space). An axis is defined by: - its origin (also referred to as its 'Location point'), and - its unit vector (referred to as its 'Direction'). An axis implicitly defines a direct, right-handed coordinate system in 2D space by: - its origin, - its 'Direction' (giving the 'X Direction' of the coordinate system), and - the unit vector normal to 'Direction' (positive angle measured in the trigonometric sense). An axis is used: - to describe 2D geometric entities (for example, the axis which defines angular coordinates on a circle). It serves for the same purpose as the STEP function 'axis placement one axis', or - to define geometric transformations (axis of symmetry, axis of rotation, and so on). Note: to define a left-handed 2D coordinate system, use gp_Ax22d.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_XYZ.hxx
	...
	cls_gp_XYZ.def("Coord", (void (gp_XYZ::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_XYZ::Coord, "None", py::arg("X"), py::arg("Y"), py::arg("Z"));
	...
	cls_gp_XYZ.def("__iadd__", (void (gp_XYZ::*)(const gp_XYZ &)) &gp_XYZ::operator+=, "None", py::arg("Other"));
	...
	// FIXME cls_gp_XYZ.def("CrossSquareMagnitude", (Standard_Real (gp_XYZ::*)(const gp_XYZ &) const ) &gp_XYZ::CrossSquareMagnitude, "Computes the square magnitude of the cross product between <me> and Right. Returns || <me> ^ Right ||**2", py::arg("Right"));
	...
	cls_gp_XYZ.def("__itruediv__", (void (gp_XYZ::*)(const Standard_Real)) &gp_XYZ::operator/=, "None", py::arg("Scalar"));
	...
	cls_gp_XYZ.def("__imul__", (void (gp_XYZ::*)(const Standard_Real)) &gp_XYZ::operator*=, "None", py::arg("Scalar"));
	...
	cls_gp_XYZ.def("__imul__", (void (gp_XYZ::*)(const gp_XYZ &)) &gp_XYZ::operator*=, "None", py::arg("Other"));
	cls_gp_XYZ.def("Multiply", (void (gp_XYZ::*)(const gp_Mat &)) &gp_XYZ::Multiply, "<me> = Matrix * <me>", py::arg("Matrix"));
	cls_gp_XYZ.def("__imul__", (void (gp_XYZ::*)(const gp_Mat &)) &gp_XYZ::operator*=, "None", py::arg("Matrix"));
	...
	cls_gp_XYZ.def("__isub__", (void (gp_XYZ::*)(const gp_XYZ &)) &gp_XYZ::operator-=, "None", py::arg("Right"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Mat.hxx
	...
	cls_gp_Mat.def("__iadd__", (void (gp_Mat::*)(const gp_Mat &)) &gp_Mat::operator+=, "None", py::arg("Other"));
	...
	cls_gp_Mat.def("__itruediv__", (void (gp_Mat::*)(const Standard_Real)) &gp_Mat::operator/=, "None", py::arg("Scalar"));
	...
	cls_gp_Mat.def("__imul__", (void (gp_Mat::*)(const gp_Mat &)) &gp_Mat::operator*=, "None", py::arg("Other"));
	...
	cls_gp_Mat.def("__imul__", (void (gp_Mat::*)(const Standard_Real)) &gp_Mat::operator*=, "None", py::arg("Scalar"));
	...
	cls_gp_Mat.def("__isub__", (void (gp_Mat::*)(const gp_Mat &)) &gp_Mat::operator-=, "None", py::arg("Other"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Quaternion.hxx
	...
	cls_gp_Quaternion.def(py::init([] (const gp_Quaternion &other) {return new gp_Quaternion(other);}), "Copy constructor", py::arg("other"));
	...
	cls_gp_Quaternion.def("GetVectorAndAngle", (void (gp_Quaternion::*)(gp_Vec &, Standard_Real &) const ) &gp_Quaternion::GetVectorAndAngle, "Convert a quaternion to Axis+Angle representation, preserve the axis direction and angle from -PI to +PI", py::arg("theAxis"), py::arg("theAngle"));
	...
	cls_gp_Quaternion.def("GetEulerAngles", (void (gp_Quaternion::*)(const gp_EulerSequence, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Quaternion::GetEulerAngles, "Returns Euler angles describing current rotation", py::arg("theOrder"), py::arg("theAlpha"), py::arg("theBeta"), py::arg("theGamma"));
	...
	cls_gp_Quaternion.def("__imul__", (void (gp_Quaternion::*)(const Standard_Real)) &gp_Quaternion::operator*=, "None", py::arg("theScale"));
	...
	cls_gp_Quaternion.def("__iadd__", (void (gp_Quaternion::*)(const gp_Quaternion &)) &gp_Quaternion::operator+=, "None", py::arg("theOther"));
	...
	cls_gp_Quaternion.def("__isub__", (void (gp_Quaternion::*)(const gp_Quaternion &)) &gp_Quaternion::operator-=, "None", py::arg("theOther"));
	...
	cls_gp_Quaternion.def("__imul__", (void (gp_Quaternion::*)(const gp_Quaternion &)) &gp_Quaternion::operator*=, "None", py::arg("theOther"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Trsf.hxx
	...
	cls_gp_Trsf.def("__imul__", (void (gp_Trsf::*)(const gp_Trsf &)) &gp_Trsf::operator*=, "None", py::arg("T"));
	...
	cls_gp_Trsf.def("Transforms", (void (gp_Trsf::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Trsf::Transforms, "None", py::arg("X"), py::arg("Y"), py::arg("Z"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_GTrsf.hxx
	...
	cls_gp_GTrsf.def("__imul__", (void (gp_GTrsf::*)(const gp_GTrsf &)) &gp_GTrsf::operator*=, "None", py::arg("T"));
	...
	cls_gp_GTrsf.def("Transforms", (void (gp_GTrsf::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_GTrsf::Transforms, "Transforms a triplet XYZ with a GTrsf.", py::arg("X"), py::arg("Y"), py::arg("Z"));
	cls_gp_GTrsf.def("Trsf", (gp_Trsf (gp_GTrsf::*)() const ) &gp_GTrsf::Trsf, "None");

	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Vec.hxx
	...
	cls_gp_Vec.def("Coord", (void (gp_Vec::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Vec::Coord, "For this vector returns its three coordinates Xv, Yv, and Zvinline", py::arg("Xv"), py::arg("Yv"), py::arg("Zv"));
	...
	cls_gp_Vec.def("__iadd__", (void (gp_Vec::*)(const gp_Vec &)) &gp_Vec::operator+=, "None", py::arg("Other"));
	...
	cls_gp_Vec.def("__isub__", (void (gp_Vec::*)(const gp_Vec &)) &gp_Vec::operator-=, "None", py::arg("Right"));
	...
	cls_gp_Vec.def("__imul__", (void (gp_Vec::*)(const Standard_Real)) &gp_Vec::operator*=, "None", py::arg("Scalar"));
	...
	cls_gp_Vec.def("__itruediv__", (void (gp_Vec::*)(const Standard_Real)) &gp_Vec::operator/=, "None", py::arg("Scalar"));
	...
	// FIXME cls_gp_Vec.def("CrossSquareMagnitude", (Standard_Real (gp_Vec::*)(const gp_Vec &) const ) &gp_Vec::CrossSquareMagnitude, "Computes the square magnitude of the cross product between <me> and Right. Returns || <me> ^ Right ||**2", py::arg("Right"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Lin.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Circ.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Elips.hxx
	...
	cls_gp_Pln.def("Coefficients", (void (gp_Pln::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Pln::Coefficients, "Returns the coefficients of the plane's cartesian equation : A * X + B * Y + C * Z + D = 0.", py::arg("A"), py::arg("B"), py::arg("C"), py::arg("D"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Cylinder.hxx
	...
	// FIXME cls_gp_Cylinder.def("Coefficients", (void (gp_Cylinder::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Cylinder::Coefficients, "Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinate system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0", py::arg("A1"), py::arg("A2"), py::arg("A3"), py::arg("B1"), py::arg("B2"), py::arg("B3"), py::arg("C1"), py::arg("C2"), py::arg("C3"), py::arg("D"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Sphere.hxx
	...
	// FIXME cls_gp_Sphere.def("Coefficients", (void (gp_Sphere::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Sphere::Coefficients, "Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinates system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0", py::arg("A1"), py::arg("A2"), py::arg("A3"), py::arg("B1"), py::arg("B2"), py::arg("B3"), py::arg("C1"), py::arg("C2"), py::arg("C3"), py::arg("D"));
	...
	// FIXME cls_gp_Cone.def("Coefficients", (void (gp_Cone::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &gp_Cone::Coefficients, "Computes the coefficients of the implicit equation of the quadric in the absolute cartesian coordinates system : A1.X**2 + A2.Y**2 + A3.Z**2 + 2.(B1.X.Y + B2.X.Z + B3.Y.Z) + 2.(C1.X + C2.Y + C3.Z) + D = 0.0", py::arg("A1"), py::arg("A2"), py::arg("A3"), py::arg("B1"), py::arg("B2"), py::arg("B3"), py::arg("C1"), py::arg("C2"), py::arg("C3"), py::arg("D"));
	...
	cls_gp_Trsf2d.def("__imul__", (void (gp_Trsf2d::*)(const gp_Trsf2d &)) &gp_Trsf2d::operator*=, "None", py::arg("T"));
	...
	cls_gp_Trsf2d.def("Transforms", (void (gp_Trsf2d::*)(Standard_Real &, Standard_Real &) const ) &gp_Trsf2d::Transforms, "None", py::arg("X"), py::arg("Y"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_GTrsf2d.hxx
	...
	cls_gp_GTrsf2d.def("__imul__", (void (gp_GTrsf2d::*)(const gp_GTrsf2d &)) &gp_GTrsf2d::operator*=, "None", py::arg("T"));
	...
	cls_gp_GTrsf2d.def("Transforms", (void (gp_GTrsf2d::*)(Standard_Real &, Standard_Real &) const ) &gp_GTrsf2d::Transforms, "Applies this transformation to the coordinates: - of the number pair Coord, or - X and Y.", py::arg("X"), py::arg("Y"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_Ax22d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_VectorWithNullMagnitude.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_QuaternionNLerp.hxx
	py::class_<gp_QuaternionNLerp, std::unique_ptr<gp_QuaternionNLerp, Deleter<gp_QuaternionNLerp>>> cls_gp_QuaternionNLerp(mod, "gp_QuaternionNLerp", "Class perform linear interpolation (approximate rotation interpolation), result quaternion nonunit, its length lay between. sqrt(2)/2 and 1.0");
	...
	py::class_<NCollection_Lerp<gp_Trsf>, std::unique_ptr<NCollection_Lerp<gp_Trsf>, Deleter<NCollection_Lerp<gp_Trsf>>>> cls_NCollection_Lerp_gp_Trsf(mod, "NCollection_Lerp_gp_Trsf", "Linear interpolation tool for transformation defined by gp_Trsf.");
	cls_NCollection_Lerp_gp_Trsf.def(py::init<>());
	cls_NCollection_Lerp_gp_Trsf.def(py::init<const gp_Trsf &, const gp_Trsf &>(), py::arg("theStart"), py::arg("theEnd"));
	cls_NCollection_Lerp_gp_Trsf.def("Init", (void (NCollection_Lerp<gp_Trsf>::*)(const gp_Trsf &, const gp_Trsf &)) &NCollection_Lerp<gp_Trsf>::Init, "Initialize values.", py::arg("theStart"), py::arg("theEnd"));
	cls_NCollection_Lerp_gp_Trsf.def("Interpolate", (void (NCollection_Lerp<gp_Trsf>::*)(double, gp_Trsf &) const ) &NCollection_Lerp<gp_Trsf>::Interpolate, "Compute interpolated value between two values.", py::arg("theT"), py::arg("theResult"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\gp_QuaternionSLerp.hxx
