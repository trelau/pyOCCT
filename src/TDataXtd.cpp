...
PYBIND11_MODULE(TDataXtd, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_GeometryEnum.hxx
	py::enum_<TDataXtd_GeometryEnum>(mod, "TDataXtd_GeometryEnum", "The terms of this enumeration define the types of geometric shapes available.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_ConstraintEnum.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Shape.hxx
	...
	// FIXME cls_TDataXtd_Shape.def("Dump", (Standard_OStream & (TDataXtd_Shape::*)(Standard_OStream &) const ) &TDataXtd_Shape::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Point.hxx
	...
	// FIXME cls_TDataXtd_Point.def("Dump", (Standard_OStream & (TDataXtd_Point::*)(Standard_OStream &) const ) &TDataXtd_Point::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Axis.hxx
	...
	// FIXME cls_TDataXtd_Axis.def("Dump", (Standard_OStream & (TDataXtd_Axis::*)(Standard_OStream &) const ) &TDataXtd_Axis::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Plane.hxx
	...
	// FIXME cls_TDataXtd_Plane.def("Dump", (Standard_OStream & (TDataXtd_Plane::*)(Standard_OStream &) const ) &TDataXtd_Plane::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Placement.hxx
	...
	// FIXME cls_TDataXtd_Placement.def("Dump", (Standard_OStream & (TDataXtd_Placement::*)(Standard_OStream &) const ) &TDataXtd_Placement::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Geometry.hxx
	...
	// FIXME cls_TDataXtd_Geometry.def("Dump", (Standard_OStream & (TDataXtd_Geometry::*)(Standard_OStream &) const ) &TDataXtd_Geometry::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Position.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Constraint.hxx
	...
	// FIXME cls_TDataXtd_Constraint.def("Dump", (Standard_OStream & (TDataXtd_Constraint::*)(Standard_OStream &) const ) &TDataXtd_Constraint::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Pattern.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_PatternStd.hxx
	...
	// FIXME cls_TDataXtd_PatternStd.def("Dump", (Standard_OStream & (TDataXtd_PatternStd::*)(Standard_OStream &) const ) &TDataXtd_PatternStd::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Presentation.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd_Triangulation.hxx
	...
	// FIXME cls_TDataXtd_Triangulation.def("Dump", (Standard_OStream & (TDataXtd_Triangulation::*)(Standard_OStream &) const ) &TDataXtd_Triangulation::Dump, "None", py::arg("anOS"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\TDataXtd.hxx
