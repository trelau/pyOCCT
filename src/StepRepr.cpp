...
PYBIND11_MODULE(StepRepr, mod) {
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_Array1OfMaterialPropertyRepresentation.hxx
	bind_NCollection_Array1<opencascade::handle<StepRepr_MaterialPropertyRepresentation> >(mod, "StepRepr_Array1OfMaterialPropertyRepresentation");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_Array1OfRepresentationItem.hxx
	bind_NCollection_Array1<opencascade::handle<StepRepr_RepresentationItem> >(mod, "StepRepr_Array1OfRepresentationItem");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_Array1OfShapeAspect.hxx
	bind_NCollection_Array1<opencascade::handle<StepRepr_ShapeAspect> >(mod, "StepRepr_Array1OfShapeAspect");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_Array1OfPropertyDefinitionRepresentation.hxx
	bind_NCollection_Array1<opencascade::handle<StepRepr_PropertyDefinitionRepresentation> >(mod, "StepRepr_Array1OfPropertyDefinitionRepresentation");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_SequenceOfMaterialPropertyRepresentation.hxx
	bind_NCollection_Sequence<opencascade::handle<StepRepr_MaterialPropertyRepresentation> >(mod, "StepRepr_SequenceOfMaterialPropertyRepresentation");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepRepr_SequenceOfRepresentationItem.hxx
	bind_NCollection_Sequence<opencascade::handle<StepRepr_RepresentationItem> >(mod, "StepRepr_SequenceOfRepresentationItem");
