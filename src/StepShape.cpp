...
PYBIND11_MODULE(StepShape, mod) {
	...
	py::class_<StepShape_Array1OfFaceBound, std::unique_ptr<StepShape_Array1OfFaceBound, Deleter<StepShape_Array1OfFaceBound>>> cls_StepShape_Array1OfFaceBound(mod, "StepShape_Array1OfFaceBound", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfFaceBound.def(py::init<>());
	cls_StepShape_Array1OfFaceBound.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfFaceBound.def(py::init([] (const StepShape_Array1OfFaceBound &other) {return new StepShape_Array1OfFaceBound(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfFaceBound.def(py::init<StepShape_Array1OfFaceBound &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfFaceBound.def(py::init<const opencascade::handle<StepShape_FaceBound> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfFaceBound.def("begin", (StepShape_Array1OfFaceBound::iterator (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfFaceBound.def("end", (StepShape_Array1OfFaceBound::iterator (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfFaceBound.def("cbegin", (StepShape_Array1OfFaceBound::const_iterator (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfFaceBound.def("cend", (StepShape_Array1OfFaceBound::const_iterator (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfFaceBound.def("Init", (void (StepShape_Array1OfFaceBound::*)(const opencascade::handle<StepShape_FaceBound> &)) &StepShape_Array1OfFaceBound::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfFaceBound.def("Size", (Standard_Integer (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::Size, "Size query");
	cls_StepShape_Array1OfFaceBound.def("Length", (Standard_Integer (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::Length, "Length query (the same)");
	cls_StepShape_Array1OfFaceBound.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfFaceBound.def("Lower", (Standard_Integer (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::Lower, "Lower bound");
	cls_StepShape_Array1OfFaceBound.def("Upper", (Standard_Integer (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::Upper, "Upper bound");
	cls_StepShape_Array1OfFaceBound.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfFaceBound.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfFaceBound.def("Assign", (StepShape_Array1OfFaceBound & (StepShape_Array1OfFaceBound::*)(const StepShape_Array1OfFaceBound &)) &StepShape_Array1OfFaceBound::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfFaceBound.def("Move", (StepShape_Array1OfFaceBound & (StepShape_Array1OfFaceBound::*)(StepShape_Array1OfFaceBound &&)) &StepShape_Array1OfFaceBound::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfFaceBound.def("assign", (StepShape_Array1OfFaceBound & (StepShape_Array1OfFaceBound::*)(const StepShape_Array1OfFaceBound &)) &StepShape_Array1OfFaceBound::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfFaceBound.def("assign", (StepShape_Array1OfFaceBound & (StepShape_Array1OfFaceBound::*)(StepShape_Array1OfFaceBound &&)) &StepShape_Array1OfFaceBound::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfFaceBound.def("First", (const opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::First, "Returns first element");
	cls_StepShape_Array1OfFaceBound.def("ChangeFirst", (opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)()) &StepShape_Array1OfFaceBound::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfFaceBound.def("Last", (const opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)() const ) &StepShape_Array1OfFaceBound::Last, "Returns last element");
	cls_StepShape_Array1OfFaceBound.def("ChangeLast", (opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)()) &StepShape_Array1OfFaceBound::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfFaceBound.def("Value", (const opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)(const Standard_Integer) const ) &StepShape_Array1OfFaceBound::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfFaceBound.def("__call__", (const opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)(const Standard_Integer) const ) &StepShape_Array1OfFaceBound::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfFaceBound.def("ChangeValue", (opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)(const Standard_Integer)) &StepShape_Array1OfFaceBound::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfFaceBound.def("__call__", (opencascade::handle<StepShape_FaceBound> & (StepShape_Array1OfFaceBound::*)(const Standard_Integer)) &StepShape_Array1OfFaceBound::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfFaceBound.def("SetValue", (void (StepShape_Array1OfFaceBound::*)(const Standard_Integer, const opencascade::handle<StepShape_FaceBound> &)) &StepShape_Array1OfFaceBound::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfFaceBound.def("Resize", (void (StepShape_Array1OfFaceBound::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfFaceBound::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfFaceBound.def("__iter__", [](const StepShape_Array1OfFaceBound &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfEdge, std::unique_ptr<StepShape_Array1OfEdge, Deleter<StepShape_Array1OfEdge>>> cls_StepShape_Array1OfEdge(mod, "StepShape_Array1OfEdge", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfEdge.def(py::init<>());
	cls_StepShape_Array1OfEdge.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfEdge.def(py::init([] (const StepShape_Array1OfEdge &other) {return new StepShape_Array1OfEdge(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfEdge.def(py::init<StepShape_Array1OfEdge &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfEdge.def(py::init<const opencascade::handle<StepShape_Edge> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfEdge.def("begin", (StepShape_Array1OfEdge::iterator (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfEdge.def("end", (StepShape_Array1OfEdge::iterator (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfEdge.def("cbegin", (StepShape_Array1OfEdge::const_iterator (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfEdge.def("cend", (StepShape_Array1OfEdge::const_iterator (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfEdge.def("Init", (void (StepShape_Array1OfEdge::*)(const opencascade::handle<StepShape_Edge> &)) &StepShape_Array1OfEdge::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfEdge.def("Size", (Standard_Integer (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::Size, "Size query");
	cls_StepShape_Array1OfEdge.def("Length", (Standard_Integer (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::Length, "Length query (the same)");
	cls_StepShape_Array1OfEdge.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfEdge.def("Lower", (Standard_Integer (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::Lower, "Lower bound");
	cls_StepShape_Array1OfEdge.def("Upper", (Standard_Integer (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::Upper, "Upper bound");
	cls_StepShape_Array1OfEdge.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfEdge.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfEdge.def("Assign", (StepShape_Array1OfEdge & (StepShape_Array1OfEdge::*)(const StepShape_Array1OfEdge &)) &StepShape_Array1OfEdge::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfEdge.def("Move", (StepShape_Array1OfEdge & (StepShape_Array1OfEdge::*)(StepShape_Array1OfEdge &&)) &StepShape_Array1OfEdge::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfEdge.def("assign", (StepShape_Array1OfEdge & (StepShape_Array1OfEdge::*)(const StepShape_Array1OfEdge &)) &StepShape_Array1OfEdge::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfEdge.def("assign", (StepShape_Array1OfEdge & (StepShape_Array1OfEdge::*)(StepShape_Array1OfEdge &&)) &StepShape_Array1OfEdge::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfEdge.def("First", (const opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::First, "Returns first element");
	cls_StepShape_Array1OfEdge.def("ChangeFirst", (opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)()) &StepShape_Array1OfEdge::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfEdge.def("Last", (const opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)() const ) &StepShape_Array1OfEdge::Last, "Returns last element");
	cls_StepShape_Array1OfEdge.def("ChangeLast", (opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)()) &StepShape_Array1OfEdge::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfEdge.def("Value", (const opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)(const Standard_Integer) const ) &StepShape_Array1OfEdge::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfEdge.def("__call__", (const opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)(const Standard_Integer) const ) &StepShape_Array1OfEdge::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfEdge.def("ChangeValue", (opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)(const Standard_Integer)) &StepShape_Array1OfEdge::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfEdge.def("__call__", (opencascade::handle<StepShape_Edge> & (StepShape_Array1OfEdge::*)(const Standard_Integer)) &StepShape_Array1OfEdge::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfEdge.def("SetValue", (void (StepShape_Array1OfEdge::*)(const Standard_Integer, const opencascade::handle<StepShape_Edge> &)) &StepShape_Array1OfEdge::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfEdge.def("Resize", (void (StepShape_Array1OfEdge::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfEdge::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfEdge.def("__iter__", [](const StepShape_Array1OfEdge &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfFace, std::unique_ptr<StepShape_Array1OfFace, Deleter<StepShape_Array1OfFace>>> cls_StepShape_Array1OfFace(mod, "StepShape_Array1OfFace", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfFace.def(py::init<>());
	cls_StepShape_Array1OfFace.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfFace.def(py::init([] (const StepShape_Array1OfFace &other) {return new StepShape_Array1OfFace(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfFace.def(py::init<StepShape_Array1OfFace &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfFace.def(py::init<const opencascade::handle<StepShape_Face> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfFace.def("begin", (StepShape_Array1OfFace::iterator (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfFace.def("end", (StepShape_Array1OfFace::iterator (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfFace.def("cbegin", (StepShape_Array1OfFace::const_iterator (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfFace.def("cend", (StepShape_Array1OfFace::const_iterator (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfFace.def("Init", (void (StepShape_Array1OfFace::*)(const opencascade::handle<StepShape_Face> &)) &StepShape_Array1OfFace::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfFace.def("Size", (Standard_Integer (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::Size, "Size query");
	cls_StepShape_Array1OfFace.def("Length", (Standard_Integer (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::Length, "Length query (the same)");
	cls_StepShape_Array1OfFace.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfFace.def("Lower", (Standard_Integer (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::Lower, "Lower bound");
	cls_StepShape_Array1OfFace.def("Upper", (Standard_Integer (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::Upper, "Upper bound");
	cls_StepShape_Array1OfFace.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfFace.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfFace.def("Assign", (StepShape_Array1OfFace & (StepShape_Array1OfFace::*)(const StepShape_Array1OfFace &)) &StepShape_Array1OfFace::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfFace.def("Move", (StepShape_Array1OfFace & (StepShape_Array1OfFace::*)(StepShape_Array1OfFace &&)) &StepShape_Array1OfFace::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfFace.def("assign", (StepShape_Array1OfFace & (StepShape_Array1OfFace::*)(const StepShape_Array1OfFace &)) &StepShape_Array1OfFace::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfFace.def("assign", (StepShape_Array1OfFace & (StepShape_Array1OfFace::*)(StepShape_Array1OfFace &&)) &StepShape_Array1OfFace::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfFace.def("First", (const opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::First, "Returns first element");
	cls_StepShape_Array1OfFace.def("ChangeFirst", (opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)()) &StepShape_Array1OfFace::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfFace.def("Last", (const opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)() const ) &StepShape_Array1OfFace::Last, "Returns last element");
	cls_StepShape_Array1OfFace.def("ChangeLast", (opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)()) &StepShape_Array1OfFace::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfFace.def("Value", (const opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)(const Standard_Integer) const ) &StepShape_Array1OfFace::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfFace.def("__call__", (const opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)(const Standard_Integer) const ) &StepShape_Array1OfFace::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfFace.def("ChangeValue", (opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)(const Standard_Integer)) &StepShape_Array1OfFace::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfFace.def("__call__", (opencascade::handle<StepShape_Face> & (StepShape_Array1OfFace::*)(const Standard_Integer)) &StepShape_Array1OfFace::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfFace.def("SetValue", (void (StepShape_Array1OfFace::*)(const Standard_Integer, const opencascade::handle<StepShape_Face> &)) &StepShape_Array1OfFace::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfFace.def("Resize", (void (StepShape_Array1OfFace::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfFace::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfFace.def("__iter__", [](const StepShape_Array1OfFace &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfOrientedClosedShell, std::unique_ptr<StepShape_Array1OfOrientedClosedShell, Deleter<StepShape_Array1OfOrientedClosedShell>>> cls_StepShape_Array1OfOrientedClosedShell(mod, "StepShape_Array1OfOrientedClosedShell", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfOrientedClosedShell.def(py::init<>());
	cls_StepShape_Array1OfOrientedClosedShell.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfOrientedClosedShell.def(py::init([] (const StepShape_Array1OfOrientedClosedShell &other) {return new StepShape_Array1OfOrientedClosedShell(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfOrientedClosedShell.def(py::init<StepShape_Array1OfOrientedClosedShell &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfOrientedClosedShell.def(py::init<const opencascade::handle<StepShape_OrientedClosedShell> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfOrientedClosedShell.def("begin", (StepShape_Array1OfOrientedClosedShell::iterator (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfOrientedClosedShell.def("end", (StepShape_Array1OfOrientedClosedShell::iterator (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfOrientedClosedShell.def("cbegin", (StepShape_Array1OfOrientedClosedShell::const_iterator (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfOrientedClosedShell.def("cend", (StepShape_Array1OfOrientedClosedShell::const_iterator (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfOrientedClosedShell.def("Init", (void (StepShape_Array1OfOrientedClosedShell::*)(const opencascade::handle<StepShape_OrientedClosedShell> &)) &StepShape_Array1OfOrientedClosedShell::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfOrientedClosedShell.def("Size", (Standard_Integer (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::Size, "Size query");
	cls_StepShape_Array1OfOrientedClosedShell.def("Length", (Standard_Integer (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::Length, "Length query (the same)");
	cls_StepShape_Array1OfOrientedClosedShell.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfOrientedClosedShell.def("Lower", (Standard_Integer (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::Lower, "Lower bound");
	cls_StepShape_Array1OfOrientedClosedShell.def("Upper", (Standard_Integer (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::Upper, "Upper bound");
	cls_StepShape_Array1OfOrientedClosedShell.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfOrientedClosedShell.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfOrientedClosedShell.def("Assign", (StepShape_Array1OfOrientedClosedShell & (StepShape_Array1OfOrientedClosedShell::*)(const StepShape_Array1OfOrientedClosedShell &)) &StepShape_Array1OfOrientedClosedShell::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfOrientedClosedShell.def("Move", (StepShape_Array1OfOrientedClosedShell & (StepShape_Array1OfOrientedClosedShell::*)(StepShape_Array1OfOrientedClosedShell &&)) &StepShape_Array1OfOrientedClosedShell::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfOrientedClosedShell.def("assign", (StepShape_Array1OfOrientedClosedShell & (StepShape_Array1OfOrientedClosedShell::*)(const StepShape_Array1OfOrientedClosedShell &)) &StepShape_Array1OfOrientedClosedShell::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfOrientedClosedShell.def("assign", (StepShape_Array1OfOrientedClosedShell & (StepShape_Array1OfOrientedClosedShell::*)(StepShape_Array1OfOrientedClosedShell &&)) &StepShape_Array1OfOrientedClosedShell::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfOrientedClosedShell.def("First", (const opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::First, "Returns first element");
	cls_StepShape_Array1OfOrientedClosedShell.def("ChangeFirst", (opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)()) &StepShape_Array1OfOrientedClosedShell::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfOrientedClosedShell.def("Last", (const opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)() const ) &StepShape_Array1OfOrientedClosedShell::Last, "Returns last element");
	cls_StepShape_Array1OfOrientedClosedShell.def("ChangeLast", (opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)()) &StepShape_Array1OfOrientedClosedShell::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfOrientedClosedShell.def("Value", (const opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer) const ) &StepShape_Array1OfOrientedClosedShell::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedClosedShell.def("__call__", (const opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer) const ) &StepShape_Array1OfOrientedClosedShell::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedClosedShell.def("ChangeValue", (opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer)) &StepShape_Array1OfOrientedClosedShell::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedClosedShell.def("__call__", (opencascade::handle<StepShape_OrientedClosedShell> & (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer)) &StepShape_Array1OfOrientedClosedShell::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedClosedShell.def("SetValue", (void (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer, const opencascade::handle<StepShape_OrientedClosedShell> &)) &StepShape_Array1OfOrientedClosedShell::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfOrientedClosedShell.def("Resize", (void (StepShape_Array1OfOrientedClosedShell::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfOrientedClosedShell::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfOrientedClosedShell.def("__iter__", [](const StepShape_Array1OfOrientedClosedShell &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfConnectedEdgeSet, std::unique_ptr<StepShape_Array1OfConnectedEdgeSet, Deleter<StepShape_Array1OfConnectedEdgeSet>>> cls_StepShape_Array1OfConnectedEdgeSet(mod, "StepShape_Array1OfConnectedEdgeSet", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfConnectedEdgeSet.def(py::init<>());
	cls_StepShape_Array1OfConnectedEdgeSet.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfConnectedEdgeSet.def(py::init([] (const StepShape_Array1OfConnectedEdgeSet &other) {return new StepShape_Array1OfConnectedEdgeSet(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfConnectedEdgeSet.def(py::init<StepShape_Array1OfConnectedEdgeSet &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfConnectedEdgeSet.def(py::init<const opencascade::handle<StepShape_ConnectedEdgeSet> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("begin", (StepShape_Array1OfConnectedEdgeSet::iterator (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfConnectedEdgeSet.def("end", (StepShape_Array1OfConnectedEdgeSet::iterator (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfConnectedEdgeSet.def("cbegin", (StepShape_Array1OfConnectedEdgeSet::const_iterator (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfConnectedEdgeSet.def("cend", (StepShape_Array1OfConnectedEdgeSet::const_iterator (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Init", (void (StepShape_Array1OfConnectedEdgeSet::*)(const opencascade::handle<StepShape_ConnectedEdgeSet> &)) &StepShape_Array1OfConnectedEdgeSet::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("Size", (Standard_Integer (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::Size, "Size query");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Length", (Standard_Integer (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::Length, "Length query (the same)");
	cls_StepShape_Array1OfConnectedEdgeSet.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Lower", (Standard_Integer (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::Lower, "Lower bound");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Upper", (Standard_Integer (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::Upper, "Upper bound");
	cls_StepShape_Array1OfConnectedEdgeSet.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfConnectedEdgeSet.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Assign", (StepShape_Array1OfConnectedEdgeSet & (StepShape_Array1OfConnectedEdgeSet::*)(const StepShape_Array1OfConnectedEdgeSet &)) &StepShape_Array1OfConnectedEdgeSet::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfConnectedEdgeSet.def("Move", (StepShape_Array1OfConnectedEdgeSet & (StepShape_Array1OfConnectedEdgeSet::*)(StepShape_Array1OfConnectedEdgeSet &&)) &StepShape_Array1OfConnectedEdgeSet::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("assign", (StepShape_Array1OfConnectedEdgeSet & (StepShape_Array1OfConnectedEdgeSet::*)(const StepShape_Array1OfConnectedEdgeSet &)) &StepShape_Array1OfConnectedEdgeSet::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfConnectedEdgeSet.def("assign", (StepShape_Array1OfConnectedEdgeSet & (StepShape_Array1OfConnectedEdgeSet::*)(StepShape_Array1OfConnectedEdgeSet &&)) &StepShape_Array1OfConnectedEdgeSet::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("First", (const opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::First, "Returns first element");
	cls_StepShape_Array1OfConnectedEdgeSet.def("ChangeFirst", (opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)()) &StepShape_Array1OfConnectedEdgeSet::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Last", (const opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)() const ) &StepShape_Array1OfConnectedEdgeSet::Last, "Returns last element");
	cls_StepShape_Array1OfConnectedEdgeSet.def("ChangeLast", (opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)()) &StepShape_Array1OfConnectedEdgeSet::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfConnectedEdgeSet.def("Value", (const opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer) const ) &StepShape_Array1OfConnectedEdgeSet::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("__call__", (const opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer) const ) &StepShape_Array1OfConnectedEdgeSet::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("ChangeValue", (opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer)) &StepShape_Array1OfConnectedEdgeSet::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("__call__", (opencascade::handle<StepShape_ConnectedEdgeSet> & (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer)) &StepShape_Array1OfConnectedEdgeSet::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("SetValue", (void (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer, const opencascade::handle<StepShape_ConnectedEdgeSet> &)) &StepShape_Array1OfConnectedEdgeSet::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("Resize", (void (StepShape_Array1OfConnectedEdgeSet::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfConnectedEdgeSet::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfConnectedEdgeSet.def("__iter__", [](const StepShape_Array1OfConnectedEdgeSet &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfOrientedEdge, std::unique_ptr<StepShape_Array1OfOrientedEdge, Deleter<StepShape_Array1OfOrientedEdge>>> cls_StepShape_Array1OfOrientedEdge(mod, "StepShape_Array1OfOrientedEdge", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfOrientedEdge.def(py::init<>());
	cls_StepShape_Array1OfOrientedEdge.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfOrientedEdge.def(py::init([] (const StepShape_Array1OfOrientedEdge &other) {return new StepShape_Array1OfOrientedEdge(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfOrientedEdge.def(py::init<StepShape_Array1OfOrientedEdge &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfOrientedEdge.def(py::init<const opencascade::handle<StepShape_OrientedEdge> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfOrientedEdge.def("begin", (StepShape_Array1OfOrientedEdge::iterator (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfOrientedEdge.def("end", (StepShape_Array1OfOrientedEdge::iterator (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfOrientedEdge.def("cbegin", (StepShape_Array1OfOrientedEdge::const_iterator (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfOrientedEdge.def("cend", (StepShape_Array1OfOrientedEdge::const_iterator (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfOrientedEdge.def("Init", (void (StepShape_Array1OfOrientedEdge::*)(const opencascade::handle<StepShape_OrientedEdge> &)) &StepShape_Array1OfOrientedEdge::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfOrientedEdge.def("Size", (Standard_Integer (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::Size, "Size query");
	cls_StepShape_Array1OfOrientedEdge.def("Length", (Standard_Integer (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::Length, "Length query (the same)");
	cls_StepShape_Array1OfOrientedEdge.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfOrientedEdge.def("Lower", (Standard_Integer (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::Lower, "Lower bound");
	cls_StepShape_Array1OfOrientedEdge.def("Upper", (Standard_Integer (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::Upper, "Upper bound");
	cls_StepShape_Array1OfOrientedEdge.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfOrientedEdge.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfOrientedEdge.def("Assign", (StepShape_Array1OfOrientedEdge & (StepShape_Array1OfOrientedEdge::*)(const StepShape_Array1OfOrientedEdge &)) &StepShape_Array1OfOrientedEdge::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfOrientedEdge.def("Move", (StepShape_Array1OfOrientedEdge & (StepShape_Array1OfOrientedEdge::*)(StepShape_Array1OfOrientedEdge &&)) &StepShape_Array1OfOrientedEdge::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfOrientedEdge.def("assign", (StepShape_Array1OfOrientedEdge & (StepShape_Array1OfOrientedEdge::*)(const StepShape_Array1OfOrientedEdge &)) &StepShape_Array1OfOrientedEdge::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfOrientedEdge.def("assign", (StepShape_Array1OfOrientedEdge & (StepShape_Array1OfOrientedEdge::*)(StepShape_Array1OfOrientedEdge &&)) &StepShape_Array1OfOrientedEdge::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfOrientedEdge.def("First", (const opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::First, "Returns first element");
	cls_StepShape_Array1OfOrientedEdge.def("ChangeFirst", (opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)()) &StepShape_Array1OfOrientedEdge::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfOrientedEdge.def("Last", (const opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)() const ) &StepShape_Array1OfOrientedEdge::Last, "Returns last element");
	cls_StepShape_Array1OfOrientedEdge.def("ChangeLast", (opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)()) &StepShape_Array1OfOrientedEdge::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfOrientedEdge.def("Value", (const opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer) const ) &StepShape_Array1OfOrientedEdge::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedEdge.def("__call__", (const opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer) const ) &StepShape_Array1OfOrientedEdge::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedEdge.def("ChangeValue", (opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer)) &StepShape_Array1OfOrientedEdge::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedEdge.def("__call__", (opencascade::handle<StepShape_OrientedEdge> & (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer)) &StepShape_Array1OfOrientedEdge::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfOrientedEdge.def("SetValue", (void (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer, const opencascade::handle<StepShape_OrientedEdge> &)) &StepShape_Array1OfOrientedEdge::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfOrientedEdge.def("Resize", (void (StepShape_Array1OfOrientedEdge::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfOrientedEdge::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfOrientedEdge.def("__iter__", [](const StepShape_Array1OfOrientedEdge &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfConnectedFaceSet, std::unique_ptr<StepShape_Array1OfConnectedFaceSet, Deleter<StepShape_Array1OfConnectedFaceSet>>> cls_StepShape_Array1OfConnectedFaceSet(mod, "StepShape_Array1OfConnectedFaceSet", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfConnectedFaceSet.def(py::init<>());
	cls_StepShape_Array1OfConnectedFaceSet.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfConnectedFaceSet.def(py::init([] (const StepShape_Array1OfConnectedFaceSet &other) {return new StepShape_Array1OfConnectedFaceSet(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfConnectedFaceSet.def(py::init<StepShape_Array1OfConnectedFaceSet &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfConnectedFaceSet.def(py::init<const opencascade::handle<StepShape_ConnectedFaceSet> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfConnectedFaceSet.def("begin", (StepShape_Array1OfConnectedFaceSet::iterator (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfConnectedFaceSet.def("end", (StepShape_Array1OfConnectedFaceSet::iterator (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfConnectedFaceSet.def("cbegin", (StepShape_Array1OfConnectedFaceSet::const_iterator (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfConnectedFaceSet.def("cend", (StepShape_Array1OfConnectedFaceSet::const_iterator (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfConnectedFaceSet.def("Init", (void (StepShape_Array1OfConnectedFaceSet::*)(const opencascade::handle<StepShape_ConnectedFaceSet> &)) &StepShape_Array1OfConnectedFaceSet::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfConnectedFaceSet.def("Size", (Standard_Integer (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::Size, "Size query");
	cls_StepShape_Array1OfConnectedFaceSet.def("Length", (Standard_Integer (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::Length, "Length query (the same)");
	cls_StepShape_Array1OfConnectedFaceSet.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfConnectedFaceSet.def("Lower", (Standard_Integer (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::Lower, "Lower bound");
	cls_StepShape_Array1OfConnectedFaceSet.def("Upper", (Standard_Integer (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::Upper, "Upper bound");
	cls_StepShape_Array1OfConnectedFaceSet.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfConnectedFaceSet.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfConnectedFaceSet.def("Assign", (StepShape_Array1OfConnectedFaceSet & (StepShape_Array1OfConnectedFaceSet::*)(const StepShape_Array1OfConnectedFaceSet &)) &StepShape_Array1OfConnectedFaceSet::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfConnectedFaceSet.def("Move", (StepShape_Array1OfConnectedFaceSet & (StepShape_Array1OfConnectedFaceSet::*)(StepShape_Array1OfConnectedFaceSet &&)) &StepShape_Array1OfConnectedFaceSet::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfConnectedFaceSet.def("assign", (StepShape_Array1OfConnectedFaceSet & (StepShape_Array1OfConnectedFaceSet::*)(const StepShape_Array1OfConnectedFaceSet &)) &StepShape_Array1OfConnectedFaceSet::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfConnectedFaceSet.def("assign", (StepShape_Array1OfConnectedFaceSet & (StepShape_Array1OfConnectedFaceSet::*)(StepShape_Array1OfConnectedFaceSet &&)) &StepShape_Array1OfConnectedFaceSet::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfConnectedFaceSet.def("First", (const opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::First, "Returns first element");
	cls_StepShape_Array1OfConnectedFaceSet.def("ChangeFirst", (opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)()) &StepShape_Array1OfConnectedFaceSet::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfConnectedFaceSet.def("Last", (const opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)() const ) &StepShape_Array1OfConnectedFaceSet::Last, "Returns last element");
	cls_StepShape_Array1OfConnectedFaceSet.def("ChangeLast", (opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)()) &StepShape_Array1OfConnectedFaceSet::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfConnectedFaceSet.def("Value", (const opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer) const ) &StepShape_Array1OfConnectedFaceSet::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedFaceSet.def("__call__", (const opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer) const ) &StepShape_Array1OfConnectedFaceSet::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedFaceSet.def("ChangeValue", (opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer)) &StepShape_Array1OfConnectedFaceSet::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedFaceSet.def("__call__", (opencascade::handle<StepShape_ConnectedFaceSet> & (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer)) &StepShape_Array1OfConnectedFaceSet::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfConnectedFaceSet.def("SetValue", (void (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer, const opencascade::handle<StepShape_ConnectedFaceSet> &)) &StepShape_Array1OfConnectedFaceSet::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfConnectedFaceSet.def("Resize", (void (StepShape_Array1OfConnectedFaceSet::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfConnectedFaceSet::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfConnectedFaceSet.def("__iter__", [](const StepShape_Array1OfConnectedFaceSet &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfGeometricSetSelect, std::unique_ptr<StepShape_Array1OfGeometricSetSelect, Deleter<StepShape_Array1OfGeometricSetSelect>>> cls_StepShape_Array1OfGeometricSetSelect(mod, "StepShape_Array1OfGeometricSetSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfGeometricSetSelect.def(py::init<>());
	cls_StepShape_Array1OfGeometricSetSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfGeometricSetSelect.def(py::init([] (const StepShape_Array1OfGeometricSetSelect &other) {return new StepShape_Array1OfGeometricSetSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfGeometricSetSelect.def(py::init<StepShape_Array1OfGeometricSetSelect &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfGeometricSetSelect.def(py::init<const StepShape_GeometricSetSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfGeometricSetSelect.def("begin", (StepShape_Array1OfGeometricSetSelect::iterator (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfGeometricSetSelect.def("end", (StepShape_Array1OfGeometricSetSelect::iterator (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfGeometricSetSelect.def("cbegin", (StepShape_Array1OfGeometricSetSelect::const_iterator (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfGeometricSetSelect.def("cend", (StepShape_Array1OfGeometricSetSelect::const_iterator (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfGeometricSetSelect.def("Init", (void (StepShape_Array1OfGeometricSetSelect::*)(const StepShape_GeometricSetSelect &)) &StepShape_Array1OfGeometricSetSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfGeometricSetSelect.def("Size", (Standard_Integer (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::Size, "Size query");
	cls_StepShape_Array1OfGeometricSetSelect.def("Length", (Standard_Integer (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::Length, "Length query (the same)");
	cls_StepShape_Array1OfGeometricSetSelect.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfGeometricSetSelect.def("Lower", (Standard_Integer (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::Lower, "Lower bound");
	cls_StepShape_Array1OfGeometricSetSelect.def("Upper", (Standard_Integer (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::Upper, "Upper bound");
	cls_StepShape_Array1OfGeometricSetSelect.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfGeometricSetSelect.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfGeometricSetSelect.def("Assign", (StepShape_Array1OfGeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const StepShape_Array1OfGeometricSetSelect &)) &StepShape_Array1OfGeometricSetSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfGeometricSetSelect.def("Move", (StepShape_Array1OfGeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(StepShape_Array1OfGeometricSetSelect &&)) &StepShape_Array1OfGeometricSetSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfGeometricSetSelect.def("assign", (StepShape_Array1OfGeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const StepShape_Array1OfGeometricSetSelect &)) &StepShape_Array1OfGeometricSetSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfGeometricSetSelect.def("assign", (StepShape_Array1OfGeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(StepShape_Array1OfGeometricSetSelect &&)) &StepShape_Array1OfGeometricSetSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfGeometricSetSelect.def("First", (const StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::First, "Returns first element");
	cls_StepShape_Array1OfGeometricSetSelect.def("ChangeFirst", (StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)()) &StepShape_Array1OfGeometricSetSelect::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfGeometricSetSelect.def("Last", (const StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)() const ) &StepShape_Array1OfGeometricSetSelect::Last, "Returns last element");
	cls_StepShape_Array1OfGeometricSetSelect.def("ChangeLast", (StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)()) &StepShape_Array1OfGeometricSetSelect::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfGeometricSetSelect.def("Value", (const StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer) const ) &StepShape_Array1OfGeometricSetSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfGeometricSetSelect.def("__call__", (const StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer) const ) &StepShape_Array1OfGeometricSetSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfGeometricSetSelect.def("ChangeValue", (StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer)) &StepShape_Array1OfGeometricSetSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfGeometricSetSelect.def("__call__", (StepShape_GeometricSetSelect & (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer)) &StepShape_Array1OfGeometricSetSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfGeometricSetSelect.def("SetValue", (void (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer, const StepShape_GeometricSetSelect &)) &StepShape_Array1OfGeometricSetSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfGeometricSetSelect.def("Resize", (void (StepShape_Array1OfGeometricSetSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfGeometricSetSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfGeometricSetSelect.def("__iter__", [](const StepShape_Array1OfGeometricSetSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfShapeDimensionRepresentationItem, std::unique_ptr<StepShape_Array1OfShapeDimensionRepresentationItem, Deleter<StepShape_Array1OfShapeDimensionRepresentationItem>>> cls_StepShape_Array1OfShapeDimensionRepresentationItem(mod, "StepShape_Array1OfShapeDimensionRepresentationItem", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def(py::init<>());
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def(py::init([] (const StepShape_Array1OfShapeDimensionRepresentationItem &other) {return new StepShape_Array1OfShapeDimensionRepresentationItem(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfShapeDimensionRepresentationItem.def(py::init<StepShape_Array1OfShapeDimensionRepresentationItem &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def(py::init<const StepShape_ShapeDimensionRepresentationItem &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("begin", (StepShape_Array1OfShapeDimensionRepresentationItem::iterator (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("end", (StepShape_Array1OfShapeDimensionRepresentationItem::iterator (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("cbegin", (StepShape_Array1OfShapeDimensionRepresentationItem::const_iterator (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("cend", (StepShape_Array1OfShapeDimensionRepresentationItem::const_iterator (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Init", (void (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const StepShape_ShapeDimensionRepresentationItem &)) &StepShape_Array1OfShapeDimensionRepresentationItem::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Size", (Standard_Integer (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Size, "Size query");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Length", (Standard_Integer (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Length, "Length query (the same)");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Lower", (Standard_Integer (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Lower, "Lower bound");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Upper", (Standard_Integer (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Upper, "Upper bound");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Assign", (StepShape_Array1OfShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const StepShape_Array1OfShapeDimensionRepresentationItem &)) &StepShape_Array1OfShapeDimensionRepresentationItem::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Move", (StepShape_Array1OfShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(StepShape_Array1OfShapeDimensionRepresentationItem &&)) &StepShape_Array1OfShapeDimensionRepresentationItem::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("assign", (StepShape_Array1OfShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const StepShape_Array1OfShapeDimensionRepresentationItem &)) &StepShape_Array1OfShapeDimensionRepresentationItem::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("assign", (StepShape_Array1OfShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(StepShape_Array1OfShapeDimensionRepresentationItem &&)) &StepShape_Array1OfShapeDimensionRepresentationItem::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("First", (const StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::First, "Returns first element");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("ChangeFirst", (StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)()) &StepShape_Array1OfShapeDimensionRepresentationItem::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Last", (const StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)() const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Last, "Returns last element");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("ChangeLast", (StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)()) &StepShape_Array1OfShapeDimensionRepresentationItem::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Value", (const StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer) const ) &StepShape_Array1OfShapeDimensionRepresentationItem::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("__call__", (const StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer) const ) &StepShape_Array1OfShapeDimensionRepresentationItem::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("ChangeValue", (StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer)) &StepShape_Array1OfShapeDimensionRepresentationItem::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("__call__", (StepShape_ShapeDimensionRepresentationItem & (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer)) &StepShape_Array1OfShapeDimensionRepresentationItem::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("SetValue", (void (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer, const StepShape_ShapeDimensionRepresentationItem &)) &StepShape_Array1OfShapeDimensionRepresentationItem::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("Resize", (void (StepShape_Array1OfShapeDimensionRepresentationItem::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfShapeDimensionRepresentationItem::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfShapeDimensionRepresentationItem.def("__iter__", [](const StepShape_Array1OfShapeDimensionRepresentationItem &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfShell, std::unique_ptr<StepShape_Array1OfShell, Deleter<StepShape_Array1OfShell>>> cls_StepShape_Array1OfShell(mod, "StepShape_Array1OfShell", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfShell.def(py::init<>());
	cls_StepShape_Array1OfShell.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfShell.def(py::init([] (const StepShape_Array1OfShell &other) {return new StepShape_Array1OfShell(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfShell.def(py::init<StepShape_Array1OfShell &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfShell.def(py::init<const StepShape_Shell &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfShell.def("begin", (StepShape_Array1OfShell::iterator (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfShell.def("end", (StepShape_Array1OfShell::iterator (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfShell.def("cbegin", (StepShape_Array1OfShell::const_iterator (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfShell.def("cend", (StepShape_Array1OfShell::const_iterator (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfShell.def("Init", (void (StepShape_Array1OfShell::*)(const StepShape_Shell &)) &StepShape_Array1OfShell::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfShell.def("Size", (Standard_Integer (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::Size, "Size query");
	cls_StepShape_Array1OfShell.def("Length", (Standard_Integer (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::Length, "Length query (the same)");
	cls_StepShape_Array1OfShell.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfShell.def("Lower", (Standard_Integer (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::Lower, "Lower bound");
	cls_StepShape_Array1OfShell.def("Upper", (Standard_Integer (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::Upper, "Upper bound");
	cls_StepShape_Array1OfShell.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfShell.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfShell.def("Assign", (StepShape_Array1OfShell & (StepShape_Array1OfShell::*)(const StepShape_Array1OfShell &)) &StepShape_Array1OfShell::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfShell.def("Move", (StepShape_Array1OfShell & (StepShape_Array1OfShell::*)(StepShape_Array1OfShell &&)) &StepShape_Array1OfShell::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfShell.def("assign", (StepShape_Array1OfShell & (StepShape_Array1OfShell::*)(const StepShape_Array1OfShell &)) &StepShape_Array1OfShell::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfShell.def("assign", (StepShape_Array1OfShell & (StepShape_Array1OfShell::*)(StepShape_Array1OfShell &&)) &StepShape_Array1OfShell::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfShell.def("First", (const StepShape_Shell & (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::First, "Returns first element");
	cls_StepShape_Array1OfShell.def("ChangeFirst", (StepShape_Shell & (StepShape_Array1OfShell::*)()) &StepShape_Array1OfShell::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfShell.def("Last", (const StepShape_Shell & (StepShape_Array1OfShell::*)() const ) &StepShape_Array1OfShell::Last, "Returns last element");
	cls_StepShape_Array1OfShell.def("ChangeLast", (StepShape_Shell & (StepShape_Array1OfShell::*)()) &StepShape_Array1OfShell::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfShell.def("Value", (const StepShape_Shell & (StepShape_Array1OfShell::*)(const Standard_Integer) const ) &StepShape_Array1OfShell::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfShell.def("__call__", (const StepShape_Shell & (StepShape_Array1OfShell::*)(const Standard_Integer) const ) &StepShape_Array1OfShell::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfShell.def("ChangeValue", (StepShape_Shell & (StepShape_Array1OfShell::*)(const Standard_Integer)) &StepShape_Array1OfShell::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfShell.def("__call__", (StepShape_Shell & (StepShape_Array1OfShell::*)(const Standard_Integer)) &StepShape_Array1OfShell::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfShell.def("SetValue", (void (StepShape_Array1OfShell::*)(const Standard_Integer, const StepShape_Shell &)) &StepShape_Array1OfShell::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfShell.def("Resize", (void (StepShape_Array1OfShell::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfShell::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfShell.def("__iter__", [](const StepShape_Array1OfShell &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepShape_Array1OfValueQualifier, std::unique_ptr<StepShape_Array1OfValueQualifier, Deleter<StepShape_Array1OfValueQualifier>>> cls_StepShape_Array1OfValueQualifier(mod, "StepShape_Array1OfValueQualifier", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepShape_Array1OfValueQualifier.def(py::init<>());
	cls_StepShape_Array1OfValueQualifier.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfValueQualifier.def(py::init([] (const StepShape_Array1OfValueQualifier &other) {return new StepShape_Array1OfValueQualifier(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepShape_Array1OfValueQualifier.def(py::init<StepShape_Array1OfValueQualifier &&>(), py::arg("theOther"));
	cls_StepShape_Array1OfValueQualifier.def(py::init<const StepShape_ValueQualifier &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepShape_Array1OfValueQualifier.def("begin", (StepShape_Array1OfValueQualifier::iterator (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfValueQualifier.def("end", (StepShape_Array1OfValueQualifier::iterator (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfValueQualifier.def("cbegin", (StepShape_Array1OfValueQualifier::const_iterator (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepShape_Array1OfValueQualifier.def("cend", (StepShape_Array1OfValueQualifier::const_iterator (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepShape_Array1OfValueQualifier.def("Init", (void (StepShape_Array1OfValueQualifier::*)(const StepShape_ValueQualifier &)) &StepShape_Array1OfValueQualifier::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepShape_Array1OfValueQualifier.def("Size", (Standard_Integer (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::Size, "Size query");
	cls_StepShape_Array1OfValueQualifier.def("Length", (Standard_Integer (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::Length, "Length query (the same)");
	cls_StepShape_Array1OfValueQualifier.def("IsEmpty", (Standard_Boolean (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepShape_Array1OfValueQualifier.def("Lower", (Standard_Integer (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::Lower, "Lower bound");
	cls_StepShape_Array1OfValueQualifier.def("Upper", (Standard_Integer (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::Upper, "Upper bound");
	cls_StepShape_Array1OfValueQualifier.def("IsDeletable", (Standard_Boolean (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::IsDeletable, "myDeletable flag");
	cls_StepShape_Array1OfValueQualifier.def("IsAllocated", (Standard_Boolean (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepShape_Array1OfValueQualifier.def("Assign", (StepShape_Array1OfValueQualifier & (StepShape_Array1OfValueQualifier::*)(const StepShape_Array1OfValueQualifier &)) &StepShape_Array1OfValueQualifier::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfValueQualifier.def("Move", (StepShape_Array1OfValueQualifier & (StepShape_Array1OfValueQualifier::*)(StepShape_Array1OfValueQualifier &&)) &StepShape_Array1OfValueQualifier::Move, "Move assignment", py::arg("theOther"));
	cls_StepShape_Array1OfValueQualifier.def("assign", (StepShape_Array1OfValueQualifier & (StepShape_Array1OfValueQualifier::*)(const StepShape_Array1OfValueQualifier &)) &StepShape_Array1OfValueQualifier::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepShape_Array1OfValueQualifier.def("assign", (StepShape_Array1OfValueQualifier & (StepShape_Array1OfValueQualifier::*)(StepShape_Array1OfValueQualifier &&)) &StepShape_Array1OfValueQualifier::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepShape_Array1OfValueQualifier.def("First", (const StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::First, "Returns first element");
	cls_StepShape_Array1OfValueQualifier.def("ChangeFirst", (StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)()) &StepShape_Array1OfValueQualifier::ChangeFirst, "Returns first element");
	cls_StepShape_Array1OfValueQualifier.def("Last", (const StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)() const ) &StepShape_Array1OfValueQualifier::Last, "Returns last element");
	cls_StepShape_Array1OfValueQualifier.def("ChangeLast", (StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)()) &StepShape_Array1OfValueQualifier::ChangeLast, "Returns last element");
	cls_StepShape_Array1OfValueQualifier.def("Value", (const StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)(const Standard_Integer) const ) &StepShape_Array1OfValueQualifier::Value, "Constant value access", py::arg("theIndex"));
	cls_StepShape_Array1OfValueQualifier.def("__call__", (const StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)(const Standard_Integer) const ) &StepShape_Array1OfValueQualifier::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepShape_Array1OfValueQualifier.def("ChangeValue", (StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)(const Standard_Integer)) &StepShape_Array1OfValueQualifier::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepShape_Array1OfValueQualifier.def("__call__", (StepShape_ValueQualifier & (StepShape_Array1OfValueQualifier::*)(const Standard_Integer)) &StepShape_Array1OfValueQualifier::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepShape_Array1OfValueQualifier.def("SetValue", (void (StepShape_Array1OfValueQualifier::*)(const Standard_Integer, const StepShape_ValueQualifier &)) &StepShape_Array1OfValueQualifier::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepShape_Array1OfValueQualifier.def("Resize", (void (StepShape_Array1OfValueQualifier::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepShape_Array1OfValueQualifier::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepShape_Array1OfValueQualifier.def("__iter__", [](const StepShape_Array1OfValueQualifier &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
