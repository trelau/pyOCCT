...
PYBIND11_MODULE(CDF, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_TypeOfActivation.hxx
	py::enum_<CDF_TypeOfActivation>(mod, "CDF_TypeOfActivation", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_TryStoreStatus.hxx
	py::enum_<CDF_TryStoreStatus>(mod, "CDF_TryStoreStatus", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_StoreSetNameStatus.hxx
	py::enum_<CDF_StoreSetNameStatus>(mod, "CDF_StoreSetNameStatus", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_SubComponentStatus.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_Session.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_Application.hxx
	...
	cls_CDF_Application.def("Retrieve", [](CDF_Application &self, const TCollection_ExtendedString & a0, const TCollection_ExtendedString & a1) -> opencascade::handle<CDM_Document> { return self.Retrieve(a0, a1); }, py::arg("aFolder"), py::arg("aName"));
	...
	cls_CDF_Application.def("Retrieve", [](CDF_Application &self, const TCollection_ExtendedString & a0, const TCollection_ExtendedString & a1, const TCollection_ExtendedString & a2) -> opencascade::handle<CDM_Document> { return self.Retrieve(a0, a1, a2); }, py::arg("aFolder"), py::arg("aName"), py::arg("aVersion"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_Directory.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_DirectoryIterator.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_StoreList.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_Store.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_MetaDataDriver.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_FWOSDriver.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_MetaDataDriverFactory.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF.hxx
	py::class_<CDF, std::unique_ptr<CDF, Deleter<CDF>>> cls_CDF(mod, "CDF", "None");
	cls_CDF.def(py::init<>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\CDF_MetaDataDriverError.hxx
