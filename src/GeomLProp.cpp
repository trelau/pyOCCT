...
PYBIND11_MODULE(GeomLProp, mod) {
	...
	cls_GeomLProp_SurfaceTool.def_static("Bounds_", (void (*)(const opencascade::handle<Geom_Surface> &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &)) &GeomLProp_SurfaceTool::Bounds, "returns the bounds of the Surface.", py::arg("S"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"));
