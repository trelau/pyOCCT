...
PYBIND11_MODULE(Storage, mod) {
	...
	cls_Storage_HeaderData.def("NumberOfObjects", (Standard_Integer (Storage_HeaderData::*)() const ) &Storage_HeaderData::NumberOfObjects, "the number of persistent objects Return: the number of persistent objects read");
	...
	cls_Storage_Data.def("NumberOfObjects", (Standard_Integer (Storage_Data::*)() const ) &Storage_Data::NumberOfObjects, "the number of persistent objects Return: the number of persistent objects read");
