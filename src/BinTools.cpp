...
PYBIND11_MODULE(BinTools, mod) {
	...
	cls_BinTools.def_static("GetReal_", (Standard_IStream & (*)(Standard_IStream &, Standard_Real &)) &BinTools::GetReal, "None", py::arg("IS"), py::arg("theValue"));
	cls_BinTools.def_static("GetInteger_", (Standard_IStream & (*)(Standard_IStream &, Standard_Integer &)) &BinTools::GetInteger, "None", py::arg("IS"), py::arg("theValue"));
	cls_BinTools.def_static("GetBool_", (Standard_IStream & (*)(Standard_IStream &, Standard_Boolean &)) &BinTools::GetBool, "None", py::arg("IS"), py::arg("theValue"));
