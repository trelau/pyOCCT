...
PYBIND11_MODULE(gce, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_ErrorType.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_Root.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeCirc.hxx
	py::class_<gce_MakeCirc, std::unique_ptr<gce_MakeCirc, Deleter<gce_MakeCirc>>, gce_Root> cls_gce_MakeCirc(mod, "gce_MakeCirc", "This class implements the following algorithms used to create Circ from gp.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeCirc2d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeCone.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeDir2d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeElips.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeElips2d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeHypr.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeHypr2d.hxx
	py::class_<gce_MakeHypr2d, std::unique_ptr<gce_MakeHypr2d, Deleter<gce_MakeHypr2d>>, gce_Root> cls_gce_MakeHypr2d(mod, "gce_MakeHypr2d", "This class implements the following algorithms used to create a 2d Hyperbola from gp. * Create a 2d Hyperbola from its center and two points: one on its axis of symmetry giving the major radius, the other giving the value of the small radius. * Create a 2d Hyperbola from its major axis and its major radius and its minor radius.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeLin.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeLin2d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeMirror.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeMirror2d.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeParab.hxx
	py::class_<gce_MakeParab, std::unique_ptr<gce_MakeParab, Deleter<gce_MakeParab>>, gce_Root> cls_gce_MakeParab(mod, "gce_MakeParab", "This class implements the following algorithms used to create Parab from gp. Defines the parabola in the parameterization range : ]-infinite, +infinite[ The vertex of the parabola is the 'Location' point of the local coordinate system (axis placement) of the parabola.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakePln.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeRotation.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeRotation2d.hxx
	py::class_<gce_MakeRotation2d, std::unique_ptr<gce_MakeRotation2d, Deleter<gce_MakeRotation2d>>> cls_gce_MakeRotation2d(mod, "gce_MakeRotation2d", "Implements an elementary construction algorithm for a rotation in 2D space. The result is a gp_Trsf2d transformation. A MakeRotation2d object provides a framework for: - defining the construction of the transformation, - implementing the construction algorithm, and - consulting the result.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeScale.hxx
	py::class_<gce_MakeScale, std::unique_ptr<gce_MakeScale, Deleter<gce_MakeScale>>> cls_gce_MakeScale(mod, "gce_MakeScale", "Implements an elementary construction algorithm for a scaling transformation in 3D space. The result is a gp_Trsf transformation. A MakeScale object provides a framework for: - defining the construction of the transformation, - implementing the construction algorithm, and - consulting the result.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeTranslation.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\gce_MakeTranslation2d.hxx
