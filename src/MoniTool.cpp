...
PYBIND11_MODULE(MoniTool, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_ValueType.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_SignText.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_TypedValue.hxx
	...
	// FIXME cls_MoniTool_TypedValue.def("Internals", (void (MoniTool_TypedValue::*)(MoniTool_ValueInterpret &, MoniTool_ValueSatisfies &, Standard_CString &, NCollection_DataMap<TCollection_AsciiString, Standard_Integer> &) const ) &MoniTool_TypedValue::Internals, "Access to internal data which have no other access", py::arg("interp"), py::arg("satisf"), py::arg("satisname"), py::arg("enums"));
	...
	cls_MoniTool_TypedValue.def("IntegerLimit", (Standard_Boolean (MoniTool_TypedValue::*)(const Standard_Boolean, Standard_Integer &) const ) &MoniTool_TypedValue::IntegerLimit, "Gives an Integer Limit (upper if <max> True, lower if <max> False). Returns True if this limit is defined, False else (in that case, gives the natural limit for Integer)", py::arg("max"), py::arg("val"));
	...
	cls_MoniTool_TypedValue.def("RealLimit", (Standard_Boolean (MoniTool_TypedValue::*)(const Standard_Boolean, Standard_Real &) const ) &MoniTool_TypedValue::RealLimit, "Gives an Real Limit (upper if <max> True, lower if <max> False). Returns True if this limit is defined, False else (in that case, gives the natural limit for Real)", py::arg("max"), py::arg("val"));
	...
	cls_MoniTool_TypedValue.def("StartEnum", [](MoniTool_TypedValue &self, const Standard_Integer a0) -> void { return self.StartEnum(a0); }, py::arg("start"));
	...
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0) -> void { return self.AddEnum(a0); }, py::arg("v1"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1) -> void { return self.AddEnum(a0, a1); }, py::arg("v1"), py::arg("v2"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2) -> void { return self.AddEnum(a0, a1, a2); }, py::arg("v1"), py::arg("v2"), py::arg("v3"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3) -> void { return self.AddEnum(a0, a1, a2, a3); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3, const Standard_CString a4) -> void { return self.AddEnum(a0, a1, a2, a3, a4); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"), py::arg("v5"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3, const Standard_CString a4, const Standard_CString a5) -> void { return self.AddEnum(a0, a1, a2, a3, a4, a5); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"), py::arg("v5"), py::arg("v6"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3, const Standard_CString a4, const Standard_CString a5, const Standard_CString a6) -> void { return self.AddEnum(a0, a1, a2, a3, a4, a5, a6); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"), py::arg("v5"), py::arg("v6"), py::arg("v7"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3, const Standard_CString a4, const Standard_CString a5, const Standard_CString a6, const Standard_CString a7) -> void { return self.AddEnum(a0, a1, a2, a3, a4, a5, a6, a7); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"), py::arg("v5"), py::arg("v6"), py::arg("v7"), py::arg("v8"));
	cls_MoniTool_TypedValue.def("AddEnum", [](MoniTool_TypedValue &self, const Standard_CString a0, const Standard_CString a1, const Standard_CString a2, const Standard_CString a3, const Standard_CString a4, const Standard_CString a5, const Standard_CString a6, const Standard_CString a7, const Standard_CString a8) -> void { return self.AddEnum(a0, a1, a2, a3, a4, a5, a6, a7, a8); }, py::arg("v1"), py::arg("v2"), py::arg("v3"), py::arg("v4"), py::arg("v5"), py::arg("v6"), py::arg("v7"), py::arg("v8"), py::arg("v9"));
	...
	cls_MoniTool_TypedValue.def("EnumDef", (Standard_Boolean (MoniTool_TypedValue::*)(Standard_Integer &, Standard_Integer &, Standard_Boolean &) const ) &MoniTool_TypedValue::EnumDef, "Gives the Enum definitions : start value, end value, match status. Returns True for an Enum, False else.", py::arg("startcase"), py::arg("endcase"), py::arg("match"));
	...
	cls_MoniTool_TypedValue.def_static("AddLib_", [](const opencascade::handle<MoniTool_TypedValue> & a0) -> Standard_Boolean { return MoniTool_TypedValue::AddLib(a0); }, py::arg("tv"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_AttrList.hxx
	py::class_<MoniTool_AttrList, std::unique_ptr<MoniTool_AttrList, Deleter<MoniTool_AttrList>>> cls_MoniTool_AttrList(mod, "MoniTool_AttrList", "a AttrList allows to record a list of attributes as Transients which can be edited, changed ... Each one is identified by a name");
	cls_MoniTool_AttrList.def(py::init<>());
	cls_MoniTool_AttrList.def(py::init([] (const MoniTool_AttrList &other) {return new MoniTool_AttrList(other);}), "Copy constructor", py::arg("other"));
	...
	cls_MoniTool_AttrList.def("GetIntegerAttribute", (Standard_Boolean (MoniTool_AttrList::*)(const Standard_CString, Standard_Integer &) const ) &MoniTool_AttrList::GetIntegerAttribute, "Returns an attribute from its name, as integer If no attribute has this name, or not an integer, <val> is 0 and returned value is False Else, it is True", py::arg("name"), py::arg("val"));
	...
	cls_MoniTool_AttrList.def("GetRealAttribute", (Standard_Boolean (MoniTool_AttrList::*)(const Standard_CString, Standard_Real &) const ) &MoniTool_AttrList::GetRealAttribute, "Returns an attribute from its name, as real If no attribute has this name, or not a real <val> is 0.0 and returned value is False Else, it is True", py::arg("name"), py::arg("val"));
	...
	// FIXME cls_MoniTool_AttrList.def("GetStringAttribute", (Standard_Boolean (MoniTool_AttrList::*)(const Standard_CString, Standard_CString &) const ) &MoniTool_AttrList::GetStringAttribute, "Returns an attribute from its name, as String If no attribute has this name, or not a String <val> is 0.0 and returned value is False Else, it is True", py::arg("name"), py::arg("val"));
	...
	cls_MoniTool_AttrList.def("GetAttributes", [](MoniTool_AttrList &self, const MoniTool_AttrList & a0) -> void { return self.GetAttributes(a0); }, py::arg("other"));
	cls_MoniTool_AttrList.def("GetAttributes", [](MoniTool_AttrList &self, const MoniTool_AttrList & a0, const Standard_CString a1) -> void { return self.GetAttributes(a0, a1); }, py::arg("other"), py::arg("fromname"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_CaseData.hxx
	...
	cls_MoniTool_CaseData.def("AddData", [](MoniTool_CaseData &self, const opencascade::handle<Standard_Transient> & a0, const Standard_Integer a1) -> void { return self.AddData(a0, a1); }, py::arg("val"), py::arg("kind"));
	...
	cls_MoniTool_CaseData.def("AddRaised", [](MoniTool_CaseData &self, const opencascade::handle<Standard_Failure> & a0) -> void { return self.AddRaised(a0); }, py::arg("theException"));
	...
	cls_MoniTool_CaseData.def("AddShape", [](MoniTool_CaseData &self, const TopoDS_Shape & a0) -> void { return self.AddShape(a0); }, py::arg("sh"));
	...
	cls_MoniTool_CaseData.def("AddXYZ", [](MoniTool_CaseData &self, const gp_XYZ & a0) -> void { return self.AddXYZ(a0); }, py::arg("aXYZ"));
	...
	cls_MoniTool_CaseData.def("AddXY", [](MoniTool_CaseData &self, const gp_XY & a0) -> void { return self.AddXY(a0); }, py::arg("aXY"));
	...
	cls_MoniTool_CaseData.def("AddReal", [](MoniTool_CaseData &self, const Standard_Real a0) -> void { return self.AddReal(a0); }, py::arg("val"));
	...
	cls_MoniTool_CaseData.def("AddReals", [](MoniTool_CaseData &self, const Standard_Real a0, const Standard_Real a1) -> void { return self.AddReals(a0, a1); }, py::arg("v1"), py::arg("v2"));
	...
	cls_MoniTool_CaseData.def("AddCPU", [](MoniTool_CaseData &self, const Standard_Real a0) -> void { return self.AddCPU(a0); }, py::arg("lastCPU"));
	cls_MoniTool_CaseData.def("AddCPU", [](MoniTool_CaseData &self, const Standard_Real a0, const Standard_Real a1) -> void { return self.AddCPU(a0, a1); }, py::arg("lastCPU"), py::arg("curCPU"));
	...
	cls_MoniTool_CaseData.def("LargeCPU", [](MoniTool_CaseData &self, const Standard_Real a0, const Standard_Real a1) -> Standard_Boolean { return self.LargeCPU(a0, a1); }, py::arg("maxCPU"), py::arg("lastCPU"));
	...
	cls_MoniTool_CaseData.def("AddGeom", [](MoniTool_CaseData &self, const opencascade::handle<Standard_Transient> & a0) -> void { return self.AddGeom(a0); }, py::arg("geom"));
	...
	cls_MoniTool_CaseData.def("AddEntity", [](MoniTool_CaseData &self, const opencascade::handle<Standard_Transient> & a0) -> void { return self.AddEntity(a0); }, py::arg("ent"));
	...
	cls_MoniTool_CaseData.def("AddText", [](MoniTool_CaseData &self, const Standard_CString a0) -> void { return self.AddText(a0); }, py::arg("text"));
	...
	cls_MoniTool_CaseData.def("AddInteger", [](MoniTool_CaseData &self, const Standard_Integer a0) -> void { return self.AddInteger(a0); }, py::arg("val"));
	...
	cls_MoniTool_CaseData.def("AddAny", [](MoniTool_CaseData &self, const opencascade::handle<Standard_Transient> & a0) -> void { return self.AddAny(a0); }, py::arg("val"));
	...
	cls_MoniTool_CaseData.def("Reals", (Standard_Boolean (MoniTool_CaseData::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &MoniTool_CaseData::Reals, "Returns a couple of reals (stored in Geom2d_CartesianPoint)", py::arg("nd"), py::arg("v1"), py::arg("v2"));
	cls_MoniTool_CaseData.def("Real", (Standard_Boolean (MoniTool_CaseData::*)(const Standard_Integer, Standard_Real &) const ) &MoniTool_CaseData::Real, "Returns a real or CPU amount (stored in Geom2d_CartesianPoint) (allows an Integer converted to a Real)", py::arg("nd"), py::arg("val"));
	// FIXME cls_MoniTool_CaseData.def("Text", (Standard_Boolean (MoniTool_CaseData::*)(const Standard_Integer, Standard_CString &) const ) &MoniTool_CaseData::Text, "Returns a text (stored in TCollection_HAsciiString)", py::arg("nd"), py::arg("text"));
	cls_MoniTool_CaseData.def("Integer", (Standard_Boolean (MoniTool_CaseData::*)(const Standard_Integer, Standard_Integer &) const ) &MoniTool_CaseData::Integer, "Returns an Integer", py::arg("nd"), py::arg("val"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_DataInfo.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_MTHasher.hxx
	py::class_<MoniTool_MTHasher, std::unique_ptr<MoniTool_MTHasher, Deleter<MoniTool_MTHasher>>> cls_MoniTool_MTHasher(mod, "MoniTool_MTHasher", "The auxiliary class provides hash code for mapping objects");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_Timer.hxx
	...
	// FIXME cls_MoniTool_Timer.def("Dump", (void (MoniTool_Timer::*)(Standard_OStream &)) &MoniTool_Timer::Dump, "Dumps current state of a timer shortly (one-line output)", py::arg("ostr"));
	...
	cls_MoniTool_Timer.def_static("GetAmendments_", (void (*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &)) &MoniTool_Timer::GetAmendments, "The computed amendmens are returned (for information only)", py::arg("Access"), py::arg("Internal"), py::arg("External"), py::arg("Error10"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_Element.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_ElemHasher.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_RealVal.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_SignShape.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_Stat.hxx
	py::class_<MoniTool_Stat, std::unique_ptr<MoniTool_Stat, Deleter<MoniTool_Stat>>> cls_MoniTool_Stat(mod, "MoniTool_Stat", "This class manages Statistics to be queried asynchronously.");
	cls_MoniTool_Stat.def(py::init<>());
	cls_MoniTool_Stat.def(py::init<const Standard_CString>(), py::arg("title"));
	cls_MoniTool_Stat.def(py::init([] (const MoniTool_Stat &other) {return new MoniTool_Stat(other);}), "Copy constructor", py::arg("other"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_TimerSentry.hxx
	py::class_<MoniTool_TimerSentry, std::unique_ptr<MoniTool_TimerSentry, Deleter<MoniTool_TimerSentry>>> cls_MoniTool_TimerSentry(mod, "MoniTool_TimerSentry", "A tool to facilitate using MoniTool_Timer functionality by automatically ensuring consistency of start/stop actions");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\MoniTool_TransientElem.hxx
