...
PYBIND11_MODULE(BlendFunc, mod) {
	...
	cls_BlendFunc_ConstRad.def("Section", (void (BlendFunc_ConstRad::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, gp_Circ &)) &BlendFunc_ConstRad::Section, "Utile pour une visu rapide et approximative de la surface.", py::arg("Param"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"), py::arg("Pdeb"), py::arg("Pfin"), py::arg("C"));
	...
	cls_BlendFunc_ConstRad.def("GetShape", (void (BlendFunc_ConstRad::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_ConstRad::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_ConstRad.def("Resolution", (void (BlendFunc_ConstRad::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_ConstRad::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_Ruled.def("GetShape", (void (BlendFunc_Ruled::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_Ruled::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_Ruled.def("Resolution", (void (BlendFunc_Ruled::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_Ruled::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_EvolRad.def("GetShape", (void (BlendFunc_EvolRad::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_EvolRad::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_EvolRad.def("Resolution", (void (BlendFunc_EvolRad::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_EvolRad::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_CSConstRad.def("Section", (void (BlendFunc_CSConstRad::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, gp_Circ &)) &BlendFunc_CSConstRad::Section, "None", py::arg("Param"), py::arg("U"), py::arg("V"), py::arg("W"), py::arg("Pdeb"), py::arg("Pfin"), py::arg("C"));
	...
	cls_BlendFunc_CSConstRad.def("GetShape", (void (BlendFunc_CSConstRad::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_CSConstRad::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_CSConstRad.def("Resolution", (void (BlendFunc_CSConstRad::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_CSConstRad::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_CSCircular.def("Section", (void (BlendFunc_CSCircular::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, gp_Circ &)) &BlendFunc_CSCircular::Section, "None", py::arg("Param"), py::arg("U"), py::arg("V"), py::arg("W"), py::arg("Pdeb"), py::arg("Pfin"), py::arg("C"));
	...
	cls_BlendFunc_CSCircular.def("GetShape", (void (BlendFunc_CSCircular::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_CSCircular::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_CSCircular.def("Resolution", (void (BlendFunc_CSCircular::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_CSCircular::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_Chamfer.def("GetShape", (void (BlendFunc_Chamfer::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_Chamfer::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_Chamfer.def("Section", (void (BlendFunc_Chamfer::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, gp_Lin &)) &BlendFunc_Chamfer::Section, "Obsolete method", py::arg("Param"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"), py::arg("Pdeb"), py::arg("Pfin"), py::arg("C"));
	...
	cls_BlendFunc_Chamfer.def("Resolution", (void (BlendFunc_Chamfer::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_Chamfer::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc_ChAsym.def("Section", (void (BlendFunc_ChAsym::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, gp_Lin &)) &BlendFunc_ChAsym::Section, "Utile pour une visu rapide et approximative de la surface.", py::arg("Param"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"), py::arg("Pdeb"), py::arg("Pfin"), py::arg("C"));
	...
	cls_BlendFunc_ChAsym.def("GetShape", (void (BlendFunc_ChAsym::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &BlendFunc_ChAsym::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	cls_BlendFunc_ChAsym.def("Resolution", (void (BlendFunc_ChAsym::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &BlendFunc_ChAsym::Resolution, "None", py::arg("IC2d"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_BlendFunc.def_static("GetShape_", (void (*)(const BlendFunc_SectionShape, const Standard_Real, Standard_Integer &, Standard_Integer &, Standard_Integer &, Convert_ParameterisationType &)) &BlendFunc::GetShape, "None", py::arg("SectShape"), py::arg("MaxAng"), py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("TypeConv"));
