...
PYBIND11_MODULE(STEPConstruct, mod) {
	...
	cls_STEPConstruct_UnitContext.def_static("ConvertSiPrefix_", (Standard_Real (*)(const StepBasic_SiPrefix)) &STEPConstruct_UnitContext::ConvertSiPrefix, "Convert SI prefix defined by enumeration to corresponding real factor (e.g. 1e6 for mega)", py::arg("aPrefix"));
