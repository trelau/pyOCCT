...
PYBIND11_MODULE(STEPConstruct, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_Tool.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_Part.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_AP203Context.hxx
	py::class_<STEPConstruct_AP203Context, std::unique_ptr<STEPConstruct_AP203Context, Deleter<STEPConstruct_AP203Context>>> cls_STEPConstruct_AP203Context(mod, "STEPConstruct_AP203Context", "Maintains context specific for AP203 (required data and management information such as persons, dates, approvals etc.) It contains static entities (which can be shared), default values for person and organisation, and also provides tool for creating management entities around specific part (SDR).");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_Assembly.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_ContextTool.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_UnitContext.hxx
	py::class_<STEPConstruct_UnitContext, std::unique_ptr<STEPConstruct_UnitContext, Deleter<STEPConstruct_UnitContext>>> cls_STEPConstruct_UnitContext(mod, "STEPConstruct_UnitContext", "Tool for creation (encoding) and decoding (for writing and reading accordingly) context defining units and tolerances (uncerntanties)");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_Styles.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_ValidationProps.hxx
	...
	cls_STEPConstruct_ValidationProps.def("AddProp", [](STEPConstruct_ValidationProps &self, const TopoDS_Shape & a0, const opencascade::handle<StepRepr_RepresentationItem> & a1, const Standard_CString a2) -> Standard_Boolean { return self.AddProp(a0, a1, a2); }, py::arg("Shape"), py::arg("Prop"), py::arg("Descr"));
	...
	cls_STEPConstruct_ValidationProps.def("AddCentroid", [](STEPConstruct_ValidationProps &self, const TopoDS_Shape & a0, const gp_Pnt & a1) -> Standard_Boolean { return self.AddCentroid(a0, a1); }, py::arg("Shape"), py::arg("Pnt"));
	...
	cls_STEPConstruct_ValidationProps.def("FindTarget", [](STEPConstruct_ValidationProps &self, const TopoDS_Shape & a0, StepRepr_CharacterizedDefinition & a1, opencascade::handle<StepRepr_RepresentationContext> & a2) -> Standard_Boolean { return self.FindTarget(a0, a1, a2); }, py::arg("S"), py::arg("target"), py::arg("Context"));
	...
	cls_STEPConstruct_ValidationProps.def("GetPropReal", (Standard_Boolean (STEPConstruct_ValidationProps::*)(const opencascade::handle<StepRepr_RepresentationItem> &, Standard_Real &, Standard_Boolean &) const ) &STEPConstruct_ValidationProps::GetPropReal, "Returns value of Real-Valued property (Area or Volume) If Property is neither Area nor Volume, returns False Else returns True and isArea indicates whether property is area or volume", py::arg("item"), py::arg("Val"), py::arg("isArea"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_ExternRefs.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct_PointHasher.hxx
	py::class_<STEPConstruct_PointHasher, std::unique_ptr<STEPConstruct_PointHasher, Deleter<STEPConstruct_PointHasher>>> cls_STEPConstruct_PointHasher(mod, "STEPConstruct_PointHasher", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\STEPConstruct.hxx
