...
PYBIND11_MODULE(BRepBuilderAPI, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_EdgeError.hxx
	py::enum_<BRepBuilderAPI_EdgeError>(mod, "BRepBuilderAPI_EdgeError", "Indicates the outcome of the construction of an edge, i.e. whether it has been successful or not, as explained below: - BRepBuilderAPI_EdgeDone No error occurred; The edge is correctly built. - BRepBuilderAPI_PointProjectionFailed No parameters were given but the projection of the 3D points on the curve failed. This happens when the point distance to the curve is greater than the precision value. - BRepBuilderAPI_ParameterOutOfRange The given parameters are not in the parametric range C->FirstParameter(), C->LastParameter() - BRepBuilderAPI_DifferentPointsOnClosedCurve The two vertices or points are the extremities of a closed curve but have different locations. - BRepBuilderAPI_PointWithInfiniteParameter A finite coordinate point was associated with an infinite parameter (see the Precision package for a definition of infinite values). - BRepBuilderAPI_DifferentsPointAndParameter The distance between the 3D point and the point evaluated on the curve with the parameter is greater than the precision. - BRepBuilderAPI_LineThroughIdenticPoints Two identical points were given to define a line (construction of an edge without curve); gp::Resolution is used for the confusion test.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_FaceError.hxx
	py::enum_<BRepBuilderAPI_FaceError>(mod, "BRepBuilderAPI_FaceError", "Indicates the outcome of the construction of a face, i.e. whether it has been successful or not, as explained below: - BRepBuilderAPI_FaceDone No error occurred. The face is correctly built. - BRepBuilderAPI_NoFace No initialization of the algorithm; only an empty constructor was used. - BRepBuilderAPI_NotPlanar No surface was given and the wire was not planar. - BRepBuilderAPI_CurveProjectionFailed Not used so far. - BRepBuilderAPI_ParametersOutOfRange The parameters given to limit the surface are out of its bounds.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_ShellError.hxx
	py::enum_<BRepBuilderAPI_ShellError>(mod, "BRepBuilderAPI_ShellError", "Indicates the outcome of the construction of a face, i.e. whether it is successful or not, as explained below: - BRepBuilderAPI_ShellDone No error occurred. The shell is correctly built. - BRepBuilderAPI_EmptyShell No initialization of the algorithm: only an empty constructor was used. - BRepBuilderAPI_DisconnectedShell not yet used - BRepBuilderAPI_ShellParametersOutOfRange The parameters given to limit the surface are out of its bounds.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_WireError.hxx
	py::enum_<BRepBuilderAPI_WireError>(mod, "BRepBuilderAPI_WireError", "Indicates the outcome of wire construction, i.e. whether it is successful or not, as explained below: - BRepBuilderAPI_WireDone No error occurred. The wire is correctly built. - BRepBuilderAPI_EmptyWire No initialization of the algorithm. Only an empty constructor was used. - BRepBuilderAPI_DisconnectedWire The last edge which you attempted to add was not connected to the wire. - BRepBuilderAPI_NonManifoldWire The wire with some singularity.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_PipeError.hxx
	py::enum_<BRepBuilderAPI_PipeError>(mod, "BRepBuilderAPI_PipeError", "Errors that can occur at (shell)pipe construction.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_ShapeModification.hxx
	py::enum_<BRepBuilderAPI_ShapeModification>(mod, "BRepBuilderAPI_ShapeModification", "Lists the possible types of modification to a shape following a topological operation: Preserved, Deleted, Trimmed, Merged or BoundaryModified. This enumeration enables you to assign a 'state' to the different shapes that are on the list of operands for each API function. The MakeShape class then uses this to determine what has happened to the shapes which constitute the list of operands.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_TransitionMode.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_Command.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeShape.hxx
	py::class_<BRepBuilderAPI_MakeShape, std::unique_ptr<BRepBuilderAPI_MakeShape, Deleter<BRepBuilderAPI_MakeShape>>, BRepBuilderAPI_Command> cls_BRepBuilderAPI_MakeShape(mod, "BRepBuilderAPI_MakeShape", "This is the root class for all shape constructions. It stores the result.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeVertex.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeEdge.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeEdge2d.hxx
	py::class_<BRepBuilderAPI_MakeEdge2d, std::unique_ptr<BRepBuilderAPI_MakeEdge2d, Deleter<BRepBuilderAPI_MakeEdge2d>>, BRepBuilderAPI_MakeShape> cls_BRepBuilderAPI_MakeEdge2d(mod, "BRepBuilderAPI_MakeEdge2d", "Provides methods to build edges.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeFace.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_FindPlane.hxx
	py::class_<BRepBuilderAPI_FindPlane, std::unique_ptr<BRepBuilderAPI_FindPlane, Deleter<BRepBuilderAPI_FindPlane>>> cls_BRepBuilderAPI_FindPlane(mod, "BRepBuilderAPI_FindPlane", "Describes functions to find the plane in which the edges of a given shape are located. A FindPlane object provides a framework for: - extracting the edges of a given shape, - implementing the construction algorithm, and - consulting the result.");
	...
	cls_BRepBuilderAPI_FindPlane.def("Init", [](BRepBuilderAPI_FindPlane &self, const TopoDS_Shape & a0) -> void { return self.Init(a0); }, py::arg("S"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_Sewing.hxx
	...
	cls_BRepBuilderAPI_Sewing.def("Init", [](BRepBuilderAPI_Sewing &self, const Standard_Real a0) -> void { return self.Init(a0); }, py::arg("tolerance"));
	cls_BRepBuilderAPI_Sewing.def("Init", [](BRepBuilderAPI_Sewing &self, const Standard_Real a0, const Standard_Boolean a1) -> void { return self.Init(a0, a1); }, py::arg("tolerance"), py::arg("option1"));
	cls_BRepBuilderAPI_Sewing.def("Init", [](BRepBuilderAPI_Sewing &self, const Standard_Real a0, const Standard_Boolean a1, const Standard_Boolean a2) -> void { return self.Init(a0, a1, a2); }, py::arg("tolerance"), py::arg("option1"), py::arg("option2"));
	cls_BRepBuilderAPI_Sewing.def("Init", [](BRepBuilderAPI_Sewing &self, const Standard_Real a0, const Standard_Boolean a1, const Standard_Boolean a2, const Standard_Boolean a3) -> void { return self.Init(a0, a1, a2, a3); }, py::arg("tolerance"), py::arg("option1"), py::arg("option2"), py::arg("option3"));
	...
	// FIXME cls_BRepBuilderAPI_Sewing.def("Dump", (void (BRepBuilderAPI_Sewing::*)() const ) &BRepBuilderAPI_Sewing::Dump, "print the informations");
	...
	cls_BRepBuilderAPI_Sewing.def("WhichFace", [](BRepBuilderAPI_Sewing &self, const TopoDS_Edge & a0) -> TopoDS_Face { return self.WhichFace(a0); }, py::arg("theEdg"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeShell.hxx
	...
	cls_BRepBuilderAPI_MakeShell.def("Init", [](BRepBuilderAPI_MakeShell &self, const opencascade::handle<Geom_Surface> & a0, const Standard_Real a1, const Standard_Real a2, const Standard_Real a3, const Standard_Real a4) -> void { return self.Init(a0, a1, a2, a3, a4); }, py::arg("S"), py::arg("UMin"), py::arg("UMax"), py::arg("VMin"), py::arg("VMax"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_MakeSolid.hxx
	py::class_<BRepBuilderAPI_MakeSolid, std::unique_ptr<BRepBuilderAPI_MakeSolid, Deleter<BRepBuilderAPI_MakeSolid>>, BRepBuilderAPI_MakeShape> cls_BRepBuilderAPI_MakeSolid(mod, "BRepBuilderAPI_MakeSolid", "Describes functions to build a solid from shells. A solid is made of one shell, or a series of shells, which do not intersect each other. One of these shells constitutes the outside skin of the solid. It may be closed (a finite solid) or open (an infinite solid). Other shells form hollows (cavities) in these previous ones. Each must bound a closed volume. A MakeSolid object provides a framework for: - defining and implementing the construction of a solid, and - consulting the result.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_Transform.hxx
	...
	cls_BRepBuilderAPI_Transform.def("Perform", [](BRepBuilderAPI_Transform &self, const TopoDS_Shape & a0) -> void { return self.Perform(a0); }, py::arg("S"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_NurbsConvert.hxx
	py::class_<BRepBuilderAPI_NurbsConvert, std::unique_ptr<BRepBuilderAPI_NurbsConvert, Deleter<BRepBuilderAPI_NurbsConvert>>, BRepBuilderAPI_ModifyShape> cls_BRepBuilderAPI_NurbsConvert(mod, "BRepBuilderAPI_NurbsConvert", "Conversion of the complete geometry of a shape (all 3D analytical representation of surfaces and curves) into NURBS geometry (execpt for Planes). For example, all curves supporting edges of the basis shape are converted into BSpline curves, and all surfaces supporting its faces are converted into BSpline surfaces.");
	...
	cls_BRepBuilderAPI_NurbsConvert.def("Perform", [](BRepBuilderAPI_NurbsConvert &self, const TopoDS_Shape & a0) -> void { return self.Perform(a0); }, py::arg("S"));
	...
	cls_BRepBuilderAPI_GTransform.def("Perform", [](BRepBuilderAPI_GTransform &self, const TopoDS_Shape & a0) -> void { return self.Perform(a0); }, py::arg("S"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_Copy.hxx
	...
	cls_BRepBuilderAPI_Copy.def("Perform", [](BRepBuilderAPI_Copy &self, const TopoDS_Shape & a0) -> void { return self.Perform(a0); }, py::arg("S"));
	cls_BRepBuilderAPI_Copy.def("Perform", [](BRepBuilderAPI_Copy &self, const TopoDS_Shape & a0, const Standard_Boolean a1) -> void { return self.Perform(a0, a1); }, py::arg("S"), py::arg("copyGeom"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_Collect.hxx
	py::class_<BRepBuilderAPI_Collect, std::unique_ptr<BRepBuilderAPI_Collect, Deleter<BRepBuilderAPI_Collect>>> cls_BRepBuilderAPI_Collect(mod, "BRepBuilderAPI_Collect", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI.hxx
	...
	// Callback for BRepBuilderAPI_BndBoxTreeSelector.
	class PyCallback_BRepBuilderAPI_BndBoxTreeSelector : public BRepBuilderAPI_BndBoxTreeSelector {
	public:
		using BRepBuilderAPI_BndBoxTreeSelector::BRepBuilderAPI_BndBoxTreeSelector;

		Standard_Boolean Accept(const int & a0) override { PYBIND11_OVERLOAD_PURE(Standard_Boolean, BRepBuilderAPI_BndBoxTreeSelector, Accept, a0); }
	};

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepBuilderAPI_BndBoxTreeSelector.hxx
	py::class_<BRepBuilderAPI_BndBoxTreeSelector, std::unique_ptr<BRepBuilderAPI_BndBoxTreeSelector, Deleter<BRepBuilderAPI_BndBoxTreeSelector>>, PyCallback_BRepBuilderAPI_BndBoxTreeSelector> cls_BRepBuilderAPI_BndBoxTreeSelector(mod, "BRepBuilderAPI_BndBoxTreeSelector", "Class BRepBuilderAPI_BndBoxTreeSelector derived from UBTree::Selector This class is used to select overlapping boxes, stored in NCollection::UBTree; contains methods to maintain the selection condition and to retrieve selected objects after search.");
