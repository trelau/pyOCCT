...
PYBIND11_MODULE(Bisector, mod) {
	...
	cls_Bisector_BisecCC.def("ValueAndDist", (gp_Pnt2d (Bisector_BisecCC::*)(const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Bisector_BisecCC::ValueAndDist, "Returns the point of parameter U. Computes the distance between the current point and the two curves I separate. Computes the parameters on each curve corresponding of the projection of the current point.", py::arg("U"), py::arg("U1"), py::arg("U2"), py::arg("Distance"));
	cls_Bisector_BisecCC.def("ValueByInt", (gp_Pnt2d (Bisector_BisecCC::*)(const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &) const ) &Bisector_BisecCC::ValueByInt, "Returns the point of parameter U. Computes the distance between the current point and the two curves I separate. Computes the parameters on each curve corresponding of the projection of the current point.", py::arg("U"), py::arg("U1"), py::arg("U2"), py::arg("Distance"));
	...
	cls_Bisector_FunctionH.def("Value", (Standard_Boolean (Bisector_FunctionH::*)(const Standard_Real, Standard_Real &)) &Bisector_FunctionH::Value, "Computes the values of the Functions for the variable <X>.", py::arg("X"), py::arg("F"));
	cls_Bisector_FunctionH.def("Derivative", (Standard_Boolean (Bisector_FunctionH::*)(const Standard_Real, Standard_Real &)) &Bisector_FunctionH::Derivative, "None", py::arg("X"), py::arg("D"));
	cls_Bisector_FunctionH.def("Values", (Standard_Boolean (Bisector_FunctionH::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &Bisector_FunctionH::Values, "Returns the values of the functions and the derivatives for the variable <X>.", py::arg("X"), py::arg("F"), py::arg("D"));
	...
	cls_Bisector_FunctionInter.def("Value", (Standard_Boolean (Bisector_FunctionInter::*)(const Standard_Real, Standard_Real &)) &Bisector_FunctionInter::Value, "Computes the values of the Functions for the variable <X>.", py::arg("X"), py::arg("F"));
	cls_Bisector_FunctionInter.def("Derivative", (Standard_Boolean (Bisector_FunctionInter::*)(const Standard_Real, Standard_Real &)) &Bisector_FunctionInter::Derivative, "None", py::arg("X"), py::arg("D"));
	cls_Bisector_FunctionInter.def("Values", (Standard_Boolean (Bisector_FunctionInter::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &Bisector_FunctionInter::Values, "Returns the values of the functions and the derivatives for the variable <X>.", py::arg("X"), py::arg("F"), py::arg("D"));
