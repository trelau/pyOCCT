...
PYBIND11_MODULE(BRepFill, mod) {
	...
	bind_NCollection_DataMap<TopoDS_Shape, NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_ShapeMapHasher>, TopTools_ShapeMapHasher>(mod, "BRepFill_DataMapOfShapeDataMapOfShapeListOfShape");
	...
	*/
	...
	bind_NCollection_DataMap<opencascade::handle<MAT_Node>, NCollection_DataMap<TopoDS_Shape, TopoDS_Shape, TopTools_ShapeMapHasher>, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "BRepFill_DataMapOfNodeDataMapOfShapeShape");
	...
	*/
	...
	bind_NCollection_DataMap<opencascade::handle<MAT_Node>, TopoDS_Shape, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "BRepFill_DataMapOfNodeShape");
	...
	*/
	...
	bind_NCollection_DataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_OrientedShapeMapHasher>(mod, "BRepFill_DataMapOfOrientedShapeListOfShape");
	...
	*/
	...
	bind_NCollection_DataMap<TopoDS_Shape, opencascade::handle<TopTools_HArray2OfShape>, TopTools_ShapeMapHasher>(mod, "BRepFill_DataMapOfShapeHArray2OfShape");
	...
	*/
	...
	bind_NCollection_DataMap<TopoDS_Shape, NCollection_Sequence<gp_Pnt>, TopTools_ShapeMapHasher>(mod, "BRepFill_DataMapOfShapeSequenceOfPnt");
	...
	*/
	...
	bind_NCollection_DataMap<TopoDS_Shape, NCollection_Sequence<double>, TopTools_ShapeMapHasher>(mod, "BRepFill_DataMapOfShapeSequenceOfReal");

	/* FIXME

	*/

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_SequenceOfEdgeFaceAndOrder.hxx
	bind_NCollection_Sequence<BRepFill_EdgeFaceAndOrder>(mod, "BRepFill_SequenceOfEdgeFaceAndOrder");

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_SequenceOfFaceAndOrder.hxx
	bind_NCollection_Sequence<BRepFill_FaceAndOrder>(mod, "BRepFill_SequenceOfFaceAndOrder");

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_IndexedDataMapOfOrientedShapeListOfShape.hxx
	bind_NCollection_IndexedDataMap<TopoDS_Shape, NCollection_List<TopoDS_Shape>, TopTools_OrientedShapeMapHasher>(mod, "BRepFill_IndexedDataMapOfOrientedShapeListOfShape");

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_ListOfOffsetWire.hxx
	bind_NCollection_List<BRepFill_OffsetWire>(mod, "BRepFill_ListOfOffsetWire");

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_ListOfOffsetWire.hxx
	bind_NCollection_TListIterator<BRepFill_OffsetWire>(mod, "BRepFill_ListIteratorOfListOfOffsetWire");

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepFill_SequenceOfSection.hxx
	bind_NCollection_Sequence<BRepFill_Section>(mod, "BRepFill_SequenceOfSection");
