...
PYBIND11_MODULE(BRepFill, mod) {
	...
	// FIXME cls_BRepFill_LocationLaw.def("Law", (const opencascade::handle<GeomFill_LocationLaw> & (BRepFill_LocationLaw::*)(const Standard_Integer) const ) &BRepFill_LocationLaw::Law, "Return the elementary Law of rank <Index> <Index> have to be in [1, NbLaw()]", py::arg("Index"));
	cls_BRepFill_LocationLaw.def("Wire", (const TopoDS_Wire & (BRepFill_LocationLaw::*)() const ) &BRepFill_LocationLaw::Wire, "return the path");
	// FIXME cls_BRepFill_LocationLaw.def("Edge", (const TopoDS_Edge & (BRepFill_LocationLaw::*)(const Standard_Integer) const ) &BRepFill_LocationLaw::Edge, "Return the Edge of rank <Index> in the path <Index> have to be in [1, NbLaw()]", py::arg("Index"));
	// FIXME cls_BRepFill_LocationLaw.def("Vertex", (TopoDS_Vertex (BRepFill_LocationLaw::*)(const Standard_Integer) const ) &BRepFill_LocationLaw::Vertex, "Return the vertex of rank <Index> in the path <Index> have to be in [0, NbLaw()]", py::arg("Index"));
