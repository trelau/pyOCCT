...
PYBIND11_MODULE(Select3D, mod) {
	...
	cls_Select3D_SensitiveCircle.def("ArrayBounds", (void (Select3D_SensitiveCircle::*)(Standard_Integer &, Standard_Integer &) const ) &Select3D_SensitiveCircle::ArrayBounds, "None", py::arg("theLow"), py::arg("theUp"));
	...
	// FIXME cls_Select3D_SensitiveGroup.def("SubEntity", (const opencascade::handle<Select3D_SensitiveEntity> & (Select3D_SensitiveGroup::*)(const Standard_Integer) const ) &Select3D_SensitiveGroup::SubEntity, "Access entity by index [1, NbSubElements()].", py::arg("theIndex"));
