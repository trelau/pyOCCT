...
PYBIND11_MODULE(StdSelect, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_TypeOfSelectionImage.hxx
	py::enum_<StdSelect_TypeOfSelectionImage>(mod, "StdSelect_TypeOfSelectionImage", "Type of output selection image.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_DisplayMode.hxx
	py::enum_<StdSelect_DisplayMode>(mod, "StdSelect_DisplayMode", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_TypeOfEdge.hxx
	py::enum_<StdSelect_TypeOfEdge>(mod, "StdSelect_TypeOfEdge", "Provides values for different types of edges. These values are used to filter edges in frameworks inheriting StdSelect_EdgeFilter.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_TypeOfFace.hxx
	py::enum_<StdSelect_TypeOfFace>(mod, "StdSelect_TypeOfFace", "Provides values for different types of faces. These values are used to filter faces in frameworks inheriting StdSelect_FaceFilter.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_SensitivityMode.hxx
	py::enum_<StdSelect_SensitivityMode>(mod, "StdSelect_SensitivityMode", "Selection sensitivity mode. SM_WINDOW mode uses the specified pixel tolerance to compute the sensitivity value, SM_VIEW mode allows to define the sensitivity manually.")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_TypeOfResult.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_ViewerSelector3d.hxx
	...
	cls_StdSelect_ViewerSelector3d.def("ToPixMap", [](StdSelect_ViewerSelector3d &self, Image_PixMap & a0, const opencascade::handle<V3d_View> & a1, const StdSelect_TypeOfSelectionImage a2) -> Standard_Boolean { return self.ToPixMap(a0, a1, a2); }, py::arg("theImage"), py::arg("theView"), py::arg("theType"));
	...
	cls_StdSelect_ViewerSelector3d.def("DisplaySensitive", [](StdSelect_ViewerSelector3d &self, const opencascade::handle<SelectMgr_Selection> & a0, const gp_Trsf & a1, const opencascade::handle<V3d_View> & a2) -> void { return self.DisplaySensitive(a0, a1, a2); }, py::arg("theSel"), py::arg("theTrsf"), py::arg("theView"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_BRepOwner.hxx
	...
	cls_StdSelect_BRepOwner.def("IsHilighted", [](StdSelect_BRepOwner &self, const opencascade::handle<PrsMgr_PresentationManager> & a0) -> Standard_Boolean { return self.IsHilighted(a0); }, py::arg("aPM"));
	...
	cls_StdSelect_BRepOwner.def("HilightWithColor", [](StdSelect_BRepOwner &self, const opencascade::handle<PrsMgr_PresentationManager3d> & a0, const opencascade::handle<Prs3d_Drawer> & a1) -> void { return self.HilightWithColor(a0, a1); }, py::arg("thePM"), py::arg("theStyle"));
	...
	cls_StdSelect_BRepOwner.def("Unhilight", [](StdSelect_BRepOwner &self, const opencascade::handle<PrsMgr_PresentationManager> & a0) -> void { return self.Unhilight(a0); }, py::arg("aPM"));
	...
	cls_StdSelect_BRepOwner.def("Clear", [](StdSelect_BRepOwner &self, const opencascade::handle<PrsMgr_PresentationManager> & a0) -> void { return self.Clear(a0); }, py::arg("aPM"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_BRepSelectionTool.hxx
	...
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const TopoDS_Shape & a1, const TopAbs_ShapeEnum a2, const Standard_Real a3, const Standard_Real a4) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4); }, py::arg("aSelection"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const TopoDS_Shape & a1, const TopAbs_ShapeEnum a2, const Standard_Real a3, const Standard_Real a4, const Standard_Boolean a5) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5); }, py::arg("aSelection"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const TopoDS_Shape & a1, const TopAbs_ShapeEnum a2, const Standard_Real a3, const Standard_Real a4, const Standard_Boolean a5, const Standard_Integer a6) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5, a6); }, py::arg("aSelection"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"), py::arg("aPriority"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const TopoDS_Shape & a1, const TopAbs_ShapeEnum a2, const Standard_Real a3, const Standard_Real a4, const Standard_Boolean a5, const Standard_Integer a6, const Standard_Integer a7) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5, a6, a7); }, py::arg("aSelection"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"), py::arg("aPriority"), py::arg("NbPOnEdge"));
	...
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const opencascade::handle<SelectMgr_SelectableObject> & a1, const TopoDS_Shape & a2, const TopAbs_ShapeEnum a3, const Standard_Real a4, const Standard_Real a5) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5); }, py::arg("aSelection"), py::arg("Origin"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const opencascade::handle<SelectMgr_SelectableObject> & a1, const TopoDS_Shape & a2, const TopAbs_ShapeEnum a3, const Standard_Real a4, const Standard_Real a5, const Standard_Boolean a6) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5, a6); }, py::arg("aSelection"), py::arg("Origin"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const opencascade::handle<SelectMgr_SelectableObject> & a1, const TopoDS_Shape & a2, const TopAbs_ShapeEnum a3, const Standard_Real a4, const Standard_Real a5, const Standard_Boolean a6, const Standard_Integer a7) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5, a6, a7); }, py::arg("aSelection"), py::arg("Origin"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"), py::arg("aPriority"));
	cls_StdSelect_BRepSelectionTool.def_static("Load_", [](const opencascade::handle<SelectMgr_Selection> & a0, const opencascade::handle<SelectMgr_SelectableObject> & a1, const TopoDS_Shape & a2, const TopAbs_ShapeEnum a3, const Standard_Real a4, const Standard_Real a5, const Standard_Boolean a6, const Standard_Integer a7, const Standard_Integer a8) -> void { return StdSelect_BRepSelectionTool::Load(a0, a1, a2, a3, a4, a5, a6, a7, a8); }, py::arg("aSelection"), py::arg("Origin"), py::arg("aShape"), py::arg("aType"), py::arg("theDeflection"), py::arg("theDeviationAngle"), py::arg("AutoTriangulation"), py::arg("aPriority"), py::arg("NbPOnEdge"));
	...
	cls_StdSelect_BRepSelectionTool.def_static("GetSensitiveForFace_", [](const TopoDS_Face & a0, const opencascade::handle<SelectMgr_EntityOwner> & a1, Select3D_EntitySequence & a2) -> Standard_Boolean { return StdSelect_BRepSelectionTool::GetSensitiveForFace(a0, a1, a2); }, py::arg("theFace"), py::arg("theOwner"), py::arg("theOutList"));
	cls_StdSelect_BRepSelectionTool.def_static("GetSensitiveForFace_", [](const TopoDS_Face & a0, const opencascade::handle<SelectMgr_EntityOwner> & a1, Select3D_EntitySequence & a2, const Standard_Boolean a3) -> Standard_Boolean { return StdSelect_BRepSelectionTool::GetSensitiveForFace(a0, a1, a2, a3); }, py::arg("theFace"), py::arg("theOwner"), py::arg("theOutList"), py::arg("theAutoTriang"));
	cls_StdSelect_BRepSelectionTool.def_static("GetSensitiveForFace_", [](const TopoDS_Face & a0, const opencascade::handle<SelectMgr_EntityOwner> & a1, Select3D_EntitySequence & a2, const Standard_Boolean a3, const Standard_Integer a4) -> Standard_Boolean { return StdSelect_BRepSelectionTool::GetSensitiveForFace(a0, a1, a2, a3, a4); }, py::arg("theFace"), py::arg("theOwner"), py::arg("theOutList"), py::arg("theAutoTriang"), py::arg("theNbPOnEdge"));
	cls_StdSelect_BRepSelectionTool.def_static("GetSensitiveForFace_", [](const TopoDS_Face & a0, const opencascade::handle<SelectMgr_EntityOwner> & a1, Select3D_EntitySequence & a2, const Standard_Boolean a3, const Standard_Integer a4, const Standard_Real a5) -> Standard_Boolean { return StdSelect_BRepSelectionTool::GetSensitiveForFace(a0, a1, a2, a3, a4, a5); }, py::arg("theFace"), py::arg("theOwner"), py::arg("theOutList"), py::arg("theAutoTriang"), py::arg("theNbPOnEdge"), py::arg("theMaxiParam"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_EdgeFilter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_FaceFilter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_ShapeTypeFilter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_Prs.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect_Shape.hxx
	...
	cls_StdSelect_Shape.def("Compute", [](StdSelect_Shape &self, const opencascade::handle<PrsMgr_PresentationManager3d> & a0, const opencascade::handle<Prs3d_Presentation> & a1) -> void { return self.Compute(a0, a1); }, py::arg("aPresentationManager"), py::arg("aPresentation"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StdSelect.hxx
