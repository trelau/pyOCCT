...
PYBIND11_MODULE(GeomLib, mod) {
	...
	cls_GeomLib_CheckCurveOnSurface.def("Range", (void (GeomLib_CheckCurveOnSurface::*)(Standard_Real &, Standard_Real &)) &GeomLib_CheckCurveOnSurface::Range, "Returns first and last parameter of the curves (2D- and 3D-curves are considered to have same range)", py::arg("theFirst"), py::arg("theLast"));
	...
	// FIXME cls_GeomLib_MakeCurvefromApprox.def("Curve", (opencascade::handle<Geom_BSplineCurve> (GeomLib_MakeCurvefromApprox::*)(const Standard_Integer) const ) &GeomLib_MakeCurvefromApprox::Curve, "returns a polynomial curve whose poles correspond to the Index3D 3D space if Index3D not in the Range [1,Nb3dSpaces] if the Approx is not Done", py::arg("Index3d"));
	// FIXME cls_GeomLib_MakeCurvefromApprox.def("Curve", (opencascade::handle<Geom_BSplineCurve> (GeomLib_MakeCurvefromApprox::*)(const Standard_Integer, const Standard_Integer) const ) &GeomLib_MakeCurvefromApprox::Curve, "returns a rational curve whose poles correspond to the index3D of the 3D space and whose weights correspond to the index1d 1D space. if Index1D not in the Range [1,Nb1dSpaces] if Index3D not in the Range [1,Nb3dSpaces] if the Approx is not Done", py::arg("Index1D"), py::arg("Index3D"));
	...
	cls_GeomLib_CheckBSplineCurve.def("NeedTangentFix", (void (GeomLib_CheckBSplineCurve::*)(Standard_Boolean &, Standard_Boolean &) const ) &GeomLib_CheckBSplineCurve::NeedTangentFix, "None", py::arg("FirstFlag"), py::arg("SecondFlag"));
	...
	cls_GeomLib_Check2dBSplineCurve.def("NeedTangentFix", (void (GeomLib_Check2dBSplineCurve::*)(Standard_Boolean &, Standard_Boolean &) const ) &GeomLib_Check2dBSplineCurve::NeedTangentFix, "None", py::arg("FirstFlag"), py::arg("SecondFlag"));
	...
	cls_GeomLib_Tool.def_static("Parameter_", (Standard_Boolean (*)(const opencascade::handle<Geom_Curve> &, const gp_Pnt &, const Standard_Real, Standard_Real &)) &GeomLib_Tool::Parameter, "Extracts the parameter of a 3D point lying on a 3D curve or at a distance less than the MaxDist value.", py::arg("Curve"), py::arg("Point"), py::arg("MaxDist"), py::arg("U"));
	cls_GeomLib_Tool.def_static("Parameters_", (Standard_Boolean (*)(const opencascade::handle<Geom_Surface> &, const gp_Pnt &, const Standard_Real, Standard_Real &, Standard_Real &)) &GeomLib_Tool::Parameters, "Extracts the parameter of a 3D point lying on a surface or at a distance less than the MaxDist value.", py::arg("Surface"), py::arg("Point"), py::arg("MaxDist"), py::arg("U"), py::arg("V"));
	cls_GeomLib_Tool.def_static("Parameter_", (Standard_Boolean (*)(const opencascade::handle<Geom2d_Curve> &, const gp_Pnt2d &, const Standard_Real, Standard_Real &)) &GeomLib_Tool::Parameter, "Extracts the parameter of a 2D point lying on a 2D curve or at a distance less than the MaxDist value.", py::arg("Curve"), py::arg("Point"), py::arg("MaxDist"), py::arg("U"));
	...
	cls_GeomLib_PolyFunc.def("Value", (Standard_Boolean (GeomLib_PolyFunc::*)(const Standard_Real, Standard_Real &)) &GeomLib_PolyFunc::Value, "computes the value <F>of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"));
	cls_GeomLib_PolyFunc.def("Derivative", (Standard_Boolean (GeomLib_PolyFunc::*)(const Standard_Real, Standard_Real &)) &GeomLib_PolyFunc::Derivative, "computes the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("D"));
	cls_GeomLib_PolyFunc.def("Values", (Standard_Boolean (GeomLib_PolyFunc::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &GeomLib_PolyFunc::Values, "computes the value <F> and the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"), py::arg("D"));
	...
	cls_GeomLib.def_static("BuildCurve3d_", [](const Standard_Real a0, Adaptor3d_CurveOnSurface & a1, const Standard_Real a2, const Standard_Real a3, opencascade::handle<Geom_Curve> & a4, Standard_Real & a5, Standard_Real & a6) -> void { return GeomLib::BuildCurve3d(a0, a1, a2, a3, a4, a5, a6); }, py::arg("Tolerance"), py::arg("CurvePtr"), py::arg("FirstParameter"), py::arg("LastParameter"), py::arg("NewCurvePtr"), py::arg("MaxDeviation"), py::arg("AverageDeviation"));
	cls_GeomLib.def_static("BuildCurve3d_", [](const Standard_Real a0, Adaptor3d_CurveOnSurface & a1, const Standard_Real a2, const Standard_Real a3, opencascade::handle<Geom_Curve> & a4, Standard_Real & a5, Standard_Real & a6, const GeomAbs_Shape a7) -> void { return GeomLib::BuildCurve3d(a0, a1, a2, a3, a4, a5, a6, a7); }, py::arg("Tolerance"), py::arg("CurvePtr"), py::arg("FirstParameter"), py::arg("LastParameter"), py::arg("NewCurvePtr"), py::arg("MaxDeviation"), py::arg("AverageDeviation"), py::arg("Continuity"));
	cls_GeomLib.def_static("BuildCurve3d_", [](const Standard_Real a0, Adaptor3d_CurveOnSurface & a1, const Standard_Real a2, const Standard_Real a3, opencascade::handle<Geom_Curve> & a4, Standard_Real & a5, Standard_Real & a6, const GeomAbs_Shape a7, const Standard_Integer a8) -> void { return GeomLib::BuildCurve3d(a0, a1, a2, a3, a4, a5, a6, a7, a8); }, py::arg("Tolerance"), py::arg("CurvePtr"), py::arg("FirstParameter"), py::arg("LastParameter"), py::arg("NewCurvePtr"), py::arg("MaxDeviation"), py::arg("AverageDeviation"), py::arg("Continuity"), py::arg("MaxDegree"));
	cls_GeomLib.def_static("BuildCurve3d_", (void (*)(const Standard_Real, Adaptor3d_CurveOnSurface &, const Standard_Real, const Standard_Real, opencascade::handle<Geom_Curve> &, Standard_Real &, Standard_Real &, const GeomAbs_Shape, const Standard_Integer, const Standard_Integer)) &GeomLib::BuildCurve3d, "None", py::arg("Tolerance"), py::arg("CurvePtr"), py::arg("FirstParameter"), py::arg("LastParameter"), py::arg("NewCurvePtr"), py::arg("MaxDeviation"), py::arg("AverageDeviation"), py::arg("Continuity"), py::arg("MaxDegree"), py::arg("MaxSegment"));
	...
	cls_GeomLib.def_static("AxeOfInertia_", [](const TColgp_Array1OfPnt & a0, gp_Ax2 & a1, Standard_Boolean & a2) -> void { return GeomLib::AxeOfInertia(a0, a1, a2); }, py::arg("Points"), py::arg("Axe"), py::arg("IsSingular"));
	cls_GeomLib.def_static("AxeOfInertia_", (void (*)(const TColgp_Array1OfPnt &, gp_Ax2 &, Standard_Boolean &, const Standard_Real)) &GeomLib::AxeOfInertia, "Compute axes of inertia, of some points -- -- -- <Axe>.Location() is the BaryCentre -- -- -- -- -- <Axe>.XDirection is the axe of upper inertia -- -- -- -- <Axe>.Direction is the Normal to the average plane -- -- -- IsSingular is True if points are on line -- Tol is used to determine singular cases.", py::arg("Points"), py::arg("Axe"), py::arg("IsSingular"), py::arg("Tol"));
	cls_GeomLib.def_static("Inertia_", (void (*)(const TColgp_Array1OfPnt &, gp_Pnt &, gp_Dir &, gp_Dir &, Standard_Real &, Standard_Real &, Standard_Real &)) &GeomLib::Inertia, "Compute principale axes of inertia, and dispertion value of some points.", py::arg("Points"), py::arg("Bary"), py::arg("XDir"), py::arg("YDir"), py::arg("Xgap"), py::arg("YGap"), py::arg("ZGap"));
	...
	cls_GeomLib.def_static("EvalMaxParametricDistance_", (void (*)(const Adaptor3d_Curve &, const Adaptor3d_Curve &, const Standard_Real, const TColStd_Array1OfReal &, Standard_Real &)) &GeomLib::EvalMaxParametricDistance, "this will compute the maximum distance at the parameters given in the Parameters array by evaluating each parameter the two curves and taking the maximum of the evaluated distance", py::arg("Curve"), py::arg("AReferenceCurve"), py::arg("Tolerance"), py::arg("Parameters"), py::arg("MaxDistance"));
	cls_GeomLib.def_static("EvalMaxDistanceAlongParameter_", (void (*)(const Adaptor3d_Curve &, const Adaptor3d_Curve &, const Standard_Real, const TColStd_Array1OfReal &, Standard_Real &)) &GeomLib::EvalMaxDistanceAlongParameter, "this will compute the maximum distancef at the parameters given in the Parameters array by projecting from the Curve to the reference curve and taking the minimum distance Than the maximum will be taken on those minimas.", py::arg("Curve"), py::arg("AReferenceCurve"), py::arg("Tolerance"), py::arg("Parameters"), py::arg("MaxDistance"));
	...
	cls_GeomLib.def_static("IsClosed_", (void (*)(const opencascade::handle<Geom_Surface> &, const Standard_Real, Standard_Boolean &, Standard_Boolean &)) &GeomLib::IsClosed, "This method defines if opposite boundaries of surface coincide with given tolerance", py::arg("S"), py::arg("Tol"), py::arg("isUClosed"), py::arg("isVClosed"));
