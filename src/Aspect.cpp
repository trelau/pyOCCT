...
PYBIND11_MODULE(Aspect, mod) {
	...
	cls_Aspect_Window.def("Position", (void (Aspect_Window::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &Aspect_Window::Position, "Returns The Window POSITION in PIXEL", py::arg("X1"), py::arg("Y1"), py::arg("X2"), py::arg("Y2"));
	cls_Aspect_Window.def("Size", (void (Aspect_Window::*)(Standard_Integer &, Standard_Integer &) const ) &Aspect_Window::Size, "Returns The Window SIZE in PIXEL", py::arg("Width"), py::arg("Height"));
	...
	cls_Aspect_Grid.def("Hit", (void (Aspect_Grid::*)(const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &) const ) &Aspect_Grid::Hit, "returns the point of the grid the closest to the point X,Y if the grid is active. If the grid is not active returns X,Y.", py::arg("X"), py::arg("Y"), py::arg("gridX"), py::arg("gridY"));
	cls_Aspect_Grid.def("Compute", (void (Aspect_Grid::*)(const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &) const ) &Aspect_Grid::Compute, "returns the point of the grid the closest to the point X,Y", py::arg("X"), py::arg("Y"), py::arg("gridX"), py::arg("gridY"));
	...
	cls_Aspect_CircularGrid.def("Compute", (void (Aspect_CircularGrid::*)(const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &) const ) &Aspect_CircularGrid::Compute, "returns the point of the grid the closest to the point X,Y", py::arg("X"), py::arg("Y"), py::arg("gridX"), py::arg("gridY"));
	...
	cls_Aspect_NeutralWindow.def("Position", (void (Aspect_NeutralWindow::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &Aspect_NeutralWindow::Position, "Return the window position.", py::arg("theX1"), py::arg("theY1"), py::arg("theX2"), py::arg("theY2"));
	...
	cls_Aspect_NeutralWindow.def("Size", (void (Aspect_NeutralWindow::*)(Standard_Integer &, Standard_Integer &) const ) &Aspect_NeutralWindow::Size, "Return the window size.", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_Aspect_RectangularGrid.def("Compute", (void (Aspect_RectangularGrid::*)(const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &) const ) &Aspect_RectangularGrid::Compute, "returns the point of the grid the closest to the point X,Y", py::arg("X"), py::arg("Y"), py::arg("gridX"), py::arg("gridY"));
