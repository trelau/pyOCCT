...
// TYPEDEF: BINOBJMGT_PCHAR

// TYPEDEF: BINOBJMGT_PBYTE
/*
*/

// TYPEDEF: BINOBJMGT_PEXTCHAR

// TYPEDEF: BINOBJMGT_PINTEGER

// TYPEDEF: BINOBJMGT_PREAL

// TYPEDEF: BINOBJMGT_PSHORTREAL
...
// Methods
// cls_BinObjMgt_Persistent.def_static("operator new_", (void * (*)(size_t)) &BinObjMgt_Persistent::operator new, "None", py::arg("theSize"));
// cls_BinObjMgt_Persistent.def_static("operator delete_", (void (*)(void *)) &BinObjMgt_Persistent::operator delete, "None", py::arg("theAddress"));
// cls_BinObjMgt_Persistent.def_static("operator new[]_", (void * (*)(size_t)) &BinObjMgt_Persistent::operator new[], "None", py::arg("theSize"));
// cls_BinObjMgt_Persistent.def_static("operator delete[]_", (void (*)(void *)) &BinObjMgt_Persistent::operator delete[], "None", py::arg("theAddress"));
// cls_BinObjMgt_Persistent.def_static("operator new_", (void * (*)(size_t, void *)) &BinObjMgt_Persistent::operator new, "None", py::arg(""), py::arg("theAddress"));
// cls_BinObjMgt_Persistent.def_static("operator delete_", (void (*)(void *, void *)) &BinObjMgt_Persistent::operator delete, "None", py::arg(""), py::arg(""));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_Character)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_Byte)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_ExtCharacter)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_Integer)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_Boolean)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_Real)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_ShortReal)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_CString)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const TCollection_AsciiString &)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const TCollection_ExtendedString &)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const TDF_Label &)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_left", (BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(const Standard_GUID &)) &BinObjMgt_Persistent::operator<<, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(Standard_Character &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(Standard_Byte &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(Standard_ExtCharacter &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", [](BinObjMgt_Persistent &self, Standard_Integer & theValue){ const BinObjMgt_Persistent & rv = self.operator>>(theValue); return std::tuple<const BinObjMgt_Persistent &, Standard_Integer &>(rv, theValue); }, "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", [](BinObjMgt_Persistent &self, Standard_Boolean & theValue){ const BinObjMgt_Persistent & rv = self.operator>>(theValue); return std::tuple<const BinObjMgt_Persistent &, Standard_Boolean &>(rv, theValue); }, "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", [](BinObjMgt_Persistent &self, Standard_Real & theValue){ const BinObjMgt_Persistent & rv = self.operator>>(theValue); return std::tuple<const BinObjMgt_Persistent &, Standard_Real &>(rv, theValue); }, "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(Standard_ShortReal &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(TCollection_AsciiString &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(TCollection_ExtendedString &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
...
cls_BinObjMgt_Persistent.def("bits_right", (const BinObjMgt_Persistent & (BinObjMgt_Persistent::*)(Standard_GUID &) const) &BinObjMgt_Persistent::operator>>, py::is_operator(), "None", py::arg("theValue"));
