...
py::class_<IGESToBRep_CurveAndSurface> cls_IGESToBRep_CurveAndSurface(mod, "IGESToBRep_CurveAndSurface", "Provides methods to transfer CurveAndSurface from IGES to CASCADE.");
...
py::class_<IGESToBRep_BasicSurface, IGESToBRep_CurveAndSurface> cls_IGESToBRep_BasicSurface(mod, "IGESToBRep_BasicSurface", "Provides methods to transfer basic geometric surface entities from IGES to CASCADE. These can be : * Spline surface * BSpline surface");
...
py::class_<IGESToBRep_BRepEntity, IGESToBRep_CurveAndSurface> cls_IGESToBRep_BRepEntity(mod, "IGESToBRep_BRepEntity", "Provides methods to transfer BRep entities ( VertexList 502, EdgeList 504, Loop 508, Face 510, Shell 514, ManifoldSolid 186) from IGES to CASCADE.");
