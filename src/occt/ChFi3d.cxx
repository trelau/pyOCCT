...
cls_ChFi3d_ChBuilder.def("Add", (void (ChFi3d_ChBuilder::*)(const Standard_Real, const TopoDS_Edge &)) &ChFi3d_ChBuilder::Add, "initializes a new contour with the edge <E> as first (the next are found by propagation ), and the distance <Dis> if the edge <E> has more than 2 adjacent faces", py::arg("Dis"), py::arg("E"));
...
cls_ChFi3d_ChBuilder.def("GetDistAngle", [](ChFi3d_ChBuilder &self, const Standard_Integer IC, Standard_Real & Dis, Standard_Real & Angle){ self.GetDistAngle(IC, Dis, Angle); return std::tuple<Standard_Real &, Standard_Real &>(Dis, Angle); }, "gives the distances <Dis> and <Angle> of the fillet contour of index <IC> in the DS", py::arg("IC"), py::arg("Dis"), py::arg("Angle"));
cls_ChFi3d_ChBuilder.def("SetMode", (void (ChFi3d_ChBuilder::*)(const ChFiDS_ChamfMode)) &ChFi3d_ChBuilder::SetMode, "set the mode of shamfer", py::arg("theMode"));
...
cls_ChFi3d_ChBuilder.def("Mode", (ChFiDS_ChamfMode (ChFi3d_ChBuilder::*)() const) &ChFi3d_ChBuilder::Mode, "returns the mode of chamfer used");
