...
py::class_<GeomToIGES_GeomPoint, GeomToIGES_GeomEntity> cls_GeomToIGES_GeomPoint(mod, "GeomToIGES_GeomPoint", "This class implements the transfer of the Point Entity from Geom to IGES . These are : . Point * CartesianPoint");
...
py::class_<GeomToIGES_GeomSurface, GeomToIGES_GeomEntity> cls_GeomToIGES_GeomSurface(mod, "GeomToIGES_GeomSurface", "This class implements the transfer of the Surface Entity from Geom To IGES. These can be : . BoundedSurface * BSplineSurface * BezierSurface * RectangularTrimmedSurface . ElementarySurface * Plane * CylindricalSurface * ConicalSurface * SphericalSurface * ToroidalSurface . SweptSurface * SurfaceOfLinearExtrusion * SurfaceOfRevolution . OffsetSurface");
