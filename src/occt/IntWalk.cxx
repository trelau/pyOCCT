...
cls_IntWalk_PWalking.def("TestDeflection", (IntWalk_StatusDeflection (IntWalk_PWalking::*)(const IntImp_ConstIsoparametric, const IntWalk_StatusDeflection)) &IntWalk_PWalking::TestDeflection, "None", py::arg("ChoixIso"), py::arg("theStatus"));
