...
py::class_<GeomLib_CheckCurveOnSurface> cls_GeomLib_CheckCurveOnSurface(mod, "GeomLib_CheckCurveOnSurface", "Computes the max distance between 3D-curve and 2D-curve in some surface.");
...
// TYPEDEF: GEOMLIB_ARRAY1OFMAT
bind_NCollection_Array1<gp_Mat>(mod, "GeomLib_Array1OfMat", py::module_local(false));
...
py::class_<GeomLib_DenominatorMultiplier> cls_GeomLib_DenominatorMultiplier(mod, "GeomLib_DenominatorMultiplier", "this defines an evaluator for a function of 2 variables that will be used by CancelDenominatorDerivative in one direction.");
...
py::class_<GeomLib_IsPlanarSurface> cls_GeomLib_IsPlanarSurface(mod, "GeomLib_IsPlanarSurface", "Find if a surface is a planar surface.");
