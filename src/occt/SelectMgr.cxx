...
bind_NCollection_Vec3<double>(mod, "SelectMgr_Vec3", py::module_local());

// TYPEDEF: SELECTMGR_VEC4
bind_NCollection_Vec4<double>(mod, "SelectMgr_Vec4", py::module_local());

// TYPEDEF: SELECTMGR_MAT4
bind_NCollection_Mat4<double>(mod, "SelectMgr_Mat4", py::module_local());
...
// Methods
cls_SelectMgr_ViewClipRange.def("IsClipped", (Standard_Boolean (SelectMgr_ViewClipRange::*)(const Standard_Real) const) &SelectMgr_ViewClipRange::IsClipped, "Check if the given depth is not within clipping range(s), e.g. TRUE means depth is clipped.", py::arg("theDepth"));
cls_SelectMgr_ViewClipRange.def("GetNearestDepth", [](SelectMgr_ViewClipRange &self, const Bnd_Range & theRange, Standard_Real & theDepth){ Standard_Boolean rv = self.GetNearestDepth(theRange, theDepth); return std::tuple<Standard_Boolean, Standard_Real &>(rv, theDepth); }, "Calculates the min not clipped value from the range. Returns FALSE if the whole range is clipped.", py::arg("theRange"), py::arg("theDepth"));
cls_SelectMgr_ViewClipRange.def("SetVoid", (void (SelectMgr_ViewClipRange::*)()) &SelectMgr_ViewClipRange::SetVoid, "Clears clipping range.");
cls_SelectMgr_ViewClipRange.def("AddClippingPlanes", (void (SelectMgr_ViewClipRange::*)(const Graphic3d_SequenceOfHClipPlane &, const gp_Ax1 &)) &SelectMgr_ViewClipRange::AddClippingPlanes, "Add clipping planes. Planes and picking ray should be defined in the same coordinate system.", py::arg("thePlanes"), py::arg("thePickRay"));
cls_SelectMgr_ViewClipRange.def("ChangeUnclipRange", (Bnd_Range & (SelectMgr_ViewClipRange::*)()) &SelectMgr_ViewClipRange::ChangeUnclipRange, "Returns the main unclipped range; [-inf, inf] by default.");
cls_SelectMgr_ViewClipRange.def("AddClipSubRange", (void (SelectMgr_ViewClipRange::*)(const Bnd_Range &)) &SelectMgr_ViewClipRange::AddClipSubRange, "Adds a clipping sub-range (for clipping chains).", py::arg("theRange"));
cls_SelectMgr_ViewClipRange.def("DumpJson", [](SelectMgr_ViewClipRange &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_SelectMgr_ViewClipRange.def("DumpJson", (void (SelectMgr_ViewClipRange::*)(Standard_OStream &, const Standard_Integer) const) &SelectMgr_ViewClipRange::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theClipRange"), py::arg("thePickResult"));
...
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_BaseFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &) const) &SelectMgr_BaseFrustum::Overlaps, "Intersection test between defined volume and given point Does not perform depth calculation, so this method is defined as helper function for inclusion test. Therefore, its implementation makes sense only for rectangular frustum with box selection mode activated.", py::arg("thePnt"));
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_BaseFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePt1"), py::arg("thePt2"), py::arg("thePt3"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_BaseFrustum.def("DistToGeometryCenter", (Standard_Real (SelectMgr_BaseFrustum::*)(const gp_Pnt &) const) &SelectMgr_BaseFrustum::DistToGeometryCenter, "Measures distance between 3d projection of user-picked screen point and given point theCOG", py::arg("theCOG"));
...
cls_SelectMgr_BaseFrustum.def("DumpJson", [](SelectMgr_BaseFrustum &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_SelectMgr_BaseFrustum.def("DumpJson", (void (SelectMgr_BaseFrustum::*)(Standard_OStream &, const Standard_Integer) const) &SelectMgr_BaseFrustum::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theClipRange"), py::arg("thePickResult"));
...
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_RectangularFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &) const) &SelectMgr_RectangularFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"));
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_RectangularFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_RectangularFrustum.def("DistToGeometryCenter", (Standard_Real (SelectMgr_RectangularFrustum::*)(const gp_Pnt &) const) &SelectMgr_RectangularFrustum::DistToGeometryCenter, "Measures distance between 3d projection of user-picked screen point and given point theCOG", py::arg("theCOG"));
...
cls_SelectMgr_RectangularFrustum.def("GetViewRayDirection", (const gp_Vec & (SelectMgr_RectangularFrustum::*)() const) &SelectMgr_RectangularFrustum::GetViewRayDirection, "Return view ray direction.");
cls_SelectMgr_RectangularFrustum.def("GetMousePosition", (const gp_Pnt2d & (SelectMgr_RectangularFrustum::*)() const) &SelectMgr_RectangularFrustum::GetMousePosition, "Return mouse coordinates.");
...
cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theMinPnt"), py::arg("theMaxPnt"), py::arg("theClipRange"), py::arg("thePickResult"));
...
cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
...
// TYPEDEF: SELECTMGR_TRIANGFRUSTUMS
bind_NCollection_List<opencascade::handle<SelectMgr_TriangularFrustum> >(mod, "SelectMgr_TriangFrustums", py::module_local(false));

// TYPEDEF: SELECTMGR_TRIANGFRUSTUMSITER
bind_NCollection_TListIterator<opencascade::handle<SelectMgr_TriangularFrustum> >(mod, "SelectMgr_TriangFrustumsIter", py::module_local(false));
...
cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("theMinPnt"), py::arg("theMaxPnt"), py::arg("theClipRange"), py::arg("thePickResult"));
...
cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, const gp_Pnt &, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theClipRange"), py::arg("thePickResult"));
cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, const SelectMgr_ViewClipRange &, SelectBasics_PickResult &) const) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theClipRange"), py::arg("thePickResult"));
...
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("thePickResult"));
...
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("thePickResult"));
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"));
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const opencascade::handle<TColgp_HArray1OfPnt> &, Standard_Integer, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPts"), py::arg("theSensType"), py::arg("thePickResult"));
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const TColgp_Array1OfPnt &, Standard_Integer, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPts"), py::arg("theSensType"), py::arg("thePickResult"));
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePickResult"));
cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Standard_Integer, SelectBasics_PickResult &) const) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("thePickResult"));
cls_SelectMgr_SelectingVolumeManager.def("DistToGeometryCenter", (Standard_Real (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &) const) &SelectMgr_SelectingVolumeManager::DistToGeometryCenter, "Measures distance between 3d projection of user-picked screen point and given point theCOG", py::arg("theCOG"));
...
cls_SelectMgr_SelectingVolumeManager.def("ObjectClipping", (const opencascade::handle<Graphic3d_SequenceOfHClipPlane> & (SelectMgr_SelectingVolumeManager::*)() const) &SelectMgr_SelectingVolumeManager::ObjectClipping, "Return object clipping planes.");
cls_SelectMgr_SelectingVolumeManager.def("SetViewClipping", (void (SelectMgr_SelectingVolumeManager::*)(const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &, const opencascade::handle<Graphic3d_SequenceOfHClipPlane> &)) &SelectMgr_SelectingVolumeManager::SetViewClipping, "Valid for point selection only! Computes depth range for clipping planes.", py::arg("theViewPlanes"), py::arg("theObjPlanes"));
cls_SelectMgr_SelectingVolumeManager.def("SetViewClipping", (void (SelectMgr_SelectingVolumeManager::*)(const SelectMgr_SelectingVolumeManager &)) &SelectMgr_SelectingVolumeManager::SetViewClipping, "Copy clipping planes from another volume manager.", py::arg("theOther"));
cls_SelectMgr_SelectingVolumeManager.def("ViewClipRanges", (const SelectMgr_ViewClipRange & (SelectMgr_SelectingVolumeManager::*)() const) &SelectMgr_SelectingVolumeManager::ViewClipRanges, "Return clipping range.");
cls_SelectMgr_SelectingVolumeManager.def("SetViewClipRanges", (void (SelectMgr_SelectingVolumeManager::*)(const SelectMgr_ViewClipRange &)) &SelectMgr_SelectingVolumeManager::SetViewClipRanges, "Set clipping range.", py::arg("theRange"));
...
cls_SelectMgr_SelectingVolumeManager.def("GetMousePosition", (gp_Pnt2d (SelectMgr_SelectingVolumeManager::*)() const) &SelectMgr_SelectingVolumeManager::GetMousePosition, "Return mouse coordinates for Point selection mode.");
...
// Constructors
cls_SelectMgr_SensitiveEntity.def(py::init<const opencascade::handle<Select3D_SensitiveEntity> &>(), py::arg("theEntity"));
...
cls_SelectMgr_SensitiveEntity.def("BaseSensitive", (const opencascade::handle<Select3D_SensitiveEntity> & (SelectMgr_SensitiveEntity::*)() const) &SelectMgr_SensitiveEntity::BaseSensitive, "Returns related instance of SelectBasics class");
...
cls_SelectMgr_Selection.def("Add", (void (SelectMgr_Selection::*)(const opencascade::handle<Select3D_SensitiveEntity> &)) &SelectMgr_Selection::Add, "Adds the sensitive primitive to the list of stored entities in this object. Raises NullObject if the primitive is a null handle.", py::arg("theSensitive"));
...
// TYPEDEF: SELECTMGR_SEQUENCEOFSELECTION
bind_NCollection_Sequence<opencascade::handle<SelectMgr_Selection> >(mod, "SelectMgr_SequenceOfSelection", py::module_local(false));

// TYPEDEF: SELECTMGR_SEQUENCEOFOWNER
bind_NCollection_Sequence<opencascade::handle<SelectMgr_EntityOwner> >(mod, "SelectMgr_SequenceOfOwner", py::module_local(false));
...
cls_SelectMgr_SelectableObject.def("ComputeSelection", (void (SelectMgr_SelectableObject::*)(const opencascade::handle<SelectMgr_Selection> &, const Standard_Integer)) &SelectMgr_SelectableObject::ComputeSelection, "Computes sensitive primitives for the given selection mode - key interface method of Selectable Object.", py::arg("theSelection"), py::arg("theMode"));
cls_SelectMgr_SelectableObject.def("AcceptShapeDecomposition", (Standard_Boolean (SelectMgr_SelectableObject::*)() const) &SelectMgr_SelectableObject::AcceptShapeDecomposition, "Informs the graphic context that the interactive Object may be decomposed into sub-shapes for dynamic selection. The most used Interactive Object is AIS_Shape.");
...
cls_SelectMgr_SelectableObject.def("HilightSelected", (void (SelectMgr_SelectableObject::*)(const opencascade::handle<PrsMgr_PresentationManager> &, const SelectMgr_SequenceOfOwner &)) &SelectMgr_SelectableObject::HilightSelected, "Method which draws selected owners ( for fast presentation draw )", py::arg("thePrsMgr"), py::arg("theSeq"));
...
cls_SelectMgr_SelectableObject.def("SetAutoHilight", (void (SelectMgr_SelectableObject::*)(const Standard_Boolean)) &SelectMgr_SelectableObject::SetAutoHilight, "Set AutoHilight property to true or false.", py::arg("theAutoHilight"));
cls_SelectMgr_SelectableObject.def("GetHilightPresentation", (opencascade::handle<Prs3d_Presentation> (SelectMgr_SelectableObject::*)(const opencascade::handle<PrsMgr_PresentationManager> &)) &SelectMgr_SelectableObject::GetHilightPresentation, "Creates or returns existing presentation for highlighting detected object.", py::arg("thePrsMgr"));
cls_SelectMgr_SelectableObject.def("GetSelectPresentation", (opencascade::handle<Prs3d_Presentation> (SelectMgr_SelectableObject::*)(const opencascade::handle<PrsMgr_PresentationManager> &)) &SelectMgr_SelectableObject::GetSelectPresentation, "Creates or returns existing presentation for highlighting selected object.", py::arg("thePrsMgr"));
...
cls_SelectMgr_SelectableObject.def("GlobalSelectionMode", (Standard_Integer (SelectMgr_SelectableObject::*)() const) &SelectMgr_SelectableObject::GlobalSelectionMode, "Returns the mode for selection of object as a whole; 0 by default.");
...
cls_SelectMgr_SelectableObject.def("DumpJson", [](SelectMgr_SelectableObject &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_SelectMgr_SelectableObject.def("DumpJson", (void (SelectMgr_SelectableObject::*)(Standard_OStream &, const Standard_Integer) const) &SelectMgr_SelectableObject::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
py::class_<SelectMgr_EntityOwner, opencascade::handle<SelectMgr_EntityOwner>, Standard_Transient> cls_SelectMgr_EntityOwner(mod, "SelectMgr_EntityOwner", "A framework to define classes of owners of sensitive primitives. The owner is the link between application and selection data structures. For the application to make its own objects selectable, it must define owner classes inheriting this framework.");
...
cls_SelectMgr_EntityOwner.def("Priority", (Standard_Integer (SelectMgr_EntityOwner::*)() const) &SelectMgr_EntityOwner::Priority, "Return selection priority (within range [0-9]) for results with the same depth; 0 by default. Example - selection of shapes: the owners are selectable objects (presentations) a user can give vertex priority [3], edges [2] faces [1] shape [0], so that if during selection one vertex one edge and one face are simultaneously detected, the vertex will only be hilighted.");
cls_SelectMgr_EntityOwner.def("SetPriority", (void (SelectMgr_EntityOwner::*)(Standard_Integer)) &SelectMgr_EntityOwner::SetPriority, "Sets the selectable priority of the owner within range [0-9].", py::arg("thePriority"));
...
cls_SelectMgr_EntityOwner.def("HandleMouseClick", (Standard_Boolean (SelectMgr_EntityOwner::*)(const Graphic3d_Vec2i &, Aspect_VKeyMouse, Aspect_VKeyFlags, bool)) &SelectMgr_EntityOwner::HandleMouseClick, "Handle mouse button click event. Does nothing by default and returns FALSE.", py::arg("thePoint"), py::arg("theButton"), py::arg("theModifiers"), py::arg("theIsDoubleClick"));
...
cls_SelectMgr_EntityOwner.def("IsHilighted", (Standard_Boolean (SelectMgr_EntityOwner::*)(const opencascade::handle<PrsMgr_PresentationManager> &, const Standard_Integer) const) &SelectMgr_EntityOwner::IsHilighted, "Returns true if the presentation manager highlights selections corresponding to the selection mode.", py::arg("thePrsMgr"), py::arg("theMode"));
cls_SelectMgr_EntityOwner.def("HilightWithColor", [](SelectMgr_EntityOwner &self, const opencascade::handle<PrsMgr_PresentationManager> & a0, const opencascade::handle<Prs3d_Drawer> & a1) -> void { return self.HilightWithColor(a0, a1); });
cls_SelectMgr_EntityOwner.def("HilightWithColor", (void (SelectMgr_EntityOwner::*)(const opencascade::handle<PrsMgr_PresentationManager> &, const opencascade::handle<Prs3d_Drawer> &, const Standard_Integer)) &SelectMgr_EntityOwner::HilightWithColor, "Highlights selectable object's presentation with display mode in presentation manager with given highlight style. Also a check for auto-highlight is performed - if selectable object manages highlighting on its own, execution will be passed to SelectMgr_SelectableObject::HilightOwnerWithColor method.", py::arg("thePrsMgr"), py::arg("theStyle"), py::arg("theMode"));
...
cls_SelectMgr_EntityOwner.def("Clear", (void (SelectMgr_EntityOwner::*)(const opencascade::handle<PrsMgr_PresentationManager> &, const Standard_Integer)) &SelectMgr_EntityOwner::Clear, "Clears the owners matching the value of the selection mode aMode from the presentation manager object aPM.", py::arg("thePrsMgr"), py::arg("theMode"));
cls_SelectMgr_EntityOwner.def("HasLocation", (Standard_Boolean (SelectMgr_EntityOwner::*)() const) &SelectMgr_EntityOwner::HasLocation, "Returns TRUE if selectable has transformation.");
cls_SelectMgr_EntityOwner.def("Location", (TopLoc_Location (SelectMgr_EntityOwner::*)() const) &SelectMgr_EntityOwner::Location, "Returns transformation of selectable.");
cls_SelectMgr_EntityOwner.def("SetLocation", (void (SelectMgr_EntityOwner::*)(const TopLoc_Location &)) &SelectMgr_EntityOwner::SetLocation, "Change owner location (callback for handling change of location of selectable object).", py::arg("theLocation"));
...
cls_SelectMgr_EntityOwner.def("State", (Standard_Integer (SelectMgr_EntityOwner::*)() const) &SelectMgr_EntityOwner::State, "Returns selection state.");
...
cls_SelectMgr_EntityOwner.def("IsForcedHilight", (Standard_Boolean (SelectMgr_EntityOwner::*)() const) &SelectMgr_EntityOwner::IsForcedHilight, "if this method returns TRUE the owner will always call method Hilight for SelectableObject when the owner is detected. By default it always return FALSE.");
...
cls_SelectMgr_EntityOwner.def("UpdateHighlightTrsf", (void (SelectMgr_EntityOwner::*)(const opencascade::handle<V3d_Viewer> &, const opencascade::handle<PrsMgr_PresentationManager> &, const Standard_Integer)) &SelectMgr_EntityOwner::UpdateHighlightTrsf, "Implements immediate application of location transformation of parent object to dynamic highlight structure", py::arg("theViewer"), py::arg("theManager"), py::arg("theDispMode"));
...
cls_SelectMgr_EntityOwner.def("DumpJson", [](SelectMgr_EntityOwner &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_SelectMgr_EntityOwner.def("DumpJson", (void (SelectMgr_EntityOwner::*)(Standard_OStream &, const Standard_Integer) const) &SelectMgr_EntityOwner::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
cls_SelectMgr_EntityOwner.def("Set", (void (SelectMgr_EntityOwner::*)(const Standard_Integer)) &SelectMgr_EntityOwner::Set, "sets the selectable priority of the owner", py::arg("thePriority"));

// TYPEDEF: SELECTBASICS_ENTITYOWNER
if (py::hasattr(mod, "SelectMgr_EntityOwner")) {
	mod.attr("SelectBasics_EntityOwner") = mod.attr("SelectMgr_EntityOwner");
}
...
// TYPEDEF: SELECTMGR_LISTOFFILTER
bind_NCollection_List<opencascade::handle<SelectMgr_Filter> >(mod, "SelectMgr_ListOfFilter", py::module_local(false));

// TYPEDEF: SELECTMGR_LISTITERATOROFLISTOFFILTER
bind_NCollection_TListIterator<opencascade::handle<SelectMgr_Filter> >(mod, "SelectMgr_ListIteratorOfListOfFilter", py::module_local(false));
...
// TYPEDEF: SELECTMGR_INDEXEDDATAMAPOFOWNERCRITERION
bind_NCollection_IndexedDataMap<opencascade::handle<SelectMgr_EntityOwner>, SelectMgr_SortCriterion, NCollection_DefaultHasher<opencascade::handle<Standard_Transient> > >(mod, "SelectMgr_IndexedDataMapOfOwnerCriterion", py::module_local(false));
...
cls_SelectMgr_ViewerSelector.def("PickedEntity", (const opencascade::handle<Select3D_SensitiveEntity> & (SelectMgr_ViewerSelector::*)(const Standard_Integer) const) &SelectMgr_ViewerSelector::PickedEntity, "Returns the Entity for the object picked at specified position.", py::arg("theRank"));
...
cls_SelectMgr_ViewerSelector.def("ActiveOwners", (void (SelectMgr_ViewerSelector::*)(NCollection_List<opencascade::handle<SelectMgr_EntityOwner> > &) const) &SelectMgr_ViewerSelector::ActiveOwners, "Returns the list of active entity owners", py::arg("theOwners"));
...
cls_SelectMgr_ViewerSelector.def("DumpJson", [](SelectMgr_ViewerSelector &self, Standard_OStream & a0) -> void { return self.DumpJson(a0); });
cls_SelectMgr_ViewerSelector.def("DumpJson", (void (SelectMgr_ViewerSelector::*)(Standard_OStream &, const Standard_Integer) const) &SelectMgr_ViewerSelector::DumpJson, "Dumps the content of me into the stream", py::arg("theOStream"), py::arg("theDepth"));
...
cls_SelectMgr_ViewerSelector.def("DetectedEntity", (const opencascade::handle<Select3D_SensitiveEntity> & (SelectMgr_ViewerSelector::*)() const) &SelectMgr_ViewerSelector::DetectedEntity, "Returns sensitive entity that was detected during the previous run of selection algorithm");

// TYPEDEF: SELECTMGR_SOPTR
...
// Constructors
cls_SelectMgr_SelectionManager.def(py::init<const opencascade::handle<SelectMgr_ViewerSelector> &>(), py::arg("theSelector"));
...
cls_SelectMgr_SelectionManager.def("Selector", (const opencascade::handle<SelectMgr_ViewerSelector> & (SelectMgr_SelectionManager::*)() const) &SelectMgr_SelectionManager::Selector, "Return the Selector.");
...
cls_SelectMgr_SelectionManager.def("Activate", (void (SelectMgr_SelectionManager::*)(const opencascade::handle<SelectMgr_SelectableObject> &, const Standard_Integer)) &SelectMgr_SelectionManager::Activate, "Activates the selection mode theMode in the selector theSelector for the selectable object anObject. By default, theMode is equal to 0. If theSelector is set to default (NULL), the selection with the mode theMode will be activated in all the viewers available.", py::arg("theObject"), py::arg("theMode"));
...
cls_SelectMgr_SelectionManager.def("Deactivate", (void (SelectMgr_SelectionManager::*)(const opencascade::handle<SelectMgr_SelectableObject> &, const Standard_Integer)) &SelectMgr_SelectionManager::Deactivate, "Deactivates mode theMode of theObject in theSelector. If theMode value is set to default (-1), all active selection modes will be deactivated. Likewise, if theSelector value is set to default (NULL), theMode will be deactivated in all viewer selectors.", py::arg("theObject"), py::arg("theMode"));
...
cls_SelectMgr_SelectionManager.def("IsActivated", (Standard_Boolean (SelectMgr_SelectionManager::*)(const opencascade::handle<SelectMgr_SelectableObject> &, const Standard_Integer) const) &SelectMgr_SelectionManager::IsActivated, "Returns true if the selection with theMode is active for the selectable object theObject and selector theSelector. If all parameters are set to default values, it returns it there is any active selection in any known viewer selector for object theObject.", py::arg("theObject"), py::arg("theMode"));
...
cls_SelectMgr_SelectionManager.def("ClearSelectionStructures", (void (SelectMgr_SelectionManager::*)(const opencascade::handle<SelectMgr_SelectableObject> &, const Standard_Integer)) &SelectMgr_SelectionManager::ClearSelectionStructures, "Removes sensitive entities from all viewer selectors after method Clear() was called to the selection they belonged to or it was recomputed somehow.", py::arg("theObj"), py::arg("theMode"));
...
cls_SelectMgr_SelectionManager.def("RestoreSelectionStructures", (void (SelectMgr_SelectionManager::*)(const opencascade::handle<SelectMgr_SelectableObject> &, const Standard_Integer)) &SelectMgr_SelectionManager::RestoreSelectionStructures, "Re-adds newly calculated sensitive entities of recomputed selection defined by mode theMode to all viewer selectors contained that selection.", py::arg("theObj"), py::arg("theMode"));
...
// TYPEDEF: SELECTMGR_SEQUENCEOFFILTER
bind_NCollection_Sequence<opencascade::handle<SelectMgr_Filter> >(mod, "SelectMgr_SequenceOfFilter", py::module_local(false));
