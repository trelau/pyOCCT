...
PYBIND11_MODULE(StepAP209, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepAP209_Construct.hxx
	py::class_<StepAP209_Construct, std::unique_ptr<StepAP209_Construct, Deleter<StepAP209_Construct>>, STEPConstruct_Tool> cls_StepAP209_Construct(mod, "StepAP209_Construct", "Basic tool for working with AP209 model");
