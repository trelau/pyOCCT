...
cls_NCollection_CellFilter.def("Add", (void (NCollection_CellFilter<Inspector>::*)(const typename NCollection_CellFilter<Inspector>::Target &, const typename NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Add, "Adds a target object for further search at a point (into only one cell)", py::arg("theTarget"), py::arg("thePnt"));
cls_NCollection_CellFilter.def("Add", (void (NCollection_CellFilter<Inspector>::*)(const typename NCollection_CellFilter<Inspector>::Target &, const typename NCollection_CellFilter<Inspector>::Point &, const typename NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Add, "Adds a target object for further search in the range of cells defined by two points (the first point must have all co-ordinates equal or less than the same co-ordinate of the second point)", py::arg("theTarget"), py::arg("thePntMin"), py::arg("thePntMax"));
cls_NCollection_CellFilter.def("Remove", (void (NCollection_CellFilter<Inspector>::*)(const typename NCollection_CellFilter<Inspector>::Target &, const typename NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Remove, "Find a target object at a point and remove it from the structures. For usage of this method 'operator ==' should be defined for Target.", py::arg("theTarget"), py::arg("thePnt"));
cls_NCollection_CellFilter.def("Remove", (void (NCollection_CellFilter<Inspector>::*)(const typename NCollection_CellFilter<Inspector>::Target &, const typename NCollection_CellFilter<Inspector>::Point &, const typename NCollection_CellFilter<Inspector>::Point &)) &NCollection_CellFilter<Inspector>::Remove, "Find a target object in the range of cells defined by two points and remove it from the structures (the first point must have all co-ordinates equal or less than the same co-ordinate of the second point). For usage of this method 'operator ==' should be defined for Target.", py::arg("theTarget"), py::arg("thePntMin"), py::arg("thePntMax"));
cls_NCollection_CellFilter.def("Inspect", (void (NCollection_CellFilter<Inspector>::*)(const typename NCollection_CellFilter<Inspector>::Point &, Inspector &)) &NCollection_CellFilter<Inspector>::Inspect, "Inspect all targets in the cell corresponding to the given point", py::arg("thePnt"), py::arg("theInspector"));
