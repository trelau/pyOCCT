...
// Methods
cls_NCollection_Sequence.def("begin", (NCollection_Sequence<TheItemType>::iterator (NCollection_Sequence<TheItemType>::*)() const) &NCollection_Sequence<TheItemType>::begin, "Returns an iterator pointing to the first element in the sequence.");
cls_NCollection_Sequence.def("end", (NCollection_Sequence<TheItemType>::iterator (NCollection_Sequence<TheItemType>::*)() const) &NCollection_Sequence<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the sequence.");
cls_NCollection_Sequence.def("cbegin", (NCollection_Sequence<TheItemType>::const_iterator (NCollection_Sequence<TheItemType>::*)() const) &NCollection_Sequence<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
cls_NCollection_Sequence.def("cend", (NCollection_Sequence<TheItemType>::const_iterator (NCollection_Sequence<TheItemType>::*)() const) &NCollection_Sequence<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
...
cls_NCollection_Sequence.def("Remove", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &)) &NCollection_Sequence<TheItemType>::Remove, "Remove one item", py::arg("thePosition"));
...
cls_NCollection_Sequence.def("InsertBefore", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
cls_NCollection_Sequence.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
cls_NCollection_Sequence.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theSeq"));
cls_NCollection_Sequence.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter theIndex another sequence", py::arg("theIndex"), py::arg("theItem"));
