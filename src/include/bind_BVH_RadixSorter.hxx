...
py::class_<BVH_RadixSorter<T, N>, std::unique_ptr<BVH_RadixSorter<T, N>, Deleter<BVH_RadixSorter<T, N>>>, BVH_Sorter<T, N>> cls_BVH_RadixSorter(mod, name.c_str(), "Performs radix sort of a BVH primitive set using 10-bit Morton codes (or 1024 x 1024 x 1024 grid).", local);
