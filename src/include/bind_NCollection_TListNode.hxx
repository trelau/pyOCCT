...
py::class_<NCollection_TListNode<TheItemType>, std::unique_ptr<NCollection_TListNode<TheItemType>, Deleter<NCollection_TListNode<TheItemType>>>, NCollection_ListNode> cls_NCollection_TListNode(mod, name.c_str(), "Purpose: Abstract list node class. Used by BaseList Remark: Internal class", local);
