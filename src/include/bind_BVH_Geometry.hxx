...
py::class_<BVH_Geometry<T, N>, std::unique_ptr<BVH_Geometry<T, N>, Deleter<BVH_Geometry<T, N>>>, BVH_ObjectSet<T, N>> cls_BVH_Geometry(mod, name.c_str(), "BVH geometry as a set of abstract geometric objects organized with bounding volume hierarchy (BVH).", local);
