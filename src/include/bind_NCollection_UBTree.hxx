...
// Nested classes
py::class_<NCollection_UBTree<TheObjType, TheBndType>::Selector> cls_Selector(cls_NCollection_UBTree, "Selector", "Class defining the minimal interface of selector.", local);
