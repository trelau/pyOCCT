...
py::class_<OpenGl_TmplCore40<theBaseClass_t>, std::unique_ptr<OpenGl_TmplCore40<theBaseClass_t>>, theBaseClass_t> cls_OpenGl_TmplCore40(mod, name.c_str(), "OpenGL 4.0 definition.", local);
