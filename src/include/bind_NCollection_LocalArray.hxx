...
py::class_<NCollection_LocalArray<theItem, MAX_ARRAY_SIZE>, std::unique_ptr<NCollection_LocalArray<theItem, MAX_ARRAY_SIZE>, Deleter<NCollection_LocalArray<theItem, MAX_ARRAY_SIZE>>>> cls_NCollection_LocalArray(mod, name.c_str(), "Auxiliary class optimizing creation of array buffer (using stack allocation for small arrays).", local);
