...
py::class_<NCollection_SparseArray<TheItemType>, std::unique_ptr<NCollection_SparseArray<TheItemType>, Deleter<NCollection_SparseArray<TheItemType>>>, NCollection_SparseArrayBase> cls_NCollection_SparseArray(mod, name.c_str(), "Dynamically resizable sparse array of objects", local);
