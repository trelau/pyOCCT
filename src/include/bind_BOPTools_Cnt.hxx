...
py::class_<BOPTools_Cnt<TypeFunctor, TypeSolverVector>, std::unique_ptr<BOPTools_Cnt<TypeFunctor, TypeSolverVector>, Deleter<BOPTools_Cnt<TypeFunctor, TypeSolverVector>>>> cls_BOPTools_Cnt(mod, name.c_str(), "None", local);
