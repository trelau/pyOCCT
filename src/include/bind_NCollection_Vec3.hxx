...
py::class_<NCollection_Vec3<Element_t>, std::unique_ptr<NCollection_Vec3<Element_t>, Deleter<NCollection_Vec3<Element_t>>>> cls_NCollection_Vec3(mod, name.c_str(), "Generic 3-components vector. To be used as RGB color pixel or XYZ 3D-point. The main target for this class - to handle raw low-level arrays (from/to graphic driver etc.).", local);
