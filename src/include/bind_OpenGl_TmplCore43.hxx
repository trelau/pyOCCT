...
py::class_<OpenGl_TmplCore43<theBaseClass_t>, std::unique_ptr<OpenGl_TmplCore43<theBaseClass_t>>, theBaseClass_t> cls_OpenGl_TmplCore43(mod, name.c_str(), "OpenGL 4.3 definition.", local);
