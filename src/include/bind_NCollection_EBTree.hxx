...
cls_NCollection_EBTree.def("FindNode", (const typename NCollection_EBTree<TheObjType, TheBndType>::TreeNode & (NCollection_EBTree<TheObjType, TheBndType>::*)(const TheObjType &) const) &NCollection_EBTree<TheObjType, TheBndType>::FindNode, "Returns The leaf node containing the object.", py::arg("theObj"));
