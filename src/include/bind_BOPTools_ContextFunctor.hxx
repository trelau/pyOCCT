...
py::class_<BOPTools_ContextFunctor<TypeSolver, TypeSolverVector, TypeContext, TN>, std::unique_ptr<BOPTools_ContextFunctor<TypeSolver, TypeSolverVector, TypeContext, TN>, Deleter<BOPTools_ContextFunctor<TypeSolver, TypeSolverVector, TypeContext, TN>>>> cls_BOPTools_ContextFunctor(mod, name.c_str(), "None", local);
