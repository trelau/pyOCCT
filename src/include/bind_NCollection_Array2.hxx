...
*/
#ifndef __NCollection_Array2__
#define __NCollection_Array2__
...
py::class_<NCollection_Array2<TheItemType>, std::unique_ptr<NCollection_Array2<TheItemType>, Deleter<NCollection_Array2<TheItemType>>>> cls_NCollection_Array2(mod, name.c_str(), "Purpose: The class Array2 represents bi-dimensional arrays of fixed size known at run time. The ranges of indices are user defined.", local);
