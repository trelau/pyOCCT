...
py::class_<NCollection_List<TheItemType>, std::unique_ptr<NCollection_List<TheItemType>, Deleter<NCollection_List<TheItemType>>>, NCollection_BaseList> cls_NCollection_List(mod, name.c_str(), "Purpose: Simple list to link items together keeping the first and the last one. Inherits BaseList, adding the data item to each node.", local);
...
// Methods
cls_NCollection_List.def("begin", (NCollection_List<TheItemType>::iterator (NCollection_List<TheItemType>::*)() const) &NCollection_List<TheItemType>::begin, "Returns an iterator pointing to the first element in the list.");
cls_NCollection_List.def("end", (NCollection_List<TheItemType>::iterator (NCollection_List<TheItemType>::*)() const) &NCollection_List<TheItemType>::end, "Returns an iterator referring to the past-the-end element in the list.");
cls_NCollection_List.def("cbegin", (NCollection_List<TheItemType>::const_iterator (NCollection_List<TheItemType>::*)() const) &NCollection_List<TheItemType>::cbegin, "Returns a const iterator pointing to the first element in the list.");
cls_NCollection_List.def("cend", (NCollection_List<TheItemType>::const_iterator (NCollection_List<TheItemType>::*)() const) &NCollection_List<TheItemType>::cend, "Returns a const iterator referring to the past-the-end element in the list.");
...
cls_NCollection_List.def("Append", (void (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Append, "Append one item at the end and output iterator pointing at the appended item", py::arg("theItem"), py::arg("theIter"));
cls_NCollection_List.def("Append", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &)) &NCollection_List<TheItemType>::Append, "Append another list at the end", py::arg("theOther"));
...
cls_NCollection_List.def("Remove", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Remove, "Remove item pointed by iterator theIter; theIter is then set to the next item", py::arg("theIter"));
cls_NCollection_List.def("InsertBefore", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theItem"), py::arg("theIter"));
cls_NCollection_List.def("InsertBefore", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theOther"), py::arg("theIter"));
cls_NCollection_List.def("InsertAfter", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theItem"), py::arg("theIter"));
cls_NCollection_List.def("InsertAfter", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theOther"), py::arg("theIter"));
