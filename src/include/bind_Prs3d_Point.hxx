...
py::class_<Prs3d_Point<AnyPoint, PointTool>, std::unique_ptr<Prs3d_Point<AnyPoint, PointTool>, Deleter<Prs3d_Point<AnyPoint, PointTool>>>> cls_Prs3d_Point(mod, name.c_str(), "None", local);
