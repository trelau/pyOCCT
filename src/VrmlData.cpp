...
PYBIND11_MODULE(VrmlData, mod) {
	...
	// FIXME cls_VrmlData_Scene.def("operator<<", (VrmlData_Scene & (VrmlData_Scene::*)(Standard_IStream &)) &VrmlData_Scene::operator<<, "Import from text stream (file or else). This method is protected by Mutex, it is not allowed to read/write two VRML streams concurrently.", py::arg("theInput"));
