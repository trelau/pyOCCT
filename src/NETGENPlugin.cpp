...
PYBIND11_MODULE(NETGENPlugin, mod) {
	...
	cls_NETGENPlugin_NetgenLibWrapper.def("setMesh", (void (NETGENPlugin_NetgenLibWrapper::*)(nglib::Ng_Mesh *)) &NETGENPlugin_NetgenLibWrapper::setMesh, "None", py::arg("mesh"));
	...
	cls_NETGENPlugin_Mesher.def_static("SetLocalSize_", (void (*)(netgen::OCCGeometry &, netgen::Mesh &)) &NETGENPlugin_Mesher::SetLocalSize, "None", py::arg("occgeo"), py::arg("ngMesh"));
	...
	cls_NETGENPlugin_Mesher.def_static("PrepareOCCgeometry_", [](netgen::OCCGeometry & a0, const TopoDS_Shape & a1, SMESH_Mesh & a2) -> void { return NETGENPlugin_Mesher::PrepareOCCgeometry(a0, a1, a2); }, py::arg("occgeom"), py::arg("shape"), py::arg("mesh"));
	cls_NETGENPlugin_Mesher.def_static("PrepareOCCgeometry_", [](netgen::OCCGeometry & a0, const TopoDS_Shape & a1, SMESH_Mesh & a2, std::list<SMESH_subMesh *> * a3) -> void { return NETGENPlugin_Mesher::PrepareOCCgeometry(a0, a1, a2, a3); }, py::arg("occgeom"), py::arg("shape"), py::arg("mesh"), py::arg("meshedSM"));
	cls_NETGENPlugin_Mesher.def_static("PrepareOCCgeometry_", (void (*)(netgen::OCCGeometry &, const TopoDS_Shape &, SMESH_Mesh &, std::list<SMESH_subMesh *> *, NETGENPlugin_Internals *)) &NETGENPlugin_Mesher::PrepareOCCgeometry, "None", py::arg("occgeom"), py::arg("shape"), py::arg("mesh"), py::arg("meshedSM"), py::arg("internalShapes"));
	...
	cls_NETGENPlugin_Mesher.def_static("RestrictLocalSize_", [](netgen::Mesh & a0, const gp_XYZ & a1, double a2) -> void { return NETGENPlugin_Mesher::RestrictLocalSize(a0, a1, a2); }, py::arg("ngMesh"), py::arg("p"), py::arg("size"));
	cls_NETGENPlugin_Mesher.def_static("RestrictLocalSize_", (void (*)(netgen::Mesh &, const gp_XYZ &, double, const bool)) &NETGENPlugin_Mesher::RestrictLocalSize, "None", py::arg("ngMesh"), py::arg("p"), py::arg("size"), py::arg("overrideMinH"));
	cls_NETGENPlugin_Mesher.def_static("FillSMesh_", [](const netgen::OCCGeometry & a0, netgen::Mesh & a1, const NETGENPlugin_ngMeshInfo & a2, SMESH_Mesh & a3, std::vector<const SMDS_MeshNode *> & a4, SMESH_Comment & a5) -> int { return NETGENPlugin_Mesher::FillSMesh(a0, a1, a2, a3, a4, a5); }, py::arg("occgeom"), py::arg("ngMesh"), py::arg("initState"), py::arg("sMesh"), py::arg("nodeVec"), py::arg("comment"));
	cls_NETGENPlugin_Mesher.def_static("FillSMesh_", (int (*)(const netgen::OCCGeometry &, netgen::Mesh &, const NETGENPlugin_ngMeshInfo &, SMESH_Mesh &, std::vector<const SMDS_MeshNode *> &, SMESH_Comment &, SMESH_MesherHelper *)) &NETGENPlugin_Mesher::FillSMesh, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("initState"), py::arg("sMesh"), py::arg("nodeVec"), py::arg("comment"), py::arg("quadHelper"));
	cls_NETGENPlugin_Mesher.def("FillNgMesh", [](NETGENPlugin_Mesher &self, netgen::OCCGeometry & a0, netgen::Mesh & a1, std::vector<const SMDS_MeshNode *> & a2, const std::list<SMESH_subMesh *> & a3) -> bool { return self.FillNgMesh(a0, a1, a2, a3); }, py::arg("occgeom"), py::arg("ngMesh"), py::arg("nodeVec"), py::arg("meshedSM"));
	cls_NETGENPlugin_Mesher.def("FillNgMesh", [](NETGENPlugin_Mesher &self, netgen::OCCGeometry & a0, netgen::Mesh & a1, std::vector<const SMDS_MeshNode *> & a2, const std::list<SMESH_subMesh *> & a3, SMESH_MesherHelper * a4) -> bool { return self.FillNgMesh(a0, a1, a2, a3, a4); }, py::arg("occgeom"), py::arg("ngMesh"), py::arg("nodeVec"), py::arg("meshedSM"), py::arg("quadHelper"));
	cls_NETGENPlugin_Mesher.def("FillNgMesh", (bool (NETGENPlugin_Mesher::*)(netgen::OCCGeometry &, netgen::Mesh &, std::vector<const SMDS_MeshNode *> &, const std::list<SMESH_subMesh *> &, SMESH_MesherHelper *, SMESH_ProxyMesh::Ptr)) &NETGENPlugin_Mesher::FillNgMesh, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("nodeVec"), py::arg("meshedSM"), py::arg("quadHelper"), py::arg("proxyMesh"));
	cls_NETGENPlugin_Mesher.def_static("FixIntFaces_", (void (*)(const netgen::OCCGeometry &, netgen::Mesh &, NETGENPlugin_Internals &)) &NETGENPlugin_Mesher::FixIntFaces, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("internalShapes"));
	cls_NETGENPlugin_Mesher.def_static("FixFaceMesh_", (bool (*)(const netgen::OCCGeometry &, netgen::Mesh &, const int)) &NETGENPlugin_Mesher::FixFaceMesh, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("faceID"));
	cls_NETGENPlugin_Mesher.def_static("AddIntVerticesInFaces_", (void (*)(const netgen::OCCGeometry &, netgen::Mesh &, std::vector<const SMDS_MeshNode *> &, NETGENPlugin_Internals &)) &NETGENPlugin_Mesher::AddIntVerticesInFaces, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("nodeVec"), py::arg("internalShapes"));
	cls_NETGENPlugin_Mesher.def_static("AddIntVerticesInSolids_", (void (*)(const netgen::OCCGeometry &, netgen::Mesh &, std::vector<const SMDS_MeshNode *> &, NETGENPlugin_Internals &)) &NETGENPlugin_Mesher::AddIntVerticesInSolids, "None", py::arg("occgeom"), py::arg("ngMesh"), py::arg("nodeVec"), py::arg("internalShapes"));
	cls_NETGENPlugin_Mesher.def_static("AddSegmentsToMesh_", [](netgen::Mesh & a0, netgen::OCCGeometry & a1, const TSideVector & a2, SMESH_MesherHelper & a3, std::vector<const SMDS_MeshNode *> & a4) -> SMESH_ComputeErrorPtr { return NETGENPlugin_Mesher::AddSegmentsToMesh(a0, a1, a2, a3, a4); }, py::arg("ngMesh"), py::arg("geom"), py::arg("wires"), py::arg("helper"), py::arg("nodeVec"));
	cls_NETGENPlugin_Mesher.def_static("AddSegmentsToMesh_", (SMESH_ComputeErrorPtr (*)(netgen::Mesh &, netgen::OCCGeometry &, const TSideVector &, SMESH_MesherHelper &, std::vector<const SMDS_MeshNode *> &, const bool)) &NETGENPlugin_Mesher::AddSegmentsToMesh, "None", py::arg("ngMesh"), py::arg("geom"), py::arg("wires"), py::arg("helper"), py::arg("nodeVec"), py::arg("overrideMinH"));
	...
	cls_NETGENPlugin_Mesher.def_static("toPython_", (void (*)(const netgen::Mesh *)) &NETGENPlugin_Mesher::toPython, "None", py::arg("ngMesh"));
