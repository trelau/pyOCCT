...
py::class_<BVH_Set<T, N>> cls_BVH_Set(mod, name.c_str(), "Set of abstract entities (bounded by BVH boxes). This is the minimal geometry interface needed to construct BVH.", local);
