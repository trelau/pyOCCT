...
cls_NCollection_Array1.def("__getitem__", (const TheItemType & (NCollection_Array1<TheItemType>::*)(Standard_Integer) const) &NCollection_Array1<TheItemType>::operator[], py::is_operator(), "operator[] - alias to Value", py::arg("theIndex"));
...
cls_NCollection_Array1.def("__getitem__", (TheItemType & (NCollection_Array1<TheItemType>::*)(Standard_Integer)) &NCollection_Array1<TheItemType>::operator[], py::is_operator(), "operator[] - alias to ChangeValue", py::arg("theIndex"));
