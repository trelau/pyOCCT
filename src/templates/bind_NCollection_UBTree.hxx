...
py::class_<NCollection_UBTree<TheObjType, TheBndType>> cls_NCollection_UBTree(mod, name.c_str(), "The algorithm of unbalanced binary tree of overlapped bounding boxes.", local);
...
cls_NCollection_UBTree_Selector.def("Accept", (Standard_Boolean (NCollection_UBTree<TheObjType, TheBndType>::Selector::*)(const TheObjType &)) &NCollection_UBTree<TheObjType, TheBndType>::Selector::Accept, "Confirm the object while making necessary tests on it. This method is called when the bounding box of the object conforms to the conditions (see Reject()). It is also supposed to keep record of accepted objects.", py::arg(""));
cls_NCollection_UBTree_Selector.def("Stop", (Standard_Boolean (NCollection_UBTree<TheObjType, TheBndType>::Selector::*)() const) &NCollection_UBTree<TheObjType, TheBndType>::Selector::Stop, "This condition is checked after each call to Accept().");
