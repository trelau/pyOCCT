...
py::class_<NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>, NCollection_BaseMap> cls_NCollection_DoubleMap(mod, name.c_str(), "Purpose: The DoubleMap is used to bind pairs (Key1,Key2) and retrieve them in linear time.", local);
...
cls_NCollection_DoubleMap.def("Find1", (const TheKey2Type & (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey1Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Find1, "Find the Key1 and return Key2 value. Raises an exception if Key1 was not bound.", py::arg("theKey1"));
cls_NCollection_DoubleMap.def("Find1", (Standard_Boolean (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey1Type &, TheKey2Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Find1, "Find the Key1 and return Key2 value (by copying its value).", py::arg("theKey1"), py::arg("theKey2"));
cls_NCollection_DoubleMap.def("Seek1", (const TheKey2Type * (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey1Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Seek1, "Find the Key1 and return pointer to Key2 or NULL if Key1 is not bound.", py::arg("theKey1"));
cls_NCollection_DoubleMap.def("Find2", (const TheKey1Type & (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey2Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Find2, "Find the Key2 and return Key1 value. Raises an exception if Key2 was not bound.", py::arg("theKey2"));
cls_NCollection_DoubleMap.def("Find2", (Standard_Boolean (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey2Type &, TheKey1Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Find2, "Find the Key2 and return Key1 value (by copying its value).", py::arg("theKey2"), py::arg("theKey1"));
cls_NCollection_DoubleMap.def("Seek2", (const TheKey1Type * (NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::*)(const TheKey2Type &) const) &NCollection_DoubleMap<TheKey1Type, TheKey2Type, Hasher1, Hasher2>::Seek2, "Find the Key2 and return pointer to Key1 or NULL if not bound.", py::arg("theKey2"));
