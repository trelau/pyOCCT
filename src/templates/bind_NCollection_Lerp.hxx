...
py::class_<NCollection_Lerp<T>> cls_NCollection_Lerp(mod, name.c_str(), "Simple linear interpolation tool (also known as mix() in GLSL). The main purpose of this template class is making interpolation routines more readable.", local);
