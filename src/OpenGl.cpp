...
PYBIND11_MODULE(OpenGl, mod) {
	...
	cls_OpenGl_Context.def_static("ReadGlVersion_", (void (*)(Standard_Integer &, Standard_Integer &)) &OpenGl_Context::ReadGlVersion, "Read OpenGL version information from active context.", py::arg("theGlVerMajor"), py::arg("theGlVerMinor"));
	...
	cls_OpenGl_View.def("FBOGetDimensions", (void (OpenGl_View::*)(const opencascade::handle<Standard_Transient> &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &OpenGl_View::FBOGetDimensions, "Read offscreen FBO configuration.", py::arg("theFbo"), py::arg("theWidth"), py::arg("theHeight"), py::arg("theWidthMax"), py::arg("theHeightMax"));
	...
	*/
	...
	cls_OpenGl_Layer.def("Remove", [](OpenGl_Layer &self, const OpenGl_Structure * a0, Standard_Integer & a1) -> bool { return self.Remove(a0, a1); }, py::arg("theStruct"), py::arg("thePriority"));
	cls_OpenGl_Layer.def("Remove", (bool (OpenGl_Layer::*)(const OpenGl_Structure *, Standard_Integer &, Standard_Boolean)) &OpenGl_Layer::Remove, "Remove structure and returns its priority, if the structure is not found, method returns negative value", py::arg("theStruct"), py::arg("thePriority"), py::arg("isForChangePriority"));
