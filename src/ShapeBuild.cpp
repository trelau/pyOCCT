...
PYBIND11_MODULE(ShapeBuild, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeBuild_ReShape.hxx
	...
	cls_ShapeBuild_ReShape.def("Apply", [](ShapeBuild_ReShape &self, const TopoDS_Shape & a0) -> TopoDS_Shape { return self.Apply(a0); }, py::arg("shape"));
	...
	cls_ShapeBuild_ReShape.def("Status", [](ShapeBuild_ReShape &self, const TopoDS_Shape & a0, TopoDS_Shape & a1) -> Standard_Integer { return self.Status(a0, a1); }, py::arg("shape"), py::arg("newsh"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeBuild_Vertex.hxx
	...
	cls_ShapeBuild_Vertex.def("CombineVertex", [](ShapeBuild_Vertex &self, const TopoDS_Vertex & a0, const TopoDS_Vertex & a1) -> TopoDS_Vertex { return self.CombineVertex(a0, a1); }, py::arg("V1"), py::arg("V2"));
	...
	cls_ShapeBuild_Vertex.def("CombineVertex", [](ShapeBuild_Vertex &self, const gp_Pnt & a0, const gp_Pnt & a1, const Standard_Real a2, const Standard_Real a3) -> TopoDS_Vertex { return self.CombineVertex(a0, a1, a2, a3); }, py::arg("pnt1"), py::arg("pnt2"), py::arg("tol1"), py::arg("tol2"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeBuild_Edge.hxx
	...
	cls_ShapeBuild_Edge.def("CopyRanges", [](ShapeBuild_Edge &self, const TopoDS_Edge & a0, const TopoDS_Edge & a1) -> void { return self.CopyRanges(a0, a1); }, py::arg("toedge"), py::arg("fromedge"));
	cls_ShapeBuild_Edge.def("CopyRanges", [](ShapeBuild_Edge &self, const TopoDS_Edge & a0, const TopoDS_Edge & a1, const Standard_Real a2) -> void { return self.CopyRanges(a0, a1, a2); }, py::arg("toedge"), py::arg("fromedge"), py::arg("alpha"));
	...
	cls_ShapeBuild_Edge.def("Copy", [](ShapeBuild_Edge &self, const TopoDS_Edge & a0) -> TopoDS_Edge { return self.Copy(a0); }, py::arg("edge"));
	...
	cls_ShapeBuild_Edge.def("TransformPCurve", (opencascade::handle<Geom2d_Curve> (ShapeBuild_Edge::*)(const opencascade::handle<Geom2d_Curve> &, const gp_Trsf2d &, const Standard_Real, Standard_Real &, Standard_Real &) const ) &ShapeBuild_Edge::TransformPCurve, "Transforms the PCurve with given matrix and affinity U factor.", py::arg("pcurve"), py::arg("trans"), py::arg("uFact"), py::arg("aFirst"), py::arg("aLast"));
	...
	// FIXME cls_ShapeBuild_Edge.def("MakeEdge", (void (ShapeBuild_Edge::*)(TopoDS_Edge &, const opencascade::handle<Geom_Curve> &, const TopLoc_Location &, const Standard_Real, const Standard_Real) const ) &ShapeBuild_Edge::MakeEdge, "Makes edge with curve, location and range [p1, p2]", py::arg("edge"), py::arg("curve"), py::arg("L"), py::arg("p1"), py::arg("p2"));
	...
	// FIXME cls_ShapeBuild_Edge.def("MakeEdge", (void (ShapeBuild_Edge::*)(TopoDS_Edge &, const opencascade::handle<Geom2d_Curve> &, const TopoDS_Face &, const Standard_Real, const Standard_Real) const ) &ShapeBuild_Edge::MakeEdge, "Makes edge with pcurve, face and range [p1, p2]", py::arg("edge"), py::arg("pcurve"), py::arg("face"), py::arg("p1"), py::arg("p2"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeBuild.hxx
	py::class_<ShapeBuild, std::unique_ptr<ShapeBuild, Deleter<ShapeBuild>>> cls_ShapeBuild(mod, "ShapeBuild", "This package provides basic building tools for other packages in ShapeHealing. These tools are rather internal for ShapeHealing .");
