...
PYBIND11_MODULE(AIS, mod) {
	...
	cls_AIS_InteractiveObject.def("PolygonOffsets", (void (AIS_InteractiveObject::*)(Standard_Integer &, Standard_ShortReal &, Standard_ShortReal &) const ) &AIS_InteractiveObject::PolygonOffsets, "Retrieves current polygon offsets settings from <myDrawer>.", py::arg("aMode"), py::arg("aFactor"), py::arg("aUnits"));
	...
	cls_AIS_InteractiveContext.def("PolygonOffsets", (void (AIS_InteractiveContext::*)(const opencascade::handle<AIS_InteractiveObject> &, Standard_Integer &, Standard_ShortReal &, Standard_ShortReal &) const ) &AIS_InteractiveContext::PolygonOffsets, "Retrieves current polygon offsets settings for Object.", py::arg("anObj"), py::arg("aMode"), py::arg("aFactor"), py::arg("aUnits"));
	...
	cls_AIS_InteractiveContext.def("PlaneSize", (Standard_Boolean (AIS_InteractiveContext::*)(Standard_Real &, Standard_Real &) const ) &AIS_InteractiveContext::PlaneSize, "Returns true if the length in the X direction XSize is the same as that in the Y direction YSize.", py::arg("XSize"), py::arg("YSize"));
	...
	cls_AIS_InteractiveContext.def("IsInLocal", (Standard_Boolean (AIS_InteractiveContext::*)(const opencascade::handle<AIS_InteractiveObject> &, Standard_Integer &) const ) &AIS_InteractiveContext::IsInLocal, "returns if possible, the first local context where the object is seen", py::arg("anObject"), py::arg("TheIndex"));
	...
	cls_AIS_GraphicTool.def_static("GetLineAtt_", (void (*)(const opencascade::handle<Prs3d_Drawer> &, const AIS_TypeOfAttribute, Quantity_NameOfColor &, Standard_Real &, Aspect_TypeOfLine &)) &AIS_GraphicTool::GetLineAtt, "None", py::arg("aDrawer"), py::arg("TheTypeOfAttributes"), py::arg("aCol"), py::arg("aWidth"), py::arg("aTyp"));
	...
	cls_AIS_Circle.def("Parameters", (void (AIS_Circle::*)(Standard_Real &, Standard_Real &) const ) &AIS_Circle::Parameters, "Constructs instances of the starting point and the end point parameters, theU1 and theU2.", py::arg("theU1"), py::arg("theU2"));
	...
	cls_AIS_Plane.def("Size", (Standard_Boolean (AIS_Plane::*)(Standard_Real &, Standard_Real &) const ) &AIS_Plane::Size, "None", py::arg("X"), py::arg("Y"));
	...
	cls_AIS_Shape.def("OwnDeviationCoefficient", (Standard_Boolean (AIS_Shape::*)(Standard_Real &, Standard_Real &) const ) &AIS_Shape::OwnDeviationCoefficient, "Returns true and the values of the deviation coefficient aCoefficient and the previous deviation coefficient aPreviousCoefficient. If these values are not already set, false is returned.", py::arg("aCoefficient"), py::arg("aPreviousCoefficient"));
	cls_AIS_Shape.def("OwnHLRDeviationCoefficient", (Standard_Boolean (AIS_Shape::*)(Standard_Real &, Standard_Real &) const ) &AIS_Shape::OwnHLRDeviationCoefficient, "Returns true and the values of the HLR deviation coefficient aCoefficient and the previous HLR deviation coefficient aPreviousCoefficient. If these values are not already set, false is returned.", py::arg("aCoefficient"), py::arg("aPreviousCoefficient"));
	cls_AIS_Shape.def("OwnDeviationAngle", (Standard_Boolean (AIS_Shape::*)(Standard_Real &, Standard_Real &) const ) &AIS_Shape::OwnDeviationAngle, "Returns true and the values of the deviation angle anAngle and the previous deviation angle aPreviousAngle. If these values are not already set, false is returned.", py::arg("anAngle"), py::arg("aPreviousAngle"));
	cls_AIS_Shape.def("OwnHLRDeviationAngle", (Standard_Boolean (AIS_Shape::*)(Standard_Real &, Standard_Real &) const ) &AIS_Shape::OwnHLRDeviationAngle, "Returns true and the values of the HLR deviation angle anAngle and of the previous HLR deviation angle aPreviousAngle. If these values are not already set, false is returned.", py::arg("anAngle"), py::arg("aPreviousAngle"));
	...
	cls_AIS.def_static("ComputeGeometry_", (Standard_Boolean (*)(const TopoDS_Edge &, opencascade::handle<Geom_Curve> &, gp_Pnt &, gp_Pnt &, Standard_Boolean &)) &AIS::ComputeGeometry, "Used by dimensions only. Computes the 3d geometry of <anEdge>. Return TRUE if ok.", py::arg("theEdge"), py::arg("theCurve"), py::arg("theFirstPnt"), py::arg("theLastPnt"), py::arg("theIsInfinite"));
	cls_AIS.def_static("ComputeGeometry_", (Standard_Boolean (*)(const TopoDS_Edge &, opencascade::handle<Geom_Curve> &, gp_Pnt &, gp_Pnt &, opencascade::handle<Geom_Curve> &, Standard_Boolean &, Standard_Boolean &, const opencascade::handle<Geom_Plane> &)) &AIS::ComputeGeometry, "Used by 2d Relation only Computes the 3d geometry of <anEdge> in the current WorkingPlane and the extremities if any. If <aCurve> is not in the current plane, <extCurve> contains the not projected curve associated to <anEdge>. If <anEdge> is infinite, <isinfinite> = true and the 2 parameters <FirstPnt> and <LastPnt> have no signification. Return TRUE if ok.", py::arg("theEdge"), py::arg("theCurve"), py::arg("theFirstPnt"), py::arg("theLastPnt"), py::arg("theExtCurve"), py::arg("theIsInfinite"), py::arg("theIsOnPlane"), py::arg("thePlane"));
	...
	cls_AIS.def_static("ComputeGeometry_", (Standard_Boolean (*)(const TopoDS_Edge &, const TopoDS_Edge &, opencascade::handle<Geom_Curve> &, opencascade::handle<Geom_Curve> &, gp_Pnt &, gp_Pnt &, gp_Pnt &, gp_Pnt &, Standard_Boolean &, Standard_Boolean &)) &AIS::ComputeGeometry, "Used by dimensions only.Computes the 3d geometry of<anEdge1> and <anEdge2> and checks if they are infinite.", py::arg("theFirstEdge"), py::arg("theSecondEdge"), py::arg("theFirstCurve"), py::arg("theSecondCurve"), py::arg("theFirstPnt1"), py::arg("theLastPnt1"), py::arg("theFirstPnt2"), py::arg("theLastPnt2"), py::arg("theIsinfinite1"), py::arg("theIsinfinite2"));
	cls_AIS.def_static("ComputeGeometry_", (Standard_Boolean (*)(const TopoDS_Edge &, const TopoDS_Edge &, Standard_Integer &, opencascade::handle<Geom_Curve> &, opencascade::handle<Geom_Curve> &, gp_Pnt &, gp_Pnt &, gp_Pnt &, gp_Pnt &, opencascade::handle<Geom_Curve> &, Standard_Boolean &, Standard_Boolean &, const opencascade::handle<Geom_Plane> &)) &AIS::ComputeGeometry, "Used by 2d Relation only Computes the 3d geometry of<anEdge1> and <anEdge2> in the current Plane and the extremities if any. Return in ExtCurve the 3d curve (not projected in the plane) of the first edge if <indexExt> =1 or of the 2nd edge if <indexExt> = 2. If <indexExt> = 0, ExtCurve is Null. if there is an edge external to the plane, <isinfinite> is true if this edge is infinite. So, the extremities of it are not significant. Return TRUE if ok", py::arg("theFirstEdge"), py::arg("theSecondEdge"), py::arg("theExtIndex"), py::arg("theFirstCurve"), py::arg("theSecondCurve"), py::arg("theFirstPnt1"), py::arg("theLastPnt1"), py::arg("theFirstPnt2"), py::arg("theLastPnt2"), py::arg("theExtCurve"), py::arg("theIsinfinite1"), py::arg("theIsinfinite2"), py::arg("thePlane"));
	cls_AIS.def_static("ComputeGeomCurve_", (Standard_Boolean (*)(opencascade::handle<Geom_Curve> &, const Standard_Real, const Standard_Real, gp_Pnt &, gp_Pnt &, const opencascade::handle<Geom_Plane> &, Standard_Boolean &)) &AIS::ComputeGeomCurve, "Checks if aCurve belongs to aPlane; if not, projects aCurve in aPlane and returns aCurve; Return TRUE if ok", py::arg("aCurve"), py::arg("first1"), py::arg("last1"), py::arg("FirstPnt1"), py::arg("LastPnt1"), py::arg("aPlane"), py::arg("isOnPlane"));
	cls_AIS.def_static("ComputeGeometry_", (Standard_Boolean (*)(const TopoDS_Vertex &, gp_Pnt &, const opencascade::handle<Geom_Plane> &, Standard_Boolean &)) &AIS::ComputeGeometry, "None", py::arg("aVertex"), py::arg("point"), py::arg("aPlane"), py::arg("isOnPlane"));
	cls_AIS.def_static("GetPlaneFromFace_", (Standard_Boolean (*)(const TopoDS_Face &, gp_Pln &, opencascade::handle<Geom_Surface> &, AIS_KindOfSurface &, Standard_Real &)) &AIS::GetPlaneFromFace, "Tryes to get Plane from Face. Returns Surface of Face in aSurf. Returns Standard_True and Plane of Face in aPlane in following cases: Face is Plane, Offset of Plane, Extrusion of Line and Offset of Extrusion of Line Returns pure type of Surface which can be: Plane, Cylinder, Cone, Sphere, Torus, SurfaceOfRevolution, SurfaceOfExtrusion", py::arg("aFace"), py::arg("aPlane"), py::arg("aSurf"), py::arg("aSurfType"), py::arg("Offset"));
	cls_AIS.def_static("InitFaceLength_", (void (*)(const TopoDS_Face &, gp_Pln &, opencascade::handle<Geom_Surface> &, AIS_KindOfSurface &, Standard_Real &)) &AIS::InitFaceLength, "None", py::arg("aFace"), py::arg("aPlane"), py::arg("aSurface"), py::arg("aSurfaceType"), py::arg("anOffset"));
	...
	cls_AIS.def_static("NearestApex_", (gp_Pnt (*)(const gp_Elips &, const gp_Pnt &, const gp_Pnt &, const Standard_Real, const Standard_Real, Standard_Boolean &)) &AIS::NearestApex, "computes nearest to ellipse arc apex", py::arg("elips"), py::arg("pApex"), py::arg("nApex"), py::arg("fpara"), py::arg("lpara"), py::arg("IsInDomain"));
	...
	cls_AIS_ColorScale.def("GetRange", (void (AIS_ColorScale::*)(Standard_Real &, Standard_Real &) const ) &AIS_ColorScale::GetRange, "Returns minimal and maximal values of color scale, 0.0 to 1.0 by default.", py::arg("theMin"), py::arg("theMax"));
	...
	cls_AIS_ColorScale.def("GetSize", (void (AIS_ColorScale::*)(Standard_Integer &, Standard_Integer &) const ) &AIS_ColorScale::GetSize, "Returns the size of color bar, 0 and 0 by default (e.g. should be set by user explicitly before displaying).", py::arg("theBreadth"), py::arg("theHeight"));
	...
	cls_AIS_ColorScale.def("GetPosition", (void (AIS_ColorScale::*)(Standard_Real &, Standard_Real &) const ) &AIS_ColorScale::GetPosition, "Returns the bottom-left position of color scale, 0x0 by default.", py::arg("theX"), py::arg("theY"));
	...
	cls_AIS_ColorScale.def("TextSize", (void (AIS_ColorScale::*)(const TCollection_ExtendedString &, const Standard_Integer, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &AIS_ColorScale::TextSize, "None", py::arg("theText"), py::arg("theHeight"), py::arg("theWidth"), py::arg("theAscent"), py::arg("theDescent"));
