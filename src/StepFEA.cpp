...
PYBIND11_MODULE(StepFEA, mod) {
	...
	py::class_<StepFEA_SequenceOfElementGeometricRelationship, std::unique_ptr<StepFEA_SequenceOfElementGeometricRelationship, Deleter<StepFEA_SequenceOfElementGeometricRelationship>>, NCollection_BaseSequence> cls_StepFEA_SequenceOfElementGeometricRelationship(mod, "StepFEA_SequenceOfElementGeometricRelationship", "Purpose: Definition of a sequence of elements indexed by an Integer in range of 1..n");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def(py::init<>());
	cls_StepFEA_SequenceOfElementGeometricRelationship.def(py::init<const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theAllocator"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def(py::init([] (const StepFEA_SequenceOfElementGeometricRelationship &other) {return new StepFEA_SequenceOfElementGeometricRelationship(other);}), "Copy constructor", py::arg("other"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("begin", (StepFEA_SequenceOfElementGeometricRelationship::iterator (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::begin, "Returns an iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("end", (StepFEA_SequenceOfElementGeometricRelationship::iterator (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::end, "Returns an iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("cbegin", (StepFEA_SequenceOfElementGeometricRelationship::const_iterator (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("cend", (StepFEA_SequenceOfElementGeometricRelationship::const_iterator (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Size", (Standard_Integer (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::Size, "Number of items");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Length", (Standard_Integer (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::Length, "Number of items");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Lower", (Standard_Integer (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::Lower, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Upper", (Standard_Integer (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::Upper, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("IsEmpty", (Standard_Boolean (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::IsEmpty, "Empty query");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Reverse", (void (StepFEA_SequenceOfElementGeometricRelationship::*)()) &StepFEA_SequenceOfElementGeometricRelationship::Reverse, "Reverse sequence");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Exchange", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfElementGeometricRelationship::Exchange, "Exchange two members", py::arg("I"), py::arg("J"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def_static("delNode_", (void (*)(NCollection_SeqNode *, opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfElementGeometricRelationship::delNode, "Static deleter to be passed to BaseSequence", py::arg("theNode"), py::arg("theAl"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Clear", [](StepFEA_SequenceOfElementGeometricRelationship &self) -> void { return self.Clear(); });
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Clear", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfElementGeometricRelationship::Clear, "Clear the items out, take a new allocator if non null", py::arg("theAllocator"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Assign", (StepFEA_SequenceOfElementGeometricRelationship & (StepFEA_SequenceOfElementGeometricRelationship::*)(const StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::Assign, "Replace this sequence by the items of theOther. This method does not change the internal allocator.", py::arg("theOther"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("assign", (StepFEA_SequenceOfElementGeometricRelationship & (StepFEA_SequenceOfElementGeometricRelationship::*)(const StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::operator=, py::is_operator(), "Replacement operator", py::arg("theOther"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Remove", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(StepFEA_SequenceOfElementGeometricRelationship::Iterator &)) &StepFEA_SequenceOfElementGeometricRelationship::Remove, "Remove one item", py::arg("thePosition"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Remove", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer)) &StepFEA_SequenceOfElementGeometricRelationship::Remove, "Remove one item", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Remove", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfElementGeometricRelationship::Remove, "Remove range of items", py::arg("theFromIndex"), py::arg("theToIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Append", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const opencascade::handle<StepFEA_ElementGeometricRelationship> &)) &StepFEA_SequenceOfElementGeometricRelationship::Append, "Append one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Append", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::Append, "Append another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Prepend", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const opencascade::handle<StepFEA_ElementGeometricRelationship> &)) &StepFEA_SequenceOfElementGeometricRelationship::Prepend, "Prepend one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Prepend", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::Prepend, "Prepend another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("InsertBefore", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementGeometricRelationship> &)) &StepFEA_SequenceOfElementGeometricRelationship::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("InsertBefore", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("InsertAfter", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(StepFEA_SequenceOfElementGeometricRelationship::Iterator &, const opencascade::handle<StepFEA_ElementGeometricRelationship> &)) &StepFEA_SequenceOfElementGeometricRelationship::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
	...
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Split", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, StepFEA_SequenceOfElementGeometricRelationship &)) &StepFEA_SequenceOfElementGeometricRelationship::Split, "Split in two sequences", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("First", (const opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::First, "First item access");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("ChangeFirst", (opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)()) &StepFEA_SequenceOfElementGeometricRelationship::ChangeFirst, "First item access");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Last", (const opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)() const ) &StepFEA_SequenceOfElementGeometricRelationship::Last, "Last item access");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("ChangeLast", (opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)()) &StepFEA_SequenceOfElementGeometricRelationship::ChangeLast, "Last item access");
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("Value", (const opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer) const ) &StepFEA_SequenceOfElementGeometricRelationship::Value, "Constant item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("__call__", (const opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer) const ) &StepFEA_SequenceOfElementGeometricRelationship::operator(), py::is_operator(), "Constant operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("ChangeValue", (opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer)) &StepFEA_SequenceOfElementGeometricRelationship::ChangeValue, "Variable item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("__call__", (opencascade::handle<StepFEA_ElementGeometricRelationship> & (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer)) &StepFEA_SequenceOfElementGeometricRelationship::operator(), py::is_operator(), "Variable operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("SetValue", (void (StepFEA_SequenceOfElementGeometricRelationship::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementGeometricRelationship> &)) &StepFEA_SequenceOfElementGeometricRelationship::SetValue, "Set item value by theIndex", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementGeometricRelationship.def("__iter__", [](const StepFEA_SequenceOfElementGeometricRelationship &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfNodeRepresentation, std::unique_ptr<StepFEA_Array1OfNodeRepresentation, Deleter<StepFEA_Array1OfNodeRepresentation>>> cls_StepFEA_Array1OfNodeRepresentation(mod, "StepFEA_Array1OfNodeRepresentation", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfNodeRepresentation.def(py::init<>());
	cls_StepFEA_Array1OfNodeRepresentation.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfNodeRepresentation.def(py::init([] (const StepFEA_Array1OfNodeRepresentation &other) {return new StepFEA_Array1OfNodeRepresentation(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfNodeRepresentation.def(py::init<StepFEA_Array1OfNodeRepresentation &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfNodeRepresentation.def(py::init<const opencascade::handle<StepFEA_NodeRepresentation> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfNodeRepresentation.def("begin", (StepFEA_Array1OfNodeRepresentation::iterator (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfNodeRepresentation.def("end", (StepFEA_Array1OfNodeRepresentation::iterator (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfNodeRepresentation.def("cbegin", (StepFEA_Array1OfNodeRepresentation::const_iterator (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfNodeRepresentation.def("cend", (StepFEA_Array1OfNodeRepresentation::const_iterator (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfNodeRepresentation.def("Init", (void (StepFEA_Array1OfNodeRepresentation::*)(const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_Array1OfNodeRepresentation::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfNodeRepresentation.def("Size", (Standard_Integer (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::Size, "Size query");
	cls_StepFEA_Array1OfNodeRepresentation.def("Length", (Standard_Integer (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::Length, "Length query (the same)");
	cls_StepFEA_Array1OfNodeRepresentation.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfNodeRepresentation.def("Lower", (Standard_Integer (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::Lower, "Lower bound");
	cls_StepFEA_Array1OfNodeRepresentation.def("Upper", (Standard_Integer (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::Upper, "Upper bound");
	cls_StepFEA_Array1OfNodeRepresentation.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfNodeRepresentation.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfNodeRepresentation.def("Assign", (StepFEA_Array1OfNodeRepresentation & (StepFEA_Array1OfNodeRepresentation::*)(const StepFEA_Array1OfNodeRepresentation &)) &StepFEA_Array1OfNodeRepresentation::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfNodeRepresentation.def("Move", (StepFEA_Array1OfNodeRepresentation & (StepFEA_Array1OfNodeRepresentation::*)(StepFEA_Array1OfNodeRepresentation &&)) &StepFEA_Array1OfNodeRepresentation::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfNodeRepresentation.def("assign", (StepFEA_Array1OfNodeRepresentation & (StepFEA_Array1OfNodeRepresentation::*)(const StepFEA_Array1OfNodeRepresentation &)) &StepFEA_Array1OfNodeRepresentation::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfNodeRepresentation.def("assign", (StepFEA_Array1OfNodeRepresentation & (StepFEA_Array1OfNodeRepresentation::*)(StepFEA_Array1OfNodeRepresentation &&)) &StepFEA_Array1OfNodeRepresentation::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfNodeRepresentation.def("First", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::First, "Returns first element");
	cls_StepFEA_Array1OfNodeRepresentation.def("ChangeFirst", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)()) &StepFEA_Array1OfNodeRepresentation::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfNodeRepresentation.def("Last", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)() const ) &StepFEA_Array1OfNodeRepresentation::Last, "Returns last element");
	cls_StepFEA_Array1OfNodeRepresentation.def("ChangeLast", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)()) &StepFEA_Array1OfNodeRepresentation::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfNodeRepresentation.def("Value", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer) const ) &StepFEA_Array1OfNodeRepresentation::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfNodeRepresentation.def("__call__", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer) const ) &StepFEA_Array1OfNodeRepresentation::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfNodeRepresentation.def("ChangeValue", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer)) &StepFEA_Array1OfNodeRepresentation::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfNodeRepresentation.def("__call__", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer)) &StepFEA_Array1OfNodeRepresentation::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfNodeRepresentation.def("SetValue", (void (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_Array1OfNodeRepresentation::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfNodeRepresentation.def("Resize", (void (StepFEA_Array1OfNodeRepresentation::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfNodeRepresentation::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfNodeRepresentation.def("__iter__", [](const StepFEA_Array1OfNodeRepresentation &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Sequence.hxx
	py::class_<StepFEA_SequenceOfElementRepresentation, std::unique_ptr<StepFEA_SequenceOfElementRepresentation, Deleter<StepFEA_SequenceOfElementRepresentation>>, NCollection_BaseSequence> cls_StepFEA_SequenceOfElementRepresentation(mod, "StepFEA_SequenceOfElementRepresentation", "Purpose: Definition of a sequence of elements indexed by an Integer in range of 1..n");
	cls_StepFEA_SequenceOfElementRepresentation.def(py::init<>());
	cls_StepFEA_SequenceOfElementRepresentation.def(py::init<const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theAllocator"));
	cls_StepFEA_SequenceOfElementRepresentation.def(py::init([] (const StepFEA_SequenceOfElementRepresentation &other) {return new StepFEA_SequenceOfElementRepresentation(other);}), "Copy constructor", py::arg("other"));
	cls_StepFEA_SequenceOfElementRepresentation.def("begin", (StepFEA_SequenceOfElementRepresentation::iterator (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::begin, "Returns an iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfElementRepresentation.def("end", (StepFEA_SequenceOfElementRepresentation::iterator (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::end, "Returns an iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfElementRepresentation.def("cbegin", (StepFEA_SequenceOfElementRepresentation::const_iterator (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfElementRepresentation.def("cend", (StepFEA_SequenceOfElementRepresentation::const_iterator (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfElementRepresentation.def("Size", (Standard_Integer (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::Size, "Number of items");
	cls_StepFEA_SequenceOfElementRepresentation.def("Length", (Standard_Integer (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::Length, "Number of items");
	cls_StepFEA_SequenceOfElementRepresentation.def("Lower", (Standard_Integer (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::Lower, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfElementRepresentation.def("Upper", (Standard_Integer (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::Upper, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfElementRepresentation.def("IsEmpty", (Standard_Boolean (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::IsEmpty, "Empty query");
	cls_StepFEA_SequenceOfElementRepresentation.def("Reverse", (void (StepFEA_SequenceOfElementRepresentation::*)()) &StepFEA_SequenceOfElementRepresentation::Reverse, "Reverse sequence");
	cls_StepFEA_SequenceOfElementRepresentation.def("Exchange", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfElementRepresentation::Exchange, "Exchange two members", py::arg("I"), py::arg("J"));
	cls_StepFEA_SequenceOfElementRepresentation.def_static("delNode_", (void (*)(NCollection_SeqNode *, opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfElementRepresentation::delNode, "Static deleter to be passed to BaseSequence", py::arg("theNode"), py::arg("theAl"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Clear", [](StepFEA_SequenceOfElementRepresentation &self) -> void { return self.Clear(); });
	cls_StepFEA_SequenceOfElementRepresentation.def("Clear", (void (StepFEA_SequenceOfElementRepresentation::*)(const opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfElementRepresentation::Clear, "Clear the items out, take a new allocator if non null", py::arg("theAllocator"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Assign", (StepFEA_SequenceOfElementRepresentation & (StepFEA_SequenceOfElementRepresentation::*)(const StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::Assign, "Replace this sequence by the items of theOther. This method does not change the internal allocator.", py::arg("theOther"));
	cls_StepFEA_SequenceOfElementRepresentation.def("assign", (StepFEA_SequenceOfElementRepresentation & (StepFEA_SequenceOfElementRepresentation::*)(const StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::operator=, py::is_operator(), "Replacement operator", py::arg("theOther"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Remove", (void (StepFEA_SequenceOfElementRepresentation::*)(StepFEA_SequenceOfElementRepresentation::Iterator &)) &StepFEA_SequenceOfElementRepresentation::Remove, "Remove one item", py::arg("thePosition"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Remove", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfElementRepresentation::Remove, "Remove one item", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Remove", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfElementRepresentation::Remove, "Remove range of items", py::arg("theFromIndex"), py::arg("theToIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Append", (void (StepFEA_SequenceOfElementRepresentation::*)(const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::Append, "Append one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Append", (void (StepFEA_SequenceOfElementRepresentation::*)(StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::Append, "Append another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Prepend", (void (StepFEA_SequenceOfElementRepresentation::*)(const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::Prepend, "Prepend one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Prepend", (void (StepFEA_SequenceOfElementRepresentation::*)(StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::Prepend, "Prepend another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementRepresentation.def("InsertBefore", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("InsertBefore", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfElementRepresentation::*)(StepFEA_SequenceOfElementRepresentation::Iterator &, const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::InsertAfter, "InsertAfter theIndex another sequence", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("Split", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfElementRepresentation &)) &StepFEA_SequenceOfElementRepresentation::Split, "Split in two sequences", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfElementRepresentation.def("First", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::First, "First item access");
	cls_StepFEA_SequenceOfElementRepresentation.def("ChangeFirst", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)()) &StepFEA_SequenceOfElementRepresentation::ChangeFirst, "First item access");
	cls_StepFEA_SequenceOfElementRepresentation.def("Last", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)() const ) &StepFEA_SequenceOfElementRepresentation::Last, "Last item access");
	cls_StepFEA_SequenceOfElementRepresentation.def("ChangeLast", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)()) &StepFEA_SequenceOfElementRepresentation::ChangeLast, "Last item access");
	cls_StepFEA_SequenceOfElementRepresentation.def("Value", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer) const ) &StepFEA_SequenceOfElementRepresentation::Value, "Constant item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("__call__", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer) const ) &StepFEA_SequenceOfElementRepresentation::operator(), py::is_operator(), "Constant operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("ChangeValue", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfElementRepresentation::ChangeValue, "Variable item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("__call__", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfElementRepresentation::operator(), py::is_operator(), "Variable operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfElementRepresentation.def("SetValue", (void (StepFEA_SequenceOfElementRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_SequenceOfElementRepresentation::SetValue, "Set item value by theIndex", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfElementRepresentation.def("__iter__", [](const StepFEA_SequenceOfElementRepresentation &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfCurveElementInterval, std::unique_ptr<StepFEA_Array1OfCurveElementInterval, Deleter<StepFEA_Array1OfCurveElementInterval>>> cls_StepFEA_Array1OfCurveElementInterval(mod, "StepFEA_Array1OfCurveElementInterval", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfCurveElementInterval.def(py::init<>());
	cls_StepFEA_Array1OfCurveElementInterval.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementInterval.def(py::init([] (const StepFEA_Array1OfCurveElementInterval &other) {return new StepFEA_Array1OfCurveElementInterval(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfCurveElementInterval.def(py::init<StepFEA_Array1OfCurveElementInterval &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementInterval.def(py::init<const opencascade::handle<StepFEA_CurveElementInterval> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementInterval.def("begin", (StepFEA_Array1OfCurveElementInterval::iterator (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementInterval.def("end", (StepFEA_Array1OfCurveElementInterval::iterator (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementInterval.def("cbegin", (StepFEA_Array1OfCurveElementInterval::const_iterator (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementInterval.def("cend", (StepFEA_Array1OfCurveElementInterval::const_iterator (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementInterval.def("Init", (void (StepFEA_Array1OfCurveElementInterval::*)(const opencascade::handle<StepFEA_CurveElementInterval> &)) &StepFEA_Array1OfCurveElementInterval::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfCurveElementInterval.def("Size", (Standard_Integer (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::Size, "Size query");
	cls_StepFEA_Array1OfCurveElementInterval.def("Length", (Standard_Integer (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::Length, "Length query (the same)");
	cls_StepFEA_Array1OfCurveElementInterval.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfCurveElementInterval.def("Lower", (Standard_Integer (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::Lower, "Lower bound");
	cls_StepFEA_Array1OfCurveElementInterval.def("Upper", (Standard_Integer (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::Upper, "Upper bound");
	cls_StepFEA_Array1OfCurveElementInterval.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfCurveElementInterval.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfCurveElementInterval.def("Assign", (StepFEA_Array1OfCurveElementInterval & (StepFEA_Array1OfCurveElementInterval::*)(const StepFEA_Array1OfCurveElementInterval &)) &StepFEA_Array1OfCurveElementInterval::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementInterval.def("Move", (StepFEA_Array1OfCurveElementInterval & (StepFEA_Array1OfCurveElementInterval::*)(StepFEA_Array1OfCurveElementInterval &&)) &StepFEA_Array1OfCurveElementInterval::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementInterval.def("assign", (StepFEA_Array1OfCurveElementInterval & (StepFEA_Array1OfCurveElementInterval::*)(const StepFEA_Array1OfCurveElementInterval &)) &StepFEA_Array1OfCurveElementInterval::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementInterval.def("assign", (StepFEA_Array1OfCurveElementInterval & (StepFEA_Array1OfCurveElementInterval::*)(StepFEA_Array1OfCurveElementInterval &&)) &StepFEA_Array1OfCurveElementInterval::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementInterval.def("First", (const opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::First, "Returns first element");
	cls_StepFEA_Array1OfCurveElementInterval.def("ChangeFirst", (opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)()) &StepFEA_Array1OfCurveElementInterval::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfCurveElementInterval.def("Last", (const opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)() const ) &StepFEA_Array1OfCurveElementInterval::Last, "Returns last element");
	cls_StepFEA_Array1OfCurveElementInterval.def("ChangeLast", (opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)()) &StepFEA_Array1OfCurveElementInterval::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfCurveElementInterval.def("Value", (const opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementInterval::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementInterval.def("__call__", (const opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementInterval::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementInterval.def("ChangeValue", (opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementInterval::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementInterval.def("__call__", (opencascade::handle<StepFEA_CurveElementInterval> & (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementInterval::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementInterval.def("SetValue", (void (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer, const opencascade::handle<StepFEA_CurveElementInterval> &)) &StepFEA_Array1OfCurveElementInterval::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfCurveElementInterval.def("Resize", (void (StepFEA_Array1OfCurveElementInterval::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfCurveElementInterval::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfCurveElementInterval.def("__iter__", [](const StepFEA_Array1OfCurveElementInterval &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfCurveElementEndOffset, std::unique_ptr<StepFEA_Array1OfCurveElementEndOffset, Deleter<StepFEA_Array1OfCurveElementEndOffset>>> cls_StepFEA_Array1OfCurveElementEndOffset(mod, "StepFEA_Array1OfCurveElementEndOffset", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def(py::init<>());
	cls_StepFEA_Array1OfCurveElementEndOffset.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def(py::init([] (const StepFEA_Array1OfCurveElementEndOffset &other) {return new StepFEA_Array1OfCurveElementEndOffset(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndOffset.def(py::init<StepFEA_Array1OfCurveElementEndOffset &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def(py::init<const opencascade::handle<StepFEA_CurveElementEndOffset> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("begin", (StepFEA_Array1OfCurveElementEndOffset::iterator (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("end", (StepFEA_Array1OfCurveElementEndOffset::iterator (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("cbegin", (StepFEA_Array1OfCurveElementEndOffset::const_iterator (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("cend", (StepFEA_Array1OfCurveElementEndOffset::const_iterator (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Init", (void (StepFEA_Array1OfCurveElementEndOffset::*)(const opencascade::handle<StepFEA_CurveElementEndOffset> &)) &StepFEA_Array1OfCurveElementEndOffset::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Size", (Standard_Integer (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::Size, "Size query");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Length", (Standard_Integer (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::Length, "Length query (the same)");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Lower", (Standard_Integer (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::Lower, "Lower bound");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Upper", (Standard_Integer (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::Upper, "Upper bound");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Assign", (StepFEA_Array1OfCurveElementEndOffset & (StepFEA_Array1OfCurveElementEndOffset::*)(const StepFEA_Array1OfCurveElementEndOffset &)) &StepFEA_Array1OfCurveElementEndOffset::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndOffset.def("Move", (StepFEA_Array1OfCurveElementEndOffset & (StepFEA_Array1OfCurveElementEndOffset::*)(StepFEA_Array1OfCurveElementEndOffset &&)) &StepFEA_Array1OfCurveElementEndOffset::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("assign", (StepFEA_Array1OfCurveElementEndOffset & (StepFEA_Array1OfCurveElementEndOffset::*)(const StepFEA_Array1OfCurveElementEndOffset &)) &StepFEA_Array1OfCurveElementEndOffset::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndOffset.def("assign", (StepFEA_Array1OfCurveElementEndOffset & (StepFEA_Array1OfCurveElementEndOffset::*)(StepFEA_Array1OfCurveElementEndOffset &&)) &StepFEA_Array1OfCurveElementEndOffset::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("First", (const opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::First, "Returns first element");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("ChangeFirst", (opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)()) &StepFEA_Array1OfCurveElementEndOffset::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Last", (const opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)() const ) &StepFEA_Array1OfCurveElementEndOffset::Last, "Returns last element");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("ChangeLast", (opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)()) &StepFEA_Array1OfCurveElementEndOffset::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Value", (const opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementEndOffset::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("__call__", (const opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementEndOffset::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("ChangeValue", (opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementEndOffset::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("__call__", (opencascade::handle<StepFEA_CurveElementEndOffset> & (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementEndOffset::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("SetValue", (void (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer, const opencascade::handle<StepFEA_CurveElementEndOffset> &)) &StepFEA_Array1OfCurveElementEndOffset::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("Resize", (void (StepFEA_Array1OfCurveElementEndOffset::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfCurveElementEndOffset::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfCurveElementEndOffset.def("__iter__", [](const StepFEA_Array1OfCurveElementEndOffset &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfCurveElementEndRelease, std::unique_ptr<StepFEA_Array1OfCurveElementEndRelease, Deleter<StepFEA_Array1OfCurveElementEndRelease>>> cls_StepFEA_Array1OfCurveElementEndRelease(mod, "StepFEA_Array1OfCurveElementEndRelease", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def(py::init<>());
	cls_StepFEA_Array1OfCurveElementEndRelease.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def(py::init([] (const StepFEA_Array1OfCurveElementEndRelease &other) {return new StepFEA_Array1OfCurveElementEndRelease(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndRelease.def(py::init<StepFEA_Array1OfCurveElementEndRelease &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def(py::init<const opencascade::handle<StepFEA_CurveElementEndRelease> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("begin", (StepFEA_Array1OfCurveElementEndRelease::iterator (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("end", (StepFEA_Array1OfCurveElementEndRelease::iterator (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("cbegin", (StepFEA_Array1OfCurveElementEndRelease::const_iterator (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("cend", (StepFEA_Array1OfCurveElementEndRelease::const_iterator (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Init", (void (StepFEA_Array1OfCurveElementEndRelease::*)(const opencascade::handle<StepFEA_CurveElementEndRelease> &)) &StepFEA_Array1OfCurveElementEndRelease::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Size", (Standard_Integer (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::Size, "Size query");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Length", (Standard_Integer (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::Length, "Length query (the same)");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Lower", (Standard_Integer (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::Lower, "Lower bound");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Upper", (Standard_Integer (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::Upper, "Upper bound");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Assign", (StepFEA_Array1OfCurveElementEndRelease & (StepFEA_Array1OfCurveElementEndRelease::*)(const StepFEA_Array1OfCurveElementEndRelease &)) &StepFEA_Array1OfCurveElementEndRelease::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndRelease.def("Move", (StepFEA_Array1OfCurveElementEndRelease & (StepFEA_Array1OfCurveElementEndRelease::*)(StepFEA_Array1OfCurveElementEndRelease &&)) &StepFEA_Array1OfCurveElementEndRelease::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("assign", (StepFEA_Array1OfCurveElementEndRelease & (StepFEA_Array1OfCurveElementEndRelease::*)(const StepFEA_Array1OfCurveElementEndRelease &)) &StepFEA_Array1OfCurveElementEndRelease::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfCurveElementEndRelease.def("assign", (StepFEA_Array1OfCurveElementEndRelease & (StepFEA_Array1OfCurveElementEndRelease::*)(StepFEA_Array1OfCurveElementEndRelease &&)) &StepFEA_Array1OfCurveElementEndRelease::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("First", (const opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::First, "Returns first element");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("ChangeFirst", (opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)()) &StepFEA_Array1OfCurveElementEndRelease::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Last", (const opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)() const ) &StepFEA_Array1OfCurveElementEndRelease::Last, "Returns last element");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("ChangeLast", (opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)()) &StepFEA_Array1OfCurveElementEndRelease::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Value", (const opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementEndRelease::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("__call__", (const opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer) const ) &StepFEA_Array1OfCurveElementEndRelease::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("ChangeValue", (opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementEndRelease::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("__call__", (opencascade::handle<StepFEA_CurveElementEndRelease> & (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer)) &StepFEA_Array1OfCurveElementEndRelease::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("SetValue", (void (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer, const opencascade::handle<StepFEA_CurveElementEndRelease> &)) &StepFEA_Array1OfCurveElementEndRelease::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("Resize", (void (StepFEA_Array1OfCurveElementEndRelease::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfCurveElementEndRelease::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfCurveElementEndRelease.def("__iter__", [](const StepFEA_Array1OfCurveElementEndRelease &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfElementRepresentation, std::unique_ptr<StepFEA_Array1OfElementRepresentation, Deleter<StepFEA_Array1OfElementRepresentation>>> cls_StepFEA_Array1OfElementRepresentation(mod, "StepFEA_Array1OfElementRepresentation", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfElementRepresentation.def(py::init<>());
	cls_StepFEA_Array1OfElementRepresentation.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfElementRepresentation.def(py::init([] (const StepFEA_Array1OfElementRepresentation &other) {return new StepFEA_Array1OfElementRepresentation(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfElementRepresentation.def(py::init<StepFEA_Array1OfElementRepresentation &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfElementRepresentation.def(py::init<const opencascade::handle<StepFEA_ElementRepresentation> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfElementRepresentation.def("begin", (StepFEA_Array1OfElementRepresentation::iterator (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfElementRepresentation.def("end", (StepFEA_Array1OfElementRepresentation::iterator (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfElementRepresentation.def("cbegin", (StepFEA_Array1OfElementRepresentation::const_iterator (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfElementRepresentation.def("cend", (StepFEA_Array1OfElementRepresentation::const_iterator (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfElementRepresentation.def("Init", (void (StepFEA_Array1OfElementRepresentation::*)(const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_Array1OfElementRepresentation::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfElementRepresentation.def("Size", (Standard_Integer (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::Size, "Size query");
	cls_StepFEA_Array1OfElementRepresentation.def("Length", (Standard_Integer (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::Length, "Length query (the same)");
	cls_StepFEA_Array1OfElementRepresentation.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfElementRepresentation.def("Lower", (Standard_Integer (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::Lower, "Lower bound");
	cls_StepFEA_Array1OfElementRepresentation.def("Upper", (Standard_Integer (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::Upper, "Upper bound");
	cls_StepFEA_Array1OfElementRepresentation.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfElementRepresentation.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfElementRepresentation.def("Assign", (StepFEA_Array1OfElementRepresentation & (StepFEA_Array1OfElementRepresentation::*)(const StepFEA_Array1OfElementRepresentation &)) &StepFEA_Array1OfElementRepresentation::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfElementRepresentation.def("Move", (StepFEA_Array1OfElementRepresentation & (StepFEA_Array1OfElementRepresentation::*)(StepFEA_Array1OfElementRepresentation &&)) &StepFEA_Array1OfElementRepresentation::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfElementRepresentation.def("assign", (StepFEA_Array1OfElementRepresentation & (StepFEA_Array1OfElementRepresentation::*)(const StepFEA_Array1OfElementRepresentation &)) &StepFEA_Array1OfElementRepresentation::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfElementRepresentation.def("assign", (StepFEA_Array1OfElementRepresentation & (StepFEA_Array1OfElementRepresentation::*)(StepFEA_Array1OfElementRepresentation &&)) &StepFEA_Array1OfElementRepresentation::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfElementRepresentation.def("First", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::First, "Returns first element");
	cls_StepFEA_Array1OfElementRepresentation.def("ChangeFirst", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)()) &StepFEA_Array1OfElementRepresentation::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfElementRepresentation.def("Last", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)() const ) &StepFEA_Array1OfElementRepresentation::Last, "Returns last element");
	cls_StepFEA_Array1OfElementRepresentation.def("ChangeLast", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)()) &StepFEA_Array1OfElementRepresentation::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfElementRepresentation.def("Value", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer) const ) &StepFEA_Array1OfElementRepresentation::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfElementRepresentation.def("__call__", (const opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer) const ) &StepFEA_Array1OfElementRepresentation::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfElementRepresentation.def("ChangeValue", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer)) &StepFEA_Array1OfElementRepresentation::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfElementRepresentation.def("__call__", (opencascade::handle<StepFEA_ElementRepresentation> & (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer)) &StepFEA_Array1OfElementRepresentation::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfElementRepresentation.def("SetValue", (void (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_ElementRepresentation> &)) &StepFEA_Array1OfElementRepresentation::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfElementRepresentation.def("Resize", (void (StepFEA_Array1OfElementRepresentation::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfElementRepresentation::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfElementRepresentation.def("__iter__", [](const StepFEA_Array1OfElementRepresentation &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepFEA_Array1OfDegreeOfFreedom, std::unique_ptr<StepFEA_Array1OfDegreeOfFreedom, Deleter<StepFEA_Array1OfDegreeOfFreedom>>> cls_StepFEA_Array1OfDegreeOfFreedom(mod, "StepFEA_Array1OfDegreeOfFreedom", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def(py::init<>());
	cls_StepFEA_Array1OfDegreeOfFreedom.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def(py::init([] (const StepFEA_Array1OfDegreeOfFreedom &other) {return new StepFEA_Array1OfDegreeOfFreedom(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepFEA_Array1OfDegreeOfFreedom.def(py::init<StepFEA_Array1OfDegreeOfFreedom &&>(), py::arg("theOther"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def(py::init<const StepFEA_DegreeOfFreedom &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("begin", (StepFEA_Array1OfDegreeOfFreedom::iterator (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("end", (StepFEA_Array1OfDegreeOfFreedom::iterator (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("cbegin", (StepFEA_Array1OfDegreeOfFreedom::const_iterator (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("cend", (StepFEA_Array1OfDegreeOfFreedom::const_iterator (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Init", (void (StepFEA_Array1OfDegreeOfFreedom::*)(const StepFEA_DegreeOfFreedom &)) &StepFEA_Array1OfDegreeOfFreedom::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Size", (Standard_Integer (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::Size, "Size query");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Length", (Standard_Integer (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::Length, "Length query (the same)");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("IsEmpty", (Standard_Boolean (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Lower", (Standard_Integer (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::Lower, "Lower bound");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Upper", (Standard_Integer (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::Upper, "Upper bound");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("IsDeletable", (Standard_Boolean (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::IsDeletable, "myDeletable flag");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("IsAllocated", (Standard_Boolean (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Assign", (StepFEA_Array1OfDegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const StepFEA_Array1OfDegreeOfFreedom &)) &StepFEA_Array1OfDegreeOfFreedom::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfDegreeOfFreedom.def("Move", (StepFEA_Array1OfDegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(StepFEA_Array1OfDegreeOfFreedom &&)) &StepFEA_Array1OfDegreeOfFreedom::Move, "Move assignment", py::arg("theOther"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("assign", (StepFEA_Array1OfDegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const StepFEA_Array1OfDegreeOfFreedom &)) &StepFEA_Array1OfDegreeOfFreedom::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepFEA_Array1OfDegreeOfFreedom.def("assign", (StepFEA_Array1OfDegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(StepFEA_Array1OfDegreeOfFreedom &&)) &StepFEA_Array1OfDegreeOfFreedom::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("First", (const StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::First, "Returns first element");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("ChangeFirst", (StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)()) &StepFEA_Array1OfDegreeOfFreedom::ChangeFirst, "Returns first element");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Last", (const StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)() const ) &StepFEA_Array1OfDegreeOfFreedom::Last, "Returns last element");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("ChangeLast", (StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)()) &StepFEA_Array1OfDegreeOfFreedom::ChangeLast, "Returns last element");
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Value", (const StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer) const ) &StepFEA_Array1OfDegreeOfFreedom::Value, "Constant value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("__call__", (const StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer) const ) &StepFEA_Array1OfDegreeOfFreedom::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("ChangeValue", (StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer)) &StepFEA_Array1OfDegreeOfFreedom::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("__call__", (StepFEA_DegreeOfFreedom & (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer)) &StepFEA_Array1OfDegreeOfFreedom::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("SetValue", (void (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer, const StepFEA_DegreeOfFreedom &)) &StepFEA_Array1OfDegreeOfFreedom::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("Resize", (void (StepFEA_Array1OfDegreeOfFreedom::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepFEA_Array1OfDegreeOfFreedom::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepFEA_Array1OfDegreeOfFreedom.def("__iter__", [](const StepFEA_Array1OfDegreeOfFreedom &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Sequence.hxx
	py::class_<StepFEA_SequenceOfCurve3dElementProperty, std::unique_ptr<StepFEA_SequenceOfCurve3dElementProperty, Deleter<StepFEA_SequenceOfCurve3dElementProperty>>, NCollection_BaseSequence> cls_StepFEA_SequenceOfCurve3dElementProperty(mod, "StepFEA_SequenceOfCurve3dElementProperty", "Purpose: Definition of a sequence of elements indexed by an Integer in range of 1..n");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def(py::init<>());
	cls_StepFEA_SequenceOfCurve3dElementProperty.def(py::init<const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theAllocator"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def(py::init([] (const StepFEA_SequenceOfCurve3dElementProperty &other) {return new StepFEA_SequenceOfCurve3dElementProperty(other);}), "Copy constructor", py::arg("other"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("begin", (StepFEA_SequenceOfCurve3dElementProperty::iterator (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::begin, "Returns an iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("end", (StepFEA_SequenceOfCurve3dElementProperty::iterator (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::end, "Returns an iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("cbegin", (StepFEA_SequenceOfCurve3dElementProperty::const_iterator (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("cend", (StepFEA_SequenceOfCurve3dElementProperty::const_iterator (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Size", (Standard_Integer (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::Size, "Number of items");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Length", (Standard_Integer (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::Length, "Number of items");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Lower", (Standard_Integer (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::Lower, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Upper", (Standard_Integer (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::Upper, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("IsEmpty", (Standard_Boolean (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::IsEmpty, "Empty query");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Reverse", (void (StepFEA_SequenceOfCurve3dElementProperty::*)()) &StepFEA_SequenceOfCurve3dElementProperty::Reverse, "Reverse sequence");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Exchange", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfCurve3dElementProperty::Exchange, "Exchange two members", py::arg("I"), py::arg("J"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def_static("delNode_", (void (*)(NCollection_SeqNode *, opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfCurve3dElementProperty::delNode, "Static deleter to be passed to BaseSequence", py::arg("theNode"), py::arg("theAl"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Clear", [](StepFEA_SequenceOfCurve3dElementProperty &self) -> void { return self.Clear(); });
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Clear", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfCurve3dElementProperty::Clear, "Clear the items out, take a new allocator if non null", py::arg("theAllocator"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Assign", (StepFEA_SequenceOfCurve3dElementProperty & (StepFEA_SequenceOfCurve3dElementProperty::*)(const StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::Assign, "Replace this sequence by the items of theOther. This method does not change the internal allocator.", py::arg("theOther"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("assign", (StepFEA_SequenceOfCurve3dElementProperty & (StepFEA_SequenceOfCurve3dElementProperty::*)(const StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::operator=, py::is_operator(), "Replacement operator", py::arg("theOther"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Remove", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(StepFEA_SequenceOfCurve3dElementProperty::Iterator &)) &StepFEA_SequenceOfCurve3dElementProperty::Remove, "Remove one item", py::arg("thePosition"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Remove", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer)) &StepFEA_SequenceOfCurve3dElementProperty::Remove, "Remove one item", py::arg("theIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Remove", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfCurve3dElementProperty::Remove, "Remove range of items", py::arg("theFromIndex"), py::arg("theToIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Append", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::Append, "Append one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Append", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::Append, "Append another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Prepend", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::Prepend, "Prepend one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Prepend", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::Prepend, "Prepend another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("InsertBefore", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("InsertBefore", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("InsertAfter", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(StepFEA_SequenceOfCurve3dElementProperty::Iterator &, const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("InsertAfter", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("InsertAfter", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::InsertAfter, "InsertAfter theIndex another sequence", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Split", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, StepFEA_SequenceOfCurve3dElementProperty &)) &StepFEA_SequenceOfCurve3dElementProperty::Split, "Split in two sequences", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("First", (const opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::First, "First item access");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("ChangeFirst", (opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)()) &StepFEA_SequenceOfCurve3dElementProperty::ChangeFirst, "First item access");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Last", (const opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)() const ) &StepFEA_SequenceOfCurve3dElementProperty::Last, "Last item access");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("ChangeLast", (opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)()) &StepFEA_SequenceOfCurve3dElementProperty::ChangeLast, "Last item access");
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("Value", (const opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer) const ) &StepFEA_SequenceOfCurve3dElementProperty::Value, "Constant item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("__call__", (const opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer) const ) &StepFEA_SequenceOfCurve3dElementProperty::operator(), py::is_operator(), "Constant operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("ChangeValue", (opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer)) &StepFEA_SequenceOfCurve3dElementProperty::ChangeValue, "Variable item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("__call__", (opencascade::handle<StepFEA_Curve3dElementProperty> & (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer)) &StepFEA_SequenceOfCurve3dElementProperty::operator(), py::is_operator(), "Variable operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("SetValue", (void (StepFEA_SequenceOfCurve3dElementProperty::*)(const Standard_Integer, const opencascade::handle<StepFEA_Curve3dElementProperty> &)) &StepFEA_SequenceOfCurve3dElementProperty::SetValue, "Set item value by theIndex", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfCurve3dElementProperty.def("__iter__", [](const StepFEA_SequenceOfCurve3dElementProperty &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Sequence.hxx
	py::class_<StepFEA_SequenceOfNodeRepresentation, std::unique_ptr<StepFEA_SequenceOfNodeRepresentation, Deleter<StepFEA_SequenceOfNodeRepresentation>>, NCollection_BaseSequence> cls_StepFEA_SequenceOfNodeRepresentation(mod, "StepFEA_SequenceOfNodeRepresentation", "Purpose: Definition of a sequence of elements indexed by an Integer in range of 1..n");
	cls_StepFEA_SequenceOfNodeRepresentation.def(py::init<>());
	cls_StepFEA_SequenceOfNodeRepresentation.def(py::init<const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theAllocator"));
	cls_StepFEA_SequenceOfNodeRepresentation.def(py::init([] (const StepFEA_SequenceOfNodeRepresentation &other) {return new StepFEA_SequenceOfNodeRepresentation(other);}), "Copy constructor", py::arg("other"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("begin", (StepFEA_SequenceOfNodeRepresentation::iterator (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::begin, "Returns an iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("end", (StepFEA_SequenceOfNodeRepresentation::iterator (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::end, "Returns an iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("cbegin", (StepFEA_SequenceOfNodeRepresentation::const_iterator (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::cbegin, "Returns a const iterator pointing to the first element in the sequence.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("cend", (StepFEA_SequenceOfNodeRepresentation::const_iterator (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::cend, "Returns a const iterator referring to the past-the-end element in the sequence.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Size", (Standard_Integer (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::Size, "Number of items");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Length", (Standard_Integer (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::Length, "Number of items");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Lower", (Standard_Integer (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::Lower, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Upper", (Standard_Integer (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::Upper, "Method for consistency with other collections.");
	cls_StepFEA_SequenceOfNodeRepresentation.def("IsEmpty", (Standard_Boolean (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::IsEmpty, "Empty query");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Reverse", (void (StepFEA_SequenceOfNodeRepresentation::*)()) &StepFEA_SequenceOfNodeRepresentation::Reverse, "Reverse sequence");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Exchange", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfNodeRepresentation::Exchange, "Exchange two members", py::arg("I"), py::arg("J"));
	cls_StepFEA_SequenceOfNodeRepresentation.def_static("delNode_", (void (*)(NCollection_SeqNode *, opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfNodeRepresentation::delNode, "Static deleter to be passed to BaseSequence", py::arg("theNode"), py::arg("theAl"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Clear", [](StepFEA_SequenceOfNodeRepresentation &self) -> void { return self.Clear(); });
	cls_StepFEA_SequenceOfNodeRepresentation.def("Clear", (void (StepFEA_SequenceOfNodeRepresentation::*)(const opencascade::handle<NCollection_BaseAllocator> &)) &StepFEA_SequenceOfNodeRepresentation::Clear, "Clear the items out, take a new allocator if non null", py::arg("theAllocator"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Assign", (StepFEA_SequenceOfNodeRepresentation & (StepFEA_SequenceOfNodeRepresentation::*)(const StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::Assign, "Replace this sequence by the items of theOther. This method does not change the internal allocator.", py::arg("theOther"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("assign", (StepFEA_SequenceOfNodeRepresentation & (StepFEA_SequenceOfNodeRepresentation::*)(const StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::operator=, py::is_operator(), "Replacement operator", py::arg("theOther"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Remove", (void (StepFEA_SequenceOfNodeRepresentation::*)(StepFEA_SequenceOfNodeRepresentation::Iterator &)) &StepFEA_SequenceOfNodeRepresentation::Remove, "Remove one item", py::arg("thePosition"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Remove", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfNodeRepresentation::Remove, "Remove one item", py::arg("theIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Remove", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, const Standard_Integer)) &StepFEA_SequenceOfNodeRepresentation::Remove, "Remove range of items", py::arg("theFromIndex"), py::arg("theToIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Append", (void (StepFEA_SequenceOfNodeRepresentation::*)(const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::Append, "Append one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Append", (void (StepFEA_SequenceOfNodeRepresentation::*)(StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::Append, "Append another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Prepend", (void (StepFEA_SequenceOfNodeRepresentation::*)(const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::Prepend, "Prepend one item", py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Prepend", (void (StepFEA_SequenceOfNodeRepresentation::*)(StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::Prepend, "Prepend another sequence (making it empty)", py::arg("theSeq"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("InsertBefore", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("InsertBefore", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfNodeRepresentation::*)(StepFEA_SequenceOfNodeRepresentation::Iterator &, const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("InsertAfter", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::InsertAfter, "InsertAfter theIndex another sequence", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("Split", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, StepFEA_SequenceOfNodeRepresentation &)) &StepFEA_SequenceOfNodeRepresentation::Split, "Split in two sequences", py::arg("theIndex"), py::arg("theSeq"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("First", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::First, "First item access");
	cls_StepFEA_SequenceOfNodeRepresentation.def("ChangeFirst", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)()) &StepFEA_SequenceOfNodeRepresentation::ChangeFirst, "First item access");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Last", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)() const ) &StepFEA_SequenceOfNodeRepresentation::Last, "Last item access");
	cls_StepFEA_SequenceOfNodeRepresentation.def("ChangeLast", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)()) &StepFEA_SequenceOfNodeRepresentation::ChangeLast, "Last item access");
	cls_StepFEA_SequenceOfNodeRepresentation.def("Value", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer) const ) &StepFEA_SequenceOfNodeRepresentation::Value, "Constant item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("__call__", (const opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer) const ) &StepFEA_SequenceOfNodeRepresentation::operator(), py::is_operator(), "Constant operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("ChangeValue", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfNodeRepresentation::ChangeValue, "Variable item access by theIndex", py::arg("theIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("__call__", (opencascade::handle<StepFEA_NodeRepresentation> & (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer)) &StepFEA_SequenceOfNodeRepresentation::operator(), py::is_operator(), "Variable operator()", py::arg("theIndex"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("SetValue", (void (StepFEA_SequenceOfNodeRepresentation::*)(const Standard_Integer, const opencascade::handle<StepFEA_NodeRepresentation> &)) &StepFEA_SequenceOfNodeRepresentation::SetValue, "Set item value by theIndex", py::arg("theIndex"), py::arg("theItem"));
	cls_StepFEA_SequenceOfNodeRepresentation.def("__iter__", [](const StepFEA_SequenceOfNodeRepresentation &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
