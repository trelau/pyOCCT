...
PYBIND11_MODULE(V3d, mod) {
	...
	cls_V3d_Viewer.def("HideGridEcho", (void (V3d_Viewer::*)(const opencascade::handle<V3d_View> &)) &V3d_Viewer::HideGridEcho, "Temporarily hide grid echo.", py::arg("theView"));
	...
	cls_V3d_View.def("SetSize", (void (V3d_View::*)(const Standard_Real)) &V3d_View::SetSize, "Defines the view projection size in its maximum dimension, keeping the initial height/width ratio unchanged.", py::arg("theSize"));
	...
	cls_V3d_Plane.def("Display", (void (V3d_Plane::*)(const opencascade::handle<V3d_View> &, const Quantity_Color &)) &V3d_Plane::Display, "Display the plane representation in the chosen view.", py::arg("theView"), py::arg("theColor"));
