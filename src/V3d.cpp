...
PYBIND11_MODULE(V3d, mod) {
	...
	cls_V3d_Viewer.def("RectangularGridValues", (void (V3d_Viewer::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_Viewer::RectangularGridValues, "Returns the definition of the rectangular grid.", py::arg("XOrigin"), py::arg("YOrigin"), py::arg("XStep"), py::arg("YStep"), py::arg("RotationAngle"));
	...
	cls_V3d_Viewer.def("CircularGridValues", (void (V3d_Viewer::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Integer &, Standard_Real &) const ) &V3d_Viewer::CircularGridValues, "Returns the definition of the circular grid.", py::arg("XOrigin"), py::arg("YOrigin"), py::arg("RadiusStep"), py::arg("DivisionNumber"), py::arg("RotationAngle"));
	...
	cls_V3d_Viewer.def("CircularGridGraphicValues", (void (V3d_Viewer::*)(Standard_Real &, Standard_Real &) const ) &V3d_Viewer::CircularGridGraphicValues, "Returns the location and the size of the grid.", py::arg("Radius"), py::arg("OffSet"));
	...
	cls_V3d_Viewer.def("RectangularGridGraphicValues", (void (V3d_Viewer::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_Viewer::RectangularGridGraphicValues, "Returns the location and the size of the grid.", py::arg("XSize"), py::arg("YSize"), py::arg("OffSet"));
	...
	cls_V3d_Viewer.def("DefaultBackgroundColor", (void (V3d_Viewer::*)(const Quantity_TypeOfColor, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_Viewer::DefaultBackgroundColor, "None", py::arg("theType"), py::arg("theV1"), py::arg("theV2"), py::arg("theV3"));
	...
	cls_V3d_View.def("Convert", (void (V3d_View::*)(const Standard_Integer, const Standard_Integer, Standard_Real &, Standard_Real &) const ) &V3d_View::Convert, "Converts the point PIXEL into a point projected in the reference frame of the projection plane.", py::arg("Xp"), py::arg("Yp"), py::arg("Xv"), py::arg("Yv"));
	...
	cls_V3d_View.def("Convert", (void (V3d_View::*)(const Standard_Real, const Standard_Real, Standard_Integer &, Standard_Integer &) const ) &V3d_View::Convert, "Converts the point defined in the reference frame of the projection plane into a point PIXEL.", py::arg("Xv"), py::arg("Yv"), py::arg("Xp"), py::arg("Yp"));
	cls_V3d_View.def("Convert", (void (V3d_View::*)(const Standard_Integer, const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::Convert, "Converts the projected point into a point in the reference frame of the view corresponding to the intersection with the projection plane of the eye/view point vector.", py::arg("Xp"), py::arg("Yp"), py::arg("X"), py::arg("Y"), py::arg("Z"));
	cls_V3d_View.def("ConvertWithProj", (void (V3d_View::*)(const Standard_Integer, const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::ConvertWithProj, "Converts the projected point into a point in the reference frame of the view corresponding to the intersection with the projection plane of the eye/view point vector and returns the projection ray for further computations.", py::arg("Xp"), py::arg("Yp"), py::arg("X"), py::arg("Y"), py::arg("Z"), py::arg("Vx"), py::arg("Vy"), py::arg("Vz"));
	cls_V3d_View.def("ConvertToGrid", (void (V3d_View::*)(const Standard_Integer, const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::ConvertToGrid, "Converts the projected point into the nearest grid point in the reference frame of the view corresponding to the intersection with the projection plane of the eye/view point vector and display the grid marker. Warning: When the grid is not active the result is identical to the above Convert() method. How to use: 1) Enable the grid echo display myViewer->SetGridEcho(Standard_True); 2) When application receive a move event: 2.1) Check if any object is detected if( myInteractiveContext->MoveTo(x,y) == AIS_SOD_Nothing ) { 2.2) Check if the grid is active if( myViewer->Grid()->IsActive() ) { 2.3) Display the grid echo and gets the grid point myView->ConvertToGrid(x,y,X,Y,Z); myView->Viewer()->ShowGridEcho (myView, Graphic3d_Vertex (X,Y,Z)); myView->RedrawImmediate(); 2.4) Else this is the standard case } else myView->Convert(x,y,X,Y,Z);", py::arg("Xp"), py::arg("Yp"), py::arg("Xg"), py::arg("Yg"), py::arg("Zg"));
	cls_V3d_View.def("ConvertToGrid", (void (V3d_View::*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::ConvertToGrid, "Converts the point into the nearest grid point and display the grid marker.", py::arg("X"), py::arg("Y"), py::arg("Z"), py::arg("Xg"), py::arg("Yg"), py::arg("Zg"));
	cls_V3d_View.def("Convert", (void (V3d_View::*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Integer &, Standard_Integer &) const ) &V3d_View::Convert, "Projects the point defined in the reference frame of the view into the projected point in the associated window.", py::arg("X"), py::arg("Y"), py::arg("Z"), py::arg("Xp"), py::arg("Yp"));
	cls_V3d_View.def("Project", (void (V3d_View::*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &) const ) &V3d_View::Project, "Converts the point defined in the user space of the view to the projection plane at the depth relative to theZ.", py::arg("theX"), py::arg("theY"), py::arg("theZ"), py::arg("theXp"), py::arg("theYp"));
	cls_V3d_View.def("Project", (void (V3d_View::*)(const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::Project, "Converts the point defined in the user space of the view to the projection plane at the depth relative to theZ.", py::arg("theX"), py::arg("theY"), py::arg("theZ"), py::arg("theXp"), py::arg("theYp"), py::arg("theZp"));
	cls_V3d_View.def("BackgroundColor", (void (V3d_View::*)(const Quantity_TypeOfColor, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::BackgroundColor, "Returns the Background color values of the view depending of the color Type.", py::arg("Type"), py::arg("V1"), py::arg("V2"), py::arg("V3"));
	...
	cls_V3d_View.def("AxialScale", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::AxialScale, "Returns the current values of the anisotropic (axial) scale factors.", py::arg("Sx"), py::arg("Sy"), py::arg("Sz"));
	cls_V3d_View.def("Size", (void (V3d_View::*)(Standard_Real &, Standard_Real &) const ) &V3d_View::Size, "Returns the height and width of the view.", py::arg("Width"), py::arg("Height"));
	cls_V3d_View.def("ZSize", (Standard_Real (V3d_View::*)() const ) &V3d_View::ZSize, "Returns the Depth of the view .");
	cls_V3d_View.def("Eye", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::Eye, "Returns the position of the eye.", py::arg("X"), py::arg("Y"), py::arg("Z"));
	cls_V3d_View.def("FocalReferencePoint", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::FocalReferencePoint, "Returns the position of point which emanating the projections.", py::arg("X"), py::arg("Y"), py::arg("Z"));
	cls_V3d_View.def("ProjReferenceAxe", (void (V3d_View::*)(const Standard_Integer, const Standard_Integer, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::ProjReferenceAxe, "Returns the coordinate of the point (Xpix,Ypix) in the view (XP,YP,ZP), and the projection vector of the view passing by the point (for PerspectiveView).", py::arg("Xpix"), py::arg("Ypix"), py::arg("XP"), py::arg("YP"), py::arg("ZP"), py::arg("VX"), py::arg("VY"), py::arg("VZ"));
	cls_V3d_View.def("Depth", (Standard_Real (V3d_View::*)() const ) &V3d_View::Depth, "Returns the Distance between the Eye and View Point.");
	cls_V3d_View.def("Proj", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::Proj, "Returns the projection vector.", py::arg("Vx"), py::arg("Vy"), py::arg("Vz"));
	cls_V3d_View.def("At", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::At, "Returns the position of the view point.", py::arg("X"), py::arg("Y"), py::arg("Z"));
	cls_V3d_View.def("Up", (void (V3d_View::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_View::Up, "Returns the vector giving the position of the high point.", py::arg("Vx"), py::arg("Vy"), py::arg("Vz"));
	...
	// FIXME cls_V3d_View.def("Dump", [](V3d_View &self, const Standard_CString a0) -> Standard_Boolean { return self.Dump(a0); }, py::arg("theFile"));
	// FIXME cls_V3d_View.def("Dump", (Standard_Boolean (V3d_View::*)(const Standard_CString, const Graphic3d_BufferType &)) &V3d_View::Dump, "dump the full contents of the view at the same scale in the file <theFile>. The file name extension must be one of '.png','.bmp','.jpg','.gif'. Returns FALSE when the dump has failed", py::arg("theFile"), py::arg("theBufferType"));
	...
	cls_V3d_CircularGrid.def("GraphicValues", (void (V3d_CircularGrid::*)(Standard_Real &, Standard_Real &) const ) &V3d_CircularGrid::GraphicValues, "None", py::arg("Radius"), py::arg("OffSet"));
	...
	cls_V3d_RectangularGrid.def("GraphicValues", (void (V3d_RectangularGrid::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_RectangularGrid::GraphicValues, "None", py::arg("XSize"), py::arg("YSize"), py::arg("OffSet"));
	...
	cls_V3d_PositionLight.def("Position", (void (V3d_PositionLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_PositionLight::Position, "Returns the position of the light source.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	cls_V3d_PositionLight.def("Target", (void (V3d_PositionLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_PositionLight::Target, "Returns the position of the target of the light source.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	...
	cls_V3d_DirectionalLight.def("Position", (void (V3d_DirectionalLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_DirectionalLight::Position, "Calls DisplayPosition method.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	cls_V3d_DirectionalLight.def("DisplayPosition", (void (V3d_DirectionalLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_DirectionalLight::DisplayPosition, "Returns the chosen position to represent the light source.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	cls_V3d_DirectionalLight.def("Direction", (void (V3d_DirectionalLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_DirectionalLight::Direction, "Returns the theVx, theVy, theVz direction of the light source.", py::arg("theVx"), py::arg("theVy"), py::arg("theVz"));
	...
	cls_V3d_Plane.def("Plane", (void (V3d_Plane::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_Plane::Plane, "Returns the parameters of the plane.", py::arg("theA"), py::arg("theB"), py::arg("theC"), py::arg("theD"));
	...
	cls_V3d_PositionalLight.def("Position", (void (V3d_PositionalLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_PositionalLight::Position, "Returns the position of the light source.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	cls_V3d_PositionalLight.def("Attenuation", (void (V3d_PositionalLight::*)(Standard_Real &, Standard_Real &) const ) &V3d_PositionalLight::Attenuation, "Returns the attenuation factors.", py::arg("theConstAttenuation"), py::arg("theLinearAttenuation"));
	...
	cls_V3d_SpotLight.def("Direction", (void (V3d_SpotLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_SpotLight::Direction, "Returns the direction of the light source defined by theVx, theVy, theVz.", py::arg("theVx"), py::arg("theVy"), py::arg("theVz"));
	cls_V3d_SpotLight.def("Position", (void (V3d_SpotLight::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &V3d_SpotLight::Position, "Returns the position of the light source.", py::arg("theX"), py::arg("theY"), py::arg("theZ"));
	cls_V3d_SpotLight.def("Attenuation", (void (V3d_SpotLight::*)(Standard_Real &, Standard_Real &) const ) &V3d_SpotLight::Attenuation, "Returns the attenuation factors A1,A2 of the light source.", py::arg("theConstAttentuation"), py::arg("theLinearAttentuation"));
