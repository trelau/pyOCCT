...
PYBIND11_MODULE(math, mod) {
	...
	*/
	...
	cls_math_Function.def("Value", (Standard_Boolean (math_Function::*)(const Standard_Real, Standard_Real &)) &math_Function::Value, "Computes the value of the function <F> for a given value of variable <X>. returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"));
	...
	cls_math_FunctionWithDerivative.def("Value", (Standard_Boolean (math_FunctionWithDerivative::*)(const Standard_Real, Standard_Real &)) &math_FunctionWithDerivative::Value, "Computes the value <F>of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"));
	cls_math_FunctionWithDerivative.def("Derivative", (Standard_Boolean (math_FunctionWithDerivative::*)(const Standard_Real, Standard_Real &)) &math_FunctionWithDerivative::Derivative, "Computes the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("D"));
	cls_math_FunctionWithDerivative.def("Values", (Standard_Boolean (math_FunctionWithDerivative::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &math_FunctionWithDerivative::Values, "Computes the value <F> and the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"), py::arg("D"));
	...
	cls_math_MultipleVarFunction.def("Value", (Standard_Boolean (math_MultipleVarFunction::*)(const math_Vector &, Standard_Real &)) &math_MultipleVarFunction::Value, "Computes the values of the Functions <F> for the variable <X>. returns True if the computation was done successfully, otherwise false.", py::arg("X"), py::arg("F"));
	...
	// FIXME cls_math_BFGS.def("SetBoundary", (void (math_BFGS::*)(const math_Vector &, const math_Vector &)) &math_BFGS::SetBoundary, "Set boundaries for conditional optimization. The expected indices range of vectors is [1, NbVariables].", py::arg("theLeftBorder"), py::arg("theRightBorder"));
	...
	cls_math_MultipleVarFunctionWithGradient.def("Value", (Standard_Boolean (math_MultipleVarFunctionWithGradient::*)(const math_Vector &, Standard_Real &)) &math_MultipleVarFunctionWithGradient::Value, "Computes the values of the Functions <F> for the variable <X>. Returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"));
	...
	cls_math_MultipleVarFunctionWithGradient.def("Values", (Standard_Boolean (math_MultipleVarFunctionWithGradient::*)(const math_Vector &, Standard_Real &, math_Vector &)) &math_MultipleVarFunctionWithGradient::Values, "computes the value <F> and the gradient <G> of the functions for the variable <X>. Returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"), py::arg("G"));
	...
	cls_math_MultipleVarFunctionWithHessian.def("Value", (Standard_Boolean (math_MultipleVarFunctionWithHessian::*)(const math_Vector &, Standard_Real &)) &math_MultipleVarFunctionWithHessian::Value, "computes the values of the Functions <F> for the variable <X>. Returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"));
	...
	cls_math_MultipleVarFunctionWithHessian.def("Values", (Standard_Boolean (math_MultipleVarFunctionWithHessian::*)(const math_Vector &, Standard_Real &, math_Vector &)) &math_MultipleVarFunctionWithHessian::Values, "computes the value <F> and the gradient <G> of the functions for the variable <X>. Returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"), py::arg("G"));
	cls_math_MultipleVarFunctionWithHessian.def("Values", (Standard_Boolean (math_MultipleVarFunctionWithHessian::*)(const math_Vector &, Standard_Real &, math_Vector &, math_Matrix &)) &math_MultipleVarFunctionWithHessian::Values, "computes the value <F>, the gradient <G> and the hessian <H> of the functions for the variable <X>. Returns True if the computation was done successfully, False otherwise.", py::arg("X"), py::arg("F"), py::arg("G"), py::arg("H"));
	...
	cls_math_FunctionSample.def("Bounds", (void (math_FunctionSample::*)(Standard_Real &, Standard_Real &) const ) &math_FunctionSample::Bounds, "Returns the bounds of parameters.", py::arg("A"), py::arg("B"));
	...
	cls_math_BracketMinimum.def("Values", (void (math_BracketMinimum::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &math_BracketMinimum::Values, "Returns the bracketed triplet of abscissae. Exceptions StdFail_NotDone if the algorithm fails (and IsDone returns false).", py::arg("A"), py::arg("B"), py::arg("C"));
	cls_math_BracketMinimum.def("FunctionValues", (void (math_BracketMinimum::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &math_BracketMinimum::FunctionValues, "returns the bracketed triplet function values. Exceptions StdFail_NotDone if the algorithm fails (and IsDone returns false).", py::arg("FA"), py::arg("FB"), py::arg("FC"));
	...
	cls_math_FunctionAllRoots.def("GetInterval", (void (math_FunctionAllRoots::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &math_FunctionAllRoots::GetInterval, "Returns the interval of parameter of range Index. An exception is raised if IsDone returns False; An exception is raised if Index<=0 or Index >Nbintervals.", py::arg("Index"), py::arg("A"), py::arg("B"));
	cls_math_FunctionAllRoots.def("GetIntervalState", (void (math_FunctionAllRoots::*)(const Standard_Integer, Standard_Integer &, Standard_Integer &) const ) &math_FunctionAllRoots::GetIntervalState, "returns the State Number associated to the interval Index. An exception is raised if IsDone returns False; An exception is raised if Index<=0 or Index >Nbintervals.", py::arg("Index"), py::arg("IFirst"), py::arg("ILast"));
	...
	// FIXME cls_math_Householder.def("Dump", (void (math_Householder::*)(Standard_OStream &) const ) &math_Householder::Dump, "Prints informations on the current state of the object.", py::arg("o"));
	...
	cls_math_KronrodSingleIntegration.def_static("GKRule_", (Standard_Boolean (*)(math_Function &, const Standard_Real, const Standard_Real, const math_Vector &, const math_Vector &, const math_Vector &, const math_Vector &, Standard_Real &, Standard_Real &)) &math_KronrodSingleIntegration::GKRule, "None", py::arg("theFunction"), py::arg("theLower"), py::arg("theUpper"), py::arg("theGaussP"), py::arg("theGaussW"), py::arg("theKronrodP"), py::arg("theKronrodW"), py::arg("theValue"), py::arg("theError"));
	...
	// FIXME cls_math_EigenValuesSearcher.def("EigenValue", (Standard_Real (math_EigenValuesSearcher::*)(const Standard_Integer) const ) &math_EigenValuesSearcher::EigenValue, "Returns the Index_th eigen value of matrix Index must be in [1, Dimension()]", py::arg("Index"));
	// FIXME cls_math_EigenValuesSearcher.def("EigenVector", (math_Vector (math_EigenValuesSearcher::*)(const Standard_Integer) const ) &math_EigenValuesSearcher::EigenVector, "Returns the Index_th eigen vector of matrix Index must be in [1, Dimension()]", py::arg("Index"));
	...
	cls_math_GlobOptMin.def("GetTol", (void (math_GlobOptMin::*)(Standard_Real &, Standard_Real &)) &math_GlobOptMin::GetTol, "Method to get tolerances.", py::arg("theDiscretizationTol"), py::arg("theSameTol"));
	...
	cls_math_PSO.def("Perform", [](math_PSO &self, const math_Vector & a0, Standard_Real & a1, math_Vector & a2) -> void { return self.Perform(a0, a1, a2); }, py::arg("theSteps"), py::arg("theValue"), py::arg("theOutPnt"));
	cls_math_PSO.def("Perform", (void (math_PSO::*)(const math_Vector &, Standard_Real &, math_Vector &, const Standard_Integer)) &math_PSO::Perform, "Perform computations, particles array is constructed inside of this function.", py::arg("theSteps"), py::arg("theValue"), py::arg("theOutPnt"), py::arg("theNbIter"));
	cls_math_PSO.def("Perform", [](math_PSO &self, math_PSOParticlesPool & a0, Standard_Integer a1, Standard_Real & a2, math_Vector & a3) -> void { return self.Perform(a0, a1, a2, a3); }, py::arg("theParticles"), py::arg("theNbParticles"), py::arg("theValue"), py::arg("theOutPnt"));
	cls_math_PSO.def("Perform", (void (math_PSO::*)(math_PSOParticlesPool &, Standard_Integer, Standard_Real &, math_Vector &, const Standard_Integer)) &math_PSO::Perform, "Perform computations with given particles array.", py::arg("theParticles"), py::arg("theNbParticles"), py::arg("theValue"), py::arg("theOutPnt"), py::arg("theNbIter"));
