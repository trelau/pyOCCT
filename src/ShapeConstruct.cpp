...
PYBIND11_MODULE(ShapeConstruct, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeConstruct_Curve.hxx
	...
	cls_ShapeConstruct_Curve.def("AdjustCurve", [](ShapeConstruct_Curve &self, const opencascade::handle<Geom_Curve> & a0, const gp_Pnt & a1, const gp_Pnt & a2) -> Standard_Boolean { return self.AdjustCurve(a0, a1, a2); }, py::arg("C3D"), py::arg("P1"), py::arg("P2"));
	cls_ShapeConstruct_Curve.def("AdjustCurve", [](ShapeConstruct_Curve &self, const opencascade::handle<Geom_Curve> & a0, const gp_Pnt & a1, const gp_Pnt & a2, const Standard_Boolean a3) -> Standard_Boolean { return self.AdjustCurve(a0, a1, a2, a3); }, py::arg("C3D"), py::arg("P1"), py::arg("P2"), py::arg("take1"));
	...
	cls_ShapeConstruct_Curve.def("AdjustCurve2d", [](ShapeConstruct_Curve &self, const opencascade::handle<Geom2d_Curve> & a0, const gp_Pnt2d & a1, const gp_Pnt2d & a2) -> Standard_Boolean { return self.AdjustCurve2d(a0, a1, a2); }, py::arg("C2D"), py::arg("P1"), py::arg("P2"));
	cls_ShapeConstruct_Curve.def("AdjustCurve2d", [](ShapeConstruct_Curve &self, const opencascade::handle<Geom2d_Curve> & a0, const gp_Pnt2d & a1, const gp_Pnt2d & a2, const Standard_Boolean a3) -> Standard_Boolean { return self.AdjustCurve2d(a0, a1, a2, a3); }, py::arg("C2D"), py::arg("P1"), py::arg("P2"), py::arg("take1"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeConstruct_ProjectCurveOnSurface.hxx
	...
	/* FIXME
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeConstruct.hxx
	py::class_<ShapeConstruct_CompBezierCurvesToBSplineCurve, std::unique_ptr<ShapeConstruct_CompBezierCurvesToBSplineCurve, Deleter<ShapeConstruct_CompBezierCurvesToBSplineCurve>>> cls_ShapeConstruct_CompBezierCurvesToBSplineCurve(mod, "ShapeConstruct_CompBezierCurvesToBSplineCurve", "None");
	cls_ShapeConstruct_CompBezierCurvesToBSplineCurve.def(py::init<>());
	*/

	/* FIXME
	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeConstruct.hxx
	py::class_<ShapeConstruct_CompBezierCurves2dToBSplineCurve2d, std::unique_ptr<ShapeConstruct_CompBezierCurves2dToBSplineCurve2d, Deleter<ShapeConstruct_CompBezierCurves2dToBSplineCurve2d>>> cls_ShapeConstruct_CompBezierCurves2dToBSplineCurve2d(mod, "ShapeConstruct_CompBezierCurves2dToBSplineCurve2d", "None");
	cls_ShapeConstruct_CompBezierCurves2dToBSplineCurve2d.def(py::init<>());
	*/

	// C:\Miniconda\envs\occt\Library\include\opencascade\ShapeConstruct_MakeTriangulation.hxx
	...
	cls_ShapeConstruct.def_static("JoinCurves_", (Standard_Boolean (*)(const opencascade::handle<Geom_Curve> &, const opencascade::handle<Geom_Curve> &, const TopAbs_Orientation, const TopAbs_Orientation, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, opencascade::handle<Geom_Curve> &, Standard_Boolean &, Standard_Boolean &)) &ShapeConstruct::JoinCurves, "Method for joininig curves 3D. Parameters : c3d1,ac3d2 - initial curves Orient1, Orient2 - initial edges orientations. first1,last1,first2,last2 - parameters for trimming curves (re-calculate with account of orientation edges) c3dOut - result curve isRev1,isRev2 - out parameters indicative on possible errors. Return value : True - if curves were joined successfully, else - False.", py::arg("c3d1"), py::arg("ac3d2"), py::arg("Orient1"), py::arg("Orient2"), py::arg("first1"), py::arg("last1"), py::arg("first2"), py::arg("last2"), py::arg("c3dOut"), py::arg("isRev1"), py::arg("isRev2"));
	cls_ShapeConstruct.def_static("JoinCurves_", [](const opencascade::handle<Geom2d_Curve> & a0, const opencascade::handle<Geom2d_Curve> & a1, const TopAbs_Orientation a2, const TopAbs_Orientation a3, Standard_Real & a4, Standard_Real & a5, Standard_Real & a6, Standard_Real & a7, opencascade::handle<Geom2d_Curve> & a8, Standard_Boolean & a9, Standard_Boolean & a10) -> Standard_Boolean { return ShapeConstruct::JoinCurves(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10); }, py::arg("c2d1"), py::arg("ac2d2"), py::arg("Orient1"), py::arg("Orient2"), py::arg("first1"), py::arg("last1"), py::arg("first2"), py::arg("last2"), py::arg("c2dOut"), py::arg("isRev1"), py::arg("isRev2"));
	cls_ShapeConstruct.def_static("JoinCurves_", (Standard_Boolean (*)(const opencascade::handle<Geom2d_Curve> &, const opencascade::handle<Geom2d_Curve> &, const TopAbs_Orientation, const TopAbs_Orientation, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, opencascade::handle<Geom2d_Curve> &, Standard_Boolean &, Standard_Boolean &, const Standard_Boolean)) &ShapeConstruct::JoinCurves, "Method for joininig curves 3D. Parameters : c3d1,ac3d2 - initial curves Orient1, Orient2 - initial edges orientations. first1,last1,first2,last2 - parameters for trimming curves (re-calculate with account of orientation edges) c3dOut - result curve isRev1,isRev2 - out parameters indicative on possible errors. isError - input parameter indicative possible errors due to that one from edges have one vertex Return value : True - if curves were joined successfully, else - False.", py::arg("c2d1"), py::arg("ac2d2"), py::arg("Orient1"), py::arg("Orient2"), py::arg("first1"), py::arg("last1"), py::arg("first2"), py::arg("last2"), py::arg("c2dOut"), py::arg("isRev1"), py::arg("isRev2"), py::arg("isError"));
