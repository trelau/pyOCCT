...
PYBIND11_MODULE(ShapeFix, mod) {
	...
	// FIXME cls_ShapeFix_Root.def("LimitTolerance", (Standard_Real (ShapeFix_Root::*)(const Standard_Real) const ) &ShapeFix_Root::LimitTolerance, "Returns tolerance limited by [myMinTol,myMaxTol]", py::arg("toler"));
	...
	cls_ShapeFix_WireSegment.def("GetPatchIndex", (void (ShapeFix_WireSegment::*)(const Standard_Integer, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &ShapeFix_WireSegment::GetPatchIndex, "Returns patch indices for edge i.", py::arg("i"), py::arg("iumin"), py::arg("iumax"), py::arg("ivmin"), py::arg("ivmax"));
	...
	cls_ShapeFix_IntersectionTool.def("CutEdge", (Standard_Boolean (ShapeFix_IntersectionTool::*)(const TopoDS_Edge &, const Standard_Real, const Standard_Real, const TopoDS_Face &, Standard_Boolean &) const ) &ShapeFix_IntersectionTool::CutEdge, "Cut edge by parameters pend and cut", py::arg("edge"), py::arg("pend"), py::arg("cut"), py::arg("face"), py::arg("iscutline"));
	cls_ShapeFix_IntersectionTool.def("FixSelfIntersectWire", (Standard_Boolean (ShapeFix_IntersectionTool::*)(opencascade::handle<ShapeExtend_WireData> &, const TopoDS_Face &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &ShapeFix_IntersectionTool::FixSelfIntersectWire, "None", py::arg("sewd"), py::arg("face"), py::arg("NbSplit"), py::arg("NbCut"), py::arg("NbRemoved"));
	...
	cls_ShapeFix_SplitTool.def("CutEdge", (Standard_Boolean (ShapeFix_SplitTool::*)(const TopoDS_Edge &, const Standard_Real, const Standard_Real, const TopoDS_Face &, Standard_Boolean &) const ) &ShapeFix_SplitTool::CutEdge, "Cut edge by parameters pend and cut", py::arg("edge"), py::arg("pend"), py::arg("cut"), py::arg("face"), py::arg("iscutline"));
	// FIXME cls_ShapeFix_SplitTool.def("SplitEdge", (Standard_Boolean (ShapeFix_SplitTool::*)(const TopoDS_Edge &, const Standard_Real, const TopoDS_Vertex &, const Standard_Real, const TopoDS_Vertex &, const TopoDS_Face &, TopTools_SequenceOfShape &, Standard_Integer &, const opencascade::handle<ShapeBuild_ReShape> &, const Standard_Real, const Standard_Real) const ) &ShapeFix_SplitTool::SplitEdge, "Split edge on two new edges using two new vertex V1 and V2 and two parameters for splitting - fp and lp correspondingly The 'face' is necessary for pcurves and using TransferParameterProj aNum - number of edge in SeqE which corresponding to [fp,lp]", py::arg("edge"), py::arg("fp"), py::arg("V1"), py::arg("lp"), py::arg("V2"), py::arg("face"), py::arg("SeqE"), py::arg("aNum"), py::arg("context"), py::arg("tol3d"), py::arg("tol2d"));
