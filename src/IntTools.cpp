...
PYBIND11_MODULE(IntTools, mod) {
	...
	cls_IntTools_EdgeFace.def("Context", (const opencascade::handle<IntTools_Context> & (IntTools_EdgeFace::*)() const ) &IntTools_EdgeFace::Context, "Gets the intersection context");
	...
	cls_IntTools_BeanFaceIntersector.def("SetContext", (void (IntTools_BeanFaceIntersector::*)(const opencascade::handle<IntTools_Context> &)) &IntTools_BeanFaceIntersector::SetContext, "Sets the intersection context", py::arg("theContext"));
	cls_IntTools_BeanFaceIntersector.def("Context", (const opencascade::handle<IntTools_Context> & (IntTools_BeanFaceIntersector::*)() const ) &IntTools_BeanFaceIntersector::Context, "Gets the intersection context");
	...
	cls_IntTools_FaceFace.def("PrepareLines3D", (void (IntTools_FaceFace::*)(const Standard_Boolean)) &IntTools_FaceFace::PrepareLines3D, "Provides post-processing the result lines. <bToSplit> - the flag. In case of <bToSplit> is true the closed 3D-curves will be split on parts. In case of <bToSplit> is false the closed 3D-curves remain untouched.", py::arg("bToSplit"));
	...
	cls_IntTools_FaceFace.def("SetContext", (void (IntTools_FaceFace::*)(const opencascade::handle<IntTools_Context> &)) &IntTools_FaceFace::SetContext, "Sets the intersection context", py::arg("aContext"));
	...
	cls_IntTools_FaceFace.def("Context", (const opencascade::handle<IntTools_Context> & (IntTools_FaceFace::*)() const ) &IntTools_FaceFace::Context, "Gets the intersection context");
