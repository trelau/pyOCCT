...
PYBIND11_MODULE(IntTools, mod) {
	...
	cls_IntTools_Root.def("Interval", (void (IntTools_Root::*)(Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &IntTools_Root::Interval, "Returns the values of interval from which the Root was found [t1,t2] and the corresponding values of the function on the bounds f(t1), f(t2).", py::arg("t1"), py::arg("t2"), py::arg("f1"), py::arg("f2"));
