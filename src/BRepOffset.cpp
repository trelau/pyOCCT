...
PYBIND11_MODULE(BRepOffset, mod) {
	...
	cls_BRepOffset_Offset.def("Init", (void (BRepOffset_Offset::*)(const TopoDS_Vertex &, const TopTools_ListOfShape &, const Standard_Real, const Standard_Boolean, const Standard_Real, const GeomAbs_Shape)) &BRepOffset_Offset::Init, "Tol and Conti are only used if Polynomial is True (Used to perform the approximation)", py::arg("Vertex"), py::arg("LEdge"), py::arg("Offset"), py::arg("Polynomial"), py::arg("Tol"), py::arg("Conti"));
	...
	cls_BRepOffset_MakeSimpleOffset.def("Generated", (const TopoDS_Shape (BRepOffset_MakeSimpleOffset::*)(const TopoDS_Shape &) const ) &BRepOffset_MakeSimpleOffset::Generated, "Returns result shape for the given one (if exists).", py::arg("theShape"));
	cls_BRepOffset_MakeSimpleOffset.def("Modified", (const TopoDS_Shape (BRepOffset_MakeSimpleOffset::*)(const TopoDS_Shape &) const ) &BRepOffset_MakeSimpleOffset::Modified, "Returns modified shape for the given one (if exists).", py::arg("theShape"));
