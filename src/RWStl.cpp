...
PYBIND11_MODULE(RWStl, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\RWStl.hxx
	...
	cls_RWStl.def_static("WriteBinary_", [](const opencascade::handle<Poly_Triangulation> & a0, const OSD_Path & a1) -> Standard_Boolean { return RWStl::WriteBinary(a0, a1); }, py::arg("theMesh"), py::arg("thePath"));
	...
	cls_RWStl.def_static("WriteAscii_", [](const opencascade::handle<Poly_Triangulation> & a0, const OSD_Path & a1) -> Standard_Boolean { return RWStl::WriteAscii(a0, a1); }, py::arg("theMesh"), py::arg("thePath"));
	...
	cls_RWStl.def_static("ReadFile_", [](const OSD_Path & a0) -> opencascade::handle<Poly_Triangulation> { return RWStl::ReadFile(a0); }, py::arg("theFile"));
	...
	cls_RWStl.def_static("ReadFile_", [](const Standard_CString a0) -> opencascade::handle<Poly_Triangulation> { return RWStl::ReadFile(a0); }, py::arg("theFile"));
	...
	cls_RWStl.def_static("ReadBinary_", [](const OSD_Path & a0) -> opencascade::handle<Poly_Triangulation> { return RWStl::ReadBinary(a0); }, py::arg("thePath"));
	...
	cls_RWStl.def_static("ReadAscii_", [](const OSD_Path & a0) -> opencascade::handle<Poly_Triangulation> { return RWStl::ReadAscii(a0); }, py::arg("thePath"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\RWStl_Reader.hxx
