...
PYBIND11_MODULE(Law, mod) {
	...
	// FIXME cls_Law_BSpline.def("IncreaseMultiplicity", (void (Law_BSpline::*)(const Standard_Integer, const Standard_Integer, const Standard_Integer)) &Law_BSpline::IncreaseMultiplicity, "Increases the multiplicities of the knots in [I1,I2] to <M>.", py::arg("I1"), py::arg("I2"), py::arg("M"));
	// FIXME cls_Law_BSpline.def("IncrementMultiplicity", (void (Law_BSpline::*)(const Standard_Integer, const Standard_Integer, const Standard_Integer)) &Law_BSpline::IncrementMultiplicity, "Increment the multiplicities of the knots in [I1,I2] by <M>.", py::arg("I1"), py::arg("I2"), py::arg("M"));
	...
	// FIXME cls_Law_BSpline.def("SetOrigin", (void (Law_BSpline::*)(const Standard_Integer)) &Law_BSpline::SetOrigin, "Set the origin of a periodic curve at Knot(index) KnotVector and poles are modified. Raised if the curve is not periodic Raised if index not in the range [FirstUKnotIndex , LastUKnotIndex]", py::arg("Index"));
