...
PYBIND11_MODULE(BRepClass, mod) {
	...
	cls_BRepClass_Intersector.def("LocalGeometry", (void (BRepClass_Intersector::*)(const BRepClass_Edge &, const Standard_Real, gp_Dir2d &, gp_Dir2d &, Standard_Real &) const ) &BRepClass_Intersector::LocalGeometry, "Returns in <T>, <N> and <C> the tangent, normal and curvature of the edge <E> at parameter value <U>.", py::arg("E"), py::arg("U"), py::arg("T"), py::arg("N"), py::arg("C"));
	...
	cls_BRepClass_FaceExplorer.def("Segment", (Standard_Boolean (BRepClass_FaceExplorer::*)(const gp_Pnt2d &, gp_Lin2d &, Standard_Real &)) &BRepClass_FaceExplorer::Segment, "Returns in <L>, <Par> a segment having at least one intersection with the face boundary to compute intersections.", py::arg("P"), py::arg("L"), py::arg("Par"));
	cls_BRepClass_FaceExplorer.def("OtherSegment", (Standard_Boolean (BRepClass_FaceExplorer::*)(const gp_Pnt2d &, gp_Lin2d &, Standard_Real &)) &BRepClass_FaceExplorer::OtherSegment, "Returns in <L>, <Par> a segment having at least one intersection with the face boundary to compute intersections. Each call gives another segment.", py::arg("P"), py::arg("L"), py::arg("Par"));
