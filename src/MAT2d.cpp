...
PYBIND11_MODULE(MAT2d, mod) {
	...
	*/
	...
	bind_NCollection_DataMap<int, gp_Pnt2d, NCollection_DefaultHasher<int> >(mod, "MAT2d_DataMapOfIntegerPnt2d");
	...
	*/
	...
	bind_NCollection_DataMap<int, gp_Vec2d, NCollection_DefaultHasher<int> >(mod, "MAT2d_DataMapOfIntegerVec2d");
	...
	*/
	...
	bind_NCollection_DataMap<MAT2d_BiInt, int, MAT2d_MapBiIntHasher>(mod, "MAT2d_DataMapOfBiIntInteger");

	/* FIXME

	*/

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_SequenceOfSequenceOfCurve.hxx
	bind_NCollection_Sequence<NCollection_Sequence<opencascade::handle<Geom2d_Curve> > >(mod, "MAT2d_SequenceOfSequenceOfCurve");

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_Array2OfConnexion.hxx
	bind_NCollection_Array2<opencascade::handle<MAT2d_Connexion> >(mod, "MAT2d_Array2OfConnexion");

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_DataMapOfIntegerConnexion.hxx
	bind_NCollection_DataMap<int, opencascade::handle<MAT2d_Connexion>, NCollection_DefaultHasher<int> >(mod, "MAT2d_DataMapOfIntegerConnexion");
	...
	*/
	...
	bind_NCollection_DataMap<MAT2d_BiInt, NCollection_Sequence<int>, MAT2d_MapBiIntHasher>(mod, "MAT2d_DataMapOfBiIntSequenceOfInteger");

	/* FIXME

	*/

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_SequenceOfSequenceOfGeometry.hxx
	bind_NCollection_Sequence<NCollection_Sequence<opencascade::handle<Geom2d_Geometry> > >(mod, "MAT2d_SequenceOfSequenceOfGeometry");

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_SequenceOfConnexion.hxx
	bind_NCollection_Sequence<opencascade::handle<MAT2d_Connexion> >(mod, "MAT2d_SequenceOfConnexion");

	// C:\Miniconda\envs\occt\Library\include\opencascade\MAT2d_DataMapOfIntegerSequenceOfConnexion.hxx
	bind_NCollection_DataMap<int, NCollection_Sequence<opencascade::handle<MAT2d_Connexion> >, NCollection_DefaultHasher<int> >(mod, "MAT2d_DataMapOfIntegerSequenceOfConnexion");
