...
PYBIND11_MODULE(ShapeAlgo, mod) {
	...
	cls_ShapeAlgo_AlgoContainer.def("ConnectNextWire", (Standard_Boolean (ShapeAlgo_AlgoContainer::*)(const opencascade::handle<ShapeAnalysis_Wire> &, const opencascade::handle<ShapeExtend_WireData> &, const Standard_Real, Standard_Real &, Standard_Boolean &, Standard_Boolean &) const ) &ShapeAlgo_AlgoContainer::ConnectNextWire, "Finds the best way to connect and connects <nextsewd> to already built <sewd> (in <saw>). Returns False if <nextsewd> cannot be connected, otherwise - True. <maxtol> specifies the maximum tolerance with which <nextsewd> can be added. <distmin> is used to receive the minimum distance between <nextsewd> and <sewd>. <revsewd> is True if <sewd> has been reversed before connecting. <revnextwd> is True if <nextsewd> has been reversed before connecting. Uses functionality of ShapeAnalysis_Wire.", py::arg("saw"), py::arg("nextsewd"), py::arg("maxtol"), py::arg("distmin"), py::arg("revsewd"), py::arg("revnextsewd"));
	...
	cls_ShapeAlgo_AlgoContainer.def("GetFaceUVBounds", (void (ShapeAlgo_AlgoContainer::*)(const TopoDS_Face &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &) const ) &ShapeAlgo_AlgoContainer::GetFaceUVBounds, "Computes exact UV bounds of all wires on the face", py::arg("F"), py::arg("Umin"), py::arg("Umax"), py::arg("Vmin"), py::arg("Vmax"));
