...
PYBIND11_MODULE(TObj, mod) {
	...
	cls_TObj_Object.def("AfterRetrieval", (void (TObj_Object::*)()) &TObj_Object::AfterRetrieval, "Performs updating the links and dependances of the object which are not stored in persistence. Should be redefined if necessary.");
	cls_TObj_Object.def("BeforeStoring", (void (TObj_Object::*)()) &TObj_Object::BeforeStoring, "Performs storing the objects transient fields in OCAF document which were outside transaction mechanism. Default implementation doesnot nothing");
	...
	cls_TObj_Partition.def("AfterRetrieval", (void (TObj_Partition::*)()) &TObj_Partition::AfterRetrieval, "Performs updating the links and dependances of the object which are not stored in persistence. Does not register the partition name");
