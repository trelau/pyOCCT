...
PYBIND11_MODULE(XmlMXCAFDoc, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_AreaDriver.hxx
	...
	cls_XmlMXCAFDoc_AreaDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_CentroidDriver.hxx
	...
	cls_XmlMXCAFDoc_CentroidDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_ColorDriver.hxx
	...
	cls_XmlMXCAFDoc_ColorDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_GraphNodeDriver.hxx
	...
	cls_XmlMXCAFDoc_GraphNodeDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_LocationDriver.hxx
	...
	cls_XmlMXCAFDoc_LocationDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_VolumeDriver.hxx
	...
	cls_XmlMXCAFDoc_VolumeDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_DatumDriver.hxx
	...
	cls_XmlMXCAFDoc_DatumDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_DimTolDriver.hxx
	...
	cls_XmlMXCAFDoc_DimTolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_MaterialDriver.hxx
	...
	cls_XmlMXCAFDoc_MaterialDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_NotesToolDriver.hxx
	...
	cls_XmlMXCAFDoc_NotesToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_NoteDriver.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_NoteCommentDriver.hxx
	...
	cls_XmlMXCAFDoc_NoteCommentDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_NoteBinDataDriver.hxx
	...
	cls_XmlMXCAFDoc_NoteBinDataDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_ClippingPlaneToolDriver.hxx
	...
	cls_XmlMXCAFDoc_ClippingPlaneToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_ColorToolDriver.hxx
	...
	cls_XmlMXCAFDoc_ColorToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_DocumentToolDriver.hxx
	...
	cls_XmlMXCAFDoc_DocumentToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_LayerToolDriver.hxx
	...
	cls_XmlMXCAFDoc_LayerToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_ShapeToolDriver.hxx
	...
	cls_XmlMXCAFDoc_ShapeToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_DimTolToolDriver.hxx
	...
	cls_XmlMXCAFDoc_DimTolToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_MaterialToolDriver.hxx
	...
	cls_XmlMXCAFDoc_MaterialToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_ViewToolDriver.hxx
	...
	cls_XmlMXCAFDoc_ViewToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc.hxx
	py::class_<XmlMXCAFDoc, std::unique_ptr<XmlMXCAFDoc, Deleter<XmlMXCAFDoc>>> cls_XmlMXCAFDoc(mod, "XmlMXCAFDoc", "Storage and Retrieval drivers for modelling attributes. Transient attributes are defined in package XCAFDoc");
	cls_XmlMXCAFDoc.def(py::init<>());
	cls_XmlMXCAFDoc.def_static("AddDrivers_", (void (*)(const opencascade::handle<XmlMDF_ADriverTable> &, const opencascade::handle<CDM_MessageDriver> &)) &XmlMXCAFDoc::AddDrivers, "Adds the attribute drivers to <aDriverTable>.", py::arg("aDriverTable"), py::arg("anMsgDrv"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_AssemblyItemRefDriver.hxx
	...
	cls_XmlMXCAFDoc_AssemblyItemRefDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\XmlMXCAFDoc_NoteBalloonDriver.hxx
	...
	cls_XmlMXCAFDoc_NoteBalloonDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMessageDriver"));
