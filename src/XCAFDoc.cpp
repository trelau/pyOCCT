...
PYBIND11_MODULE(XCAFDoc, mod) {
	...
	cls_XCAFDoc_DimTolTool.def("GetDimTol", (Standard_Boolean (XCAFDoc_DimTolTool::*)(const TDF_Label &, Standard_Integer &, opencascade::handle<TColStd_HArray1OfReal> &, opencascade::handle<TCollection_HAsciiString> &, opencascade::handle<TCollection_HAsciiString> &) const ) &XCAFDoc_DimTolTool::GetDimTol, "Returns dimtol assigned to <DimTolL> Returns False if no such dimtol is assigned", py::arg("DimTolL"), py::arg("kind"), py::arg("aVal"), py::arg("aName"), py::arg("aDescription"));
	...
	cls_XCAFDoc_Color.def("GetRGB", (void (XCAFDoc_Color::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &XCAFDoc_Color::GetRGB, "None", py::arg("R"), py::arg("G"), py::arg("B"));
	...
	cls_XCAFDoc_Volume.def_static("Get_", (Standard_Boolean (*)(const TDF_Label &, Standard_Real &)) &XCAFDoc_Volume::Get, "Returns volume as argument returns false if no such attribute at the <label>", py::arg("label"), py::arg("vol"));
	...
	cls_XCAFDoc_Area.def_static("Get_", (Standard_Boolean (*)(const TDF_Label &, Standard_Real &)) &XCAFDoc_Area::Get, "Returns volume of area as argument and succes status returns false if no such attribute at the <label>", py::arg("label"), py::arg("area"));
	...
	cls_XCAFDoc_ClippingPlaneTool.def("GetCapping", (Standard_Boolean (XCAFDoc_ClippingPlaneTool::*)(const TDF_Label &, Standard_Boolean &) const ) &XCAFDoc_ClippingPlaneTool::GetCapping, "Get capping value for given clipping plane label Return true if Label is valid abd capping is exist.", py::arg("theClippingPlaneL"), py::arg("theCapping"));
	...
	cls_XCAFDoc_MaterialTool.def("GetMaterial", (Standard_Boolean (XCAFDoc_MaterialTool::*)(const TDF_Label &, opencascade::handle<TCollection_HAsciiString> &, opencascade::handle<TCollection_HAsciiString> &, Standard_Real &, opencascade::handle<TCollection_HAsciiString> &, opencascade::handle<TCollection_HAsciiString> &) const ) &XCAFDoc_MaterialTool::GetMaterial, "Returns Material assigned to <MatL> Returns False if no such Material is assigned", py::arg("MatL"), py::arg("aName"), py::arg("aDescription"), py::arg("aDensity"), py::arg("aDensName"), py::arg("aDensValType"));
