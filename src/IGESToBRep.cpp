...
PYBIND11_MODULE(IGESToBRep, mod) {
	...
	cls_IGESToBRep_BasicSurface.def("TransferBasicSurface", (opencascade::handle<Geom_Surface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESData_IGESEntity> &)) &IGESToBRep_BasicSurface::TransferBasicSurface, "Returns Surface from Geom if the last transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferPlaneSurface", (opencascade::handle<Geom_Plane> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESSolid_PlaneSurface> &)) &IGESToBRep_BasicSurface::TransferPlaneSurface, "Returns Plane from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferRightCylindricalSurface", (opencascade::handle<Geom_CylindricalSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESSolid_CylindricalSurface> &)) &IGESToBRep_BasicSurface::TransferRightCylindricalSurface, "Returns CylindricalSurface from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferRightConicalSurface", (opencascade::handle<Geom_ConicalSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESSolid_ConicalSurface> &)) &IGESToBRep_BasicSurface::TransferRightConicalSurface, "Returns ConicalSurface from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferSphericalSurface", (opencascade::handle<Geom_SphericalSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESSolid_SphericalSurface> &)) &IGESToBRep_BasicSurface::TransferSphericalSurface, "Returns SphericalSurface from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferToroidalSurface", (opencascade::handle<Geom_ToroidalSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESSolid_ToroidalSurface> &)) &IGESToBRep_BasicSurface::TransferToroidalSurface, "Returns SphericalSurface from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferSplineSurface", (opencascade::handle<Geom_BSplineSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESGeom_SplineSurface> &)) &IGESToBRep_BasicSurface::TransferSplineSurface, "Returns BSplineSurface from Geom if the transfer has succeeded.", py::arg("start"));
	cls_IGESToBRep_BasicSurface.def("TransferBSplineSurface", (opencascade::handle<Geom_BSplineSurface> (IGESToBRep_BasicSurface::*)(const opencascade::handle<IGESGeom_BSplineSurface> &)) &IGESToBRep_BasicSurface::TransferBSplineSurface, "Returns BSplineSurface from Geom if the transfer has succeeded.", py::arg("start"));
