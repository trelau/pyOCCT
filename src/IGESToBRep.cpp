...
PYBIND11_MODULE(IGESToBRep, mod) {
	...
	cls_IGESToBRep_TopoSurface.def("ParamSurface", (TopoDS_Shape (IGESToBRep_TopoSurface::*)(const opencascade::handle<IGESData_IGESEntity> &, gp_Trsf2d &, Standard_Real &)) &IGESToBRep_TopoSurface::ParamSurface, "None", py::arg("start"), py::arg("trans"), py::arg("uFact"));
