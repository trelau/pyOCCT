...
PYBIND11_MODULE(IntPatch, mod) {
	...
	py::class_<IntPatch_Point, std::unique_ptr<IntPatch_Point, Deleter<IntPatch_Point>>> cls_IntPatch_Point(mod, "IntPatch_Point", "Definition of an intersection point between two surfaces. Such a point is contains geometrical information (see the Value method) and logical information.");
	...
	cls_IntPatch_ImpPrmIntersection.def("IsDone", (Standard_Boolean (IntPatch_ImpPrmIntersection::*)() const ) &IntPatch_ImpPrmIntersection::IsDone, "Returns true if the calculus was successful.");
	...
	py::class_<IntPatch_PolyhedronTool, std::unique_ptr<IntPatch_PolyhedronTool, Deleter<IntPatch_PolyhedronTool>>> cls_IntPatch_PolyhedronTool(mod, "IntPatch_PolyhedronTool", "Describe the signature of a polyedral surface with only triangular facets and the necessary information to compute the interferences.");
	...
	cls_IntPatch_PrmPrmIntersection.def("IsDone", (Standard_Boolean (IntPatch_PrmPrmIntersection::*)() const ) &IntPatch_PrmPrmIntersection::IsDone, "Returns true if the calculus was successful.");
