...
PYBIND11_MODULE(StepDimTol, mod) {
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfDatumReferenceModifier.hxx
	bind_NCollection_Array1<StepDimTol_DatumReferenceModifier>(mod, "StepDimTol_Array1OfDatumReferenceModifier");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfDatumSystemOrReference.hxx
	bind_NCollection_Array1<StepDimTol_DatumSystemOrReference>(mod, "StepDimTol_Array1OfDatumSystemOrReference");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfDatumReference.hxx
	bind_NCollection_Array1<opencascade::handle<StepDimTol_DatumReference> >(mod, "StepDimTol_Array1OfDatumReference");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfDatumReferenceElement.hxx
	bind_NCollection_Array1<opencascade::handle<StepDimTol_DatumReferenceElement> >(mod, "StepDimTol_Array1OfDatumReferenceElement");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfDatumReferenceCompartment.hxx
	bind_NCollection_Array1<opencascade::handle<StepDimTol_DatumReferenceCompartment> >(mod, "StepDimTol_Array1OfDatumReferenceCompartment");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfGeometricToleranceModifier.hxx
	bind_NCollection_Array1<StepDimTol_GeometricToleranceModifier>(mod, "StepDimTol_Array1OfGeometricToleranceModifier");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepDimTol_Array1OfToleranceZoneTarget.hxx
	bind_NCollection_Array1<StepDimTol_ToleranceZoneTarget>(mod, "StepDimTol_Array1OfToleranceZoneTarget");
