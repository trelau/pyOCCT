...
PYBIND11_MODULE(IGESSolid, mod) {
	...
	cls_IGESSolid_TopoBuilder.def("Edge", (void (IGESSolid_TopoBuilder::*)(const Standard_Integer, opencascade::handle<IGESData_IGESEntity> &, Standard_Integer &, Standard_Integer &) const ) &IGESSolid_TopoBuilder::Edge, "Returns the definition of an Edge (3D) given its rank", py::arg("num"), py::arg("curve"), py::arg("vstart"), py::arg("vend"));
