...
PYBIND11_MODULE(BRepFeat, mod) {
	...
	py::enum_<BRepFeat_StatusError>(mod, "BRepFeat_StatusError", "Describes the error.")
	...
	cls_BRepFeat_Builder.def("Init", (void (BRepFeat_Builder::*)(const TopoDS_Shape &)) &BRepFeat_Builder::Init, "Initializes the object of local boolean operation.", py::arg("theShape"));
	cls_BRepFeat_Builder.def("Init", (void (BRepFeat_Builder::*)(const TopoDS_Shape &, const TopoDS_Shape &)) &BRepFeat_Builder::Init, "Initializes the arguments of local boolean operation.", py::arg("theShape"), py::arg("theTool"));
	...
	cls_BRepFeat_Builder.def("KeepParts", (void (BRepFeat_Builder::*)(const TopTools_ListOfShape &)) &BRepFeat_Builder::KeepParts, "Initializes parts of the tool for second step of algorithm. Collects shapes and all sub-shapes into myShapes map.", py::arg("theIm"));
	...
	cls_BRepFeat_MakeCylindricalHole.def("Perform", (void (BRepFeat_MakeCylindricalHole::*)(const Standard_Real)) &BRepFeat_MakeCylindricalHole::Perform, "Performs every hole of radius <Radius>. This command has the same effect as a cut operation with an infinite cylinder defined by the given axis and <Radius>.", py::arg("Radius"));
	...
	cls_BRepFeat_MakeCylindricalHole.def("Perform", (void (BRepFeat_MakeCylindricalHole::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Boolean)) &BRepFeat_MakeCylindricalHole::Perform, "Performs every hole of radius <Radius> located between PFrom and PTo on the given axis. If <WithControl> is set to Standard_False no control are done on the resulting shape after the operation is performed.", py::arg("Radius"), py::arg("PFrom"), py::arg("PTo"), py::arg("WithControl"));
	...
	cls_BRepFeat_MakeCylindricalHole.def("PerformUntilEnd", (void (BRepFeat_MakeCylindricalHole::*)(const Standard_Real, const Standard_Boolean)) &BRepFeat_MakeCylindricalHole::PerformUntilEnd, "Performs every hole of radius <Radius> located after the origin of the given axis. If <WithControl> is set to Standard_False no control are done on the resulting shape after the operation is performed.", py::arg("Radius"), py::arg("WithControl"));
