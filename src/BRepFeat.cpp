...
PYBIND11_MODULE(BRepFeat, mod) {
	...
	cls_BRepFeat_MakeLinearForm.def("Propagate", (Standard_Boolean (BRepFeat_MakeLinearForm::*)(TopTools_ListOfShape &, const TopoDS_Face &, const gp_Pnt &, const gp_Pnt &, Standard_Boolean &)) &BRepFeat_MakeLinearForm::Propagate, "None", py::arg("L"), py::arg("F"), py::arg("FPoint"), py::arg("LPoint"), py::arg("falseside"));
	...
	cls_BRepFeat_MakeRevolutionForm.def("Init", (void (BRepFeat_MakeRevolutionForm::*)(const TopoDS_Shape &, const TopoDS_Wire &, const opencascade::handle<Geom_Plane> &, const gp_Ax1 &, const Standard_Real, const Standard_Real, const Standard_Integer, Standard_Boolean &)) &BRepFeat_MakeRevolutionForm::Init, "Initializes this construction algorithm A contour W, a shape Sbase and a plane P are initialized to serve as the basic elements in the construction of the rib or groove. The axis Axis of the revolved surface in the basis shape defines the feature's axis of revolution. Height1 and Height2 may be used as limits to the construction of the feature. Fuse offers a choice between: - removing matter with a Boolean cut using the setting 0 in case of the groove - adding matter with Boolean fusion using the setting 1 in case of the rib.", py::arg("Sbase"), py::arg("W"), py::arg("Plane"), py::arg("Axis"), py::arg("Height1"), py::arg("Height2"), py::arg("Fuse"), py::arg("Sliding"));
	...
	cls_BRepFeat_MakeRevolutionForm.def("Propagate", (Standard_Boolean (BRepFeat_MakeRevolutionForm::*)(TopTools_ListOfShape &, const TopoDS_Face &, const gp_Pnt &, const gp_Pnt &, Standard_Boolean &)) &BRepFeat_MakeRevolutionForm::Propagate, "None", py::arg("L"), py::arg("F"), py::arg("FPoint"), py::arg("LPoint"), py::arg("falseside"));
	...
	cls_BRepFeat.def_static("ParametricMinMax_", [](const TopoDS_Shape & a0, const opencascade::handle<Geom_Curve> & a1, Standard_Real & a2, Standard_Real & a3, Standard_Real & a4, Standard_Real & a5, Standard_Boolean & a6) -> void { return BRepFeat::ParametricMinMax(a0, a1, a2, a3, a4, a5, a6); }, py::arg("S"), py::arg("C"), py::arg("prmin"), py::arg("prmax"), py::arg("prbmin"), py::arg("prbmax"), py::arg("flag"));
	cls_BRepFeat.def_static("ParametricMinMax_", (void (*)(const TopoDS_Shape &, const opencascade::handle<Geom_Curve> &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Boolean &, const Standard_Boolean)) &BRepFeat::ParametricMinMax, "Ori = True taking account the orientation", py::arg("S"), py::arg("C"), py::arg("prmin"), py::arg("prmax"), py::arg("prbmin"), py::arg("prbmax"), py::arg("flag"), py::arg("Ori"));
