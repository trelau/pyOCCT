...
PYBIND11_MODULE(StepBasic, mod) {
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfApproval.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_Approval> >(mod, "StepBasic_Array1OfApproval");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfProductContext.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_ProductContext> >(mod, "StepBasic_Array1OfProductContext");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfDerivedUnitElement.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_DerivedUnitElement> >(mod, "StepBasic_Array1OfDerivedUnitElement");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfDocument.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_Document> >(mod, "StepBasic_Array1OfDocument");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfNamedUnit.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_NamedUnit> >(mod, "StepBasic_Array1OfNamedUnit");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfOrganization.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_Organization> >(mod, "StepBasic_Array1OfOrganization");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfPerson.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_Person> >(mod, "StepBasic_Array1OfPerson");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfProduct.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_Product> >(mod, "StepBasic_Array1OfProduct");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfProductDefinition.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_ProductDefinition> >(mod, "StepBasic_Array1OfProductDefinition");

	// C:\Miniconda\envs\occt\Library\include\opencascade\StepBasic_Array1OfUncertaintyMeasureWithUnit.hxx
	bind_NCollection_Array1<opencascade::handle<StepBasic_UncertaintyMeasureWithUnit> >(mod, "StepBasic_Array1OfUncertaintyMeasureWithUnit");
