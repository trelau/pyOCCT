...
PYBIND11_MODULE(BinMXCAFDoc, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_AreaDriver.hxx
	...
	cls_BinMXCAFDoc_AreaDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_CentroidDriver.hxx
	...
	cls_BinMXCAFDoc_CentroidDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ClippingPlaneToolDriver.hxx
	...
	cls_BinMXCAFDoc_ClippingPlaneToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ColorDriver.hxx
	...
	cls_BinMXCAFDoc_ColorDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_GraphNodeDriver.hxx
	...
	cls_BinMXCAFDoc_GraphNodeDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_LocationDriver.hxx
	...
	cls_BinMXCAFDoc_LocationDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_VolumeDriver.hxx
	...
	cls_BinMXCAFDoc_VolumeDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_DatumDriver.hxx
	...
	cls_BinMXCAFDoc_DatumDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_GeomToleranceDriver.hxx
	...
	cls_BinMXCAFDoc_GeomToleranceDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_DimensionDriver.hxx
	...
	cls_BinMXCAFDoc_DimensionDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_DimTolDriver.hxx
	...
	cls_BinMXCAFDoc_DimTolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_MaterialDriver.hxx
	...
	cls_BinMXCAFDoc_MaterialDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ColorToolDriver.hxx
	...
	cls_BinMXCAFDoc_ColorToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_DocumentToolDriver.hxx
	...
	cls_BinMXCAFDoc_DocumentToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_LayerToolDriver.hxx
	...
	cls_BinMXCAFDoc_LayerToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ShapeToolDriver.hxx
	...
	cls_BinMXCAFDoc_ShapeToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_DimTolToolDriver.hxx
	...
	cls_BinMXCAFDoc_DimTolToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_MaterialToolDriver.hxx
	...
	cls_BinMXCAFDoc_MaterialToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ViewDriver.hxx
	...
	cls_BinMXCAFDoc_ViewDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_ViewToolDriver.hxx
	...
	cls_BinMXCAFDoc_ViewToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc.hxx
	...
	cls_BinMXCAFDoc.def_static("AddDrivers_", (void (*)(const opencascade::handle<BinMDF_ADriverTable> &, const opencascade::handle<CDM_MessageDriver> &)) &BinMXCAFDoc::AddDrivers, "Adds the attribute drivers to <theDriverTable>.", py::arg("theDriverTable"), py::arg("theMsgDrv"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_AssemblyItemRefDriver.hxx
	...
	cls_BinMXCAFDoc_AssemblyItemRefDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_NoteDriver.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_NoteCommentDriver.hxx
	...
	cls_BinMXCAFDoc_NoteCommentDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_NoteBalloonDriver.hxx
	...
	cls_BinMXCAFDoc_NoteBalloonDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_NoteBinDataDriver.hxx
	...
	cls_BinMXCAFDoc_NoteBinDataDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BinMXCAFDoc_NotesToolDriver.hxx
	...
	cls_BinMXCAFDoc_NotesToolDriver.def(py::init<const opencascade::handle<CDM_MessageDriver> &>(), py::arg("theMsgDriver"));
