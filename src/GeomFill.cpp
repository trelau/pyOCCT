...
PYBIND11_MODULE(GeomFill, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_PipeError.hxx
	py::enum_<GeomFill_PipeError>(mod, "GeomFill_PipeError", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Trihedron.hxx
	py::enum_<GeomFill_Trihedron>(mod, "GeomFill_Trihedron", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_ApproxStyle.hxx
	py::enum_<GeomFill_ApproxStyle>(mod, "GeomFill_ApproxStyle", "None")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_FillingStyle.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_LocationLaw.hxx
	...
	cls_GeomFill_LocationLaw.def("GetInterval", (void (GeomFill_LocationLaw::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationLaw::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_LocationLaw.def("GetDomain", (void (GeomFill_LocationLaw::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationLaw::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	cls_GeomFill_LocationLaw.def("Resolution", (void (GeomFill_LocationLaw::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &GeomFill_LocationLaw::Resolution, "Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation.", py::arg("Index"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_GeomFill_LocationLaw.def("IsTranslation", (Standard_Boolean (GeomFill_LocationLaw::*)(Standard_Real &) const ) &GeomFill_LocationLaw::IsTranslation, "Say if the Location Law, is an translation of Location The default implementation is ' returns False '.", py::arg("Error"));
	cls_GeomFill_LocationLaw.def("IsRotation", (Standard_Boolean (GeomFill_LocationLaw::*)(Standard_Real &) const ) &GeomFill_LocationLaw::IsRotation, "Say if the Location Law, is a rotation of Location The default implementation is ' returns False '.", py::arg("Error"));
	...
	cls_GeomFill_LocationGuide.def("Set", (void (GeomFill_LocationGuide::*)(const opencascade::handle<GeomFill_SectionLaw> &, const Standard_Boolean, const Standard_Real, const Standard_Real, const Standard_Real, Standard_Real &)) &GeomFill_LocationGuide::Set, "None", py::arg("Section"), py::arg("rotat"), py::arg("SFirst"), py::arg("SLast"), py::arg("PrecAngle"), py::arg("LastAngle"));
	...
	cls_GeomFill_LocationGuide.def("GetInterval", (void (GeomFill_LocationGuide::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationGuide::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_LocationGuide.def("GetDomain", (void (GeomFill_LocationGuide::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationGuide::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_LocationGuide.def("Resolution", (void (GeomFill_LocationGuide::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &GeomFill_LocationGuide::Resolution, "Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0", py::arg("Index"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_GeomFill_LocationGuide.def("IsTranslation", (Standard_Boolean (GeomFill_LocationGuide::*)(Standard_Real &) const ) &GeomFill_LocationGuide::IsTranslation, "Say if the Location Law, is an translation of Location The default implementation is ' returns False '.", py::arg("Error"));
	cls_GeomFill_LocationGuide.def("IsRotation", (Standard_Boolean (GeomFill_LocationGuide::*)(Standard_Real &) const ) &GeomFill_LocationGuide::IsRotation, "Say if the Location Law, is a rotation of Location The default implementation is ' returns False '.", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_LocationDraft.hxx
	...
	cls_GeomFill_LocationDraft.def("GetInterval", (void (GeomFill_LocationDraft::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationDraft::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_LocationDraft.def("GetDomain", (void (GeomFill_LocationDraft::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_LocationDraft::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	cls_GeomFill_LocationDraft.def("Resolution", (void (GeomFill_LocationDraft::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &GeomFill_LocationDraft::Resolution, "Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0", py::arg("Index"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	cls_GeomFill_LocationDraft.def("IsTranslation", (Standard_Boolean (GeomFill_LocationDraft::*)(Standard_Real &) const ) &GeomFill_LocationDraft::IsTranslation, "Say if the Location Law, is an translation of Location The default implementation is ' returns False '.", py::arg("Error"));
	cls_GeomFill_LocationDraft.def("IsRotation", (Standard_Boolean (GeomFill_LocationDraft::*)(Standard_Real &) const ) &GeomFill_LocationDraft::IsRotation, "Say if the Location Law, is a rotation of Location The default implementation is ' returns False '.", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SectionLaw.hxx
	...
	cls_GeomFill_SectionLaw.def("SectionShape", (void (GeomFill_SectionLaw::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_SectionLaw::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	cls_GeomFill_SectionLaw.def("GetInterval", (void (GeomFill_SectionLaw::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_SectionLaw::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_SectionLaw.def("GetDomain", (void (GeomFill_SectionLaw::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_SectionLaw::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_SectionLaw.def("IsConstant", (Standard_Boolean (GeomFill_SectionLaw::*)(Standard_Real &) const ) &GeomFill_SectionLaw::IsConstant, "Say if all sections are equals", py::arg("Error"));
	...
	cls_GeomFill_SectionLaw.def("IsConicalLaw", (Standard_Boolean (GeomFill_SectionLaw::*)(Standard_Real &) const ) &GeomFill_SectionLaw::IsConicalLaw, "Returns True if all section are circle, with same plane,same center and linear radius evolution Return False by Default.", py::arg("Error"));
	...
	cls_GeomFill_Boundary.def("Bounds", (void (GeomFill_Boundary::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_Boundary::Bounds, "None", py::arg("First"), py::arg("Last"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_BoundWithSurf.hxx
	...
	cls_GeomFill_BoundWithSurf.def("Bounds", (void (GeomFill_BoundWithSurf::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_BoundWithSurf::Bounds, "None", py::arg("First"), py::arg("Last"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SimpleBound.hxx
	...
	cls_GeomFill_SimpleBound.def("Bounds", (void (GeomFill_SimpleBound::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_SimpleBound::Bounds, "None", py::arg("First"), py::arg("Last"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_CornerState.hxx
	...
	cls_GeomFill_CornerState.def("IsToKill", (Standard_Boolean (GeomFill_CornerState::*)(Standard_Real &) const ) &GeomFill_CornerState::IsToKill, "None", py::arg("Scal"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_CoonsAlgPatch.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_TgtField.hxx
	...
	cls_GeomFill_ConstrainedFilling.def("Init", [](GeomFill_ConstrainedFilling &self, const opencascade::handle<GeomFill_Boundary> & a0, const opencascade::handle<GeomFill_Boundary> & a1, const opencascade::handle<GeomFill_Boundary> & a2, const opencascade::handle<GeomFill_Boundary> & a3) -> void { return self.Init(a0, a1, a2, a3); }, py::arg("B1"), py::arg("B2"), py::arg("B3"), py::arg("B4"));
	...
	cls_GeomFill_ConstrainedFilling.def("Eval", (Standard_Integer (GeomFill_ConstrainedFilling::*)(const Standard_Real, const Standard_Integer, Standard_Real &) const ) &GeomFill_ConstrainedFilling::Eval, "Internal use for Advmath approximation call.", py::arg("W"), py::arg("Ord"), py::arg("Result"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Filling.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Stretch.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Coons.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Curved.hxx
	py::class_<GeomFill_Curved, std::unique_ptr<GeomFill_Curved, Deleter<GeomFill_Curved>>, GeomFill_Filling> cls_GeomFill_Curved(mod, "GeomFill_Curved", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_BezierCurves.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Profiler.hxx
	...
	// FIXME cls_GeomFill_Profiler.def("Poles", (void (GeomFill_Profiler::*)(const Standard_Integer, TColgp_Array1OfPnt &) const ) &GeomFill_Profiler::Poles, "returns in <Poles> the poles of the BSplineCurve from index <Index> adjusting to the current profile. Raises if not yet perform Raises if <Index> not in the range [1,NbCurves] if the length of <Poles> is not equal to NbPoles().", py::arg("Index"), py::arg("Poles"));
	// FIXME cls_GeomFill_Profiler.def("Weights", (void (GeomFill_Profiler::*)(const Standard_Integer, TColStd_Array1OfReal &) const ) &GeomFill_Profiler::Weights, "returns in <Weights> the weights of the BSplineCurve from index <Index> adjusting to the current profile. Raises if not yet perform Raises if <Index> not in the range [1,NbCurves] or if the length of <Weights> is not equal to NbPoles().", py::arg("Index"), py::arg("Weights"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SectionGenerator.hxx
	py::class_<GeomFill_SectionGenerator, std::unique_ptr<GeomFill_SectionGenerator, Deleter<GeomFill_SectionGenerator>>, GeomFill_Profiler> cls_GeomFill_SectionGenerator(mod, "GeomFill_SectionGenerator", "gives the functions needed for instantiation from AppSurf in AppBlend. Allow to evaluate a surface passing by all the curves if the Profiler.");
	...
	cls_GeomFill_SectionGenerator.def("GetShape", (void (GeomFill_SectionGenerator::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_SectionGenerator::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Line.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_AppSurf.hxx
	...
	cls_GeomFill_AppSurf.def("Init", [](GeomFill_AppSurf &self, const Standard_Integer a0, const Standard_Integer a1, const Standard_Real a2, const Standard_Real a3, const Standard_Integer a4) -> void { return self.Init(a0, a1, a2, a3, a4); }, py::arg("Degmin"), py::arg("Degmax"), py::arg("Tol3d"), py::arg("Tol2d"), py::arg("NbIt"));
	...
	cls_GeomFill_AppSurf.def("CriteriumWeight", (void (GeomFill_AppSurf::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &GeomFill_AppSurf::CriteriumWeight, "returns the Weights (as percent) associed to the criterium used in the optimization.", py::arg("W1"), py::arg("W2"), py::arg("W3"));
	cls_GeomFill_AppSurf.def("Perform", [](GeomFill_AppSurf &self, const opencascade::handle<GeomFill_Line> & a0, GeomFill_SectionGenerator & a1) -> void { return self.Perform(a0, a1); }, py::arg("Lin"), py::arg("SecGen"));
	...
	cls_GeomFill_AppSurf.def("SurfShape", (void (GeomFill_AppSurf::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_AppSurf::SurfShape, "None", py::arg("UDegree"), py::arg("VDegree"), py::arg("NbUPoles"), py::arg("NbVPoles"), py::arg("NbUKnots"), py::arg("NbVKnots"));
	...
	cls_GeomFill_AppSurf.def("Curves2dShape", (void (GeomFill_AppSurf::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_AppSurf::Curves2dShape, "None", py::arg("Degree"), py::arg("NbPoles"), py::arg("NbKnots"));
	...
	cls_GeomFill_AppSurf.def("TolReached", (void (GeomFill_AppSurf::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_AppSurf::TolReached, "None", py::arg("Tol3d"), py::arg("Tol2d"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SweepSectionGenerator.hxx
	...
	cls_GeomFill_SweepSectionGenerator.def("GetShape", (void (GeomFill_SweepSectionGenerator::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_SweepSectionGenerator::GetShape, "None", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("NbPoles2d"));
	...
	// FIXME cls_GeomFill_SweepSectionGenerator.def("Transformation", (const gp_Trsf & (GeomFill_SweepSectionGenerator::*)(const Standard_Integer) const ) &GeomFill_SweepSectionGenerator::Transformation, "raised if <Index> not in the range [1,NbSections()]", py::arg("Index"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_AppSweep.hxx
	py::class_<GeomFill_AppSweep, std::unique_ptr<GeomFill_AppSweep, Deleter<GeomFill_AppSweep>>, AppBlend_Approx> cls_GeomFill_AppSweep(mod, "GeomFill_AppSweep", "Approximate a sweep surface passing by all the curves described in the SweepSectionGenerator.");
	...
	cls_GeomFill_AppSweep.def("Init", [](GeomFill_AppSweep &self, const Standard_Integer a0, const Standard_Integer a1, const Standard_Real a2, const Standard_Real a3, const Standard_Integer a4) -> void { return self.Init(a0, a1, a2, a3, a4); }, py::arg("Degmin"), py::arg("Degmax"), py::arg("Tol3d"), py::arg("Tol2d"), py::arg("NbIt"));
	...
	cls_GeomFill_AppSweep.def("CriteriumWeight", (void (GeomFill_AppSweep::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &GeomFill_AppSweep::CriteriumWeight, "returns the Weights (as percent) associed to the criterium used in the optimization.", py::arg("W1"), py::arg("W2"), py::arg("W3"));
	cls_GeomFill_AppSweep.def("Perform", [](GeomFill_AppSweep &self, const opencascade::handle<GeomFill_Line> & a0, GeomFill_SweepSectionGenerator & a1) -> void { return self.Perform(a0, a1); }, py::arg("Lin"), py::arg("SecGen"));
	...
	cls_GeomFill_AppSweep.def("SurfShape", (void (GeomFill_AppSweep::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_AppSweep::SurfShape, "None", py::arg("UDegree"), py::arg("VDegree"), py::arg("NbUPoles"), py::arg("NbVPoles"), py::arg("NbUKnots"), py::arg("NbVKnots"));
	...
	cls_GeomFill_AppSweep.def("Curves2dShape", (void (GeomFill_AppSweep::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_AppSweep::Curves2dShape, "None", py::arg("Degree"), py::arg("NbPoles"), py::arg("NbKnots"));
	...
	cls_GeomFill_AppSweep.def("TolReached", (void (GeomFill_AppSweep::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_AppSweep::TolReached, "None", py::arg("Tol3d"), py::arg("Tol2d"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Generator.hxx
	...
	cls_GeomFill_Pipe.def("Init", [](GeomFill_Pipe &self, const opencascade::handle<Geom_Curve> & a0, const opencascade::handle<Geom_Curve> & a1) -> void { return self.Init(a0, a1); }, py::arg("Path"), py::arg("FirstSect"));
	...
	cls_GeomFill_Pipe.def("Perform", [](GeomFill_Pipe &self, const Standard_Boolean a0) -> void { return self.Perform(a0); }, py::arg("WithParameters"));
	...
	cls_GeomFill_Pipe.def("Perform", [](GeomFill_Pipe &self, const Standard_Real a0, const Standard_Boolean a1) -> void { return self.Perform(a0, a1); }, py::arg("Tol"), py::arg("Polynomial"));
	cls_GeomFill_Pipe.def("Perform", [](GeomFill_Pipe &self, const Standard_Real a0, const Standard_Boolean a1, const GeomAbs_Shape a2) -> void { return self.Perform(a0, a1, a2); }, py::arg("Tol"), py::arg("Polynomial"), py::arg("Conti"));
	cls_GeomFill_Pipe.def("Perform", [](GeomFill_Pipe &self, const Standard_Real a0, const Standard_Boolean a1, const GeomAbs_Shape a2, const Standard_Integer a3) -> void { return self.Perform(a0, a1, a2, a3); }, py::arg("Tol"), py::arg("Polynomial"), py::arg("Conti"), py::arg("MaxDegree"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Tensor.hxx
	py::class_<GeomFill_Tensor, std::unique_ptr<GeomFill_Tensor, Deleter<GeomFill_Tensor>>> cls_GeomFill_Tensor(mod, "GeomFill_Tensor", "used to store the 'gradient of gradient'");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_DegeneratedBound.hxx
	...
	cls_GeomFill_DegeneratedBound.def("Bounds", (void (GeomFill_DegeneratedBound::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_DegeneratedBound::Bounds, "None", py::arg("First"), py::arg("Last"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_TgtOnCoons.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_CircularBlendFunc.hxx
	...
	cls_GeomFill_CircularBlendFunc.def("SectionShape", (void (GeomFill_CircularBlendFunc::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_CircularBlendFunc::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SweepFunction.hxx
	...
	cls_GeomFill_SweepFunction.def("SectionShape", (void (GeomFill_SweepFunction::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_SweepFunction::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	cls_GeomFill_SweepFunction.def("Resolution", (void (GeomFill_SweepFunction::*)(const Standard_Integer, const Standard_Real, Standard_Real &, Standard_Real &) const ) &GeomFill_SweepFunction::Resolution, "Returns the resolutions in the sub-space 2d <Index> This information is usfull to find an good tolerance in 2d approximation. Warning: Used only if Nb2dCurve > 0", py::arg("Index"), py::arg("Tol"), py::arg("TolU"), py::arg("TolV"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_LocFunction.hxx
	py::class_<GeomFill_LocFunction, std::unique_ptr<GeomFill_LocFunction, Deleter<GeomFill_LocFunction>>> cls_GeomFill_LocFunction(mod, "GeomFill_LocFunction", "None");
	...
	cls_GeomFill_LocFunction.def("DN", (void (GeomFill_LocFunction::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Integer, Standard_Real &, Standard_Integer &)) &GeomFill_LocFunction::DN, "None", py::arg("Param"), py::arg("First"), py::arg("Last"), py::arg("Order"), py::arg("Result"), py::arg("Ier"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_PolynomialConvertor.hxx
	py::class_<GeomFill_PolynomialConvertor, std::unique_ptr<GeomFill_PolynomialConvertor, Deleter<GeomFill_PolynomialConvertor>>> cls_GeomFill_PolynomialConvertor(mod, "GeomFill_PolynomialConvertor", "To convert circular section in polynome");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_QuasiAngularConvertor.hxx
	py::class_<GeomFill_QuasiAngularConvertor, std::unique_ptr<GeomFill_QuasiAngularConvertor, Deleter<GeomFill_QuasiAngularConvertor>>> cls_GeomFill_QuasiAngularConvertor(mod, "GeomFill_QuasiAngularConvertor", "To convert circular section in QuasiAngular Bezier form");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SnglrFunc.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_FunctionDraft.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_PlanFunc.hxx
	...
	cls_GeomFill_PlanFunc.def("Value", (Standard_Boolean (GeomFill_PlanFunc::*)(const Standard_Real, Standard_Real &)) &GeomFill_PlanFunc::Value, "computes the value <F>of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"));
	cls_GeomFill_PlanFunc.def("Derivative", (Standard_Boolean (GeomFill_PlanFunc::*)(const Standard_Real, Standard_Real &)) &GeomFill_PlanFunc::Derivative, "computes the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("D"));
	cls_GeomFill_PlanFunc.def("Values", (Standard_Boolean (GeomFill_PlanFunc::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &GeomFill_PlanFunc::Values, "computes the value <F> and the derivative <D> of the function for the variable <X>. Returns True if the calculation were successfully done, False otherwise.", py::arg("X"), py::arg("F"), py::arg("D"));
	cls_GeomFill_PlanFunc.def("D2", (void (GeomFill_PlanFunc::*)(const Standard_Real, Standard_Real &, Standard_Real &, Standard_Real &)) &GeomFill_PlanFunc::D2, "None", py::arg("X"), py::arg("F"), py::arg("D1"), py::arg("D2"));
	cls_GeomFill_PlanFunc.def("DEDT", (void (GeomFill_PlanFunc::*)(const Standard_Real, const gp_Vec &, const gp_Vec &, Standard_Real &)) &GeomFill_PlanFunc::DEDT, "None", py::arg("X"), py::arg("DP"), py::arg("DV"), py::arg("DF"));
	cls_GeomFill_PlanFunc.def("D2E", (void (GeomFill_PlanFunc::*)(const Standard_Real, const gp_Vec &, const gp_Vec &, const gp_Vec &, const gp_Vec &, Standard_Real &, Standard_Real &, Standard_Real &)) &GeomFill_PlanFunc::D2E, "None", py::arg("X"), py::arg("DP"), py::arg("D2P"), py::arg("DV"), py::arg("D2V"), py::arg("DFDT"), py::arg("D2FDT2"), py::arg("D2FDTDX"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_FunctionGuide.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_UniformSection.hxx
	...
	cls_GeomFill_UniformSection.def("SectionShape", (void (GeomFill_UniformSection::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_UniformSection::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	cls_GeomFill_UniformSection.def("GetInterval", (void (GeomFill_UniformSection::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_UniformSection::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_UniformSection.def("GetDomain", (void (GeomFill_UniformSection::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_UniformSection::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_UniformSection.def("IsConstant", (Standard_Boolean (GeomFill_UniformSection::*)(Standard_Real &) const ) &GeomFill_UniformSection::IsConstant, "return True", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_EvolvedSection.hxx
	...
	cls_GeomFill_EvolvedSection.def("SectionShape", (void (GeomFill_EvolvedSection::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_EvolvedSection::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	cls_GeomFill_EvolvedSection.def("GetInterval", (void (GeomFill_EvolvedSection::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_EvolvedSection::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_EvolvedSection.def("GetDomain", (void (GeomFill_EvolvedSection::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_EvolvedSection::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_EvolvedSection.def("IsConstant", (Standard_Boolean (GeomFill_EvolvedSection::*)(Standard_Real &) const ) &GeomFill_EvolvedSection::IsConstant, "return True If the Law isConstant", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_NSections.hxx
	...
	cls_GeomFill_NSections.def("SectionShape", (void (GeomFill_NSections::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &GeomFill_NSections::SectionShape, "get the format of an section", py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"));
	...
	cls_GeomFill_NSections.def("GetInterval", (void (GeomFill_NSections::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_NSections::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_NSections.def("GetDomain", (void (GeomFill_NSections::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_NSections::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_NSections.def("IsConstant", (Standard_Boolean (GeomFill_NSections::*)(Standard_Real &) const ) &GeomFill_NSections::IsConstant, "return True If the Law isConstant", py::arg("Error"));
	...
	cls_GeomFill_NSections.def("IsConicalLaw", (Standard_Boolean (GeomFill_NSections::*)(Standard_Real &) const ) &GeomFill_NSections::IsConicalLaw, "Returns True if all section are circle, with same plane,same center and linear radius evolution Return False by Default.", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_CurveAndTrihedron.hxx
	...
	cls_GeomFill_CurveAndTrihedron.def("GetInterval", (void (GeomFill_CurveAndTrihedron::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_CurveAndTrihedron::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	cls_GeomFill_CurveAndTrihedron.def("GetDomain", (void (GeomFill_CurveAndTrihedron::*)(Standard_Real &, Standard_Real &) const ) &GeomFill_CurveAndTrihedron::GetDomain, "Gets the bounds of the function parametric domain. Warning: This domain it is not modified by the SetValue method", py::arg("First"), py::arg("Last"));
	...
	cls_GeomFill_CurveAndTrihedron.def("IsTranslation", (Standard_Boolean (GeomFill_CurveAndTrihedron::*)(Standard_Real &) const ) &GeomFill_CurveAndTrihedron::IsTranslation, "Say if the Location Law, is an translation of Location The default implementation is ' returns False '.", py::arg("Error"));
	cls_GeomFill_CurveAndTrihedron.def("IsRotation", (Standard_Boolean (GeomFill_CurveAndTrihedron::*)(Standard_Real &) const ) &GeomFill_CurveAndTrihedron::IsRotation, "Say if the Location Law, is a rotation of Location The default implementation is ' returns False '.", py::arg("Error"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_TrihedronLaw.hxx
	...
	cls_GeomFill_TrihedronLaw.def("GetInterval", (void (GeomFill_TrihedronLaw::*)(Standard_Real &, Standard_Real &)) &GeomFill_TrihedronLaw::GetInterval, "Gets the bounds of the parametric interval on the function", py::arg("First"), py::arg("Last"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Fixed.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Frenet.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_CorrectedFrenet.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_DiscreteTrihedron.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_ConstantBiNormal.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Darboux.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_DraftTrihedron.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_TrihedronWithGuide.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_GuideTrihedronAC.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_GuideTrihedronPlan.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_Sweep.hxx
	...
	// FIXME cls_GeomFill_Sweep.def("SetDomain", (void (GeomFill_Sweep::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real)) &GeomFill_Sweep::SetDomain, "Set parametric information [<First>, <Last>] Sets the parametric bound of the sweeping surface to build. <SectionFirst>, <SectionLast> gives coresponding bounds parameter on the section law of <First> and <Last>", py::arg("First"), py::arg("Last"), py::arg("SectionFirst"), py::arg("SectionLast"));
	cls_GeomFill_Sweep.def("SetTolerance", [](GeomFill_Sweep &self, const Standard_Real a0) -> void { return self.SetTolerance(a0); }, py::arg("Tol3d"));
	cls_GeomFill_Sweep.def("SetTolerance", [](GeomFill_Sweep &self, const Standard_Real a0, const Standard_Real a1) -> void { return self.SetTolerance(a0, a1); }, py::arg("Tol3d"), py::arg("BoundTol"));
	cls_GeomFill_Sweep.def("SetTolerance", [](GeomFill_Sweep &self, const Standard_Real a0, const Standard_Real a1, const Standard_Real a2) -> void { return self.SetTolerance(a0, a1, a2); }, py::arg("Tol3d"), py::arg("BoundTol"), py::arg("Tol2d"));
	...
	cls_GeomFill_Sweep.def("Build", [](GeomFill_Sweep &self, const opencascade::handle<GeomFill_SectionLaw> & a0) -> void { return self.Build(a0); }, py::arg("Section"));
	cls_GeomFill_Sweep.def("Build", [](GeomFill_Sweep &self, const opencascade::handle<GeomFill_SectionLaw> & a0, const GeomFill_ApproxStyle a1) -> void { return self.Build(a0, a1); }, py::arg("Section"), py::arg("Methode"));
	cls_GeomFill_Sweep.def("Build", [](GeomFill_Sweep &self, const opencascade::handle<GeomFill_SectionLaw> & a0, const GeomFill_ApproxStyle a1, const GeomAbs_Shape a2) -> void { return self.Build(a0, a1, a2); }, py::arg("Section"), py::arg("Methode"), py::arg("Continuity"));
	cls_GeomFill_Sweep.def("Build", [](GeomFill_Sweep &self, const opencascade::handle<GeomFill_SectionLaw> & a0, const GeomFill_ApproxStyle a1, const GeomAbs_Shape a2, const Standard_Integer a3) -> void { return self.Build(a0, a1, a2, a3); }, py::arg("Section"), py::arg("Methode"), py::arg("Continuity"), py::arg("Degmax"));
	...
	cls_GeomFill_Sweep.def("ErrorOnRestriction", (void (GeomFill_Sweep::*)(const Standard_Boolean, Standard_Real &, Standard_Real &) const ) &GeomFill_Sweep::ErrorOnRestriction, "Gets the Approximation error.", py::arg("IsFirst"), py::arg("UError"), py::arg("VError"));
	cls_GeomFill_Sweep.def("ErrorOnTrace", (void (GeomFill_Sweep::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &GeomFill_Sweep::ErrorOnTrace, "Gets the Approximation error.", py::arg("IndexOfTrace"), py::arg("UError"), py::arg("VError"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_SectionPlacement.hxx
	py::class_<GeomFill_SectionPlacement, std::unique_ptr<GeomFill_SectionPlacement, Deleter<GeomFill_SectionPlacement>>> cls_GeomFill_SectionPlacement(mod, "GeomFill_SectionPlacement", "To place section in sweep Function");
	...
	cls_GeomFill_SectionPlacement.def("Transformation", [](GeomFill_SectionPlacement &self, const Standard_Boolean a0) -> gp_Trsf { return self.Transformation(a0); }, py::arg("WithTranslation"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill.hxx
	...
	cls_GeomFill.def_static("GetShape_", (void (*)(const Standard_Real, Standard_Integer &, Standard_Integer &, Standard_Integer &, Convert_ParameterisationType &)) &GeomFill::GetShape, "None", py::arg("MaxAng"), py::arg("NbPoles"), py::arg("NbKnots"), py::arg("Degree"), py::arg("TypeConv"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GeomFill_HSequenceOfAx2.hxx
	py::class_<GeomFill_HSequenceOfAx2, opencascade::handle<GeomFill_HSequenceOfAx2>, GeomFill_SequenceOfAx2, Standard_Transient> cls_GeomFill_HSequenceOfAx2(mod, "GeomFill_HSequenceOfAx2", "None");
