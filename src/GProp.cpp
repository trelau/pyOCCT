...
PYBIND11_MODULE(GProp, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_ValueType.hxx
	py::enum_<GProp_ValueType>(mod, "GProp_ValueType", "Algorithmes :")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_EquaType.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_GProps.hxx
	py::class_<GProp_GProps, std::unique_ptr<GProp_GProps, Deleter<GProp_GProps>>> cls_GProp_GProps(mod, "GProp_GProps", "Implements a general mechanism to compute the global properties of a 'compound geometric system' in 3d space by composition of the global properties of 'elementary geometric entities' such as (curve, surface, solid, set of points). It is possible to compose the properties of several 'compound geometric systems' too.");
	cls_GProp_GProps.def(py::init<>());
	cls_GProp_GProps.def(py::init<const gp_Pnt &>(), py::arg("SystemLocation"));
	cls_GProp_GProps.def("Add", [](GProp_GProps &self, const GProp_GProps & a0) -> void { return self.Add(a0); }, py::arg("Item"));
	...
	cls_GProp_GProps.def("StaticMoments", (void (GProp_GProps::*)(Standard_Real &, Standard_Real &, Standard_Real &) const ) &GProp_GProps::StaticMoments, "Returns Ix, Iy, Iz, the static moments of inertia of the current system; i.e. the moments of inertia about the three axes of the Cartesian coordinate system.", py::arg("Ix"), py::arg("Iy"), py::arg("Iz"));
	...
	cls_GProp_PGProps.def_static("Barycentre_", (void (*)(const TColgp_Array1OfPnt &, const TColStd_Array1OfReal &, Standard_Real &, gp_Pnt &)) &GProp_PGProps::Barycentre, "Computes the barycentre of a set of points. A density is associated with each point.", py::arg("Pnts"), py::arg("Density"), py::arg("Mass"), py::arg("G"));
	cls_GProp_PGProps.def_static("Barycentre_", (void (*)(const TColgp_Array2OfPnt &, const TColStd_Array2OfReal &, Standard_Real &, gp_Pnt &)) &GProp_PGProps::Barycentre, "Computes the barycentre of a set of points. A density is associated with each point.", py::arg("Pnts"), py::arg("Density"), py::arg("Mass"), py::arg("G"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_CelGProps.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_SelGProps.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_VelGProps.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_PEquation.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\GProp_UndefinedAxis.hxx
