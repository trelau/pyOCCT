...
PYBIND11_MODULE(BRepLProp, mod) {
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepLProp_CurveTool.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepLProp_SurfaceTool.hxx
	...
	cls_BRepLProp_SurfaceTool.def_static("Bounds_", (void (*)(const BRepAdaptor_Surface &, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &)) &BRepLProp_SurfaceTool::Bounds, "returns the bounds of the Surface.", py::arg("S"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepLProp_CLProps.hxx
	py::class_<BRepLProp_CLProps, std::unique_ptr<BRepLProp_CLProps, Deleter<BRepLProp_CLProps>>> cls_BRepLProp_CLProps(mod, "BRepLProp_CLProps", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepLProp_SLProps.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\BRepLProp.hxx
