...
PYBIND11_MODULE(Font, mod) {
	...
	*/
	...
	cls_Font_TextFormatter.def("SetupAlignment", (void (Font_TextFormatter::*)(const Graphic3d_HorizontalTextAlignment, const Graphic3d_VerticalTextAlignment)) &Font_TextFormatter::SetupAlignment, "Setup alignment style.", py::arg("theAlignX"), py::arg("theAlignY"));
	...
	*/
	...
	cls_Font_BRepTextBuilder.def("Perform", [](Font_BRepTextBuilder &self, Font_BRepFont & a0, const Font_TextFormatter & a1) -> TopoDS_Shape { return self.Perform(a0, a1); }, py::arg("theFont"), py::arg("theFormatter"));
	cls_Font_BRepTextBuilder.def("Perform", (TopoDS_Shape (Font_BRepTextBuilder::*)(Font_BRepFont &, const Font_TextFormatter &, const gp_Ax3 &)) &Font_BRepTextBuilder::Perform, "Render text as BRep shape.", py::arg("theFont"), py::arg("theFormatter"), py::arg("thePenLoc"));
	cls_Font_BRepTextBuilder.def("Perform", [](Font_BRepTextBuilder &self, Font_BRepFont & a0, const NCollection_String & a1) -> TopoDS_Shape { return self.Perform(a0, a1); }, py::arg("theFont"), py::arg("theString"));
	cls_Font_BRepTextBuilder.def("Perform", [](Font_BRepTextBuilder &self, Font_BRepFont & a0, const NCollection_String & a1, const gp_Ax3 & a2) -> TopoDS_Shape { return self.Perform(a0, a1, a2); }, py::arg("theFont"), py::arg("theString"), py::arg("thePenLoc"));
	cls_Font_BRepTextBuilder.def("Perform", [](Font_BRepTextBuilder &self, Font_BRepFont & a0, const NCollection_String & a1, const gp_Ax3 & a2, const Graphic3d_HorizontalTextAlignment a3) -> TopoDS_Shape { return self.Perform(a0, a1, a2, a3); }, py::arg("theFont"), py::arg("theString"), py::arg("thePenLoc"), py::arg("theHAlign"));
