...
PYBIND11_MODULE(StepVisual, mod) {
	...
	py::class_<StepVisual_Array1OfPresentationStyleSelect, std::unique_ptr<StepVisual_Array1OfPresentationStyleSelect, Deleter<StepVisual_Array1OfPresentationStyleSelect>>> cls_StepVisual_Array1OfPresentationStyleSelect(mod, "StepVisual_Array1OfPresentationStyleSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def(py::init<>());
	cls_StepVisual_Array1OfPresentationStyleSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def(py::init([] (const StepVisual_Array1OfPresentationStyleSelect &other) {return new StepVisual_Array1OfPresentationStyleSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleSelect.def(py::init<StepVisual_Array1OfPresentationStyleSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def(py::init<const StepVisual_PresentationStyleSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("begin", (StepVisual_Array1OfPresentationStyleSelect::iterator (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("end", (StepVisual_Array1OfPresentationStyleSelect::iterator (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("cbegin", (StepVisual_Array1OfPresentationStyleSelect::const_iterator (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("cend", (StepVisual_Array1OfPresentationStyleSelect::const_iterator (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Init", (void (StepVisual_Array1OfPresentationStyleSelect::*)(const StepVisual_PresentationStyleSelect &)) &StepVisual_Array1OfPresentationStyleSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Size", (Standard_Integer (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::Size, "Size query");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Length", (Standard_Integer (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Assign", (StepVisual_Array1OfPresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const StepVisual_Array1OfPresentationStyleSelect &)) &StepVisual_Array1OfPresentationStyleSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleSelect.def("Move", (StepVisual_Array1OfPresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(StepVisual_Array1OfPresentationStyleSelect &&)) &StepVisual_Array1OfPresentationStyleSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("assign", (StepVisual_Array1OfPresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const StepVisual_Array1OfPresentationStyleSelect &)) &StepVisual_Array1OfPresentationStyleSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleSelect.def("assign", (StepVisual_Array1OfPresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(StepVisual_Array1OfPresentationStyleSelect &&)) &StepVisual_Array1OfPresentationStyleSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("First", (const StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::First, "Returns first element");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("ChangeFirst", (StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)()) &StepVisual_Array1OfPresentationStyleSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Last", (const StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)() const ) &StepVisual_Array1OfPresentationStyleSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("ChangeLast", (StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)()) &StepVisual_Array1OfPresentationStyleSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Value", (const StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfPresentationStyleSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("__call__", (const StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfPresentationStyleSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("ChangeValue", (StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer)) &StepVisual_Array1OfPresentationStyleSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("__call__", (StepVisual_PresentationStyleSelect & (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer)) &StepVisual_Array1OfPresentationStyleSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("SetValue", (void (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer, const StepVisual_PresentationStyleSelect &)) &StepVisual_Array1OfPresentationStyleSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("Resize", (void (StepVisual_Array1OfPresentationStyleSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfPresentationStyleSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfPresentationStyleSelect.def("__iter__", [](const StepVisual_Array1OfPresentationStyleSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfPresentationStyleAssignment, std::unique_ptr<StepVisual_Array1OfPresentationStyleAssignment, Deleter<StepVisual_Array1OfPresentationStyleAssignment>>> cls_StepVisual_Array1OfPresentationStyleAssignment(mod, "StepVisual_Array1OfPresentationStyleAssignment", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def(py::init<>());
	cls_StepVisual_Array1OfPresentationStyleAssignment.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def(py::init([] (const StepVisual_Array1OfPresentationStyleAssignment &other) {return new StepVisual_Array1OfPresentationStyleAssignment(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleAssignment.def(py::init<StepVisual_Array1OfPresentationStyleAssignment &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def(py::init<const opencascade::handle<StepVisual_PresentationStyleAssignment> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("begin", (StepVisual_Array1OfPresentationStyleAssignment::iterator (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("end", (StepVisual_Array1OfPresentationStyleAssignment::iterator (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("cbegin", (StepVisual_Array1OfPresentationStyleAssignment::const_iterator (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("cend", (StepVisual_Array1OfPresentationStyleAssignment::const_iterator (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Init", (void (StepVisual_Array1OfPresentationStyleAssignment::*)(const opencascade::handle<StepVisual_PresentationStyleAssignment> &)) &StepVisual_Array1OfPresentationStyleAssignment::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Size", (Standard_Integer (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::Size, "Size query");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Length", (Standard_Integer (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::Length, "Length query (the same)");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Lower", (Standard_Integer (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::Lower, "Lower bound");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Upper", (Standard_Integer (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::Upper, "Upper bound");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Assign", (StepVisual_Array1OfPresentationStyleAssignment & (StepVisual_Array1OfPresentationStyleAssignment::*)(const StepVisual_Array1OfPresentationStyleAssignment &)) &StepVisual_Array1OfPresentationStyleAssignment::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleAssignment.def("Move", (StepVisual_Array1OfPresentationStyleAssignment & (StepVisual_Array1OfPresentationStyleAssignment::*)(StepVisual_Array1OfPresentationStyleAssignment &&)) &StepVisual_Array1OfPresentationStyleAssignment::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("assign", (StepVisual_Array1OfPresentationStyleAssignment & (StepVisual_Array1OfPresentationStyleAssignment::*)(const StepVisual_Array1OfPresentationStyleAssignment &)) &StepVisual_Array1OfPresentationStyleAssignment::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfPresentationStyleAssignment.def("assign", (StepVisual_Array1OfPresentationStyleAssignment & (StepVisual_Array1OfPresentationStyleAssignment::*)(StepVisual_Array1OfPresentationStyleAssignment &&)) &StepVisual_Array1OfPresentationStyleAssignment::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("First", (const opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::First, "Returns first element");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("ChangeFirst", (opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)()) &StepVisual_Array1OfPresentationStyleAssignment::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Last", (const opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)() const ) &StepVisual_Array1OfPresentationStyleAssignment::Last, "Returns last element");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("ChangeLast", (opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)()) &StepVisual_Array1OfPresentationStyleAssignment::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Value", (const opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer) const ) &StepVisual_Array1OfPresentationStyleAssignment::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("__call__", (const opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer) const ) &StepVisual_Array1OfPresentationStyleAssignment::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("ChangeValue", (opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer)) &StepVisual_Array1OfPresentationStyleAssignment::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("__call__", (opencascade::handle<StepVisual_PresentationStyleAssignment> & (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer)) &StepVisual_Array1OfPresentationStyleAssignment::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("SetValue", (void (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer, const opencascade::handle<StepVisual_PresentationStyleAssignment> &)) &StepVisual_Array1OfPresentationStyleAssignment::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("Resize", (void (StepVisual_Array1OfPresentationStyleAssignment::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfPresentationStyleAssignment::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfPresentationStyleAssignment.def("__iter__", [](const StepVisual_Array1OfPresentationStyleAssignment &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfAnnotationPlaneElement, std::unique_ptr<StepVisual_Array1OfAnnotationPlaneElement, Deleter<StepVisual_Array1OfAnnotationPlaneElement>>> cls_StepVisual_Array1OfAnnotationPlaneElement(mod, "StepVisual_Array1OfAnnotationPlaneElement", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def(py::init<>());
	cls_StepVisual_Array1OfAnnotationPlaneElement.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def(py::init([] (const StepVisual_Array1OfAnnotationPlaneElement &other) {return new StepVisual_Array1OfAnnotationPlaneElement(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfAnnotationPlaneElement.def(py::init<StepVisual_Array1OfAnnotationPlaneElement &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def(py::init<const StepVisual_AnnotationPlaneElement &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("begin", (StepVisual_Array1OfAnnotationPlaneElement::iterator (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("end", (StepVisual_Array1OfAnnotationPlaneElement::iterator (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("cbegin", (StepVisual_Array1OfAnnotationPlaneElement::const_iterator (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("cend", (StepVisual_Array1OfAnnotationPlaneElement::const_iterator (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Init", (void (StepVisual_Array1OfAnnotationPlaneElement::*)(const StepVisual_AnnotationPlaneElement &)) &StepVisual_Array1OfAnnotationPlaneElement::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Size", (Standard_Integer (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::Size, "Size query");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Length", (Standard_Integer (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::Length, "Length query (the same)");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Lower", (Standard_Integer (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::Lower, "Lower bound");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Upper", (Standard_Integer (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::Upper, "Upper bound");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Assign", (StepVisual_Array1OfAnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const StepVisual_Array1OfAnnotationPlaneElement &)) &StepVisual_Array1OfAnnotationPlaneElement::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfAnnotationPlaneElement.def("Move", (StepVisual_Array1OfAnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(StepVisual_Array1OfAnnotationPlaneElement &&)) &StepVisual_Array1OfAnnotationPlaneElement::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("assign", (StepVisual_Array1OfAnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const StepVisual_Array1OfAnnotationPlaneElement &)) &StepVisual_Array1OfAnnotationPlaneElement::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfAnnotationPlaneElement.def("assign", (StepVisual_Array1OfAnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(StepVisual_Array1OfAnnotationPlaneElement &&)) &StepVisual_Array1OfAnnotationPlaneElement::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("First", (const StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::First, "Returns first element");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("ChangeFirst", (StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)()) &StepVisual_Array1OfAnnotationPlaneElement::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Last", (const StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)() const ) &StepVisual_Array1OfAnnotationPlaneElement::Last, "Returns last element");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("ChangeLast", (StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)()) &StepVisual_Array1OfAnnotationPlaneElement::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Value", (const StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer) const ) &StepVisual_Array1OfAnnotationPlaneElement::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("__call__", (const StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer) const ) &StepVisual_Array1OfAnnotationPlaneElement::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("ChangeValue", (StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer)) &StepVisual_Array1OfAnnotationPlaneElement::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("__call__", (StepVisual_AnnotationPlaneElement & (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer)) &StepVisual_Array1OfAnnotationPlaneElement::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("SetValue", (void (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer, const StepVisual_AnnotationPlaneElement &)) &StepVisual_Array1OfAnnotationPlaneElement::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("Resize", (void (StepVisual_Array1OfAnnotationPlaneElement::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfAnnotationPlaneElement::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfAnnotationPlaneElement.def("__iter__", [](const StepVisual_Array1OfAnnotationPlaneElement &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect, std::unique_ptr<StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect, Deleter<StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect>>> cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect(mod, "StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def(py::init<>());
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def(py::init([] (const StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &other) {return new StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def(py::init<StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def(py::init<const StepVisual_CameraModelD3MultiClippingInterectionSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("begin", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::iterator (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("end", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::iterator (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("cbegin", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::const_iterator (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("cend", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::const_iterator (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Init", (void (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const StepVisual_CameraModelD3MultiClippingInterectionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Size", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Size, "Size query");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Length", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Assign", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Move", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &&)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("assign", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("assign", (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &&)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("First", (const StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::First, "Returns first element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("ChangeFirst", (StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)()) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Last", (const StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("ChangeLast", (StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)()) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Value", (const StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("__call__", (const StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("ChangeValue", (StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("__call__", (StepVisual_CameraModelD3MultiClippingInterectionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("SetValue", (void (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer, const StepVisual_CameraModelD3MultiClippingInterectionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("Resize", (void (StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect.def("__iter__", [](const StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect, std::unique_ptr<StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect, Deleter<StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect>>> cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect(mod, "StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def(py::init<>());
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def(py::init([] (const StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &other) {return new StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def(py::init<StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def(py::init<const StepVisual_CameraModelD3MultiClippingUnionSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("begin", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::iterator (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("end", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::iterator (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("cbegin", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::const_iterator (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("cend", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::const_iterator (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Init", (void (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const StepVisual_CameraModelD3MultiClippingUnionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Size", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Size, "Size query");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Length", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Assign", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Move", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &&)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("assign", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("assign", (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &&)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("First", (const StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::First, "Returns first element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("ChangeFirst", (StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)()) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Last", (const StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)() const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("ChangeLast", (StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)()) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Value", (const StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("__call__", (const StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("ChangeValue", (StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("__call__", (StepVisual_CameraModelD3MultiClippingUnionSelect & (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("SetValue", (void (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer, const StepVisual_CameraModelD3MultiClippingUnionSelect &)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("Resize", (void (StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect.def("__iter__", [](const StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfTextOrCharacter, std::unique_ptr<StepVisual_Array1OfTextOrCharacter, Deleter<StepVisual_Array1OfTextOrCharacter>>> cls_StepVisual_Array1OfTextOrCharacter(mod, "StepVisual_Array1OfTextOrCharacter", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfTextOrCharacter.def(py::init<>());
	cls_StepVisual_Array1OfTextOrCharacter.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfTextOrCharacter.def(py::init([] (const StepVisual_Array1OfTextOrCharacter &other) {return new StepVisual_Array1OfTextOrCharacter(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfTextOrCharacter.def(py::init<StepVisual_Array1OfTextOrCharacter &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfTextOrCharacter.def(py::init<const StepVisual_TextOrCharacter &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfTextOrCharacter.def("begin", (StepVisual_Array1OfTextOrCharacter::iterator (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfTextOrCharacter.def("end", (StepVisual_Array1OfTextOrCharacter::iterator (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfTextOrCharacter.def("cbegin", (StepVisual_Array1OfTextOrCharacter::const_iterator (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfTextOrCharacter.def("cend", (StepVisual_Array1OfTextOrCharacter::const_iterator (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfTextOrCharacter.def("Init", (void (StepVisual_Array1OfTextOrCharacter::*)(const StepVisual_TextOrCharacter &)) &StepVisual_Array1OfTextOrCharacter::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfTextOrCharacter.def("Size", (Standard_Integer (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::Size, "Size query");
	cls_StepVisual_Array1OfTextOrCharacter.def("Length", (Standard_Integer (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::Length, "Length query (the same)");
	cls_StepVisual_Array1OfTextOrCharacter.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfTextOrCharacter.def("Lower", (Standard_Integer (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::Lower, "Lower bound");
	cls_StepVisual_Array1OfTextOrCharacter.def("Upper", (Standard_Integer (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::Upper, "Upper bound");
	cls_StepVisual_Array1OfTextOrCharacter.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfTextOrCharacter.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfTextOrCharacter.def("Assign", (StepVisual_Array1OfTextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const StepVisual_Array1OfTextOrCharacter &)) &StepVisual_Array1OfTextOrCharacter::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfTextOrCharacter.def("Move", (StepVisual_Array1OfTextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(StepVisual_Array1OfTextOrCharacter &&)) &StepVisual_Array1OfTextOrCharacter::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfTextOrCharacter.def("assign", (StepVisual_Array1OfTextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const StepVisual_Array1OfTextOrCharacter &)) &StepVisual_Array1OfTextOrCharacter::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfTextOrCharacter.def("assign", (StepVisual_Array1OfTextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(StepVisual_Array1OfTextOrCharacter &&)) &StepVisual_Array1OfTextOrCharacter::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfTextOrCharacter.def("First", (const StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::First, "Returns first element");
	cls_StepVisual_Array1OfTextOrCharacter.def("ChangeFirst", (StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)()) &StepVisual_Array1OfTextOrCharacter::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfTextOrCharacter.def("Last", (const StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)() const ) &StepVisual_Array1OfTextOrCharacter::Last, "Returns last element");
	cls_StepVisual_Array1OfTextOrCharacter.def("ChangeLast", (StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)()) &StepVisual_Array1OfTextOrCharacter::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfTextOrCharacter.def("Value", (const StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer) const ) &StepVisual_Array1OfTextOrCharacter::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfTextOrCharacter.def("__call__", (const StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer) const ) &StepVisual_Array1OfTextOrCharacter::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfTextOrCharacter.def("ChangeValue", (StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer)) &StepVisual_Array1OfTextOrCharacter::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfTextOrCharacter.def("__call__", (StepVisual_TextOrCharacter & (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer)) &StepVisual_Array1OfTextOrCharacter::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfTextOrCharacter.def("SetValue", (void (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer, const StepVisual_TextOrCharacter &)) &StepVisual_Array1OfTextOrCharacter::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfTextOrCharacter.def("Resize", (void (StepVisual_Array1OfTextOrCharacter::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfTextOrCharacter::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfTextOrCharacter.def("__iter__", [](const StepVisual_Array1OfTextOrCharacter &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfInvisibleItem, std::unique_ptr<StepVisual_Array1OfInvisibleItem, Deleter<StepVisual_Array1OfInvisibleItem>>> cls_StepVisual_Array1OfInvisibleItem(mod, "StepVisual_Array1OfInvisibleItem", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfInvisibleItem.def(py::init<>());
	cls_StepVisual_Array1OfInvisibleItem.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfInvisibleItem.def(py::init([] (const StepVisual_Array1OfInvisibleItem &other) {return new StepVisual_Array1OfInvisibleItem(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfInvisibleItem.def(py::init<StepVisual_Array1OfInvisibleItem &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfInvisibleItem.def(py::init<const StepVisual_InvisibleItem &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfInvisibleItem.def("begin", (StepVisual_Array1OfInvisibleItem::iterator (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfInvisibleItem.def("end", (StepVisual_Array1OfInvisibleItem::iterator (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfInvisibleItem.def("cbegin", (StepVisual_Array1OfInvisibleItem::const_iterator (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfInvisibleItem.def("cend", (StepVisual_Array1OfInvisibleItem::const_iterator (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfInvisibleItem.def("Init", (void (StepVisual_Array1OfInvisibleItem::*)(const StepVisual_InvisibleItem &)) &StepVisual_Array1OfInvisibleItem::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfInvisibleItem.def("Size", (Standard_Integer (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::Size, "Size query");
	cls_StepVisual_Array1OfInvisibleItem.def("Length", (Standard_Integer (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::Length, "Length query (the same)");
	cls_StepVisual_Array1OfInvisibleItem.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfInvisibleItem.def("Lower", (Standard_Integer (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::Lower, "Lower bound");
	cls_StepVisual_Array1OfInvisibleItem.def("Upper", (Standard_Integer (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::Upper, "Upper bound");
	cls_StepVisual_Array1OfInvisibleItem.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfInvisibleItem.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfInvisibleItem.def("Assign", (StepVisual_Array1OfInvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const StepVisual_Array1OfInvisibleItem &)) &StepVisual_Array1OfInvisibleItem::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfInvisibleItem.def("Move", (StepVisual_Array1OfInvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(StepVisual_Array1OfInvisibleItem &&)) &StepVisual_Array1OfInvisibleItem::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfInvisibleItem.def("assign", (StepVisual_Array1OfInvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const StepVisual_Array1OfInvisibleItem &)) &StepVisual_Array1OfInvisibleItem::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfInvisibleItem.def("assign", (StepVisual_Array1OfInvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(StepVisual_Array1OfInvisibleItem &&)) &StepVisual_Array1OfInvisibleItem::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfInvisibleItem.def("First", (const StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::First, "Returns first element");
	cls_StepVisual_Array1OfInvisibleItem.def("ChangeFirst", (StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)()) &StepVisual_Array1OfInvisibleItem::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfInvisibleItem.def("Last", (const StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)() const ) &StepVisual_Array1OfInvisibleItem::Last, "Returns last element");
	cls_StepVisual_Array1OfInvisibleItem.def("ChangeLast", (StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)()) &StepVisual_Array1OfInvisibleItem::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfInvisibleItem.def("Value", (const StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfInvisibleItem::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfInvisibleItem.def("__call__", (const StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfInvisibleItem::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfInvisibleItem.def("ChangeValue", (StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer)) &StepVisual_Array1OfInvisibleItem::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfInvisibleItem.def("__call__", (StepVisual_InvisibleItem & (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer)) &StepVisual_Array1OfInvisibleItem::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfInvisibleItem.def("SetValue", (void (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer, const StepVisual_InvisibleItem &)) &StepVisual_Array1OfInvisibleItem::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfInvisibleItem.def("Resize", (void (StepVisual_Array1OfInvisibleItem::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfInvisibleItem::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfInvisibleItem.def("__iter__", [](const StepVisual_Array1OfInvisibleItem &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfStyleContextSelect, std::unique_ptr<StepVisual_Array1OfStyleContextSelect, Deleter<StepVisual_Array1OfStyleContextSelect>>> cls_StepVisual_Array1OfStyleContextSelect(mod, "StepVisual_Array1OfStyleContextSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfStyleContextSelect.def(py::init<>());
	cls_StepVisual_Array1OfStyleContextSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfStyleContextSelect.def(py::init([] (const StepVisual_Array1OfStyleContextSelect &other) {return new StepVisual_Array1OfStyleContextSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfStyleContextSelect.def(py::init<StepVisual_Array1OfStyleContextSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfStyleContextSelect.def(py::init<const StepVisual_StyleContextSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfStyleContextSelect.def("begin", (StepVisual_Array1OfStyleContextSelect::iterator (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfStyleContextSelect.def("end", (StepVisual_Array1OfStyleContextSelect::iterator (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfStyleContextSelect.def("cbegin", (StepVisual_Array1OfStyleContextSelect::const_iterator (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfStyleContextSelect.def("cend", (StepVisual_Array1OfStyleContextSelect::const_iterator (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfStyleContextSelect.def("Init", (void (StepVisual_Array1OfStyleContextSelect::*)(const StepVisual_StyleContextSelect &)) &StepVisual_Array1OfStyleContextSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfStyleContextSelect.def("Size", (Standard_Integer (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::Size, "Size query");
	cls_StepVisual_Array1OfStyleContextSelect.def("Length", (Standard_Integer (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfStyleContextSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfStyleContextSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfStyleContextSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfStyleContextSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfStyleContextSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfStyleContextSelect.def("Assign", (StepVisual_Array1OfStyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const StepVisual_Array1OfStyleContextSelect &)) &StepVisual_Array1OfStyleContextSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfStyleContextSelect.def("Move", (StepVisual_Array1OfStyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(StepVisual_Array1OfStyleContextSelect &&)) &StepVisual_Array1OfStyleContextSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfStyleContextSelect.def("assign", (StepVisual_Array1OfStyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const StepVisual_Array1OfStyleContextSelect &)) &StepVisual_Array1OfStyleContextSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfStyleContextSelect.def("assign", (StepVisual_Array1OfStyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(StepVisual_Array1OfStyleContextSelect &&)) &StepVisual_Array1OfStyleContextSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfStyleContextSelect.def("First", (const StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::First, "Returns first element");
	cls_StepVisual_Array1OfStyleContextSelect.def("ChangeFirst", (StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)()) &StepVisual_Array1OfStyleContextSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfStyleContextSelect.def("Last", (const StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)() const ) &StepVisual_Array1OfStyleContextSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfStyleContextSelect.def("ChangeLast", (StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)()) &StepVisual_Array1OfStyleContextSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfStyleContextSelect.def("Value", (const StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfStyleContextSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfStyleContextSelect.def("__call__", (const StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfStyleContextSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfStyleContextSelect.def("ChangeValue", (StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer)) &StepVisual_Array1OfStyleContextSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfStyleContextSelect.def("__call__", (StepVisual_StyleContextSelect & (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer)) &StepVisual_Array1OfStyleContextSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfStyleContextSelect.def("SetValue", (void (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer, const StepVisual_StyleContextSelect &)) &StepVisual_Array1OfStyleContextSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfStyleContextSelect.def("Resize", (void (StepVisual_Array1OfStyleContextSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfStyleContextSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfStyleContextSelect.def("__iter__", [](const StepVisual_Array1OfStyleContextSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfCurveStyleFontPattern, std::unique_ptr<StepVisual_Array1OfCurveStyleFontPattern, Deleter<StepVisual_Array1OfCurveStyleFontPattern>>> cls_StepVisual_Array1OfCurveStyleFontPattern(mod, "StepVisual_Array1OfCurveStyleFontPattern", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def(py::init<>());
	cls_StepVisual_Array1OfCurveStyleFontPattern.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def(py::init([] (const StepVisual_Array1OfCurveStyleFontPattern &other) {return new StepVisual_Array1OfCurveStyleFontPattern(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfCurveStyleFontPattern.def(py::init<StepVisual_Array1OfCurveStyleFontPattern &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def(py::init<const opencascade::handle<StepVisual_CurveStyleFontPattern> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("begin", (StepVisual_Array1OfCurveStyleFontPattern::iterator (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("end", (StepVisual_Array1OfCurveStyleFontPattern::iterator (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("cbegin", (StepVisual_Array1OfCurveStyleFontPattern::const_iterator (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("cend", (StepVisual_Array1OfCurveStyleFontPattern::const_iterator (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Init", (void (StepVisual_Array1OfCurveStyleFontPattern::*)(const opencascade::handle<StepVisual_CurveStyleFontPattern> &)) &StepVisual_Array1OfCurveStyleFontPattern::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Size", (Standard_Integer (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::Size, "Size query");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Length", (Standard_Integer (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::Length, "Length query (the same)");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Lower", (Standard_Integer (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::Lower, "Lower bound");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Upper", (Standard_Integer (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::Upper, "Upper bound");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Assign", (StepVisual_Array1OfCurveStyleFontPattern & (StepVisual_Array1OfCurveStyleFontPattern::*)(const StepVisual_Array1OfCurveStyleFontPattern &)) &StepVisual_Array1OfCurveStyleFontPattern::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCurveStyleFontPattern.def("Move", (StepVisual_Array1OfCurveStyleFontPattern & (StepVisual_Array1OfCurveStyleFontPattern::*)(StepVisual_Array1OfCurveStyleFontPattern &&)) &StepVisual_Array1OfCurveStyleFontPattern::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("assign", (StepVisual_Array1OfCurveStyleFontPattern & (StepVisual_Array1OfCurveStyleFontPattern::*)(const StepVisual_Array1OfCurveStyleFontPattern &)) &StepVisual_Array1OfCurveStyleFontPattern::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfCurveStyleFontPattern.def("assign", (StepVisual_Array1OfCurveStyleFontPattern & (StepVisual_Array1OfCurveStyleFontPattern::*)(StepVisual_Array1OfCurveStyleFontPattern &&)) &StepVisual_Array1OfCurveStyleFontPattern::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("First", (const opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::First, "Returns first element");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("ChangeFirst", (opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)()) &StepVisual_Array1OfCurveStyleFontPattern::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Last", (const opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)() const ) &StepVisual_Array1OfCurveStyleFontPattern::Last, "Returns last element");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("ChangeLast", (opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)()) &StepVisual_Array1OfCurveStyleFontPattern::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Value", (const opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer) const ) &StepVisual_Array1OfCurveStyleFontPattern::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("__call__", (const opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer) const ) &StepVisual_Array1OfCurveStyleFontPattern::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("ChangeValue", (opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer)) &StepVisual_Array1OfCurveStyleFontPattern::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("__call__", (opencascade::handle<StepVisual_CurveStyleFontPattern> & (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer)) &StepVisual_Array1OfCurveStyleFontPattern::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("SetValue", (void (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer, const opencascade::handle<StepVisual_CurveStyleFontPattern> &)) &StepVisual_Array1OfCurveStyleFontPattern::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("Resize", (void (StepVisual_Array1OfCurveStyleFontPattern::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfCurveStyleFontPattern::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfCurveStyleFontPattern.def("__iter__", [](const StepVisual_Array1OfCurveStyleFontPattern &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfDraughtingCalloutElement, std::unique_ptr<StepVisual_Array1OfDraughtingCalloutElement, Deleter<StepVisual_Array1OfDraughtingCalloutElement>>> cls_StepVisual_Array1OfDraughtingCalloutElement(mod, "StepVisual_Array1OfDraughtingCalloutElement", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def(py::init<>());
	cls_StepVisual_Array1OfDraughtingCalloutElement.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def(py::init([] (const StepVisual_Array1OfDraughtingCalloutElement &other) {return new StepVisual_Array1OfDraughtingCalloutElement(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfDraughtingCalloutElement.def(py::init<StepVisual_Array1OfDraughtingCalloutElement &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def(py::init<const StepVisual_DraughtingCalloutElement &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("begin", (StepVisual_Array1OfDraughtingCalloutElement::iterator (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("end", (StepVisual_Array1OfDraughtingCalloutElement::iterator (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("cbegin", (StepVisual_Array1OfDraughtingCalloutElement::const_iterator (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("cend", (StepVisual_Array1OfDraughtingCalloutElement::const_iterator (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Init", (void (StepVisual_Array1OfDraughtingCalloutElement::*)(const StepVisual_DraughtingCalloutElement &)) &StepVisual_Array1OfDraughtingCalloutElement::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Size", (Standard_Integer (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::Size, "Size query");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Length", (Standard_Integer (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::Length, "Length query (the same)");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Lower", (Standard_Integer (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::Lower, "Lower bound");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Upper", (Standard_Integer (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::Upper, "Upper bound");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Assign", (StepVisual_Array1OfDraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const StepVisual_Array1OfDraughtingCalloutElement &)) &StepVisual_Array1OfDraughtingCalloutElement::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfDraughtingCalloutElement.def("Move", (StepVisual_Array1OfDraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(StepVisual_Array1OfDraughtingCalloutElement &&)) &StepVisual_Array1OfDraughtingCalloutElement::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("assign", (StepVisual_Array1OfDraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const StepVisual_Array1OfDraughtingCalloutElement &)) &StepVisual_Array1OfDraughtingCalloutElement::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfDraughtingCalloutElement.def("assign", (StepVisual_Array1OfDraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(StepVisual_Array1OfDraughtingCalloutElement &&)) &StepVisual_Array1OfDraughtingCalloutElement::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("First", (const StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::First, "Returns first element");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("ChangeFirst", (StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)()) &StepVisual_Array1OfDraughtingCalloutElement::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Last", (const StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)() const ) &StepVisual_Array1OfDraughtingCalloutElement::Last, "Returns last element");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("ChangeLast", (StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)()) &StepVisual_Array1OfDraughtingCalloutElement::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Value", (const StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer) const ) &StepVisual_Array1OfDraughtingCalloutElement::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("__call__", (const StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer) const ) &StepVisual_Array1OfDraughtingCalloutElement::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("ChangeValue", (StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer)) &StepVisual_Array1OfDraughtingCalloutElement::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("__call__", (StepVisual_DraughtingCalloutElement & (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer)) &StepVisual_Array1OfDraughtingCalloutElement::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("SetValue", (void (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer, const StepVisual_DraughtingCalloutElement &)) &StepVisual_Array1OfDraughtingCalloutElement::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("Resize", (void (StepVisual_Array1OfDraughtingCalloutElement::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfDraughtingCalloutElement::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfDraughtingCalloutElement.def("__iter__", [](const StepVisual_Array1OfDraughtingCalloutElement &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfFillStyleSelect, std::unique_ptr<StepVisual_Array1OfFillStyleSelect, Deleter<StepVisual_Array1OfFillStyleSelect>>> cls_StepVisual_Array1OfFillStyleSelect(mod, "StepVisual_Array1OfFillStyleSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfFillStyleSelect.def(py::init<>());
	cls_StepVisual_Array1OfFillStyleSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfFillStyleSelect.def(py::init([] (const StepVisual_Array1OfFillStyleSelect &other) {return new StepVisual_Array1OfFillStyleSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfFillStyleSelect.def(py::init<StepVisual_Array1OfFillStyleSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfFillStyleSelect.def(py::init<const StepVisual_FillStyleSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfFillStyleSelect.def("begin", (StepVisual_Array1OfFillStyleSelect::iterator (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfFillStyleSelect.def("end", (StepVisual_Array1OfFillStyleSelect::iterator (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfFillStyleSelect.def("cbegin", (StepVisual_Array1OfFillStyleSelect::const_iterator (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfFillStyleSelect.def("cend", (StepVisual_Array1OfFillStyleSelect::const_iterator (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfFillStyleSelect.def("Init", (void (StepVisual_Array1OfFillStyleSelect::*)(const StepVisual_FillStyleSelect &)) &StepVisual_Array1OfFillStyleSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfFillStyleSelect.def("Size", (Standard_Integer (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::Size, "Size query");
	cls_StepVisual_Array1OfFillStyleSelect.def("Length", (Standard_Integer (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfFillStyleSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfFillStyleSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfFillStyleSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfFillStyleSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfFillStyleSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfFillStyleSelect.def("Assign", (StepVisual_Array1OfFillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const StepVisual_Array1OfFillStyleSelect &)) &StepVisual_Array1OfFillStyleSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfFillStyleSelect.def("Move", (StepVisual_Array1OfFillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(StepVisual_Array1OfFillStyleSelect &&)) &StepVisual_Array1OfFillStyleSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfFillStyleSelect.def("assign", (StepVisual_Array1OfFillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const StepVisual_Array1OfFillStyleSelect &)) &StepVisual_Array1OfFillStyleSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfFillStyleSelect.def("assign", (StepVisual_Array1OfFillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(StepVisual_Array1OfFillStyleSelect &&)) &StepVisual_Array1OfFillStyleSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfFillStyleSelect.def("First", (const StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::First, "Returns first element");
	cls_StepVisual_Array1OfFillStyleSelect.def("ChangeFirst", (StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)()) &StepVisual_Array1OfFillStyleSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfFillStyleSelect.def("Last", (const StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)() const ) &StepVisual_Array1OfFillStyleSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfFillStyleSelect.def("ChangeLast", (StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)()) &StepVisual_Array1OfFillStyleSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfFillStyleSelect.def("Value", (const StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfFillStyleSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfFillStyleSelect.def("__call__", (const StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfFillStyleSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfFillStyleSelect.def("ChangeValue", (StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer)) &StepVisual_Array1OfFillStyleSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfFillStyleSelect.def("__call__", (StepVisual_FillStyleSelect & (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer)) &StepVisual_Array1OfFillStyleSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfFillStyleSelect.def("SetValue", (void (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer, const StepVisual_FillStyleSelect &)) &StepVisual_Array1OfFillStyleSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfFillStyleSelect.def("Resize", (void (StepVisual_Array1OfFillStyleSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfFillStyleSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfFillStyleSelect.def("__iter__", [](const StepVisual_Array1OfFillStyleSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfBoxCharacteristicSelect, std::unique_ptr<StepVisual_Array1OfBoxCharacteristicSelect, Deleter<StepVisual_Array1OfBoxCharacteristicSelect>>> cls_StepVisual_Array1OfBoxCharacteristicSelect(mod, "StepVisual_Array1OfBoxCharacteristicSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def(py::init<>());
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def(py::init([] (const StepVisual_Array1OfBoxCharacteristicSelect &other) {return new StepVisual_Array1OfBoxCharacteristicSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfBoxCharacteristicSelect.def(py::init<StepVisual_Array1OfBoxCharacteristicSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def(py::init<const StepVisual_BoxCharacteristicSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("begin", (StepVisual_Array1OfBoxCharacteristicSelect::iterator (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("end", (StepVisual_Array1OfBoxCharacteristicSelect::iterator (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("cbegin", (StepVisual_Array1OfBoxCharacteristicSelect::const_iterator (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("cend", (StepVisual_Array1OfBoxCharacteristicSelect::const_iterator (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Init", (void (StepVisual_Array1OfBoxCharacteristicSelect::*)(const StepVisual_BoxCharacteristicSelect &)) &StepVisual_Array1OfBoxCharacteristicSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Size", (Standard_Integer (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::Size, "Size query");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Length", (Standard_Integer (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Assign", (StepVisual_Array1OfBoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const StepVisual_Array1OfBoxCharacteristicSelect &)) &StepVisual_Array1OfBoxCharacteristicSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Move", (StepVisual_Array1OfBoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(StepVisual_Array1OfBoxCharacteristicSelect &&)) &StepVisual_Array1OfBoxCharacteristicSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("assign", (StepVisual_Array1OfBoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const StepVisual_Array1OfBoxCharacteristicSelect &)) &StepVisual_Array1OfBoxCharacteristicSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfBoxCharacteristicSelect.def("assign", (StepVisual_Array1OfBoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(StepVisual_Array1OfBoxCharacteristicSelect &&)) &StepVisual_Array1OfBoxCharacteristicSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("First", (const StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::First, "Returns first element");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("ChangeFirst", (StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)()) &StepVisual_Array1OfBoxCharacteristicSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Last", (const StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)() const ) &StepVisual_Array1OfBoxCharacteristicSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("ChangeLast", (StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)()) &StepVisual_Array1OfBoxCharacteristicSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Value", (const StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfBoxCharacteristicSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("__call__", (const StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfBoxCharacteristicSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("ChangeValue", (StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer)) &StepVisual_Array1OfBoxCharacteristicSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("__call__", (StepVisual_BoxCharacteristicSelect & (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer)) &StepVisual_Array1OfBoxCharacteristicSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("SetValue", (void (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer, const StepVisual_BoxCharacteristicSelect &)) &StepVisual_Array1OfBoxCharacteristicSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("Resize", (void (StepVisual_Array1OfBoxCharacteristicSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfBoxCharacteristicSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfBoxCharacteristicSelect.def("__iter__", [](const StepVisual_Array1OfBoxCharacteristicSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfDirectionCountSelect, std::unique_ptr<StepVisual_Array1OfDirectionCountSelect, Deleter<StepVisual_Array1OfDirectionCountSelect>>> cls_StepVisual_Array1OfDirectionCountSelect(mod, "StepVisual_Array1OfDirectionCountSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfDirectionCountSelect.def(py::init<>());
	cls_StepVisual_Array1OfDirectionCountSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfDirectionCountSelect.def(py::init([] (const StepVisual_Array1OfDirectionCountSelect &other) {return new StepVisual_Array1OfDirectionCountSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfDirectionCountSelect.def(py::init<StepVisual_Array1OfDirectionCountSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfDirectionCountSelect.def(py::init<const StepVisual_DirectionCountSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("begin", (StepVisual_Array1OfDirectionCountSelect::iterator (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfDirectionCountSelect.def("end", (StepVisual_Array1OfDirectionCountSelect::iterator (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfDirectionCountSelect.def("cbegin", (StepVisual_Array1OfDirectionCountSelect::const_iterator (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfDirectionCountSelect.def("cend", (StepVisual_Array1OfDirectionCountSelect::const_iterator (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Init", (void (StepVisual_Array1OfDirectionCountSelect::*)(const StepVisual_DirectionCountSelect &)) &StepVisual_Array1OfDirectionCountSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("Size", (Standard_Integer (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::Size, "Size query");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Length", (Standard_Integer (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfDirectionCountSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfDirectionCountSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfDirectionCountSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Assign", (StepVisual_Array1OfDirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const StepVisual_Array1OfDirectionCountSelect &)) &StepVisual_Array1OfDirectionCountSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfDirectionCountSelect.def("Move", (StepVisual_Array1OfDirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(StepVisual_Array1OfDirectionCountSelect &&)) &StepVisual_Array1OfDirectionCountSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("assign", (StepVisual_Array1OfDirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const StepVisual_Array1OfDirectionCountSelect &)) &StepVisual_Array1OfDirectionCountSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfDirectionCountSelect.def("assign", (StepVisual_Array1OfDirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(StepVisual_Array1OfDirectionCountSelect &&)) &StepVisual_Array1OfDirectionCountSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("First", (const StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::First, "Returns first element");
	cls_StepVisual_Array1OfDirectionCountSelect.def("ChangeFirst", (StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)()) &StepVisual_Array1OfDirectionCountSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Last", (const StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)() const ) &StepVisual_Array1OfDirectionCountSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfDirectionCountSelect.def("ChangeLast", (StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)()) &StepVisual_Array1OfDirectionCountSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfDirectionCountSelect.def("Value", (const StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfDirectionCountSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("__call__", (const StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfDirectionCountSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("ChangeValue", (StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer)) &StepVisual_Array1OfDirectionCountSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("__call__", (StepVisual_DirectionCountSelect & (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer)) &StepVisual_Array1OfDirectionCountSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("SetValue", (void (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer, const StepVisual_DirectionCountSelect &)) &StepVisual_Array1OfDirectionCountSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("Resize", (void (StepVisual_Array1OfDirectionCountSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfDirectionCountSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfDirectionCountSelect.def("__iter__", [](const StepVisual_Array1OfDirectionCountSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfLayeredItem, std::unique_ptr<StepVisual_Array1OfLayeredItem, Deleter<StepVisual_Array1OfLayeredItem>>> cls_StepVisual_Array1OfLayeredItem(mod, "StepVisual_Array1OfLayeredItem", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfLayeredItem.def(py::init<>());
	cls_StepVisual_Array1OfLayeredItem.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfLayeredItem.def(py::init([] (const StepVisual_Array1OfLayeredItem &other) {return new StepVisual_Array1OfLayeredItem(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfLayeredItem.def(py::init<StepVisual_Array1OfLayeredItem &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfLayeredItem.def(py::init<const StepVisual_LayeredItem &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfLayeredItem.def("begin", (StepVisual_Array1OfLayeredItem::iterator (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfLayeredItem.def("end", (StepVisual_Array1OfLayeredItem::iterator (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfLayeredItem.def("cbegin", (StepVisual_Array1OfLayeredItem::const_iterator (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfLayeredItem.def("cend", (StepVisual_Array1OfLayeredItem::const_iterator (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfLayeredItem.def("Init", (void (StepVisual_Array1OfLayeredItem::*)(const StepVisual_LayeredItem &)) &StepVisual_Array1OfLayeredItem::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfLayeredItem.def("Size", (Standard_Integer (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::Size, "Size query");
	cls_StepVisual_Array1OfLayeredItem.def("Length", (Standard_Integer (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::Length, "Length query (the same)");
	cls_StepVisual_Array1OfLayeredItem.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfLayeredItem.def("Lower", (Standard_Integer (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::Lower, "Lower bound");
	cls_StepVisual_Array1OfLayeredItem.def("Upper", (Standard_Integer (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::Upper, "Upper bound");
	cls_StepVisual_Array1OfLayeredItem.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfLayeredItem.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfLayeredItem.def("Assign", (StepVisual_Array1OfLayeredItem & (StepVisual_Array1OfLayeredItem::*)(const StepVisual_Array1OfLayeredItem &)) &StepVisual_Array1OfLayeredItem::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfLayeredItem.def("Move", (StepVisual_Array1OfLayeredItem & (StepVisual_Array1OfLayeredItem::*)(StepVisual_Array1OfLayeredItem &&)) &StepVisual_Array1OfLayeredItem::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfLayeredItem.def("assign", (StepVisual_Array1OfLayeredItem & (StepVisual_Array1OfLayeredItem::*)(const StepVisual_Array1OfLayeredItem &)) &StepVisual_Array1OfLayeredItem::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfLayeredItem.def("assign", (StepVisual_Array1OfLayeredItem & (StepVisual_Array1OfLayeredItem::*)(StepVisual_Array1OfLayeredItem &&)) &StepVisual_Array1OfLayeredItem::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfLayeredItem.def("First", (const StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::First, "Returns first element");
	cls_StepVisual_Array1OfLayeredItem.def("ChangeFirst", (StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)()) &StepVisual_Array1OfLayeredItem::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfLayeredItem.def("Last", (const StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)() const ) &StepVisual_Array1OfLayeredItem::Last, "Returns last element");
	cls_StepVisual_Array1OfLayeredItem.def("ChangeLast", (StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)()) &StepVisual_Array1OfLayeredItem::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfLayeredItem.def("Value", (const StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfLayeredItem::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfLayeredItem.def("__call__", (const StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfLayeredItem::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfLayeredItem.def("ChangeValue", (StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer)) &StepVisual_Array1OfLayeredItem::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfLayeredItem.def("__call__", (StepVisual_LayeredItem & (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer)) &StepVisual_Array1OfLayeredItem::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfLayeredItem.def("SetValue", (void (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer, const StepVisual_LayeredItem &)) &StepVisual_Array1OfLayeredItem::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfLayeredItem.def("Resize", (void (StepVisual_Array1OfLayeredItem::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfLayeredItem::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfLayeredItem.def("__iter__", [](const StepVisual_Array1OfLayeredItem &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfSurfaceStyleElementSelect, std::unique_ptr<StepVisual_Array1OfSurfaceStyleElementSelect, Deleter<StepVisual_Array1OfSurfaceStyleElementSelect>>> cls_StepVisual_Array1OfSurfaceStyleElementSelect(mod, "StepVisual_Array1OfSurfaceStyleElementSelect", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def(py::init<>());
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def(py::init([] (const StepVisual_Array1OfSurfaceStyleElementSelect &other) {return new StepVisual_Array1OfSurfaceStyleElementSelect(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfSurfaceStyleElementSelect.def(py::init<StepVisual_Array1OfSurfaceStyleElementSelect &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def(py::init<const StepVisual_SurfaceStyleElementSelect &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("begin", (StepVisual_Array1OfSurfaceStyleElementSelect::iterator (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("end", (StepVisual_Array1OfSurfaceStyleElementSelect::iterator (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("cbegin", (StepVisual_Array1OfSurfaceStyleElementSelect::const_iterator (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("cend", (StepVisual_Array1OfSurfaceStyleElementSelect::const_iterator (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Init", (void (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const StepVisual_SurfaceStyleElementSelect &)) &StepVisual_Array1OfSurfaceStyleElementSelect::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Size", (Standard_Integer (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Size, "Size query");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Length", (Standard_Integer (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Length, "Length query (the same)");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Lower", (Standard_Integer (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Lower, "Lower bound");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Upper", (Standard_Integer (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Upper, "Upper bound");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Assign", (StepVisual_Array1OfSurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const StepVisual_Array1OfSurfaceStyleElementSelect &)) &StepVisual_Array1OfSurfaceStyleElementSelect::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Move", (StepVisual_Array1OfSurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(StepVisual_Array1OfSurfaceStyleElementSelect &&)) &StepVisual_Array1OfSurfaceStyleElementSelect::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("assign", (StepVisual_Array1OfSurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const StepVisual_Array1OfSurfaceStyleElementSelect &)) &StepVisual_Array1OfSurfaceStyleElementSelect::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("assign", (StepVisual_Array1OfSurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(StepVisual_Array1OfSurfaceStyleElementSelect &&)) &StepVisual_Array1OfSurfaceStyleElementSelect::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("First", (const StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::First, "Returns first element");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("ChangeFirst", (StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)()) &StepVisual_Array1OfSurfaceStyleElementSelect::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Last", (const StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)() const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Last, "Returns last element");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("ChangeLast", (StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)()) &StepVisual_Array1OfSurfaceStyleElementSelect::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Value", (const StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfSurfaceStyleElementSelect::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("__call__", (const StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer) const ) &StepVisual_Array1OfSurfaceStyleElementSelect::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("ChangeValue", (StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer)) &StepVisual_Array1OfSurfaceStyleElementSelect::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("__call__", (StepVisual_SurfaceStyleElementSelect & (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer)) &StepVisual_Array1OfSurfaceStyleElementSelect::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("SetValue", (void (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer, const StepVisual_SurfaceStyleElementSelect &)) &StepVisual_Array1OfSurfaceStyleElementSelect::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("Resize", (void (StepVisual_Array1OfSurfaceStyleElementSelect::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfSurfaceStyleElementSelect::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfSurfaceStyleElementSelect.def("__iter__", [](const StepVisual_Array1OfSurfaceStyleElementSelect &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
	...
	py::class_<StepVisual_VectorOfHSequenceOfInteger, std::unique_ptr<StepVisual_VectorOfHSequenceOfInteger, Deleter<StepVisual_VectorOfHSequenceOfInteger>>, NCollection_BaseVector> cls_StepVisual_VectorOfHSequenceOfInteger(mod, "StepVisual_VectorOfHSequenceOfInteger", "Class NCollection_Vector (dynamic array of objects)");
	cls_StepVisual_VectorOfHSequenceOfInteger.def(py::init<>());
	cls_StepVisual_VectorOfHSequenceOfInteger.def(py::init<const Standard_Integer>(), py::arg("theIncrement"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def(py::init<const Standard_Integer, const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theIncrement"), py::arg("theAlloc"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def(py::init([] (const StepVisual_VectorOfHSequenceOfInteger &other) {return new StepVisual_VectorOfHSequenceOfInteger(other);}), "Copy constructor", py::arg("other"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("begin", (StepVisual_VectorOfHSequenceOfInteger::iterator (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::begin, "Returns an iterator pointing to the first element in the vector.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("end", (StepVisual_VectorOfHSequenceOfInteger::iterator (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::end, "Returns an iterator referring to the past-the-end element in the vector.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("cbegin", (StepVisual_VectorOfHSequenceOfInteger::const_iterator (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::cbegin, "Returns a const iterator pointing to the first element in the vector.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("cend", (StepVisual_VectorOfHSequenceOfInteger::const_iterator (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::cend, "Returns a const iterator referring to the past-the-end element in the vector.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Length", (Standard_Integer (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::Length, "Total number of items");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Size", (Standard_Integer (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::Size, "Total number of items in the vector");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Lower", (Standard_Integer (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::Lower, "Method for consistency with other collections.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Upper", (Standard_Integer (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::Upper, "Method for consistency with other collections.");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("IsEmpty", (Standard_Boolean (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::IsEmpty, "Empty query");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Assign", [](StepVisual_VectorOfHSequenceOfInteger &self, const StepVisual_VectorOfHSequenceOfInteger & a0) -> void { return self.Assign(a0); }, py::arg("theOther"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Assign", (void (StepVisual_VectorOfHSequenceOfInteger::*)(const StepVisual_VectorOfHSequenceOfInteger &, const Standard_Boolean)) &StepVisual_VectorOfHSequenceOfInteger::Assign, "Assignment to the collection of the same type", py::arg("theOther"), py::arg("theOwnAllocator"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("assign", (StepVisual_VectorOfHSequenceOfInteger & (StepVisual_VectorOfHSequenceOfInteger::*)(const StepVisual_VectorOfHSequenceOfInteger &)) &StepVisual_VectorOfHSequenceOfInteger::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Append", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const opencascade::handle<TColStd_HSequenceOfInteger> &)) &StepVisual_VectorOfHSequenceOfInteger::Append, "Append", py::arg("theValue"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("__call__", (const opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const Standard_Integer) const ) &StepVisual_VectorOfHSequenceOfInteger::operator(), py::is_operator(), "Operator() - query the const value", py::arg("theIndex"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Value", (const opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const Standard_Integer) const ) &StepVisual_VectorOfHSequenceOfInteger::Value, "None", py::arg("theIndex"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("First", (const opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::First, "Returns first element");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("ChangeFirst", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)()) &StepVisual_VectorOfHSequenceOfInteger::ChangeFirst, "Returns first element");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("Last", (const opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)() const ) &StepVisual_VectorOfHSequenceOfInteger::Last, "Returns last element");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("ChangeLast", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)()) &StepVisual_VectorOfHSequenceOfInteger::ChangeLast, "Returns last element");
	cls_StepVisual_VectorOfHSequenceOfInteger.def("__call__", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const Standard_Integer)) &StepVisual_VectorOfHSequenceOfInteger::operator(), py::is_operator(), "Operator() - query the value", py::arg("theIndex"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("ChangeValue", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const Standard_Integer)) &StepVisual_VectorOfHSequenceOfInteger::ChangeValue, "None", py::arg("theIndex"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("SetValue", (opencascade::handle<TColStd_HSequenceOfInteger> & (StepVisual_VectorOfHSequenceOfInteger::*)(const Standard_Integer, const opencascade::handle<TColStd_HSequenceOfInteger> &)) &StepVisual_VectorOfHSequenceOfInteger::SetValue, "SetValue () - set or append a value", py::arg("theIndex"), py::arg("theValue"));
	cls_StepVisual_VectorOfHSequenceOfInteger.def("__iter__", [](const StepVisual_VectorOfHSequenceOfInteger &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\NCollection_Array1.hxx
	py::class_<StepVisual_Array1OfTessellatedItem, std::unique_ptr<StepVisual_Array1OfTessellatedItem, Deleter<StepVisual_Array1OfTessellatedItem>>> cls_StepVisual_Array1OfTessellatedItem(mod, "StepVisual_Array1OfTessellatedItem", "Purpose: The class Array1 represents unidimensional arrays of fixed size known at run time. The range of the index is user defined. An array1 can be constructed with a 'C array'. This functionality is useful to call methods expecting an Array1. It allows to carry the bounds inside the arrays.");
	cls_StepVisual_Array1OfTessellatedItem.def(py::init<>());
	cls_StepVisual_Array1OfTessellatedItem.def(py::init<const Standard_Integer, const Standard_Integer>(), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfTessellatedItem.def(py::init([] (const StepVisual_Array1OfTessellatedItem &other) {return new StepVisual_Array1OfTessellatedItem(other);}), "Copy constructor", py::arg("other"));
	// FIXME cls_StepVisual_Array1OfTessellatedItem.def(py::init<StepVisual_Array1OfTessellatedItem &&>(), py::arg("theOther"));
	cls_StepVisual_Array1OfTessellatedItem.def(py::init<const opencascade::handle<StepVisual_TessellatedItem> &, const Standard_Integer, const Standard_Integer>(), py::arg("theBegin"), py::arg("theLower"), py::arg("theUpper"));
	cls_StepVisual_Array1OfTessellatedItem.def("begin", (StepVisual_Array1OfTessellatedItem::iterator (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::begin, "Returns an iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfTessellatedItem.def("end", (StepVisual_Array1OfTessellatedItem::iterator (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::end, "Returns an iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfTessellatedItem.def("cbegin", (StepVisual_Array1OfTessellatedItem::const_iterator (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::cbegin, "Returns a const iterator pointing to the first element in the array.");
	cls_StepVisual_Array1OfTessellatedItem.def("cend", (StepVisual_Array1OfTessellatedItem::const_iterator (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::cend, "Returns a const iterator referring to the past-the-end element in the array.");
	cls_StepVisual_Array1OfTessellatedItem.def("Init", (void (StepVisual_Array1OfTessellatedItem::*)(const opencascade::handle<StepVisual_TessellatedItem> &)) &StepVisual_Array1OfTessellatedItem::Init, "Initialise the items with theValue", py::arg("theValue"));
	cls_StepVisual_Array1OfTessellatedItem.def("Size", (Standard_Integer (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::Size, "Size query");
	cls_StepVisual_Array1OfTessellatedItem.def("Length", (Standard_Integer (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::Length, "Length query (the same)");
	cls_StepVisual_Array1OfTessellatedItem.def("IsEmpty", (Standard_Boolean (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::IsEmpty, "Return TRUE if array has zero length.");
	cls_StepVisual_Array1OfTessellatedItem.def("Lower", (Standard_Integer (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::Lower, "Lower bound");
	cls_StepVisual_Array1OfTessellatedItem.def("Upper", (Standard_Integer (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::Upper, "Upper bound");
	cls_StepVisual_Array1OfTessellatedItem.def("IsDeletable", (Standard_Boolean (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::IsDeletable, "myDeletable flag");
	cls_StepVisual_Array1OfTessellatedItem.def("IsAllocated", (Standard_Boolean (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::IsAllocated, "IsAllocated flag - for naming compatibility");
	cls_StepVisual_Array1OfTessellatedItem.def("Assign", (StepVisual_Array1OfTessellatedItem & (StepVisual_Array1OfTessellatedItem::*)(const StepVisual_Array1OfTessellatedItem &)) &StepVisual_Array1OfTessellatedItem::Assign, "Assignment", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfTessellatedItem.def("Move", (StepVisual_Array1OfTessellatedItem & (StepVisual_Array1OfTessellatedItem::*)(StepVisual_Array1OfTessellatedItem &&)) &StepVisual_Array1OfTessellatedItem::Move, "Move assignment", py::arg("theOther"));
	cls_StepVisual_Array1OfTessellatedItem.def("assign", (StepVisual_Array1OfTessellatedItem & (StepVisual_Array1OfTessellatedItem::*)(const StepVisual_Array1OfTessellatedItem &)) &StepVisual_Array1OfTessellatedItem::operator=, py::is_operator(), "Assignment operator", py::arg("theOther"));
	// FIXME cls_StepVisual_Array1OfTessellatedItem.def("assign", (StepVisual_Array1OfTessellatedItem & (StepVisual_Array1OfTessellatedItem::*)(StepVisual_Array1OfTessellatedItem &&)) &StepVisual_Array1OfTessellatedItem::operator=, py::is_operator(), "Move assignment operator.", py::arg("theOther"));
	cls_StepVisual_Array1OfTessellatedItem.def("First", (const opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::First, "Returns first element");
	cls_StepVisual_Array1OfTessellatedItem.def("ChangeFirst", (opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)()) &StepVisual_Array1OfTessellatedItem::ChangeFirst, "Returns first element");
	cls_StepVisual_Array1OfTessellatedItem.def("Last", (const opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)() const ) &StepVisual_Array1OfTessellatedItem::Last, "Returns last element");
	cls_StepVisual_Array1OfTessellatedItem.def("ChangeLast", (opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)()) &StepVisual_Array1OfTessellatedItem::ChangeLast, "Returns last element");
	cls_StepVisual_Array1OfTessellatedItem.def("Value", (const opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfTessellatedItem::Value, "Constant value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfTessellatedItem.def("__call__", (const opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer) const ) &StepVisual_Array1OfTessellatedItem::operator(), py::is_operator(), "operator() - alias to Value", py::arg("theIndex"));
	cls_StepVisual_Array1OfTessellatedItem.def("ChangeValue", (opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer)) &StepVisual_Array1OfTessellatedItem::ChangeValue, "Variable value access", py::arg("theIndex"));
	cls_StepVisual_Array1OfTessellatedItem.def("__call__", (opencascade::handle<StepVisual_TessellatedItem> & (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer)) &StepVisual_Array1OfTessellatedItem::operator(), py::is_operator(), "operator() - alias to ChangeValue", py::arg("theIndex"));
	cls_StepVisual_Array1OfTessellatedItem.def("SetValue", (void (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer, const opencascade::handle<StepVisual_TessellatedItem> &)) &StepVisual_Array1OfTessellatedItem::SetValue, "Set value", py::arg("theIndex"), py::arg("theItem"));
	cls_StepVisual_Array1OfTessellatedItem.def("Resize", (void (StepVisual_Array1OfTessellatedItem::*)(const Standard_Integer, const Standard_Integer, const Standard_Boolean)) &StepVisual_Array1OfTessellatedItem::Resize, "Resizes the array to specified bounds. No re-allocation will be done if length of array does not change, but existing values will not be discarded if theToCopyData set to FALSE.", py::arg("theLower"), py::arg("theUpper"), py::arg("theToCopyData"));
	cls_StepVisual_Array1OfTessellatedItem.def("__iter__", [](const StepVisual_Array1OfTessellatedItem &s) { return py::make_iterator(s.begin(), s.end()); }, py::keep_alive<0, 1>());
