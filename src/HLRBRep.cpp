...
PYBIND11_MODULE(HLRBRep, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TypeOfResultingEdge.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ShapeBounds.hxx
	...
	cls_HLRBRep_ShapeBounds.def("Sizes", (void (HLRBRep_ShapeBounds::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &HLRBRep_ShapeBounds::Sizes, "None", py::arg("NV"), py::arg("NE"), py::arg("NF"));
	cls_HLRBRep_ShapeBounds.def("Bounds", (void (HLRBRep_ShapeBounds::*)(Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &HLRBRep_ShapeBounds::Bounds, "None", py::arg("V1"), py::arg("V2"), py::arg("E1"), py::arg("E2"), py::arg("F1"), py::arg("F2"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Data.hxx
	...
	cls_HLRBRep_Data.def("LocalLEGeometry2D", (void (HLRBRep_Data::*)(const Standard_Real, gp_Dir2d &, gp_Dir2d &, Standard_Real &)) &HLRBRep_Data::LocalLEGeometry2D, "Returns the local description of the projection of the current LEdge at parameter <Param>.", py::arg("Param"), py::arg("Tg"), py::arg("Nm"), py::arg("Cu"));
	cls_HLRBRep_Data.def("LocalFEGeometry2D", (void (HLRBRep_Data::*)(const Standard_Integer, const Standard_Real, gp_Dir2d &, gp_Dir2d &, Standard_Real &)) &HLRBRep_Data::LocalFEGeometry2D, "Returns the local description of the projection of the current FEdge at parameter <Param>.", py::arg("FE"), py::arg("Param"), py::arg("Tg"), py::arg("Nm"), py::arg("Cu"));
	...
	// FIXME cls_HLRBRep_Data.def("SimplClassify", (TopAbs_State (HLRBRep_Data::*)(const Standard_Integer, const HLRBRep_EdgeData &, const Standard_Integer, const Standard_Real, const Standard_Real)) &HLRBRep_Data::SimplClassify, "Simple classification of part of edge [p1, p2] returns OUT if at least 1 of Nbp points of edge is out othewise returns IN It is used to check 'suspision' hided part of edge.", py::arg("E"), py::arg("ED"), py::arg("Nbp"), py::arg("p1"), py::arg("p2"));
	cls_HLRBRep_Data.def("Classify", (TopAbs_State (HLRBRep_Data::*)(const Standard_Integer, const HLRBRep_EdgeData &, const Standard_Boolean, Standard_Integer &, const Standard_Real)) &HLRBRep_Data::Classify, "Classification of an edge.", py::arg("E"), py::arg("ED"), py::arg("LevelFlag"), py::arg("Level"), py::arg("param"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_InternalAlgo.hxx
	...
	cls_HLRBRep_InternalAlgo.def("Load", [](HLRBRep_InternalAlgo &self, const opencascade::handle<HLRTopoBRep_OutLiner> & a0, const opencascade::handle<Standard_Transient> & a1) -> void { return self.Load(a0, a1); }, py::arg("S"), py::arg("SData"));
	...
	cls_HLRBRep_InternalAlgo.def("Load", [](HLRBRep_InternalAlgo &self, const opencascade::handle<HLRTopoBRep_OutLiner> & a0) -> void { return self.Load(a0); }, py::arg("S"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Algo.hxx
	...
	cls_HLRBRep_Algo.def("Add", [](HLRBRep_Algo &self, const TopoDS_Shape & a0, const opencascade::handle<Standard_Transient> & a1) -> void { return self.Add(a0, a1); }, py::arg("S"), py::arg("SData"));
	...
	cls_HLRBRep_Algo.def("Add", [](HLRBRep_Algo &self, const TopoDS_Shape & a0) -> void { return self.Add(a0); }, py::arg("S"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Curve.hxx
	...
	// FIXME cls_HLRBRep_Curve.def("Update", (Standard_Real (HLRBRep_Curve::*)(Standard_Real [16], Standard_Real [16])) &HLRBRep_Curve::Update, "Update the minmax and the internal data", py::arg("TotMin"), py::arg("TotMax"));
	// FIXME cls_HLRBRep_Curve.def("UpdateMinMax", (Standard_Real (HLRBRep_Curve::*)(Standard_Real [16], Standard_Real [16])) &HLRBRep_Curve::UpdateMinMax, "Update the minmax returns tol for enlarge;", py::arg("TotMin"), py::arg("TotMax"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_CurveTool.hxx
	...
	cls_HLRBRep_CurveTool.def_static("GetInterval_", (void (*)(const Standard_Address, const Standard_Integer, const TColStd_Array1OfReal &, Standard_Real &, Standard_Real &)) &HLRBRep_CurveTool::GetInterval, "output the bounds of interval of index <Index> used if Type == Composite.", py::arg("C"), py::arg("Index"), py::arg("Tab"), py::arg("U1"), py::arg("U2"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_BCurveTool.hxx
	py::class_<HLRBRep_BCurveTool, std::unique_ptr<HLRBRep_BCurveTool, Deleter<HLRBRep_BCurveTool>>> cls_HLRBRep_BCurveTool(mod, "HLRBRep_BCurveTool", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_SurfaceTool.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_BSurfaceTool.hxx
	py::class_<HLRBRep_BSurfaceTool, std::unique_ptr<HLRBRep_BSurfaceTool, Deleter<HLRBRep_BSurfaceTool>>> cls_HLRBRep_BSurfaceTool(mod, "HLRBRep_BSurfaceTool", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Surface.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_CLPropsATool.hxx
	py::class_<HLRBRep_CLPropsATool, std::unique_ptr<HLRBRep_CLPropsATool, Deleter<HLRBRep_CLPropsATool>>> cls_HLRBRep_CLPropsATool(mod, "HLRBRep_CLPropsATool", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_CLProps.hxx
	py::class_<HLRBRep_CLProps, std::unique_ptr<HLRBRep_CLProps, Deleter<HLRBRep_CLProps>>> cls_HLRBRep_CLProps(mod, "HLRBRep_CLProps", "None");
	// FIXME cls_HLRBRep_CLProps.def(py::init<const HLRBRep_Curve *&, const Standard_Integer, const Standard_Real>(), py::arg("C"), py::arg("N"), py::arg("Resolution"));
	// FIXME cls_HLRBRep_CLProps.def(py::init<const HLRBRep_Curve *&, const Standard_Real, const Standard_Integer, const Standard_Real>(), py::arg("C"), py::arg("U"), py::arg("N"), py::arg("Resolution"));
	...
	// FIXME cls_HLRBRep_CLProps.def("SetCurve", (void (HLRBRep_CLProps::*)(const HLRBRep_Curve *&)) &HLRBRep_CLProps::SetCurve, "Initializes the local properties of the curve for the new curve.", py::arg("C"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_SLPropsATool.hxx
	py::class_<HLRBRep_SLPropsATool, std::unique_ptr<HLRBRep_SLPropsATool, Deleter<HLRBRep_SLPropsATool>>> cls_HLRBRep_SLPropsATool(mod, "HLRBRep_SLPropsATool", "None");
	...
	cls_HLRBRep_SLPropsATool.def_static("Bounds_", (void (*)(const Standard_Address, Standard_Real &, Standard_Real &, Standard_Real &, Standard_Real &)) &HLRBRep_SLPropsATool::Bounds, "returns the bounds of the Surface.", py::arg("A"), py::arg("U1"), py::arg("V1"), py::arg("U2"), py::arg("V2"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_SLProps.hxx
	py::class_<HLRBRep_SLProps, std::unique_ptr<HLRBRep_SLProps, Deleter<HLRBRep_SLProps>>> cls_HLRBRep_SLProps(mod, "HLRBRep_SLProps", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_CInter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_LineTool.hxx
	py::class_<HLRBRep_LineTool, std::unique_ptr<HLRBRep_LineTool, Deleter<HLRBRep_LineTool>>> cls_HLRBRep_LineTool(mod, "HLRBRep_LineTool", "The LineTool class provides class methods to access the methodes of the Line.");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_InterCSurf.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_EdgeFaceTool.hxx
	py::class_<HLRBRep_EdgeFaceTool, std::unique_ptr<HLRBRep_EdgeFaceTool, Deleter<HLRBRep_EdgeFaceTool>>> cls_HLRBRep_EdgeFaceTool(mod, "HLRBRep_EdgeFaceTool", "The EdgeFaceTool computes the UV coordinates at a given parameter on a Curve and a Surface. It also compute the signed curvature value in a direction at a given u,v point on a surface.");
	...
	cls_HLRBRep_EdgeFaceTool.def_static("UVPoint_", (Standard_Boolean (*)(const Standard_Real, const Standard_Address, const Standard_Address, Standard_Real &, Standard_Real &)) &HLRBRep_EdgeFaceTool::UVPoint, "return True if U and V are found.", py::arg("Par"), py::arg("E"), py::arg("F"), py::arg("U"), py::arg("V"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Intersector.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_EdgeData.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_FaceData.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_FaceIterator.hxx
	py::class_<HLRBRep_FaceIterator, std::unique_ptr<HLRBRep_FaceIterator, Deleter<HLRBRep_FaceIterator>>> cls_HLRBRep_FaceIterator(mod, "HLRBRep_FaceIterator", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ShapeToHLR.hxx
	...
	cls_HLRBRep_ShapeToHLR.def_static("Load_", [](const opencascade::handle<HLRTopoBRep_OutLiner> & a0, const HLRAlgo_Projector & a1, BRepTopAdaptor_MapOfShapeTool & a2) -> opencascade::handle<HLRBRep_Data> { return HLRBRep_ShapeToHLR::Load(a0, a1, a2); }, py::arg("S"), py::arg("P"), py::arg("MST"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_EdgeInterferenceTool.hxx
	...
	cls_HLRBRep_EdgeInterferenceTool.def("InterferenceBoundaryGeometry", (void (HLRBRep_EdgeInterferenceTool::*)(const HLRAlgo_Interference &, gp_Dir &, gp_Dir &, Standard_Real &) const ) &HLRBRep_EdgeInterferenceTool::InterferenceBoundaryGeometry, "Returns the geometry of the boundary at the interference <I>. See the AddInterference method of the class EdgeFaceTransition from TopCnx for the other arguments.", py::arg("I"), py::arg("Tang"), py::arg("Norm"), py::arg("Curv"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_VertexList.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_EdgeIList.hxx
	py::class_<HLRBRep_EdgeIList, std::unique_ptr<HLRBRep_EdgeIList, Deleter<HLRBRep_EdgeIList>>> cls_HLRBRep_EdgeIList(mod, "HLRBRep_EdgeIList", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_AreaLimit.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_EdgeBuilder.hxx
	py::class_<HLRBRep_EdgeBuilder, std::unique_ptr<HLRBRep_EdgeBuilder, Deleter<HLRBRep_EdgeBuilder>>> cls_HLRBRep_EdgeBuilder(mod, "HLRBRep_EdgeBuilder", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Hider.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_PolyAlgo.hxx
	...
	cls_HLRBRep_PolyAlgo.def("Hide", (HLRAlgo_BiPoint::PointsT & (HLRBRep_PolyAlgo::*)(HLRAlgo_EdgeStatus &, TopoDS_Shape &, Standard_Boolean &, Standard_Boolean &, Standard_Boolean &, Standard_Boolean &)) &HLRBRep_PolyAlgo::Hide, "None", py::arg("status"), py::arg("S"), py::arg("reg1"), py::arg("regn"), py::arg("outl"), py::arg("intl"));
	...
	cls_HLRBRep_PolyAlgo.def("Show", (HLRAlgo_BiPoint::PointsT & (HLRBRep_PolyAlgo::*)(TopoDS_Shape &, Standard_Boolean &, Standard_Boolean &, Standard_Boolean &, Standard_Boolean &)) &HLRBRep_PolyAlgo::Show, "None", py::arg("S"), py::arg("reg1"), py::arg("regn"), py::arg("outl"), py::arg("intl"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_BiPoint.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_BiPnt2D.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_PolyHLRToShape.hxx
	py::class_<HLRBRep_PolyHLRToShape, std::unique_ptr<HLRBRep_PolyHLRToShape, Deleter<HLRBRep_PolyHLRToShape>>> cls_HLRBRep_PolyHLRToShape(mod, "HLRBRep_PolyHLRToShape", "A framework for filtering the computation results of an HLRBRep_Algo algorithm by extraction. From the results calculated by the algorithm on a shape, a filter returns the type of edge you want to identify. You can choose any of the following types of output: - visible sharp edges - hidden sharp edges - visible smooth edges - hidden smooth edges - visible sewn edges - hidden sewn edges - visible outline edges - hidden outline edges. - visible isoparameters and - hidden isoparameters. Sharp edges present a C0 continuity (non G1). Smooth edges present a G1 continuity (non G2). Sewn edges present a C2 continuity. The result is composed of 2D edges in the projection plane of the view which the algorithm has worked with. These 2D edges are not included in the data structure of the visualized shape. In order to obtain a complete image, you must combine the shapes given by each of the chosen filters. The construction of the shape does not call a new computation of the algorithm, but only reads its internal results.");
	...
	cls_HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter.def("Value", (Standard_Boolean (HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::*)(const Standard_Real, Standard_Real &)) &HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::Value, "Calculation of F(U).", py::arg("U"), py::arg("F"));
	cls_HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter.def("Derivative", (Standard_Boolean (HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::*)(const Standard_Real, Standard_Real &)) &HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::Derivative, "Calculation of F'(U).", py::arg("U"), py::arg("DF"));
	cls_HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter.def("Values", (Standard_Boolean (HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &HLRBRep_PCLocFOfTheLocateExtPCOfTheProjPCurOfCInter::Values, "Calculation of F(U) and F'(U).", py::arg("U"), py::arg("F"), py::arg("DF"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter.hxx
	py::class_<HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter, std::unique_ptr<HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter, Deleter<HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter>>> cls_HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter(mod, "HLRBRep_TheLocateExtPCOfTheProjPCurOfCInter", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheProjPCurOfCInter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter.hxx
	...
	cls_HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter.def("Value", (Standard_Boolean (HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::*)(const Standard_Real, Standard_Real &)) &HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::Value, "Computes the value of the signed distance between the implicit curve and the point at parameter Param on the parametrised curve.", py::arg("Param"), py::arg("F"));
	cls_HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter.def("Derivative", (Standard_Boolean (HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::*)(const Standard_Real, Standard_Real &)) &HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::Derivative, "Computes the derivative of the previous function at parameter Param.", py::arg("Param"), py::arg("D"));
	cls_HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter.def("Values", (Standard_Boolean (HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &HLRBRep_MyImpParToolOfTheIntersectorOfTheIntConicCurveOfCInter::Values, "Computes the value and the derivative of the function.", py::arg("Param"), py::arg("F"), py::arg("D"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter.hxx
	py::class_<HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter, std::unique_ptr<HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter, Deleter<HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter>>, IntRes2d_Intersection> cls_HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter(mod, "HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter", "None");
	...
	cls_HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter.def("And_Domaine_Objet1_Intersections", (void (HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter::*)(const IntCurve_IConicTool &, const Standard_Address &, const IntRes2d_Domain &, const IntRes2d_Domain &, Standard_Integer &, TColStd_Array1OfReal &, TColStd_Array1OfReal &, TColStd_Array1OfReal &, TColStd_Array1OfReal &, const Standard_Real) const ) &HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter::And_Domaine_Objet1_Intersections, "None", py::arg("IntCurve_IConicTool"), py::arg("TheParCurve"), py::arg("TheImpCurveDomain"), py::arg("TheParCurveDomain"), py::arg("NbResultats"), py::arg("Inter2_And_Domain2"), py::arg("Inter1"), py::arg("Resultat1"), py::arg("Resultat2"), py::arg("EpsNul"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheIntConicCurveOfCInter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_IntConicCurveOfCInter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter.hxx
	...
	// FIXME cls_HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter.def("Dump", (void (HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter::*)() const ) &HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter::Dump, "None");

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter.hxx
	py::class_<HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter, std::unique_ptr<HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter, Deleter<HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter>>, math_FunctionSetWithDerivatives> cls_HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter(mod, "HLRBRep_TheDistBetweenPCurvesOfTheIntPCurvePCurveOfCInter", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter.hxx
	py::class_<HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter, std::unique_ptr<HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter, Deleter<HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter>>> cls_HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter(mod, "HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter", "None");
	...
	cls_HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter.def("Perform", (void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)(const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter &, const HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter &, Standard_Integer &, Standard_Integer &, Standard_Real &, Standard_Real &)) &HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::Perform, "None", py::arg("Poly1"), py::arg("Poly2"), py::arg("NumSegOn1"), py::arg("NumSegOn2"), py::arg("ParamOnSeg1"), py::arg("ParamOnSeg2"));
	...
	cls_HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter.def("Roots", (void (HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::*)(Standard_Real &, Standard_Real &)) &HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter::Roots, "None", py::arg("U"), py::arg("V"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheIntPCurvePCurveOfCInter.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ThePolygonOfInterCSurf.hxx
	...
	// FIXME cls_HLRBRep_ThePolygonOfInterCSurf.def("Dump", (void (HLRBRep_ThePolygonOfInterCSurf::*)() const ) &HLRBRep_ThePolygonOfInterCSurf::Dump, "None");

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ThePolygonToolOfInterCSurf.hxx
	py::class_<HLRBRep_ThePolygonToolOfInterCSurf, std::unique_ptr<HLRBRep_ThePolygonToolOfInterCSurf, Deleter<HLRBRep_ThePolygonToolOfInterCSurf>>> cls_HLRBRep_ThePolygonToolOfInterCSurf(mod, "HLRBRep_ThePolygonToolOfInterCSurf", "None");
	...
	// FIXME cls_HLRBRep_ThePolygonToolOfInterCSurf.def_static("Dump_", (void (*)(const HLRBRep_ThePolygonOfInterCSurf &)) &HLRBRep_ThePolygonToolOfInterCSurf::Dump, "None", py::arg("thePolygon"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ThePolyhedronOfInterCSurf.hxx
	...
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("Size", (void (HLRBRep_ThePolyhedronOfInterCSurf::*)(Standard_Integer &, Standard_Integer &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::Size, "get the size of the discretization.", py::arg("nbdu"), py::arg("nbdv"));
	...
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("Triangle", (void (HLRBRep_ThePolyhedronOfInterCSurf::*)(const Standard_Integer, Standard_Integer &, Standard_Integer &, Standard_Integer &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::Triangle, "Give the 3 points of the triangle of addresse Index in the double array of triangles.", py::arg("Index"), py::arg("P1"), py::arg("P2"), py::arg("P3"));
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("TriConnex", (Standard_Integer (HLRBRep_ThePolyhedronOfInterCSurf::*)(const Standard_Integer, const Standard_Integer, const Standard_Integer, Standard_Integer &, Standard_Integer &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::TriConnex, "Give the addresse Tricon of the triangle connexe to the triangle of address Triang by the edge Pivot Pedge and the third point of this connexe triangle. When we are on a free edge TriCon==0 but the function return the value of the triangle in the other side of Pivot on the free edge. Used to turn around a vertex.", py::arg("Triang"), py::arg("Pivot"), py::arg("Pedge"), py::arg("TriCon"), py::arg("OtherP"));
	...
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("Point", (const gp_Pnt & (HLRBRep_ThePolyhedronOfInterCSurf::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::Point, "Give the point of index i in the MaTriangle.", py::arg("Index"), py::arg("U"), py::arg("V"));
	...
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("PlaneEquation", (void (HLRBRep_ThePolyhedronOfInterCSurf::*)(const Standard_Integer, gp_XYZ &, Standard_Real &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::PlaneEquation, "Give the plane equation of the triangle of addresse Triang.", py::arg("Triang"), py::arg("NormalVector"), py::arg("PolarDistance"));
	...
	cls_HLRBRep_ThePolyhedronOfInterCSurf.def("Parameters", (void (HLRBRep_ThePolyhedronOfInterCSurf::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &HLRBRep_ThePolyhedronOfInterCSurf::Parameters, "None", py::arg("Index"), py::arg("U"), py::arg("V"));
	...
	// FIXME cls_HLRBRep_ThePolyhedronOfInterCSurf.def("Dump", (void (HLRBRep_ThePolyhedronOfInterCSurf::*)() const ) &HLRBRep_ThePolyhedronOfInterCSurf::Dump, "None");

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_ThePolyhedronToolOfInterCSurf.hxx
	...
	cls_HLRBRep_ThePolyhedronToolOfInterCSurf.def_static("Triangle_", (void (*)(const HLRBRep_ThePolyhedronOfInterCSurf &, const Standard_Integer, Standard_Integer &, Standard_Integer &, Standard_Integer &)) &HLRBRep_ThePolyhedronToolOfInterCSurf::Triangle, "Give the indices of the 3 points of the triangle of address Index in the PolyhedronTool.", py::arg("thePolyh"), py::arg("Index"), py::arg("P1"), py::arg("P2"), py::arg("P3"));
	...
	// FIXME cls_HLRBRep_ThePolyhedronToolOfInterCSurf.def_static("Dump_", (void (*)(const HLRBRep_ThePolyhedronOfInterCSurf &)) &HLRBRep_ThePolyhedronToolOfInterCSurf::Dump, "None", py::arg("thePolyh"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheInterferenceOfInterCSurf.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheCSFunctionOfInterCSurf.hxx
	py::class_<HLRBRep_TheCSFunctionOfInterCSurf, std::unique_ptr<HLRBRep_TheCSFunctionOfInterCSurf, Deleter<HLRBRep_TheCSFunctionOfInterCSurf>>, math_FunctionSetWithDerivatives> cls_HLRBRep_TheCSFunctionOfInterCSurf(mod, "HLRBRep_TheCSFunctionOfInterCSurf", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheExactInterCSurf.hxx
	py::class_<HLRBRep_TheExactInterCSurf, std::unique_ptr<HLRBRep_TheExactInterCSurf, Deleter<HLRBRep_TheExactInterCSurf>>> cls_HLRBRep_TheExactInterCSurf(mod, "HLRBRep_TheExactInterCSurf", "None");
	...
	cls_HLRBRep_TheExactInterCSurf.def("ParameterOnSurface", (void (HLRBRep_TheExactInterCSurf::*)(Standard_Real &, Standard_Real &) const ) &HLRBRep_TheExactInterCSurf::ParameterOnSurface, "None", py::arg("U"), py::arg("V"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf.hxx
	...
	cls_HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf.def("Value", (Standard_Boolean (HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::*)(const Standard_Real, Standard_Real &)) &HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::Value, "Computes the value of the signed distance between the implicit surface and the point at parameter Param on the parametrised curve. Value always returns True.", py::arg("Param"), py::arg("F"));
	cls_HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf.def("Derivative", (Standard_Boolean (HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::*)(const Standard_Real, Standard_Real &)) &HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::Derivative, "Computes the derivative of the previous function at parameter Param. Derivative always returns True.", py::arg("Param"), py::arg("D"));
	cls_HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf.def("Values", (Standard_Boolean (HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &HLRBRep_TheQuadCurvFuncOfTheQuadCurvExactInterCSurf::Values, "Computes the value and the derivative of the function. returns True.", py::arg("Param"), py::arg("F"), py::arg("D"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_TheQuadCurvExactInterCSurf.hxx
	...
	cls_HLRBRep_TheQuadCurvExactInterCSurf.def("Intervals", (void (HLRBRep_TheQuadCurvExactInterCSurf::*)(const Standard_Integer, Standard_Real &, Standard_Real &) const ) &HLRBRep_TheQuadCurvExactInterCSurf::Intervals, "U1 and U2 are the parameters of a segment on the curve.", py::arg("Index"), py::arg("U1"), py::arg("U2"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep.hxx
	...
	cls_HLRBRep.def_static("PolyHLRAngleAndDeflection_", (void (*)(const Standard_Real, Standard_Real &, Standard_Real &)) &HLRBRep::PolyHLRAngleAndDeflection, "None", py::arg("InAngl"), py::arg("OutAngl"), py::arg("OutDefl"));

	/* FIXME
	// C:\Miniconda\envs\occt\Library\include\opencascade\HLRBRep_Data.hxx
	py::class_<TableauRejection, std::unique_ptr<TableauRejection, Deleter<TableauRejection>>> cls_TableauRejection(mod, "TableauRejection", "None");
