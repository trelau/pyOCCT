...
PYBIND11_MODULE(CPnts, mod) {
	...
	cls_CPnts_AbscissaPoint.def("AdvPerform", (void (CPnts_AbscissaPoint::*)(const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real)) &CPnts_AbscissaPoint::AdvPerform, "Computes the point at the distance <Abscissa> of the curve; performs more appropriate tolerance management; to use this method in right way it is necessary to call empty consructor. then call method Init with Tolerance = Resolution, then call AdvPermorm. U0 is the parameter of the point from which the distance is measured and Ui is the starting value for the iterative process (should be close to the final solution).", py::arg("Abscissa"), py::arg("U0"), py::arg("Ui"), py::arg("Resolution"));
	...
	cls_CPnts_UniformDeflection.def("Initialize", (void (CPnts_UniformDeflection::*)(const Adaptor3d_Curve &, const Standard_Real, const Standard_Real, const Standard_Boolean)) &CPnts_UniformDeflection::Initialize, "Initialize the algorithms with <C>, <Deflection>, <UStep>, <Resolution> and <WithControl>", py::arg("C"), py::arg("Deflection"), py::arg("Resolution"), py::arg("WithControl"));
	cls_CPnts_UniformDeflection.def("Initialize", (void (CPnts_UniformDeflection::*)(const Adaptor2d_Curve2d &, const Standard_Real, const Standard_Real, const Standard_Boolean)) &CPnts_UniformDeflection::Initialize, "Initialize the algorithms with <C>, <Deflection>, <UStep>, <Resolution> and <WithControl>", py::arg("C"), py::arg("Deflection"), py::arg("Resolution"), py::arg("WithControl"));
	cls_CPnts_UniformDeflection.def("Initialize", (void (CPnts_UniformDeflection::*)(const Adaptor3d_Curve &, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Boolean)) &CPnts_UniformDeflection::Initialize, "Initialize the algorithms with <C>, <Deflection>, <UStep>, <U1>, <U2> and <WithControl>", py::arg("C"), py::arg("Deflection"), py::arg("U1"), py::arg("U2"), py::arg("Resolution"), py::arg("WithControl"));
	cls_CPnts_UniformDeflection.def("Initialize", (void (CPnts_UniformDeflection::*)(const Adaptor2d_Curve2d &, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Real, const Standard_Boolean)) &CPnts_UniformDeflection::Initialize, "Initialize the algorithms with <C>, <Deflection>, <UStep>, <U1>, <U2> and <WithControl>", py::arg("C"), py::arg("Deflection"), py::arg("U1"), py::arg("U2"), py::arg("Resolution"), py::arg("WithControl"));
