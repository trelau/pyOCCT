...
PYBIND11_MODULE(ShapeUpgrade, mod) {
	...
	cls_ShapeUpgrade_FixSmallCurves.def("Approx", (Standard_Boolean (ShapeUpgrade_FixSmallCurves::*)(opencascade::handle<Geom_Curve> &, opencascade::handle<Geom2d_Curve> &, opencascade::handle<Geom2d_Curve> &, Standard_Real &, Standard_Real &)) &ShapeUpgrade_FixSmallCurves::Approx, "None", py::arg("Curve3d"), py::arg("Curve2d"), py::arg("Curve2dR"), py::arg("First"), py::arg("Last"));
	...
	cls_ShapeUpgrade_FixSmallBezierCurves.def("Approx", (Standard_Boolean (ShapeUpgrade_FixSmallBezierCurves::*)(opencascade::handle<Geom_Curve> &, opencascade::handle<Geom2d_Curve> &, opencascade::handle<Geom2d_Curve> &, Standard_Real &, Standard_Real &)) &ShapeUpgrade_FixSmallBezierCurves::Approx, "None", py::arg("Curve3d"), py::arg("Curve2d"), py::arg("Curve2dR"), py::arg("First"), py::arg("Last"));
