...
PYBIND11_MODULE(AdvApp2Var, mod) {
	...
	// FIXME cls_AdvApp2Var_ApproxAFunc2Var.def("Dump", (void (AdvApp2Var_ApproxAFunc2Var::*)(Standard_OStream &) const ) &AdvApp2Var_ApproxAFunc2Var::Dump, "Prints on the stream o information on the current state of the object.", py::arg("o"));
