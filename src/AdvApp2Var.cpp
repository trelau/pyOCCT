...
PYBIND11_MODULE(AdvApp2Var, mod) {
	...
	// ENUMS
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_CriterionType.hxx
	py::enum_<AdvApp2Var_CriterionType>(mod, "AdvApp2Var_CriterionType", "influency of the criterion on cutting process//! cutting when criterion is not satisfied desactivation of the compute of the error max//! cutting when error max is not good or if error max is good and criterion is not satisfied")
		...
		.export_values();
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_CriterionRepartition.hxx
	...
	// CLASSES
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Context.hxx
	...
	// Callback for AdvApp2Var_EvaluatorFunc2Var.
	class PyCallback_AdvApp2Var_EvaluatorFunc2Var : public AdvApp2Var_EvaluatorFunc2Var {
	public:
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_EvaluatorFunc2Var.hxx
	py::class_<AdvApp2Var_EvaluatorFunc2Var, std::unique_ptr<AdvApp2Var_EvaluatorFunc2Var, Deleter<AdvApp2Var_EvaluatorFunc2Var>>, PyCallback_AdvApp2Var_EvaluatorFunc2Var> cls_AdvApp2Var_EvaluatorFunc2Var(mod, "AdvApp2Var_EvaluatorFunc2Var", "None");
	cls_AdvApp2Var_EvaluatorFunc2Var.def(py::init<>());
	cls_AdvApp2Var_EvaluatorFunc2Var.def("Evaluate", (void (AdvApp2Var_EvaluatorFunc2Var::*)(Standard_Integer *, Standard_Real *, Standard_Real *, Standard_Integer *, Standard_Real *, Standard_Integer *, Standard_Real *, Standard_Integer *, Standard_Integer *, Standard_Real *, Standard_Integer *) const ) &AdvApp2Var_EvaluatorFunc2Var::Evaluate, "Function evaluation method to be defined by descendant", py::arg("theDimension"), py::arg("theUStartEnd"), py::arg("theVStartEnd"), py::arg("theFavorIso"), py::arg("theConstParam"), py::arg("theNbParams"), py::arg("theParameters"), py::arg("theUOrder"), py::arg("theVOrder"), py::arg("theResult"), py::arg("theErrorCode"));
	cls_AdvApp2Var_EvaluatorFunc2Var.def("__call__", (void (AdvApp2Var_EvaluatorFunc2Var::*)(Standard_Integer *, Standard_Real *, Standard_Real *, Standard_Integer *, Standard_Real *, Standard_Integer *, Standard_Real *, Standard_Integer *, Standard_Integer *, Standard_Real *, Standard_Integer *) const ) &AdvApp2Var_EvaluatorFunc2Var::operator(), py::is_operator(), "Shortcut for function-call style usage", py::arg("theDimension"), py::arg("theUStartEnd"), py::arg("theVStartEnd"), py::arg("theFavorIso"), py::arg("theConstParam"), py::arg("theNbParams"), py::arg("theParameters"), py::arg("theUOrder"), py::arg("theVOrder"), py::arg("theResult"), py::arg("theErrorCode"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Framework.hxx
	...
	cls_AdvApp2Var_Framework.def("FirstNotApprox", (Standard_Boolean (AdvApp2Var_Framework::*)(Standard_Integer &, Standard_Integer &, AdvApp2Var_Iso &) const ) &AdvApp2Var_Framework::FirstNotApprox, "search the Index of the first Iso not approximated, if all Isos are approximated Standard_False is returned.", py::arg("IndexIso"), py::arg("IndexStrip"), py::arg("anIso"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Criterion.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Patch.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Network.hxx
	...
	cls_AdvApp2Var_Network.def("FirstNotApprox", (Standard_Boolean (AdvApp2Var_Network::*)(Standard_Integer &) const ) &AdvApp2Var_Network::FirstNotApprox, "search the Index of the first Patch not approximated, if all Patches are approximated Standard_False is returned", py::arg("Index"));
	...
	cls_AdvApp2Var_Network.def("SameDegree", (void (AdvApp2Var_Network::*)(const Standard_Integer, const Standard_Integer, Standard_Integer &, Standard_Integer &)) &AdvApp2Var_Network::SameDegree, "None", py::arg("iu"), py::arg("iv"), py::arg("ncfu"), py::arg("ncfv"));
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Node.hxx
	py::class_<AdvApp2Var_Node, std::unique_ptr<AdvApp2Var_Node, Deleter<AdvApp2Var_Node>>> cls_AdvApp2Var_Node(mod, "AdvApp2Var_Node", "used to store constraints on a (Ui,Vj) point");
	...
	// FIXME cls_AdvApp2Var_ApproxAFunc2Var.def("Dump", (void (AdvApp2Var_ApproxAFunc2Var::*)(Standard_OStream &) const ) &AdvApp2Var_ApproxAFunc2Var::Dump, "Prints on the stream o informations on the current state of the object.", py::arg("o"));

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data_f2c.hxx
	py::class_<inlist, std::unique_ptr<inlist, Deleter<inlist>>> cls_(mod, "", "None");
	cls_.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_ApproxF2var.hxx
	py::class_<AdvApp2Var_ApproxF2var, std::unique_ptr<AdvApp2Var_ApproxF2var, Deleter<AdvApp2Var_ApproxF2var>>> cls_AdvApp2Var_ApproxF2var(mod, "AdvApp2Var_ApproxF2var", "None");
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mdnombr_1_, std::unique_ptr<mdnombr_1_, Deleter<mdnombr_1_>>> cls_mdnombr_1(mod, "mdnombr_1", "None");
	cls_mdnombr_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<minombr_1_, std::unique_ptr<minombr_1_, Deleter<minombr_1_>>> cls_minombr_1(mod, "minombr_1", "None");
	cls_minombr_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<maovpar_1_, std::unique_ptr<maovpar_1_, Deleter<maovpar_1_>>> cls_maovpar_1(mod, "maovpar_1", "None");
	cls_maovpar_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<maovpch_1_, std::unique_ptr<maovpch_1_, Deleter<maovpch_1_>>> cls_maovpch_1(mod, "maovpch_1", "None");
	cls_maovpch_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mlgdrtl_1_, std::unique_ptr<mlgdrtl_1_, Deleter<mlgdrtl_1_>>> cls_mlgdrtl_1(mod, "mlgdrtl_1", "None");
	cls_mlgdrtl_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmjcobi_1_, std::unique_ptr<mmjcobi_1_, Deleter<mmjcobi_1_>>> cls_mmjcobi_1(mod, "mmjcobi_1", "None");
	cls_mmjcobi_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmcmcnp_1_, std::unique_ptr<mmcmcnp_1_, Deleter<mmcmcnp_1_>>> cls_mmcmcnp_1(mod, "mmcmcnp_1", "None");
	cls_mmcmcnp_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmapgss_1_, std::unique_ptr<mmapgss_1_, Deleter<mmapgss_1_>>> cls_mmapgss_1(mod, "mmapgss_1", "None");
	cls_mmapgss_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmapgs0_1_, std::unique_ptr<mmapgs0_1_, Deleter<mmapgs0_1_>>> cls_mmapgs0_1(mod, "mmapgs0_1", "None");
	cls_mmapgs0_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmapgs1_1_, std::unique_ptr<mmapgs1_1_, Deleter<mmapgs1_1_>>> cls_mmapgs1_1(mod, "mmapgs1_1", "None");
	cls_mmapgs1_1.def(py::init<>());

	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data.hxx
	py::class_<mmapgs2_1_, std::unique_ptr<mmapgs2_1_, Deleter<mmapgs2_1_>>> cls_mmapgs2_1(mod, "mmapgs2_1", "None");
	cls_mmapgs2_1.def(py::init<>());
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_MathBase.hxx
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_SysBase.hxx
	...
	if (py::hasattr(other_mod, "Standard_Utf8Char")) {
		mod.attr("logical1") = other_mod.attr("Standard_Utf8Char");
	}
	...
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data_f2c.hxx
	// C:\Miniconda\envs\occt\Library\include\opencascade\AdvApp2Var_Data_f2c.hxx
	if (py::hasattr(mod, "Z_f")) {
		mod.attr("C_f") = mod.attr("Z_f");
	}
