...
PYBIND11_MODULE(SelectMgr, mod) {
	...
	cls_SelectMgr_FrustumBuilder.def("WindowSize", (void (SelectMgr_FrustumBuilder::*)(Standard_Integer &, Standard_Integer &) const ) &SelectMgr_FrustumBuilder::WindowSize, "None", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_SelectMgr_BaseFrustum.def("WindowSize", (void (SelectMgr_BaseFrustum::*)(Standard_Integer &, Standard_Integer &) const ) &SelectMgr_BaseFrustum::WindowSize, "None", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Real &)) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theDepth"));
	cls_SelectMgr_BaseFrustum.def("Overlaps", [](SelectMgr_BaseFrustum &self, const SelectMgr_Vec3 & a0, const SelectMgr_Vec3 & a1) -> Standard_Boolean { return self.Overlaps(a0, a1); }, py::arg("theBoxMin"), py::arg("theBoxMax"));
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Boolean *)) &SelectMgr_BaseFrustum::Overlaps, "Returns true if selecting volume is overlapped by axis-aligned bounding box with minimum corner at point theMinPt and maximum at point theMaxPt", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theInside"));
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, Standard_Real &)) &SelectMgr_BaseFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theDepth"));
	...
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectMgr_BaseFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theDepth"));
	cls_SelectMgr_BaseFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_BaseFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_BaseFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePt1"), py::arg("thePt2"), py::arg("thePt3"), py::arg("theSensType"), py::arg("theDepth"));
	...
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Real &)) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theDepth"));
	cls_SelectMgr_RectangularFrustum.def("Overlaps", [](SelectMgr_RectangularFrustum &self, const SelectMgr_Vec3 & a0, const SelectMgr_Vec3 & a1) -> Standard_Boolean { return self.Overlaps(a0, a1); }, py::arg("theBoxMin"), py::arg("theBoxMax"));
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Boolean *)) &SelectMgr_RectangularFrustum::Overlaps, "Returns true if selecting volume is overlapped by axis-aligned bounding box with minimum corner at point theMinPt and maximum at point theMaxPt", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theInside"));
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, Standard_Real &)) &SelectMgr_RectangularFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theDepth"));
	...
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectMgr_RectangularFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theDepth"));
	cls_SelectMgr_RectangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_RectangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_RectangularFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theDepth"));
	...
	*/
	...
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Real &)) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theMinPnt"), py::arg("theMaxPnt"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Boolean *)) &SelectMgr_TriangularFrustum::Overlaps, "Returns true if selecting volume is overlapped by axis-aligned bounding box with minimum corner at point theMinPt and maximum at point theMaxPt", py::arg("theMinPt"), py::arg("theMaxPt"), py::arg("theInside"));
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, Standard_Real &)) &SelectMgr_TriangularFrustum::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectMgr_TriangularFrustum::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustum.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustum::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_TriangularFrustum::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theDepth"));
	...
	*/
	...
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Real &)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("theMinPnt"), py::arg("theMaxPnt"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Boolean *)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("theMinPnt"), py::arg("theMaxPnt"), py::arg("theInside"));
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, Standard_Real &)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const TColgp_Array1OfPnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("theArrayOfPnts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theDepth"));
	cls_SelectMgr_TriangularFrustumSet.def("Overlaps", (Standard_Boolean (SelectMgr_TriangularFrustumSet::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Select3D_TypeOfSensitivity, Standard_Real &)) &SelectMgr_TriangularFrustumSet::Overlaps, "None", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theDepth"));
	...
	cls_SelectMgr_SelectingVolumeManager.def("WindowSize", (void (SelectMgr_SelectingVolumeManager::*)(Standard_Integer &, Standard_Integer &) const ) &SelectMgr_SelectingVolumeManager::WindowSize, "None", py::arg("theWidth"), py::arg("theHeight"));
	...
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Real &)) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given axis-aligned box", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theDepth"));
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", [](SelectMgr_SelectingVolumeManager &self, const SelectMgr_Vec3 & a0, const SelectMgr_Vec3 & a1) -> Standard_Boolean { return self.Overlaps(a0, a1); }, py::arg("theBoxMin"), py::arg("theBoxMax"));
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const SelectMgr_Vec3 &, const SelectMgr_Vec3 &, Standard_Boolean *)) &SelectMgr_SelectingVolumeManager::Overlaps, "Returns true if selecting volume is overlapped by axis-aligned bounding box with minimum corner at point theMinPt and maximum at point theMaxPt", py::arg("theBoxMin"), py::arg("theBoxMax"), py::arg("theInside"));
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, Standard_Real &)) &SelectMgr_SelectingVolumeManager::Overlaps, "Intersection test between defined volume and given point", py::arg("thePnt"), py::arg("theDepth"));
	...
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const TColgp_Array1OfPnt &, Standard_Integer, Standard_Real &)) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given ordered set of points, representing line segments. The test may be considered of interior part or boundary line defined by segments depending on given sensitivity type", py::arg("theArrayOfPts"), py::arg("theSensType"), py::arg("theDepth"));
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, Standard_Real &)) &SelectMgr_SelectingVolumeManager::Overlaps, "Checks if line segment overlaps selecting frustum", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("theDepth"));
	cls_SelectMgr_SelectingVolumeManager.def("Overlaps", (Standard_Boolean (SelectMgr_SelectingVolumeManager::*)(const gp_Pnt &, const gp_Pnt &, const gp_Pnt &, Standard_Integer, Standard_Real &)) &SelectMgr_SelectingVolumeManager::Overlaps, "SAT intersection test between defined volume and given triangle. The test may be considered of interior part or boundary line defined by triangle vertices depending on given sensitivity type", py::arg("thePnt1"), py::arg("thePnt2"), py::arg("thePnt3"), py::arg("theSensType"), py::arg("theDepth"));
