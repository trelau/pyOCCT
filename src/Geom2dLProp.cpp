...
PYBIND11_MODULE(Geom2dLProp, mod) {
	...
	cls_Geom2dLProp_FuncCurExt.def("Value", (Standard_Boolean (Geom2dLProp_FuncCurExt::*)(const Standard_Real, Standard_Real &)) &Geom2dLProp_FuncCurExt::Value, "Returns the value for the variable <X>.", py::arg("X"), py::arg("F"));
	cls_Geom2dLProp_FuncCurExt.def("Derivative", (Standard_Boolean (Geom2dLProp_FuncCurExt::*)(const Standard_Real, Standard_Real &)) &Geom2dLProp_FuncCurExt::Derivative, "Returns the derivative for the variable <X>.", py::arg("X"), py::arg("D"));
	cls_Geom2dLProp_FuncCurExt.def("Values", (Standard_Boolean (Geom2dLProp_FuncCurExt::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &Geom2dLProp_FuncCurExt::Values, "Returns the value of the function and the derivative for the variable <X>.", py::arg("X"), py::arg("F"), py::arg("D"));
	...
	cls_Geom2dLProp_FuncCurNul.def("Value", (Standard_Boolean (Geom2dLProp_FuncCurNul::*)(const Standard_Real, Standard_Real &)) &Geom2dLProp_FuncCurNul::Value, "Returns the value for the variable <X>.", py::arg("X"), py::arg("F"));
	cls_Geom2dLProp_FuncCurNul.def("Derivative", (Standard_Boolean (Geom2dLProp_FuncCurNul::*)(const Standard_Real, Standard_Real &)) &Geom2dLProp_FuncCurNul::Derivative, "Returns the derivative for the variable <X>", py::arg("X"), py::arg("D"));
	cls_Geom2dLProp_FuncCurNul.def("Values", (Standard_Boolean (Geom2dLProp_FuncCurNul::*)(const Standard_Real, Standard_Real &, Standard_Real &)) &Geom2dLProp_FuncCurNul::Values, "Returns the value of the function and the derivative for the variable <X>.", py::arg("X"), py::arg("F"), py::arg("D"));
